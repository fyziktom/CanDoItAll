# Corrective playbook - graph invariant reset
...
`	ext
Execute only corrective subbundle _corrective-graph-invariant-reset. Repair the specific blocking defect, rerun the failed proof on fresh artifacts, update the live execution report and gate memo, and do not unblock downstream work until the gate passes.
`

## Preserved Bundle Notes

- Repair any failure to reject self-loops or dependency cycles at the service, runtime, or canvas boundary.
- Rerun the graph legality tests and Gate A proof before reopening runtime or workspace work.
