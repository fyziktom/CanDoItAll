# Corrective graph invariant reset

## Status
- Template

## Purpose
- Use when cyclic/self-loop process graphs still slip through save/publish or when runtime/canvas still hide invalid graphs behind silent fallbacks.
