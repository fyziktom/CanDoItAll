# Corrective template isolation reset

## Status
- Template

## Purpose
- Use when helper extraction still leaves mapping rules duplicated or introduces unsafe shared mutable template-pack state.
