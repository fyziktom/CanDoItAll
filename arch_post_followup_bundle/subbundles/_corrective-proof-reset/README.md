# Corrective playbook - proof reset
...
`	ext
Execute only corrective subbundle _corrective-proof-reset. Repair the specific blocking defect, rerun the failed proof on fresh artifacts, update the live execution report and gate memo, and do not unblock downstream work until the gate passes.
`
...
- Rerun the failed proof commands and rebuild the live execution report before reopening downstream phases.
