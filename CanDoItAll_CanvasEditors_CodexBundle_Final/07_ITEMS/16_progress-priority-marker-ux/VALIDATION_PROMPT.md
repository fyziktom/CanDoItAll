...
Validate **I16 — Progress, priority, and marker UX normalization** as a strict QA inspector.
...
- Node screenshot showing progress and priority badges.
- Context menu screenshot showing enlarged compact ring actions.
