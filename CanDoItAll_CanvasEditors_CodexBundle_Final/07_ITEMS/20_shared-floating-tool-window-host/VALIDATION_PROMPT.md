...
Validate **I20 — Shared floating tool window host for canvas editors** as a strict QA inspector.
...
- Floating tool window pinned inside the canvas.
- Floating tool window moved near another edge while still clamped to the visible canvas.
