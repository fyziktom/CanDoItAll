...
Validate **I17 — Relationship editing, delete behavior, and borders** as a strict QA inspector.
...
- Reconnect flow screenshot or sequence.
- Delete confirmation behavior for a complex node.
- Named border with dropped nodes inside it.
