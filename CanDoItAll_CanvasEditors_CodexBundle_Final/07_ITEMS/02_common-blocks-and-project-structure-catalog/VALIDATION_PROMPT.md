...
Validate **I02 — Common starter blocks and project structure catalog refresh** as a strict QA inspector.
...
- Capture the standard blocks toolbox or catalog with the new starter blocks visible.
- Capture a canvas screenshot showing one instance of each starter block added successfully.
