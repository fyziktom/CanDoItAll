...
Validate **I04 — Recording, transcript, and LLM-backed actions** as a strict QA inspector.
...
- Recording node context menu or inspector with Create transcript action.
- Transcript node with source metadata or standalone metadata visible.
- LLM confirmation dialog showing OpenAI API and Local Ollama selector.
