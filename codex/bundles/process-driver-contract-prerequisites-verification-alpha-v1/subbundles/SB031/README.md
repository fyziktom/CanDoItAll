# SB031 — Core package and API documentation
...
Document current Core namespaces, public descriptors, extension rules, and forbidden dependencies for future contributors.
...
Implement SB031 for phase P11 (Core documentation, package hygiene, and compatibility roadmap). Keep changes scoped to: Document current Core namespaces, public descriptors, extension rules, and forbidden dependencies for future contributors.
