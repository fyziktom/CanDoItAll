# SB024 — Gate H: descriptor consumer boundary
...
Prove Core consumers are allow-listed and no side-effect dispatch files import Core by broad/global using.
...
Implement SB024 for phase P08 (Core evidence descriptor consumer hardening). Keep changes scoped to: Prove Core consumers are allow-listed and no side-effect dispatch files import Core by broad/global using.
