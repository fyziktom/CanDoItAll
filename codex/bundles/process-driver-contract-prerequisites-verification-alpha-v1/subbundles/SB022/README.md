# SB022 — Execution/finalizer descriptor consumer map
...
Update adapter ownership map for execution/finalizer descriptors and ensure only explicit module adapters consume Core descriptors.
...
Implement SB022 for phase P08 (Core evidence descriptor consumer hardening). Keep changes scoped to: Update adapter ownership map for execution/finalizer descriptors and ensure only explicit module adapters consume Core descriptors.
