# SB011 — Secret masking and sensitive field policy
...
Define and test redaction rules for tokens, connection strings, env vars, emails where needed, and unrelated user content.
...
Implement SB011 for phase P04 (Audit facts, redaction, and evidence traceability). Keep changes scoped to: Define and test redaction rules for tokens, connection strings, env vars, emails where needed, and unrelated user content.
