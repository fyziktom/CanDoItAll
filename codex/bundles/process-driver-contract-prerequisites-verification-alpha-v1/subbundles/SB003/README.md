...
Run build/full unit/focused process tests and source scans before downstream phases can start.
...
Implement SB003 for phase P01 (Baseline, active proof intake, and no-regression guardrails). Keep changes scoped to: Run build/full unit/focused process tests and source scans before downstream phases can start.
