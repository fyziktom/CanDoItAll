# SB004 — Core public API snapshot refresh
...
Inventory every public Core type/member and classify as stable, provisional, or candidate-to-split.
...
Implement SB004 for phase P02 (Core API stability and descriptor governance). Keep changes scoped to: Inventory every public Core type/member and classify as stable, provisional, or candidate-to-split.
