# SB023 — Projection/validation descriptor consumer map
...
Update projection/validation descriptor adapter map and keep storage/workspace/browser probing module-local.
...
Implement SB023 for phase P08 (Core evidence descriptor consumer hardening). Keep changes scoped to: Update projection/validation descriptor adapter map and keep storage/workspace/browser probing module-local.
