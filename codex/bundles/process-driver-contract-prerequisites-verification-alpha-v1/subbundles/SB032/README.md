# SB032 — Compatibility and migration guide
...
Write migration notes for route/subprocess/artifact/execution/finalizer descriptor consumers and adapter ownership.
...
Implement SB032 for phase P11 (Core documentation, package hygiene, and compatibility roadmap). Keep changes scoped to: Write migration notes for route/subprocess/artifact/execution/finalizer descriptor consumers and adapter ownership.
