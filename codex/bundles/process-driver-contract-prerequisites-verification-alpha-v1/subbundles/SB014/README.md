# SB014 — Sandbox boundary requirements
...
Define future sandbox prerequisites: working directory, timeout, captured output hash, network policy, file-system policy, and failure semantics.
...
Implement SB014 for phase P05 (Sandbox and command policy denial). Keep changes scoped to: Define future sandbox prerequisites: working directory, timeout, captured output hash, network policy, file-system policy, and failure semantics.
