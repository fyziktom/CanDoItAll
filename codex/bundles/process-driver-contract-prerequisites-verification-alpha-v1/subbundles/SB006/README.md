# SB006 — Gate B: Core API governance
...
Prove public Core API guard, no forbidden dependency drift, and compatibility docs/tests are current.
...
Implement SB006 for phase P02 (Core API stability and descriptor governance). Keep changes scoped to: Prove public Core API guard, no forbidden dependency drift, and compatibility docs/tests are current.
