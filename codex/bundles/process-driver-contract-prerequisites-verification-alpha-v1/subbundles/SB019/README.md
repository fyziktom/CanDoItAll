# SB019 — .NET/Rust evidence fixture inventory
...
Inventory current build/test/proof transcript shapes that a future verification-only .NET/Rust driver may inspect.
...
Implement SB019 for phase P07 (.NET/Rust transcript verifier alpha preparation). Keep changes scoped to: Inventory current build/test/proof transcript shapes that a future verification-only .NET/Rust driver may inspect.
