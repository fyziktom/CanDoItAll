# SB005 — Descriptor versioning and compatibility policy
...
Define explicit v1 compatibility rules for Core descriptors, enum additions, deprecations, and API owner review.
...
Implement SB005 for phase P02 (Core API stability and descriptor governance). Keep changes scoped to: Define explicit v1 compatibility rules for Core descriptors, enum additions, deprecations, and API owner review.
