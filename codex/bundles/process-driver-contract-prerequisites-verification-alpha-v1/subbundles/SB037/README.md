...
Run solution build, full unit tests, focused integration matrix, architecture tests, no-Core-broad/no-driver-runtime/no-UI/no-stub scans.
...
Implement SB037 for phase P13 (Broad smoke, red-team, and completed-stage closure). Keep changes scoped to: Run solution build, full unit tests, focused integration matrix, architecture tests, no-Core-broad/no-driver-runtime/no-UI/no-stub scans.
