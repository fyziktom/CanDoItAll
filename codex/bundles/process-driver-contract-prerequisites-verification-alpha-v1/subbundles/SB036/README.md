...
Prove roadmap is consistent with Core/API/driver decisions and contains no production runtime implementation instructions.
...
Implement SB036 for phase P12 (Long-range roadmap to stable Core + domain drivers). Keep changes scoped to: Prove roadmap is consistent with Core/API/driver decisions and contains no production runtime implementation instructions.
