# SB020 — Transcript normalization and diagnostic taxonomy
...
Define read-only taxonomy for build warnings/errors, test failures, missing artifacts, unsupported target framework, and runtime proof gaps.
...
Implement SB020 for phase P07 (.NET/Rust transcript verifier alpha preparation). Keep changes scoped to: Define read-only taxonomy for build warnings/errors, test failures, missing artifacts, unsupported target framework, and runtime proof gaps.
