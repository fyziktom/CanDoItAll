# SB017 — Driver denial and unsupported operation results
...
Define consistent denial result shape for unsupported mutation, missing permission, unsupported lane, unsafe command, and missing evidence.
...
Implement SB017 for phase P06 (Verification-only contract rehearsal without production runtime). Keep changes scoped to: Define consistent denial result shape for unsupported mutation, missing permission, unsupported lane, unsafe command, and missing evidence.
