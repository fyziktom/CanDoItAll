# SB008 — Capability scope and lane ownership matrix
...
Define capability scopes for route, artifact, runtime verification, .NET/Rust, Office, and business-analysis lanes with denied side effects.
...
Implement SB008 for phase P03 (Driver permission model as executable prerequisites). Keep changes scoped to: Define capability scopes for route, artifact, runtime verification, .NET/Rust, Office, and business-analysis lanes with denied side effects.
