# SB007 — Permission mode facts and denial matrix
...
Convert VerificationOnly, ManagerReadonly, and ExecutionCapableFuture mode semantics into executable tests and docs-only read models.
...
Implement SB007 for phase P03 (Driver permission model as executable prerequisites). Keep changes scoped to: Convert VerificationOnly, ManagerReadonly, and ExecutionCapableFuture mode semantics into executable tests and docs-only read models.
