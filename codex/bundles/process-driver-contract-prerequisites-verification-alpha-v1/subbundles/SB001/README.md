# SB001 — Current branch and proof intake
...
Verify the latest maf-processes-refactor branch, last bundle proof, changed Core/API surface, warning status, and driver decision docs before any implementation.
...
Implement SB001 for phase P01 (Baseline, active proof intake, and no-regression guardrails). Keep changes scoped to: Verify the latest maf-processes-refactor branch, last bundle proof, changed Core/API surface, warning status, and driver decision docs before any implementation.
