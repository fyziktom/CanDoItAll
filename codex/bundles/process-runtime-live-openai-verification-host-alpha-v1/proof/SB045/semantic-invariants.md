...
## SB045-INV-001
- Invariant ID: SB045-INV-001
- Source raw note: Keep generic Process Core with domain drivers.
- Expected behavior: Execution-capable driver names and hosted execution hooks remain absent from production source.
...
- Failing-first test: N/A process non-production future gate; no execution behavior changed by this gate.
