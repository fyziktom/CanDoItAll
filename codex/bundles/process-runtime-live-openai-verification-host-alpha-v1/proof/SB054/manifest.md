...
## Semantic Contract
- Invariant contract: bundle://proof/SB054/semantic-invariants.md
- Invariant IDs: SB054-INV-001
- Raw note owned: Prepare detailed bundle zip.
...
- Failing-first: N/A process non-production docs gate; no behavior changed by this gate.
