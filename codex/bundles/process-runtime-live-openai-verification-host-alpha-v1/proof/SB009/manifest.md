...
## Semantic Contract
- Invariant contract: bundle://proof/SB009/semantic-invariants.md
- Invariant IDs: SB009-INV-001
- Raw note owned: Use OpenAI credits for actual test.
...
## Command Transcripts
- Passing transcript: bundle://proof/SB006/transcripts/live-openai-specialist-agent-smoke.txt
...
- Failing-first: N/A process non-production live-route gate; no behavior changed by this gate.
