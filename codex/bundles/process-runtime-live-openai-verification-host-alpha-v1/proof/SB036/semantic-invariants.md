...
- Expected behavior: The source scan proves no hosted service, scheduler, or workflow hook was added for driver execution.
...
- Failing-first test: N/A process non-production scheduler gate; no behavior changed by this gate.
