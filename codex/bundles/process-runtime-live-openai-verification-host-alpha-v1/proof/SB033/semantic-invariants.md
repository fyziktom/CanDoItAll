...
- Expected behavior: Audit evidence stores lane, correlation, outcome counts, and an observation hash without secret values.
...
- Failing-first test: N/A process non-production hardening gate; no separate behavior changed by this gate.
