...
## SB042-INV-001
- Invariant ID: SB042-INV-001
- Source raw note: Keep generic Process Core with domain drivers.
- Expected behavior: Process Core remains free of module, driver, EF, storage, workspace, logging, and service-provider dependencies.
...
- Failing-first test: N/A process non-production dependency audit; no behavior changed by this gate.
- Passing test: bundle://proof/SB015/transcripts/architecture-boundary-tests-after-host.txt
