...
## Semantic Contract
- Invariant contract: bundle://proof/SB042/semantic-invariants.md
- Invariant IDs: SB042-INV-001
- Raw note owned: Keep generic Process Core with domain drivers.
...
## Command Transcripts
- Passing transcript: bundle://proof/SB015/transcripts/architecture-boundary-tests-after-host.txt
...
- Failing-first: N/A process non-production dependency audit; no behavior changed by this gate.
