...
- Expected behavior: Manager diagnostics carry the audit identity into the read-only projection with no UI file drift.
...
- Failing-first test: N/A process non-production projection gate; no separate UI behavior changed by this gate.
