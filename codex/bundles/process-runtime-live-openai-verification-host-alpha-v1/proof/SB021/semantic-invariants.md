...
- Expected behavior: DI composes the verification host, manager command, lane selector, and shared audit boundary without registering execution-capable hooks.
