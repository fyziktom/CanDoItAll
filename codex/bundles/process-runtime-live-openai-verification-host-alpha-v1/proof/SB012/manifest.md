...
## Semantic Contract
- Invariant contract: bundle://proof/SB012/semantic-invariants.md
- Invariant IDs: SB012-INV-001
- Raw note owned: Look at real test outcome.
...
- Failing-first: N/A process non-production safety-net gate; no behavior changed by this gate.
