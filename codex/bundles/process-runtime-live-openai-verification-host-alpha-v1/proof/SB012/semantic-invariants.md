...
- Expected behavior: Deterministic safety proof stays green after the live smoke and host implementation.
...
- Failing-first test: N/A process non-production safety-net gate; no behavior changed by this gate.
