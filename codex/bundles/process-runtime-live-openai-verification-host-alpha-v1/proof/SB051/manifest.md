...
## Semantic Contract
- Invariant contract: bundle://proof/SB051/semantic-invariants.md
- Invariant IDs: SB051-INV-001
...
## Command Transcripts
- Passing transcript: bundle://proof/SB051/transcripts/unit-tests-debug-rerun.txt
...
- Failing-first: N/A process non-production release gate; no distinct behavior changed by this gate.
