...
## SB057-INV-001
- Invariant ID: SB057-INV-001
- Source raw note: Prepare detailed bundle zip.
- Expected behavior: Report-only, deterministic-only, secret-leaking, bundle-coupled, and stubbed implementations are rejected by scans and tests.
...
- Failing-first test: N/A process non-production red-team gate; no behavior changed by this gate.
