# SB037 — Host observability events and failure taxonomy

## Status
Prepared.

## Objective
Execute the host observability events and failure taxonomy slice for **P13: Process runtime host observability and failure taxonomy**.
...
- Proof artifacts under `bundle://proof/SB037/`.

## Dependency Impact
This subbundle belongs to P13. Its output feeds downstream phases in `bundle://plan/01-phase-plan.md`. If this proof is wrong, later host/manager/runtime conclusions are untrustworthy.
...
## Proof Required
- `bundle://proof/SB037/manifest.md`
...
## Progression Gate
SB037 may close only after its proof exists and downstream dependencies are checked.

## Suggested Agent Prompt
Implement SB037 for process-runtime-live-openai-verification-host-alpha-v1. Preserve process runtime behavior, keep drivers verification-only, and close proof with source-backed tests instead of report-only claims.
