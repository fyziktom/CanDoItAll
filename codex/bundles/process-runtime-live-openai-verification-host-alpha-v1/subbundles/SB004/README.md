# SB004 — OpenAI live configuration normalization

## Status
- Status: Completed

## Objective
Execute the openai live configuration normalization slice for **P02: Guarded live OpenAI smoke**.
...
- Proof artifacts under `bundle://proof/SB004/`.
...
This subbundle belongs to P02. Its output feeds downstream phases in `bundle://plan/01-phase-plan.md`. If this proof is wrong, later host/manager/runtime conclusions are untrustworthy.
...
## Proof Required
- `bundle://proof/SB004/manifest.md`
...
SB004 may close only after its proof exists and downstream dependencies are checked.

## Suggested Agent Prompt
Implement SB004 for process-runtime-live-openai-verification-host-alpha-v1. Preserve process runtime behavior, keep drivers verification-only, and close proof with source-backed tests instead of report-only claims.
