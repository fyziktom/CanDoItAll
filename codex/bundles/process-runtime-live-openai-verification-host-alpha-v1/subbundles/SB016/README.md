# SB016 — Explicit registry implementation

## Status
- Status: Completed

## Objective
Execute the explicit registry implementation slice for **P06: Explicit registry and selector alpha**.
...
- Proof artifacts under `bundle://proof/SB016/`.
...
## Proof Required
- `bundle://proof/SB016/manifest.md`
...
SB016 may close only after its proof exists and downstream dependencies are checked.

## Suggested Agent Prompt
Implement SB016 for process-runtime-live-openai-verification-host-alpha-v1. Preserve process runtime behavior, keep drivers verification-only, and close proof with source-backed tests instead of report-only claims.
