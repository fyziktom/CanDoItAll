# SB005 — Minimal live OpenAI provider smoke

## Status
Prepared.

## Objective
Execute the minimal live openai provider smoke slice for **P02: Guarded live OpenAI smoke**.
...
- Proof artifacts under `bundle://proof/SB005/`.
...
## Proof Required
- `bundle://proof/SB005/manifest.md`
...
## Progression Gate
SB005 may close only after its proof exists and downstream dependencies are checked.

## Suggested Agent Prompt
Implement SB005 for process-runtime-live-openai-verification-host-alpha-v1. Preserve process runtime behavior, keep drivers verification-only, and close proof with source-backed tests instead of report-only claims.
