# SB038 — Failure handoff/readback integration

## Status
Prepared.

## Objective
Execute the failure handoff/readback integration slice for **P13: Process runtime host observability and failure taxonomy**.
...
- Proof artifacts under `bundle://proof/SB038/`.
...
## Proof Required
- `bundle://proof/SB038/manifest.md`
...
## Progression Gate
SB038 may close only after its proof exists and downstream dependencies are checked.

## Suggested Agent Prompt
Implement SB038 for process-runtime-live-openai-verification-host-alpha-v1. Preserve process runtime behavior, keep drivers verification-only, and close proof with source-backed tests instead of report-only claims.
