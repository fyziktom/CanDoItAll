# SB049 — Release-candidate build/unit/focused integration matrix

## Status
Prepared.

## Objective
Execute the release-candidate build/unit/focused integration matrix slice for **P17: Release-candidate full matrix**.
...
- Proof artifacts under `bundle://proof/SB049/`.

## Dependency Impact
This subbundle belongs to P17. Its output feeds downstream phases in `bundle://plan/01-phase-plan.md`. If this proof is wrong, later host/manager/runtime conclusions are untrustworthy.
...
## Proof Required
- `bundle://proof/SB049/manifest.md`
...
## Progression Gate
SB049 may close only after its proof exists and downstream dependencies are checked.

## Suggested Agent Prompt
Implement SB049 for process-runtime-live-openai-verification-host-alpha-v1. Preserve process runtime behavior, keep drivers verification-only, and close proof with source-backed tests instead of report-only claims.
