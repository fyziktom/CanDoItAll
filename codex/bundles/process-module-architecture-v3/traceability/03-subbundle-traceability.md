...
| SB21 Launch Planning And Candidate Readiness | REQ-010, REQ-011, REQ-014, REQ-024, REQ-051, REQ-052, REQ-054 | `architecture/04-builder-and-instance-composition.md`, `architecture/14-manager-runtime-and-control-loop.md`, `architecture/20-role-candidate-selection-and-readiness.md` | US-026 to US-029, US-041, US-056 | AC-004, AC-005, AC-012, AC-021, AC-040, AC-042 | G21, launch/candidate-readiness/approval/provisioning proof. |
...
| SB27 Project/API Compatibility | REQ-006 to REQ-011, REQ-030, REQ-037 to REQ-040, REQ-051, REQ-052, REQ-055 | `architecture/16-execution-adapters-and-integration-boundaries.md`, `architecture/10-security-governance-and-agent-change-auditing.md`, `architecture/21-process-api-codex-skill-and-e2e-source-scenarios.md` | US-002, US-049 to US-051 | AC-010, AC-021, AC-026, AC-036, AC-040, AC-043 | G27, project/API/tool/skill/scenario-loading proof. |
| SB28 Final Closure | REQ-001 to REQ-055 | All architecture files | US-001 to US-056 final regression | AC-001 to AC-043 | G28, E2E, final source scenario replay, scans, refactoring, security, complete story proof, performance scan summary, candidate readiness proof. |
