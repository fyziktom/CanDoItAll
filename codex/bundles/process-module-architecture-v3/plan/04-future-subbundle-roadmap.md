...
| SB21 Launch Planning And Candidate Readiness | SB18 | `architecture/04-builder-and-instance-composition.md`, `architecture/14-manager-runtime-and-control-loop.md`, `architecture/20-role-candidate-selection-and-readiness.md` | US-026 to US-029, US-041, US-056 | AC-004, AC-012, AC-021, AC-040, AC-042 | SB18 report, builder/manager architecture, role candidate readiness architecture. |
