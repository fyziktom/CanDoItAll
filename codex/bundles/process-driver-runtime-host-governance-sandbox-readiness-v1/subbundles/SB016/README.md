# SB016 - Manager API/readback facade: inventory and source changes
...
## Proof Required
- `proof/SB016/manifest.md`
- `proof/SB016/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB016/transcripts/`.
- Changed-file hashes.
...
Implement SB016 for `Manager API/readback facade`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.