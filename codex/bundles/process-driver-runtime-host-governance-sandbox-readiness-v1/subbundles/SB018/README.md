# SB018 - Critical Gate P06: semantic closure for Manager API/readback facade
...
- `proof/SB018/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB018/transcripts/`.
- Changed-file hashes.
...
Implement SB018 for `Manager API/readback facade`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.