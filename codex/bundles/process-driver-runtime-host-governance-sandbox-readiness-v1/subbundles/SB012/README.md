# SB012 - Critical Gate P04: semantic closure for Host health, readiness, emergency disable
...
- `proof/SB012/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB012/transcripts/`.
- Changed-file hashes.
...
Implement SB012 for `Host health, readiness, emergency disable`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.