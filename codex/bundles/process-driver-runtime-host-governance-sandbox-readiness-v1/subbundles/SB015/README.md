# SB015 - Critical Gate P05: semantic closure for Exact registry/selector and lane options
...
## Proof Required
- `proof/SB015/manifest.md`
- `proof/SB015/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB015/transcripts/`.
- Changed-file hashes.
...
Implement SB015 for `Exact registry/selector and lane options`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.