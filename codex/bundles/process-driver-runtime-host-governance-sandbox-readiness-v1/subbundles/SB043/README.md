# SB043 - Domain driver pack topology and no self-registration: inventory and source changes
...
- `proof/SB043/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB043/transcripts/`.
- Changed-file hashes.
...
Implement SB043 for `Domain driver pack topology and no self-registration`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.