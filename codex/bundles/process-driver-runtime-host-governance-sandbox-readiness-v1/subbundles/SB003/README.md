# SB003 - Critical Gate P01: semantic closure for Source and proof reconciliation
...
- `proof/SB003/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB003/transcripts/`.
- Changed-file hashes.
...
Implement SB003 for `Source and proof reconciliation`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.