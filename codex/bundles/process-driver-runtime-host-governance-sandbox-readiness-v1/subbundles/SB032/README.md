# SB032 - Observability, correlation, failure taxonomy: behavior implementation and focused tests
...
- `proof/SB032/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB032/transcripts/`.
- Changed-file hashes.
...
Implement SB032 for `Observability, correlation, failure taxonomy`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.