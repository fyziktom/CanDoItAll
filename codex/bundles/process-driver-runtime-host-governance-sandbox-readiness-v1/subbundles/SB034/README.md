# SB034 - Audit retention and query governance: inventory and source changes
...
- `proof/SB034/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB034/transcripts/`.
- Changed-file hashes.
...
Implement SB034 for `Audit retention and query governance`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.