# SB022 - Scheduler/workflow read-only verification jobs: inventory and source changes
...
## Proof Required
- `proof/SB022/manifest.md`
- `proof/SB022/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB022/transcripts/`.
- Changed-file hashes.
...
Implement SB022 for `Scheduler/workflow read-only verification jobs`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.