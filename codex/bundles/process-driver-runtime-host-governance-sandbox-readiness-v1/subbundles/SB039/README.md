# SB039 - Critical Gate P13: semantic closure for Dry-run sandbox and allow-list contracts
...
5. Record proof under `proof/SB039/`.
...
- `proof/SB039/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB039/transcripts/`.
- Changed-file hashes.
...
Implement SB039 for `Dry-run sandbox and allow-list contracts`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.