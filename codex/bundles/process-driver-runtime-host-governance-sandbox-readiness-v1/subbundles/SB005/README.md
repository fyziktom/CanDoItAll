# SB005 - Durable EF audit production default: behavior implementation and focused tests
...
## Deliverables
- Source changes or proof artifacts for `Durable EF audit production default`.
...
- `proof/SB005/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB005/transcripts/`.
- Changed-file hashes.
...
Implement SB005 for `Durable EF audit production default`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.