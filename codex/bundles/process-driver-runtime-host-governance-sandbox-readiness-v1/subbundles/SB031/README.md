# SB031 - Observability, correlation, failure taxonomy: inventory and source changes
...
- `proof/SB031/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB031/transcripts/`.
- Changed-file hashes.
...
Implement SB031 for `Observability, correlation, failure taxonomy`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.