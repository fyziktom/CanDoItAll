# SB013 - Exact registry/selector and lane options: inventory and source changes
...
## Proof Required
- `proof/SB013/manifest.md`
- `proof/SB013/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB013/transcripts/`.
- Changed-file hashes.
...
Implement SB013 for `Exact registry/selector and lane options`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.