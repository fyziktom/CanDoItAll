# SB049 - Release-candidate build/unit/focused matrix: inventory and source changes
...
5. Record proof under `proof/SB049/`.
...
- `proof/SB049/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB049/transcripts/`.
- Changed-file hashes.
...
Implement SB049 for `Release-candidate build/unit/focused matrix`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.