# SB036 - Critical Gate P12: semantic closure for Audit retention and query governance
...
- `proof/SB036/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB036/transcripts/`.
- Changed-file hashes.
...
Implement SB036 for `Audit retention and query governance`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.