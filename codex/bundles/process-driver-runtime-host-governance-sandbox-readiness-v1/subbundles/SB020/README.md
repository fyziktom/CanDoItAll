# SB020 - Manager UI/operator readback: behavior implementation and focused tests
...
## Deliverables
- Source changes or proof artifacts for `Manager UI/operator readback`.
...
- `proof/SB020/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB020/transcripts/`.
- Changed-file hashes.
...
Implement SB020 for `Manager UI/operator readback`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.