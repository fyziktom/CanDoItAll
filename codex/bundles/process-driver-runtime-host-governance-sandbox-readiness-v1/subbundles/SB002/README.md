# SB002 - Source and proof reconciliation: behavior implementation and focused tests
...
- `proof/SB002/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB002/transcripts/`.
- Changed-file hashes.
...
Implement SB002 for `Source and proof reconciliation`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.