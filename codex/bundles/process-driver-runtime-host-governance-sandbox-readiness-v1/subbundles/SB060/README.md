# SB060 - Critical Gate P20: semantic closure for Final red-team and validators
...
5. Record proof under `proof/SB060/`.
...
## Proof Required
- `proof/SB060/manifest.md`
- `proof/SB060/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB060/transcripts/`.
- Changed-file hashes.
...
Implement SB060 for `Final red-team and validators`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.