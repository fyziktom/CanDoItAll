# SB051 - Critical Gate P17: semantic closure for Release-candidate build/unit/focused matrix
...
5. Record proof under `proof/SB051/`.
...
## Proof Required
- `proof/SB051/manifest.md`
- `proof/SB051/semantic-invariants.md` if this is a critical gate or introduces production behavior.
- Command transcripts under `proof/SB051/transcripts/`.
- Changed-file hashes.
...
Implement SB051 for `Release-candidate build/unit/focused matrix`. Use the exact source references above. Preserve generic Process Core and verification-only host constraints. Record source-backed proof before claiming completion.