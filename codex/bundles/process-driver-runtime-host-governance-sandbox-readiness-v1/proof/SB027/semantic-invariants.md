...
- Expected behavior: P09 Live OpenAI process-run proof hardening is source-backed, test-backed, and does not grant effectful driver authority.
...
- Failing-first test: N/A process/no production behavior change; bundle://proof/SB027/transcripts/sb027-source-assertions.txt documents the negative gate.
...
- Red-team negative case: bundle://proof/SB057/transcripts/required-source-scans.txt and bundle://proof/SB027/transcripts/sb027-source-assertions.txt reject fallback discovery, direct module-to-driver calls, bundle path coupling, and secret leakage.
