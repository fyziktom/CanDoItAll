...
- Expected behavior: P18 Large-screen UI/operator smoke is source-backed, test-backed, and does not grant effectful driver authority.
...
- Failing-first test: N/A process/no production behavior change; bundle://proof/SB054/transcripts/sb054-source-assertions.txt documents the negative gate.
- Passing test: bundle://proof/SB054/transcripts/large-desktop-process-run-detail-operator-proof.txt
...
- Red-team negative case: bundle://proof/SB057/transcripts/required-source-scans.txt and bundle://proof/SB054/transcripts/sb054-source-assertions.txt reject fallback discovery, direct module-to-driver calls, bundle path coupling, and secret leakage.
...
| --- | --- | --- | --- | --- |
| Large-desktop operator proof | repo://CanDoItAll.slnx | repo://tests/CanDoItAll.Tests.Integration/ProcessDomainEvidenceReadOnlyAdapterTests.cs | bundle://proof/SB051/transcripts/solution-build-debug.txt | bundle://proof/SB057/transcripts/required-source-scans.txt |
