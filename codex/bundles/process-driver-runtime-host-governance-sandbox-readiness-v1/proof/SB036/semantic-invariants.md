...
- Expected behavior: P12 Audit retention and query governance is source-backed, test-backed, and does not grant effectful driver authority.
...
- Failing-first test: N/A process/no production behavior change; bundle://proof/SB036/transcripts/sb036-source-assertions.txt documents the negative gate.
...
- Red-team negative case: bundle://proof/SB057/transcripts/required-source-scans.txt and bundle://proof/SB036/transcripts/sb036-source-assertions.txt reject fallback discovery, direct module-to-driver calls, bundle path coupling, and secret leakage.
