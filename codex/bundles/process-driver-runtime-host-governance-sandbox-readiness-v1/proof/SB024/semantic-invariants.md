...
- Expected behavior: P08 Scheduler/workflow read-only verification jobs is source-backed, test-backed, and does not grant effectful driver authority.
...
- Red-team negative case: bundle://proof/SB057/transcripts/required-source-scans.txt and bundle://proof/SB024/transcripts/sb024-source-assertions.txt reject fallback discovery, direct module-to-driver calls, bundle path coupling, and secret leakage.
