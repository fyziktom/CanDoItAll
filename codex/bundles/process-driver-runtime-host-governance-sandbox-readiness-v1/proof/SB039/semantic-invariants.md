...
- Expected behavior: P13 Dry-run sandbox and allow-list contracts is source-backed, test-backed, and does not grant effectful driver authority.
...
- Red-team negative case: bundle://proof/SB057/transcripts/required-source-scans.txt and bundle://proof/SB039/transcripts/sb039-source-assertions.txt reject fallback discovery, direct module-to-driver calls, bundle path coupling, and secret leakage.
