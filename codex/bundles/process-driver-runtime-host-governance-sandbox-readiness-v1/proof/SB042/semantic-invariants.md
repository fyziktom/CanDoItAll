...
- Expected behavior: P14 Execution-capable future gate tests is source-backed, test-backed, and does not grant effectful driver authority.
...
- Red-team negative case: bundle://proof/SB057/transcripts/required-source-scans.txt and bundle://proof/SB042/transcripts/sb042-source-assertions.txt reject fallback discovery, direct module-to-driver calls, bundle path coupling, and secret leakage.
