...
- Expected behavior: P10 Deterministic process runtime safety net is source-backed, test-backed, and does not grant effectful driver authority.
...
- Failing-first test: N/A process/no production behavior change; bundle://proof/SB030/transcripts/sb030-source-assertions.txt documents the negative gate.
...
- Red-team negative case: bundle://proof/SB057/transcripts/required-source-scans.txt and bundle://proof/SB030/transcripts/sb030-source-assertions.txt reject fallback discovery, direct module-to-driver calls, bundle path coupling, and secret leakage.
