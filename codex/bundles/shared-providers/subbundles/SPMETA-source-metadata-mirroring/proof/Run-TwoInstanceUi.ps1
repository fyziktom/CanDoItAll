param([Parameter(Mandatory)] [string] $RunLabel)
...
try {
    ...
    & (Join-Path $PSScriptRoot 'Run-FocusedTests.ps1') -Project tests\Playwright\CanDoItAll.Tests.Playwright\CanDoItAll.Tests.Playwright.csproj -NoBuild -ExpectedCount 1 -Filter 'FullyQualifiedName=CanDoItAll.Tests.Playwright.SharedProviderTwoInstanceUiAcceptanceTests.Provider_empty_client_imports_shared_providers_and_runs_chat_image_and_vision' -RunLabel $RunLabel
