# SB041 - Start transition reload proof
...
Verify failed start transition reload logic still continues only for matching InProgress step.
...
6. If this is a critical gate, create `proof/SB041/manifest.md` and `proof/SB041/semantic-invariants.md`.
...
Implement `SB041 - Start transition reload proof` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
