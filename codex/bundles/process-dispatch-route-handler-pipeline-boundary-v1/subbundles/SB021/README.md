# SB021 - Upstream materialization handler extraction
...
Move missing upstream artifact materialization route into a handler.
...
6. If this is a critical gate, create `proof/SB021/manifest.md` and `proof/SB021/semantic-invariants.md`.
...
Implement `SB021 - Upstream materialization handler extraction` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
