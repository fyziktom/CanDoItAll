# SB037 - Subprocess artifact projection coordinator boundary review
...
Check whether ProjectCompletedSubprocessArtifactsAsync still belongs in Dispatch.cs and prepare split.
...
6. If this is a critical gate, create `proof/SB037/manifest.md` and `proof/SB037/semantic-invariants.md`.
...
Implement `SB037 - Subprocess artifact projection coordinator boundary review` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
