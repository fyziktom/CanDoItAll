# SB067 - Finalizer handler host narrowing
...
Reduce finalizer handler dependencies.
...
6. If this is a critical gate, create `proof/SB067/manifest.md` and `proof/SB067/semantic-invariants.md`.
...
Implement `SB067 - Finalizer handler host narrowing` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
