# SB086 - Dispatch.cs line-count target pass
...
Reduce Dispatch.cs residual body by moving helper factories or route leftovers.
...
6. If this is a critical gate, create `proof/SB086/manifest.md` and `proof/SB086/semantic-invariants.md`.
...
Implement `SB086 - Dispatch.cs line-count target pass` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
