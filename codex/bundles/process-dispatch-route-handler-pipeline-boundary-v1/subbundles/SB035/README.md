# SB035 - Subprocess route handler extraction
...
Extract HandleSubprocessDispatchAsync route entry behind a handler.
...
6. If this is a critical gate, create `proof/SB035/manifest.md` and `proof/SB035/semantic-invariants.md`.
...
Implement `SB035 - Subprocess route handler extraction` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
