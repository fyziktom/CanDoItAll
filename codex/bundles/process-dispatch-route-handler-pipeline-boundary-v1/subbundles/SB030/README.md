# SB030 - Pre-execution source line review
...
Record line count and residual route body in RouteExecution.cs.
...
6. If this is a critical gate, create `proof/SB030/manifest.md` and `proof/SB030/semantic-invariants.md`.
...
Implement `SB030 - Pre-execution source line review` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
