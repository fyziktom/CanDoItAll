# SB018 - Fresh recovery skip parity tests
...
Test fresh in-progress grace period handling and no further route execution after handled.
...
6. If this is a critical gate, create `proof/SB018/manifest.md` and `proof/SB018/semantic-invariants.md`.
...
Implement `SB018 - Fresh recovery skip parity tests` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
