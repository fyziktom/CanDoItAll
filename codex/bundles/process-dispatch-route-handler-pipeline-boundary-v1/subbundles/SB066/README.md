# SB066 - Workflow handler host narrowing
...
Reduce workflow handler dependencies.
...
6. If this is a critical gate, create `proof/SB066/manifest.md` and `proof/SB066/semantic-invariants.md`.
...
Implement `SB066 - Workflow handler host narrowing` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
