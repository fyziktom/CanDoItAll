# SB055 - Direct-agent execution route handler extraction
...
Extract ExecuteUntilSettled route call into handler.
...
6. If this is a critical gate, create `proof/SB055/manifest.md` and `proof/SB055/semantic-invariants.md`.
...
Implement `SB055 - Direct-agent execution route handler extraction` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
