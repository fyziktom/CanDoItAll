# SB064 - Gate J: workflow/direct/finalizer proof
...
Close P4 with route order and focused tests.
...
6. If this is a critical gate, create `proof/SB064/manifest.md` and `proof/SB064/semantic-invariants.md`.
...
Implement `SB064 - Gate J: workflow/direct/finalizer proof` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
