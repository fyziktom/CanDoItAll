# SB068 - Gate K: workflow/direct host proof
...
Verify narrowed host still passes tests.
...
6. If this is a critical gate, create `proof/SB068/manifest.md` and `proof/SB068/semantic-invariants.md`.
...
Implement `SB068 - Gate K: workflow/direct host proof` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
