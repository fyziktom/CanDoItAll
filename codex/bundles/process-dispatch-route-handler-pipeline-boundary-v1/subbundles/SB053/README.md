# SB053 - Workflow route handler extraction
...
Extract workflow TryRunOrObserve and workflow outcome handling into handler.
...
6. If this is a critical gate, create `proof/SB053/manifest.md` and `proof/SB053/semantic-invariants.md`.
...
Implement `SB053 - Workflow route handler extraction` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
