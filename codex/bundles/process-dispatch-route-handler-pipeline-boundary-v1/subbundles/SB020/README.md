# SB020 - Database requirement transition proof
...
Preserve block/no-op/unsupported target behavior.
...
6. If this is a critical gate, create `proof/SB020/manifest.md` and `proof/SB020/semantic-invariants.md`.
...
Implement `SB020 - Database requirement transition proof` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
