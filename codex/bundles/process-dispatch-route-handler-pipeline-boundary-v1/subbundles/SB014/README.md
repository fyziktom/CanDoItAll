# SB014 - Route handler source scan guard
...
Add source scan guard against direct route body reintroduction into Dispatch.cs.
...
6. If this is a critical gate, create `proof/SB014/manifest.md` and `proof/SB014/semantic-invariants.md`.
...
Implement `SB014 - Route handler source scan guard` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
