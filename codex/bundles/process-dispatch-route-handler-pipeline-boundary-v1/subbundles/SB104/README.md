...
Close build/tests/source scan phase.
...
6. If this is a critical gate, create `proof/SB104/manifest.md` and `proof/SB104/semantic-invariants.md`.
...
Implement `SB104 - Gate R: broad proof gate` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
