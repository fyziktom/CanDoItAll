# SB025 - Pre-execution context slimming pass
...
Remove duplicated candidate/trigger/claim plumbing from pre-execution callers.
...
6. If this is a critical gate, create `proof/SB025/manifest.md` and `proof/SB025/semantic-invariants.md`.
...
Implement `SB025 - Pre-execution context slimming pass` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
