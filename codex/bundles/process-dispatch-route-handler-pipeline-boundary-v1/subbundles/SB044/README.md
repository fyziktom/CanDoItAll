# SB044 - Gate G: recovery/subprocess/start proof
...
Close recovery/subprocess/start handler phase.
...
6. If this is a critical gate, create `proof/SB044/manifest.md` and `proof/SB044/semantic-invariants.md`.
...
Implement `SB044 - Gate G: recovery/subprocess/start proof` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
