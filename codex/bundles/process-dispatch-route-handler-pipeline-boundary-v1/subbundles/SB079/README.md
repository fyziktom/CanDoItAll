# SB079 - Claim model adapter introduction
...
Introduce top-level internal ProcessDispatchClaim if safe; keep old wrapper if needed.
...
6. If this is a critical gate, create `proof/SB079/manifest.md` and `proof/SB079/semantic-invariants.md`.
...
Implement `SB079 - Claim model adapter introduction` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
