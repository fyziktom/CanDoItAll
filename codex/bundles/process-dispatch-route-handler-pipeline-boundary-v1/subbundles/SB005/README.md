# SB005 - Define module-local route handler result vocabulary
...
Create internal route result records/enums for Handled/Continue/Complete/ContinueCandidates without public Core contracts.
...
6. If this is a critical gate, create `proof/SB005/manifest.md` and `proof/SB005/semantic-invariants.md`.
...
Implement `SB005 - Define module-local route handler result vocabulary` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
