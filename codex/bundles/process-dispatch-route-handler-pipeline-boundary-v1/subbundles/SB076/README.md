# SB076 - Failure transition claim-held proof
...
Verify failure transition is skipped if run closed or claim lost.
...
6. If this is a critical gate, create `proof/SB076/manifest.md` and `proof/SB076/semantic-invariants.md`.
...
Implement `SB076 - Failure transition claim-held proof` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
