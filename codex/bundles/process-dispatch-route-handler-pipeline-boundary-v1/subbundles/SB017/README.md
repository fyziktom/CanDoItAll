# SB017 - Fresh recovery skip handler extraction
...
Move fresh recovery skip decision/logging into a route handler.
...
6. If this is a critical gate, create `proof/SB017/manifest.md` and `proof/SB017/semantic-invariants.md`.
...
Implement `SB017 - Fresh recovery skip handler extraction` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
