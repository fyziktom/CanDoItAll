# SB047 - Subprocess log/error reason preservation tests
...
Verify log messages/reasons remain materially equivalent.
...
6. If this is a critical gate, create `proof/SB047/manifest.md` and `proof/SB047/semantic-invariants.md`.
...
Implement `SB047 - Subprocess log/error reason preservation tests` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
