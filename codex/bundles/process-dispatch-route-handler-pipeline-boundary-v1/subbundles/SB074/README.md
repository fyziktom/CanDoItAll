# SB074 - Claim-lost closure handler split
...
Split heartbeat claim-lost and explicit claim-lost closure into module-local rule/helper.
...
6. If this is a critical gate, create `proof/SB074/manifest.md` and `proof/SB074/semantic-invariants.md`.
...
Implement `SB074 - Claim-lost closure handler split` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
