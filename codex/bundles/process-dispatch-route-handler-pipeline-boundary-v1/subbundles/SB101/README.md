...
Run unit route/claim/failure/architecture tests.
...
6. If this is a critical gate, create `proof/SB101/manifest.md` and `proof/SB101/semantic-invariants.md`.
...
Implement `SB101 - Focused unit tests` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
