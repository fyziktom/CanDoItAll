# SB061 - Finalizer transition handler extraction
...
Extract direct-agent finalizer context and transition application into handler.
...
6. If this is a critical gate, create `proof/SB061/manifest.md` and `proof/SB061/semantic-invariants.md`.
...
Implement `SB061 - Finalizer transition handler extraction` from `process-dispatch-route-handler-pipeline-boundary-v1`. Preserve behavior, keep all work module-local, do not create Process Core or driver APIs, and update proof before continuing.
