...
```mermaid
graph TD
  SB01[SB01 Proof claim-to-code verifier] --> SB02[SB02 Portable proof and skill sync]
  SB02 --> SB03[SB03 Failing-first corpus]
  SB03 --> SB04[SB04 Multilingual professor extraction]
  SB03 --> SB05[SB05 Outcome accepted-use integration]
  SB03 --> SB06[SB06 Embedding/ranker clustering]
  SB03 --> SB07[SB07 Dream synthesis and provenance]
  SB04 --> SB10[SB10 E2E red-team closure]
  SB05 --> SB10
  SB06 --> SB10
  SB07 --> SB08[SB08 Recall brief and lineage]
  SB08 --> SB10
  SB09[SB09 Refactor boundaries] --> SB10
```
