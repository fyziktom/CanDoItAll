# SB006 - Gate B: run lifecycle creation and duplicate guards

## Status
Prepared.

## Objective
Gate B: run lifecycle creation and duplicate guards.
...
Implement SB006: Gate B: run lifecycle creation and duplicate guards. Preserve all hard constraints and produce source-backed proof.
