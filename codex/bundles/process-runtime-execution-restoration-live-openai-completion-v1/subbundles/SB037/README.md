...
## Objective
API launch endpoints compatibility matrix.
...
Implement SB037: API launch endpoints compatibility matrix. Preserve all hard constraints and produce source-backed proof.
