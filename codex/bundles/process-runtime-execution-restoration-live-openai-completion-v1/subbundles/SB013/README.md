# SB013 - MAF workflow-backed role runtime proof

## Status
- Completed

## Objective
MAF workflow-backed role runtime proof.
...
Implement SB013: MAF workflow-backed role runtime proof. Preserve all hard constraints and produce source-backed proof.
