...
## Objective
Run detail UI status/step/artifact proof.
...
## Completion Evidence
- Proof: `bundle://proof/SB028/run-detail-ui-status-step-artifact-proof.md`
...
Implement SB028: Run detail UI status/step/artifact proof. Preserve all hard constraints and produce source-backed proof.
