# SB023 — Enforce URI/hash/size/content-type policies and denial diagnostics across all read-only drivers.

## Status
- Status: `Completed`

## Objective
Enforce URI/hash/size/content-type policies and denial diagnostics across all read-only drivers.
...
- Updated proof artifacts under `proof/SB023/` if this is a critical gate.
...
## Closure Proof
- Focused tests: `bundle://proof/SB023/transcripts/focused-evidence-policy-tests.txt`.
- Source scan and anti-stub audit: `bundle://proof/SB023/transcripts/evidence-policy-source-scan-and-anti-stub-audit.txt`.
- Proof manifest: `bundle://proof/SB023/manifest.md`.
...
Implement SB023: Enforce URI/hash/size/content-type policies and denial diagnostics across all read-only drivers.. Preserve all hard constraints from bundle://requirements/02-hard-constraints.md and close proof in reviews/01-execution-report.md.
