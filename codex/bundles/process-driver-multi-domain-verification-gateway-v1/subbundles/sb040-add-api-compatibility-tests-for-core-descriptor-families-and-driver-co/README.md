# SB040 — Add API compatibility tests for Core descriptor families and driver contract versions.

## Status
- Status: `Completed`

## Objective
Add API compatibility tests for Core descriptor families and driver contract versions.
...
- Updated proof artifacts under `proof/SB040/` if this is a critical gate.
...
## Progression Gate
- Noncritical: downstream work may continue. Focused proof is green in `bundle://proof/SB040/transcripts/focused-core-descriptor-contract-compatibility-tests.txt`, and the API compatibility source scan is green in `bundle://proof/SB040/transcripts/core-descriptor-contract-compatibility-source-scan.txt`.

## Suggested Agent Prompt
Implement SB040: Add API compatibility tests for Core descriptor families and driver contract versions.. Preserve all hard constraints from bundle://requirements/02-hard-constraints.md and close proof in reviews/01-execution-report.md.
