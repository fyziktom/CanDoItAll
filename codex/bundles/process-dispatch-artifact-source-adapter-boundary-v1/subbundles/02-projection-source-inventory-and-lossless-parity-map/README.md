# Projection source inventory and lossless parity map
...
Classify all remaining projection source paths, key builders, side effects, and parity requirements before movement.
...
- Updated semantic invariants under `proof/SB02/semantic-invariants.md`.
...
- `proof/SB02/source-assertions/*.txt` or `.md`
...
SB03 may start only after this closure gate passes.

## Suggested Agent Prompt

Execute subbundle `02-projection-source-inventory-and-lossless-parity-map` exactly. Keep the change small, preserve behavior, record proof, and stop if any guardrail fails.
