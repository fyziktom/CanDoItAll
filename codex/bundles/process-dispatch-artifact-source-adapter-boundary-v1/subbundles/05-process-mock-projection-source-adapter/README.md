# Process mock projection source adapter
...
Move process mock projection planning into a pure source adapter with exact key and duplicate behavior tests.
...
- Updated proof manifest under `proof/SB05/manifest.md`.
- Updated semantic invariants under `proof/SB05/semantic-invariants.md`.
...
- `proof/SB05/source-assertions/*.txt` or `.md`
...
SB06 may start only after this closure gate passes.

## Suggested Agent Prompt

Execute subbundle `05-process-mock-projection-source-adapter` exactly. Keep the change small, preserve behavior, record proof, and stop if any guardrail fails.
