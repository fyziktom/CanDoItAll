# Response text and provider-native browser projection adapters
...
Move assistant-response and provider-native browser projection planning into adapters.
...
- Updated proof manifest under `proof/SB08/manifest.md`.
- Updated semantic invariants under `proof/SB08/semantic-invariants.md`.
...
- `proof/SB08/source-assertions/*.txt` or `.md`
...
- SB09 may start only after this closure gate passes.

## Suggested Agent Prompt

Execute subbundle `08-response-and-provider-native-browser-projection-adapters` exactly. Keep the change small, preserve behavior, record proof, and stop if any guardrail fails.
