# Workspace-written and existing-managed projection adapters
...
Move workspace-written and existing-managed projection planning into pure source adapters.
...
- Updated semantic invariants under `proof/SB06/semantic-invariants.md`.
...
- `proof/SB06/source-assertions/*.txt` or `.md`
...
SB07 may start only after this closure gate passes.

## Suggested Agent Prompt

Execute subbundle `06-workspace-and-existing-managed-projection-adapters` exactly. Keep the change small, preserve behavior, record proof, and stop if any guardrail fails.
