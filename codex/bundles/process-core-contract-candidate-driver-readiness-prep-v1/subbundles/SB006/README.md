# SB006 - Gate B - route model adapter confinement

## Status
Completed.

## Objective
Prove route handlers/services no longer depend on hidden dispatcher payloads except in a named adapter file with documented owners and no logic beyond conversion.
...
- Proof transcript under `codex/bundles/process-core-contract-candidate-driver-readiness-prep-v1/proof/SB006/`.
- Execution report row for `SB006`.
...
## Closure Notes
- Entry gate: Passed. SB005 is completed.
- Closure gate: Passed. Route-facing models, handlers, facets, pipeline, factory, and route services are adapter-free; remaining adapter calls are edge compatibility seams.
- Critical proof: `bundle://proof/SB006/manifest.md` and `bundle://proof/SB006/semantic-invariants.md`.

## Suggested Agent Prompt
Implement `SB006` from `process-core-contract-candidate-driver-readiness-prep-v1`. Preserve runtime behavior. Keep this work module-local and do not introduce Process Core or production driver APIs.
