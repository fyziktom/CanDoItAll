# SB010 - Hydration read model and query service split

## Status
Completed.

## Objective
Split ProcessDispatchCandidateHydrationService into EF readback/query, artifact-input preparation, route candidate assembly, and direct-agent binding collaborators.
...
- Proof transcript under `codex/bundles/process-core-contract-candidate-driver-readiness-prep-v1/proof/SB010/`.
- Execution report row for `SB010`.
...
## Closure Notes
- Entry gate: Passed. SB009 is completed.
- Closure gate: Passed. Hydration service now loads the EF snapshot and delegates artifact-input preparation plus candidate assembly to dedicated module-local collaborators.
- Test proof: `bundle://proof/SB010/transcripts/hydration-split-architecture-tests.txt`.
- Source assertions and guard scans: `bundle://proof/SB010/transcripts/source-assertions-and-scans.txt`.

## Suggested Agent Prompt
Implement `SB010` from `process-core-contract-candidate-driver-readiness-prep-v1`. Preserve runtime behavior. Keep this work module-local and do not introduce Process Core or production driver APIs.
