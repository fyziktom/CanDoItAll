# SB038 — Migration guide and version notes

## Status
Prepared.

## Objective
Migration guide and version notes within phase `P13 — Package Docs, Samples, And Migration Notes`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB038/transcripts/`.
...
Implement `SB038 — Migration guide and version notes` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
