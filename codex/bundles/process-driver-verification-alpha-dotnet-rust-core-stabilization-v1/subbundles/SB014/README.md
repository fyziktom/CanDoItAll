# SB014 — Rust fixtures and mixed transcript cases

## Status
- Completed
## Objective
Rust fixtures and mixed transcript cases within phase `P05 — Rust Transcript Verification Rules`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB014/transcripts/`.
...
Implement `SB014 — Rust fixtures and mixed transcript cases` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
