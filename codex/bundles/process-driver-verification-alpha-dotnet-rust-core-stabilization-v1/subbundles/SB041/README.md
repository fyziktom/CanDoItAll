# SB041 — Focused integration/source scan proof

## Status
Prepared.

## Objective
Focused integration/source scan proof within phase `P14 — Broad Smoke Matrix And Red-Team`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB041/transcripts/`.
...
Implement `SB041 — Focused integration/source scan proof` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
