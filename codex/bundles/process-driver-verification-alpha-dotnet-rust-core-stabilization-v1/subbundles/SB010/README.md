# SB010 — .NET transcript diagnostic parser

## Status
Prepared.

## Objective
.NET transcript diagnostic parser within phase `P04 — .NET Transcript Verification Rules`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB010/transcripts/`.
...
Implement `SB010 — .NET transcript diagnostic parser` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
