# SB029 — Core driver dependency direction guard

## Status
Prepared.

## Objective
Core driver dependency direction guard within phase `P10 — Core Descriptor Compatibility And Consumer Allowlist`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB029/transcripts/`.
...
Implement `SB029 — Core driver dependency direction guard` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
