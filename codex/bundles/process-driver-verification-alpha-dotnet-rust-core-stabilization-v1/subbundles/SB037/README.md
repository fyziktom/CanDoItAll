# SB037 — Package docs and API samples

## Status
Prepared.

## Objective
Package docs and API samples within phase `P13 — Package Docs, Samples, And Migration Notes`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB037/transcripts/`.
...
Implement `SB037 — Package docs and API samples` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
