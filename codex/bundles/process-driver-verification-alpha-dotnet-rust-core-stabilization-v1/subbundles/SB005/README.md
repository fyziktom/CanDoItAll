# SB005 — Versioning and compatibility guard

## Status
Prepared.

## Objective
Versioning and compatibility guard within phase `P02 — Contract API Stability And Versioning`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB005/transcripts/`.
...
Implement `SB005 — Versioning and compatibility guard` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
