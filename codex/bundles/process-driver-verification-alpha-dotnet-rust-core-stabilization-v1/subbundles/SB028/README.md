# SB028 — Core descriptor compatibility map

## Status
- Completed
## Objective
Core descriptor compatibility map within phase `P10 — Core Descriptor Compatibility And Consumer Allowlist`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB028/transcripts/`.
...
Implement `SB028 — Core descriptor compatibility map` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
