...
## Objective
Active architecture guard baseline within phase `P01 — Baseline, Proof Intake, And Active Guardrails`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB002/transcripts/`.
...
Implement `SB002 — Active architecture guard baseline` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
