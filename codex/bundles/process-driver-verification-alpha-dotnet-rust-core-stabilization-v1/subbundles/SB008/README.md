# SB008 — Define alpha package forbidden dependency tests

## Status
Prepared.

## Objective
Define alpha package forbidden dependency tests within phase `P03 — Alpha Driver Package Boundary`. This is part of the verification-only driver alpha and Core stabilization path.
...
- Proof transcript(s) under `proof/SB008/transcripts/`.
...
Implement `SB008 — Define alpha package forbidden dependency tests` exactly as scoped. Preserve verification-only semantics and write proof before moving on.
