# SB06: Sandbox and authorization evaluator

## Status
- Completed

## Objective
Add dry-run sandbox evaluator that models allowlist, authorization grant, revocation, emergency stop, timeout/cancellation, and denial categories.
...
## Prerequisites
- SB05 closure gate is completed or explicitly blocked before this subbundle starts.
...
## Scope
- All effectful operations remain denied. Dry-run plans must be audited and no-mutation.
...
Implement SB06 as a code-first production/test change. Keep proof concise. Preserve Process Core genericity and keep execution-capable drivers blocked.
