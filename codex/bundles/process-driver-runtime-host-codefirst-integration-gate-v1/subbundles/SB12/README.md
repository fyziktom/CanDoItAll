# SB12: Release candidate and code-first red-team

## Status
- Completed

## Objective
Run final build/test/source scans, compute code-first ratio, and reject report-only/proof-heavy closure.
...
## Prerequisites
- SB11 closure gate is completed or explicitly blocked before this subbundle starts.
...
## Scope
- Final closure fails if codex/bundle diffs dominate or execution-capable effects are introduced.
...
Implement SB12 as a code-first production/test change. Keep proof concise. Preserve Process Core genericity and keep execution-capable drivers blocked.
