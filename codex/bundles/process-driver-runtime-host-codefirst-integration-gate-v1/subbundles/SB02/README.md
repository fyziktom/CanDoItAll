# SB02: Runtime dry-run contracts

## Status
- Completed

## Objective
Extract or stabilize generic dry-run request/result/plan contracts so future execution-capable host can share them without Process Core leakage.
...
## Prerequisites
- SB01 closure gate is completed or explicitly blocked before this subbundle starts.
...
## Scope
- Move module-local dry-run concepts toward a stable process-driver runtime contract boundary, but keep implementation in Process Module if contracts would otherwise pull in process runtime dependencies.
...
Implement SB02 as a code-first production/test change. Keep proof concise. Preserve Process Core genericity and keep execution-capable drivers blocked.
