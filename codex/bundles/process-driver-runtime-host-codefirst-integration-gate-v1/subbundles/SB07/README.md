# SB07: Static driver capability descriptors

## Status
- Completed

## Objective
Add static domain driver capability descriptors for verification lanes and dry-run future surfaces without self-registration or reflection discovery.
...
## Prerequisites
- SB06 closure gate is completed or explicitly blocked before this subbundle starts.
...
## Scope
- Descriptors are reviewed/compiled contracts only. No runtime discovery, no plugin loading, no DI auto-registration.
...
Implement SB07 as a code-first production/test change. Keep proof concise. Preserve Process Core genericity and keep execution-capable drivers blocked.
