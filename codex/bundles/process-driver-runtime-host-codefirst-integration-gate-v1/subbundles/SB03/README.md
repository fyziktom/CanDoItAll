# SB03: Durable EF audit hardening

## Status
- Completed

## Objective
Make EF audit production-ready: entity configuration, indexes, scoped readback, query windows, redaction, retention-ready query model.
...
## Prerequisites
- SB02 closure gate is completed or explicitly blocked before this subbundle starts.
...
## Scope
- This must be a real EF/model/test change, not only DI proof.
...
Implement SB03 as a code-first production/test change. Keep proof concise. Preserve Process Core genericity and keep execution-capable drivers blocked.
