# SB08: Manager run-detail readback

## Status
- Completed

## Objective
Surface verification/dry-run audit and diagnostics in run-detail readback: audit id/hash, denial category/code, evidence counts, no-mutation flags.
...
## Prerequisites
- SB07 closure gate is completed or explicitly blocked before this subbundle starts.
...
## Scope
- Prefer service/API first; add UI proof only if route/component source changes.
...
Implement SB08 as a code-first production/test change. Keep proof concise. Preserve Process Core genericity and keep execution-capable drivers blocked.
