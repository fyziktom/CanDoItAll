...
## Scope
- Critical gate: Gate B parser parity and verifier package stability.
- Invariant contract: bundle://proof/SB006/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB006_INV_001
- Result: the existing transcript verifier stays compatible while the process adapter consumes supplied transcript evidence.