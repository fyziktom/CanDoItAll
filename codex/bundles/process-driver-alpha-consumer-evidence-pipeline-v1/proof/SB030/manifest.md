...
## Scope
- Critical gate: Gate J .NET/Rust fixture coverage and parser domain parity.
- Invariant contract: bundle://proof/SB030/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB030_INV_001
- Result: .NET and Rust transcript cases remain covered by unit and adapter-focused test proof.