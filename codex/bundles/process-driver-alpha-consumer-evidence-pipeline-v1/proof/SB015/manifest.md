...
## Scope
- Critical gate: Gate E supplied evidence URI and hash policy.
- Invariant contract: bundle://proof/SB015/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB015_INV_001
- Result: the adapter rejects hash mismatches and unapproved evidence URIs before verifier invocation.