...
## Scope
- Critical gate: Gate L Office and business-analysis lane denial closure.
- Invariant contract: bundle://proof/SB036/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB036_INV_001
- Result: Office and business-analysis lanes are denied while .NET/Rust read-only verification remains allowed.