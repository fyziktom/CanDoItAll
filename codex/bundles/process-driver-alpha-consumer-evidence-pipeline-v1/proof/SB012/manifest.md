...
## Scope
- Critical gate: Gate D process-module read-only adapter boundary.
...
## Closure
- Invariant ID in transcript output: SB012_INV_001
- Result: the process module exposes only a narrow read-only adapter and does not register a runtime hook.