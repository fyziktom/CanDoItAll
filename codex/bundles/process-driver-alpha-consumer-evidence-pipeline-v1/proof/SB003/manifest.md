...
## Scope
- Critical gate: Gate A baseline closure and guardrail retention.
- Invariant contract: bundle://proof/SB003/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB003_INV_001
- Result: baseline build, architecture guards, source scans, and anti-stub checks keep the branch inside the alpha-driver constraints.