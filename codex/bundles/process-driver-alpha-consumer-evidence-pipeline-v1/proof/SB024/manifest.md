...
## Scope
- Critical gate: Gate H process consumer rehearsal without state mutation.
- Invariant contract: bundle://proof/SB024/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB024_INV_001
- Result: the rehearsal consumes supplied .NET/Rust evidence through the process adapter without changing process state.