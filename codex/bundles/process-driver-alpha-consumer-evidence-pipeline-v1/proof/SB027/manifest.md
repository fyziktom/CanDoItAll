...
## Scope
- Critical gate: Gate I Process Core compatibility and reverse-reference guard.
- Invariant contract: bundle://proof/SB027/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB027_INV_001
- Result: Process Core remains free of driver dependencies while module-level consumers compile and test.