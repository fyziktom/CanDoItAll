...
## Scope
- Critical gate: Gate F observation mapping and diagnostics parity.
- Invariant contract: bundle://proof/SB018/semantic-invariants.md
...
## Closure
- Invariant ID in transcript output: SB018_INV_001
- Result: verification responses map into process-owned observations with audit facts and no mutation side effects.