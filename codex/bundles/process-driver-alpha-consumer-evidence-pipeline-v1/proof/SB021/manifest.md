...
## Scope
- Critical gate: Gate G audit, redaction, and no-mutation behavior.
...
## Closure
- Invariant ID in transcript output: SB021_INV_001
- Result: mutation requests, untrusted sources, and sensitive transcript details are denied or redacted without verifier side effects.