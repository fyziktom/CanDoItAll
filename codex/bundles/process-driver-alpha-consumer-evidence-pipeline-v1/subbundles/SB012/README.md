...
## Objective
Critical gate: adapter negative tests for mutation attempts, source scans for forbidden runtime hooks, focused process integration proof.
...
Implement `SB012 — Gate D adapter boundary` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
