...
## Objective
Critical gate: read-only evidence allowed, all side effects denied, no connector/runtime imports.
...
Implement `SB036 — Gate L Office/business denial closure` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
