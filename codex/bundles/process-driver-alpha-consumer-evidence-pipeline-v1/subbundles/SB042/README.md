...
## Objective
Critical gate: docs are consistent with source and do not imply unauthorized runtime behavior.
...
Implement `SB042 — Gate N docs/release closure` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
