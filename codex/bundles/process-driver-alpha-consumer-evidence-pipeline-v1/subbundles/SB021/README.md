...
## Objective
Critical gate: secret masking, safe summary hash, denial audit, no-mutation, and no logging of raw secrets.
...
Implement `SB021 — Gate G audit/redaction/no-mutation` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
