# SB043 — Broad build/unit/integration/source scans

## Status
Prepared.

## Objective
Run solution build, full unit tests, focused integration, source scans, anti-stub, no UI/media drift.
...
Implement `SB043 — Broad build/unit/integration/source scans` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
