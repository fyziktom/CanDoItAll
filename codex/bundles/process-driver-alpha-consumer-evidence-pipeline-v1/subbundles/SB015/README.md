...
## Objective
Critical gate: hash mismatch, missing content, unsupported evidence source, duplicate evidence, and redaction proof.
...
Implement `SB015 — Gate E evidence/hash policy` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
