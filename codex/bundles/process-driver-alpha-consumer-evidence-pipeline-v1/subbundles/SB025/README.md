# SB025 — Core descriptor allow-list refresh

## Status
Prepared.

## Objective
Update exact dispatch/Core consumer allow-list after adapter additions.
...
Implement `SB025 — Core descriptor allow-list refresh` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
