...
## Objective
Critical gate: next bundle scope is explicit and rejects broad runtime/driver execution until proof supports it.
...
Implement `SB048 — Gate O next-bundle decision` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
