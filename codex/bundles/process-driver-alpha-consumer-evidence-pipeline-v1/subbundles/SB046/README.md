# SB046 — Core/domain roadmap refresh

## Status
Prepared.

## Objective
Update roadmap toward stable Core/domain drivers after this adapter/evidence pipeline.
...
Implement `SB046 — Core/domain roadmap refresh` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
