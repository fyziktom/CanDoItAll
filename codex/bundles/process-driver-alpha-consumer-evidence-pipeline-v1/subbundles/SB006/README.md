...
## Objective
Critical gate: failing-first parser gaps, passing .NET/Rust fixtures, hash mismatch, unsupported language, and no-issue transcript proof.
...
Implement `SB006 — Gate B parser parity` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
