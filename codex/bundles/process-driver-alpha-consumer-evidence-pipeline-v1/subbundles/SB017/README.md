# SB017 — Observation adapter mapping

## Status
- Completed

## Objective
Map verifier response into process-owned observation without writes and without losing evidence hash/audit fields.
...
Implement `SB017 — Observation adapter mapping` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
