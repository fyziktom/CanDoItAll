...
## Objective
Critical gate: Core public API snapshot, consumer allow-list, no reverse dependency, no broad global using.
...
Implement `SB027 — Gate I Core compatibility` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
