# SB013 — Evidence payload shape

## Status
Prepared.

## Objective
Define process-owned payload shape for transcript text, evidence references, hash, caller, process/run/step/artifact ids.
...
Implement `SB013 — Evidence payload shape` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
