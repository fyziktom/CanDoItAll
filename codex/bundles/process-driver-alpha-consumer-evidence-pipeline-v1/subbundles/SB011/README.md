# SB011 — Adapter implementation

## Status
- Completed

## Objective
Implement module-local adapter that invokes transcript verifier with supplied payloads only; no registry, selector, DI hook, or manager command.
...
Implement `SB011 — Adapter implementation` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
