# SB026 — Core dependency and reverse reference guard

## Status
Prepared.

## Objective
Assert Core never references driver abstractions or transcript verification; process adapter imports are explicit.
...
Implement `SB026 — Core dependency and reverse reference guard` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
