# SB014 — Hash validation and source allowlist

## Status
Prepared.

## Objective
Implement strict hash validation and deny arbitrary file reads, external URLs, workspace globbing, and connectors.
...
Implement `SB014 — Hash validation and source allowlist` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
