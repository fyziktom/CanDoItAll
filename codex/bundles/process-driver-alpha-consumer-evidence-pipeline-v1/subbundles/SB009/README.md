...
## Objective
Critical gate: public API snapshot, no runtime contract tokens, compatibility docs, and negative tests.
...
Implement `SB009 — Gate C contract/API stability` from `process-driver-alpha-consumer-evidence-pipeline-v1`. Preserve all hard constraints and update proof before continuing.
