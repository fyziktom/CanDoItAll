# SB017 — Add malicious secret/email/token corpus for diagnostic and audit summary redaction.

## Status
Prepared.

## Objective
Add malicious secret/email/token corpus for diagnostic and audit summary redaction.
...
## Prerequisites
- Previous subbundle: `SB016` must be closed unless this is SB001.
...
Implement `SB017` from `bundle://subbundles/SB017/README.md`. Preserve hard boundaries, update proof, and stop if implementation requires runtime host, DI, manager command, process mutation, storage/workspace writes, shell/Graph calls, or UI changes.
