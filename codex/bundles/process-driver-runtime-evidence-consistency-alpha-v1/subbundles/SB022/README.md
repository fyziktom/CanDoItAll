# SB022 — Implement execution/finalizer/retry/provider contradiction rules.

## Status
Prepared.

## Objective
Implement execution/finalizer/retry/provider contradiction rules.
...
## Prerequisites
- Previous subbundle: `SB021` must be closed unless this is SB001.
...
Implement `SB022` from `bundle://subbundles/SB022/README.md`. Preserve hard boundaries, update proof, and stop if implementation requires runtime host, DI, manager command, process mutation, storage/workspace writes, shell/Graph calls, or UI changes.
