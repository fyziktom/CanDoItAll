# SB003 — Gate A: close source/proof reconciliation with build/test/source-scan baseline before implementation movement.
...
## Objective
Gate A: close source/proof reconciliation with build/test/source-scan baseline before implementation movement.
...
## Prerequisites
- Previous subbundle: `SB002` must be closed unless this is SB001.
...
- Anti-stub audit.
- `proof/SB003/manifest.md` with changed-file hashes, command transcripts, source assertions, anti-stub output, and red-team notes.
- `proof/SB003/semantic-invariants.md` with shallow-pass trap, adversarial negative proof, semantic positive proof, and raw-note closure.
...
- Critical closure manifest: `bundle://proof/SB003/manifest.md`.
...
Implement `SB003` from `bundle://subbundles/SB003/README.md`. Preserve hard boundaries, update proof, and stop if implementation requires runtime host, DI, manager command, process mutation, storage/workspace writes, shell/Graph calls, or UI changes.
