# SB014 — Add negative tests for mismatched hashes, invalid hashes, duplicate references, unsafe schemes, and missing evidence.
...
## Objective
Add negative tests for mismatched hashes, invalid hashes, duplicate references, unsafe schemes, and missing evidence.
...
## Prerequisites
- Previous subbundle: `SB013` must be closed unless this is SB001.
...
Implement `SB014` from `bundle://subbundles/SB014/README.md`. Preserve hard boundaries, update proof, and stop if implementation requires runtime host, DI, manager command, process mutation, storage/workspace writes, shell/Graph calls, or UI changes.
