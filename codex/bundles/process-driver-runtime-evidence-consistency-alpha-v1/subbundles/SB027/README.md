...
## Prerequisites
- Previous subbundle: `SB026` must be closed unless this is SB001.
...
- Anti-stub audit.
- `proof/SB027/manifest.md` with changed-file hashes, command transcripts, source assertions, anti-stub output, and red-team notes.
