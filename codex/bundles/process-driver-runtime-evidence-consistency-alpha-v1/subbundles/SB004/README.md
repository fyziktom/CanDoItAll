# SB004 — Split transcript verifier request/scope/operation validation into an internal policy component.

## Status
Prepared.

## Objective
Split transcript verifier request/scope/operation validation into an internal policy component.
...
## Prerequisites
- Previous subbundle: `SB003` must be closed unless this is SB001.
...
Implement `SB004` from `bundle://subbundles/SB004/README.md`. Preserve hard boundaries, update proof, and stop if implementation requires runtime host, DI, manager command, process mutation, storage/workspace writes, shell/Graph calls, or UI changes.
