...
- Expected behavior: Malicious and contradictory cases exercise production verifiers.
...
- Production assertions: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverRuntimeEvidenceConsistencyAlphaTests.cs
