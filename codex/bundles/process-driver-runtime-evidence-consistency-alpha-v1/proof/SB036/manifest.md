...
- Representative source proof: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverRuntimeEvidenceConsistencyAlphaTests.cs

## Command Transcripts
- Closure proof index: bundle://proof/SB036/transcripts/closure-proof-index.txt
...
## Source Assertions
- Production source assertion: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverRuntimeEvidenceConsistencyAlphaTests.cs
...
- Adversarial negative proof: bundle://proof/SB036/transcripts/closure-proof-index.txt
