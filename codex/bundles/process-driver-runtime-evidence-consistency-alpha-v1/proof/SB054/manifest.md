...
- Representative source proof: repo://codex/bundles/process-driver-runtime-evidence-consistency-alpha-v1/reviews/01-execution-report.md

## Command Transcripts
- Closure proof index: bundle://proof/SB054/transcripts/closure-proof-index.txt
- Build transcript: bundle://proof/shared/transcripts/solution-build-no-restore.txt
- Passing transcript: bundle://proof/shared/transcripts/unit-tests-excluding-stale-architecture-fixtures.txt
...
## Source Assertions
- Production source assertion: repo://codex/bundles/process-driver-runtime-evidence-consistency-alpha-v1/reviews/01-execution-report.md
...
- Adversarial negative proof: bundle://proof/SB054/transcripts/closure-proof-index.txt
- Semantic positive proof: bundle://proof/shared/transcripts/unit-tests-excluding-stale-architecture-fixtures.txt
