...
- Representative source proof: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverTranscriptVerificationAlphaTests.cs

## Command Transcripts
- Closure proof index: bundle://proof/SB003/transcripts/closure-proof-index.txt
...
## Source Assertions
- Production source assertion: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverTranscriptVerificationAlphaTests.cs
...
- Adversarial negative proof: bundle://proof/SB003/transcripts/closure-proof-index.txt
