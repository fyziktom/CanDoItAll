...
- Expected behavior: Crash recovery proof is source-backed and not report-only.
...
- Production assertions: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverTranscriptVerificationAlphaTests.cs
