...
- Representative source proof: repo://src/CanDoItAll.Processes.Drivers.Abstractions/Verification/ProcessDriverContractVersion.cs

## Command Transcripts
- Closure proof index: bundle://proof/SB009/transcripts/closure-proof-index.txt
- Build transcript: bundle://proof/shared/transcripts/solution-build-no-restore.txt
- Passing transcript: bundle://proof/shared/transcripts/focused-contract-api-boundary-unit-tests.txt
...
## Source Assertions
- Production source assertion: repo://src/CanDoItAll.Processes.Drivers.Abstractions/Verification/ProcessDriverContractVersion.cs
...
- Adversarial negative proof: bundle://proof/SB009/transcripts/closure-proof-index.txt
- Semantic positive proof: bundle://proof/shared/transcripts/focused-contract-api-boundary-unit-tests.txt
