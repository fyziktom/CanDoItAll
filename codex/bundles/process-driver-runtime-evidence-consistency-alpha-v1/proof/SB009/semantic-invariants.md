...
- Expected behavior: Driver contracts remain compatibility-focused and runtime-free.
...
- Passing test: bundle://proof/shared/transcripts/focused-contract-api-boundary-unit-tests.txt
- Changed source files: bundle://proof/shared/changed-file-hashes.md
- Production assertions: repo://src/CanDoItAll.Processes.Drivers.Abstractions/Verification/ProcessDriverContractVersion.cs
