...
- Representative source proof: repo://src/CanDoItAll.Processes.Drivers.RuntimeEvidence/CanDoItAll.Processes.Drivers.RuntimeEvidence.csproj

## Command Transcripts
- Closure proof index: bundle://proof/SB021/transcripts/closure-proof-index.txt
- Build transcript: bundle://proof/shared/transcripts/solution-build-no-restore.txt
- Passing transcript: bundle://proof/shared/transcripts/focused-runtime-evidence-unit-tests.txt
...
## Source Assertions
- Production source assertion: repo://src/CanDoItAll.Processes.Drivers.RuntimeEvidence/CanDoItAll.Processes.Drivers.RuntimeEvidence.csproj
...
- Adversarial negative proof: bundle://proof/SB021/transcripts/closure-proof-index.txt
- Semantic positive proof: bundle://proof/shared/transcripts/focused-runtime-evidence-unit-tests.txt
