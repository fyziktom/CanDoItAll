...
- Expected behavior: Core descriptor consumers remain allow-listed.
...
- Passing test: bundle://proof/shared/transcripts/focused-process-driver-prerequisites-core-consumer-allowlist-test.txt
- Changed source files: bundle://proof/shared/changed-file-hashes.md
- Production assertions: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverContractPrerequisitesVerificationTests.cs
