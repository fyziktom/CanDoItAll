...
- Expected behavior: Redaction, audit, and no-mutation facts remain explicit.
...
- Production assertions: repo://src/CanDoItAll.Processes.Drivers.Abstractions/Audit/ProcessDriverRedactionPolicy.cs
