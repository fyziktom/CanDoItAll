...
- Expected behavior: Evidence URI and hash policy stays deterministic and supplied-reference only.
...
- Production assertions: repo://src/CanDoItAll.Processes.Drivers.Abstractions/Evidence/ProcessDriverEvidencePolicy.cs
