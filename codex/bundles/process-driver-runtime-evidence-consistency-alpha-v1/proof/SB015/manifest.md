...
- Representative source proof: repo://src/CanDoItAll.Processes.Drivers.Abstractions/Evidence/ProcessDriverEvidencePolicy.cs

## Command Transcripts
- Closure proof index: bundle://proof/SB015/transcripts/closure-proof-index.txt
...
## Source Assertions
- Production source assertion: repo://src/CanDoItAll.Processes.Drivers.Abstractions/Evidence/ProcessDriverEvidencePolicy.cs
...
- Adversarial negative proof: bundle://proof/SB015/transcripts/closure-proof-index.txt
