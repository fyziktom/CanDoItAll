...
- Representative source proof: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessTranscriptVerificationReadOnlyAdapter.cs

## Command Transcripts
- Closure proof index: bundle://proof/SB012/transcripts/closure-proof-index.txt
- Build transcript: bundle://proof/shared/transcripts/solution-build-no-restore.txt
- Passing transcript: bundle://proof/shared/transcripts/focused-process-transcript-adapter-integration-tests.txt
...
## Source Assertions
- Production source assertion: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessTranscriptVerificationReadOnlyAdapter.cs
...
- Adversarial negative proof: bundle://proof/SB012/transcripts/closure-proof-index.txt
- Semantic positive proof: bundle://proof/shared/transcripts/focused-process-transcript-adapter-integration-tests.txt
