...
- Expected behavior: Process transcript adapter helper split preserves read-only observations.
...
- Passing test: bundle://proof/shared/transcripts/focused-process-transcript-adapter-integration-tests.txt
- Changed source files: bundle://proof/shared/changed-file-hashes.md
- Production assertions: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessTranscriptVerificationReadOnlyAdapter.cs
