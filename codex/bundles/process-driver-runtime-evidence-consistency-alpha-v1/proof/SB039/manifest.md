...
- Representative source proof: repo://tests/CanDoItAll.Tests.Integration/ProcessTranscriptVerificationReadOnlyAdapterTests.cs

## Command Transcripts
- Closure proof index: bundle://proof/SB039/transcripts/closure-proof-index.txt
...
## Source Assertions
- Production source assertion: repo://tests/CanDoItAll.Tests.Integration/ProcessTranscriptVerificationReadOnlyAdapterTests.cs
...
- Adversarial negative proof: bundle://proof/SB039/transcripts/closure-proof-index.txt
