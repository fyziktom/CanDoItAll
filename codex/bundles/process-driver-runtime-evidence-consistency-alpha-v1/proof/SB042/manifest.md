...
- Representative source proof: repo://tests/CanDoItAll.Tests.Integration/ProcessRuntimeEvidenceVerificationReadOnlyAdapterTests.cs

## Command Transcripts
- Closure proof index: bundle://proof/SB042/transcripts/closure-proof-index.txt
- Build transcript: bundle://proof/shared/transcripts/solution-build-no-restore.txt
- Passing transcript: bundle://proof/shared/transcripts/focused-runtime-adapter-core-allowlist-unit-test.txt
...
## Source Assertions
- Production source assertion: repo://tests/CanDoItAll.Tests.Integration/ProcessRuntimeEvidenceVerificationReadOnlyAdapterTests.cs
...
- Adversarial negative proof: bundle://proof/SB042/transcripts/closure-proof-index.txt
- Semantic positive proof: bundle://proof/shared/transcripts/focused-runtime-adapter-core-allowlist-unit-test.txt
