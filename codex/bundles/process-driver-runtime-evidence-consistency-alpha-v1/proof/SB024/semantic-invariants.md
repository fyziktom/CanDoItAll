...
- Expected behavior: Runtime evidence consistency detects descriptor contradictions.
...
- Production assertions: repo://src/CanDoItAll.Processes.Drivers.RuntimeEvidence/RuntimeEvidenceConsistencyAlphaVerifier.cs
