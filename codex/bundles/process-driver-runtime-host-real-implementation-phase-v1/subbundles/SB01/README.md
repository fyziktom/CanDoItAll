...
## Objective
Measure actual diff and prevent another bundle-heavy closure.
...
- `repo://codex/bundles/process-driver-runtime-host-codefirst-integration-gate-v1/reviews/01-execution-report.md`
...
## Deliverables
- Add or update a test that fails if long-lived tests/source read concrete codex bundle paths.
- Add a source/test ratio script or test helper that computes grouped diff totals.
- Record start SHA and require final ratio pass.
...
## Do Not Do
- Do not implement runtime behavior in this subbundle except minimal guards.
- Do not create more bundle files than necessary.
...
Implement SB01 as a code-first production/test change. Keep proof concise. Preserve Process Core genericity, deny all execution-capable effects, and keep the runtime-host roadmap explicit.
