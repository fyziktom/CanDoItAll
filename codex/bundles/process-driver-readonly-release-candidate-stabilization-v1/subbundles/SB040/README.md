# SB040 - Update package README samples to supplied-payload-only usage

## Status
Prepared for Codex implementation. Standard phase work.

## Objective
Update package README samples to supplied-payload-only usage
...
- `proof/SB040/semantic-invariants.md` for critical gates
...
Implement `SB040 - Update package README samples to supplied-payload-only usage` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
