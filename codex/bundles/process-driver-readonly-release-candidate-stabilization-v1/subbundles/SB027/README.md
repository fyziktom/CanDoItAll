...
## Objective
Gate I: projection planner has no persistence/UI/manager command
...
- `proof/SB027/semantic-invariants.md` for critical gates
...
Implement `SB027 - Gate I: projection planner has no persistence/UI/manager command` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
