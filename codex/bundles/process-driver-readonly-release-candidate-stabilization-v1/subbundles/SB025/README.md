# SB025 - Add DTO-only projection planner over batch observations and aggregates
...
## Objective
Add DTO-only projection planner over batch observations and aggregates
...
- `proof/SB025/semantic-invariants.md` for critical gates
...
Implement `SB025 - Add DTO-only projection planner over batch observations and aggregates` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
