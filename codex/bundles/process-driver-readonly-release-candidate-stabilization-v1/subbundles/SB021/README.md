...
## Objective
Gate G: evidence policy uniform across all lanes
...
5. Record proof under `proof/SB021/`.
...
## Proof Required
- `proof/SB021/manifest.md`
- `proof/SB021/semantic-invariants.md` for critical gates
...
Implement `SB021 - Gate G: evidence policy uniform across all lanes` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
