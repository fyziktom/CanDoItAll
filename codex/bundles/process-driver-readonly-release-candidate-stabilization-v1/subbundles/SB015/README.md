...
## Objective
Gate E: batch orchestration remains explicit and read-only
...
- `proof/SB015/semantic-invariants.md` for critical gates
...
Implement `SB015 - Gate E: batch orchestration remains explicit and read-only` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
