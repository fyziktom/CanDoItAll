...
## Objective
Gate H: accepted/denied responses carry no-mutation and redacted audit facts
...
- `proof/SB024/semantic-invariants.md` for critical gates
...
Implement `SB024 - Gate H: accepted/denied responses carry no-mutation and redacted audit facts` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
