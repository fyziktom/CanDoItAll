# SB001 - Re-read branch, compare report with source, classify latest changes
...
## Objective
Re-read branch, compare report with source, classify latest changes
...
- `proof/SB001/semantic-invariants.md` for critical gates
...
Implement `SB001 - Re-read branch, compare report with source, classify latest changes` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
