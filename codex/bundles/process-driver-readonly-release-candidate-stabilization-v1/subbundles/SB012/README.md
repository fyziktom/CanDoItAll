...
## Objective
Gate D: payload builder parity and hash/URI behavior preserved
...
- `proof/SB012/semantic-invariants.md` for critical gates
...
Implement `SB012 - Gate D: payload builder parity and hash/URI behavior preserved` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
