# SB052 - Run prepared/completed validators after execution edits
...
- `proof/SB052/semantic-invariants.md` for critical gates
...
Implement `SB052 - Run prepared/completed validators after execution edits` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
