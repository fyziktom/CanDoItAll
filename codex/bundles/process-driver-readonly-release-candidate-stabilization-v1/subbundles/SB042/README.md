...
## Objective
Gate N: docs do not imply runtime host or side-effect approval
...
- `proof/SB042/semantic-invariants.md` for critical gates
...
Implement `SB042 - Gate N: docs do not imply runtime host or side-effect approval` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
