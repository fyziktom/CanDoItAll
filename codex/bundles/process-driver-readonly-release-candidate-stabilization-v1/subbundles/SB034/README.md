# SB034 - Generate exact process-module driver/Core consumer map

## Status
Prepared for Codex implementation. Standard phase work.

## Objective
Generate exact process-module driver/Core consumer map
...
- `proof/SB034/semantic-invariants.md` for critical gates
...
Implement `SB034 - Generate exact process-module driver/Core consumer map` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
