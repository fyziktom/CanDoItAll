# SB041 - Add process-module adapter migration and stop-condition docs
...
## Objective
Add process-module adapter migration and stop-condition docs
...
- `proof/SB041/semantic-invariants.md` for critical gates
...
Implement `SB041 - Add process-module adapter migration and stop-condition docs` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
