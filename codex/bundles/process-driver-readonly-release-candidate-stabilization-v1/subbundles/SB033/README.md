...
## Objective
Gate K: corpus exercises production parsers/verifiers
...
- `proof/SB033/semantic-invariants.md` for critical gates
...
Implement `SB033 - Gate K: corpus exercises production parsers/verifiers` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
