# SB019 - Centralize bounded size, URI, hash and supplied-content policy coverage
...
## Objective
Centralize bounded size, URI, hash and supplied-content policy coverage
...
- `proof/SB019/semantic-invariants.md` for critical gates
...
Implement `SB019 - Centralize bounded size, URI, hash and supplied-content policy coverage` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
