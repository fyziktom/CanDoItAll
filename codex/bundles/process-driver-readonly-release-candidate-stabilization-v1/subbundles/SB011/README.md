# SB011 - Extract shared identity/scope/evidence-reference helpers
...
## Objective
Extract shared identity/scope/evidence-reference helpers
...
- `proof/SB011/semantic-invariants.md` for critical gates
...
Implement `SB011 - Extract shared identity/scope/evidence-reference helpers` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
