# SB004 - Refresh Core public API and consumer allow-list snapshots

## Status
Prepared for Codex implementation. Standard phase work.

## Objective
Refresh Core public API and consumer allow-list snapshots
...
- `proof/SB004/semantic-invariants.md` for critical gates
...
Implement `SB004 - Refresh Core public API and consumer allow-list snapshots` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
