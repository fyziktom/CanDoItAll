# SB005 - Refresh driver package topology and solution/project reference map
...
## Objective
Refresh driver package topology and solution/project reference map
...
- `proof/SB005/semantic-invariants.md` for critical gates
...
Implement `SB005 - Refresh driver package topology and solution/project reference map` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
