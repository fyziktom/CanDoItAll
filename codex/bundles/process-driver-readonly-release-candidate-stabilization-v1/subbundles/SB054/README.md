...
## Objective
Gate R: final handoff zip and closure
...
- `proof/SB054/semantic-invariants.md` for critical gates
...
Implement `SB054 - Gate R: final handoff zip and closure` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
