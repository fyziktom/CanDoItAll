...
## Objective
Gate P: release-candidate smoke passes
...
- `proof/SB048/semantic-invariants.md` for critical gates
...
Implement `SB048 - Gate P: release-candidate smoke passes` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
