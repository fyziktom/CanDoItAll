# SB008 - Move payload/observation records and lane enums into lane-specific files

## Status
Prepared for Codex implementation. Standard phase work.

## Objective
Move payload/observation records and lane enums into lane-specific files
...
- `proof/SB008/semantic-invariants.md` for critical gates
...
Implement `SB008 - Move payload/observation records and lane enums into lane-specific files` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
