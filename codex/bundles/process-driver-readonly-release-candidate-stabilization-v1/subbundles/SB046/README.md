# SB046 - Run solution build, full unit, focused unit, focused integration, source scans

## Status
Prepared for Codex implementation. Standard phase work.

## Objective
Run solution build, full unit, focused unit, focused integration, source scans
...
- `proof/SB046/semantic-invariants.md` for critical gates
...
Implement `SB046 - Run solution build, full unit, focused unit, focused integration, source scans` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
