...
## Objective
Gate L: process module driver coupling is explicit and bounded
...
- `proof/SB036/semantic-invariants.md` for critical gates
...
Implement `SB036 - Gate L: process module driver coupling is explicit and bounded` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
