# SB035 - Add tests preventing unlisted driver usage in dispatch/runtime services
...
## Objective
Add tests preventing unlisted driver usage in dispatch/runtime services
...
- `proof/SB035/semantic-invariants.md` for critical gates
...
Implement `SB035 - Add tests preventing unlisted driver usage in dispatch/runtime services` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
