# SB013 - Reduce repeated response mapping and add lane order invariants

## Status
Prepared for Codex implementation. Standard phase work.

## Objective
Reduce repeated response mapping and add lane order invariants
...
- `proof/SB013/semantic-invariants.md` for critical gates
...
Implement `SB013 - Reduce repeated response mapping and add lane order invariants` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
