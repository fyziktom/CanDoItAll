# SB037 - Refresh v1.x contract version history and compatibility docs
...
## Objective
Refresh v1.x contract version history and compatibility docs
...
- `proof/SB037/semantic-invariants.md` for critical gates
...
Implement `SB037 - Refresh v1.x contract version history and compatibility docs` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
