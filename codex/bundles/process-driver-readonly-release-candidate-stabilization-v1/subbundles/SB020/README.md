# SB020 - Add cross-lane evidence mismatch and content-type tests
...
## Objective
Add cross-lane evidence mismatch and content-type tests
...
- `proof/SB020/semantic-invariants.md` for critical gates
...
Implement `SB020 - Add cross-lane evidence mismatch and content-type tests` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
