# SB044 - Add tests rejecting accidental approval language and runtime hooks
...
## Objective
Add tests rejecting accidental approval language and runtime hooks
...
- `proof/SB044/semantic-invariants.md` for critical gates
...
Implement `SB044 - Add tests rejecting accidental approval language and runtime hooks` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
