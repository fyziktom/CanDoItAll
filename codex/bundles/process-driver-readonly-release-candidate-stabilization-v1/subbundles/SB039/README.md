...
## Objective
Gate M: version/API governance is source-backed
...
- `proof/SB039/semantic-invariants.md` for critical gates
...
Implement `SB039 - Gate M: version/API governance is source-backed` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
