...
## Objective
Gate Q: proof quality is artifact-backed
...
- `proof/SB051/semantic-invariants.md` for critical gates
...
Implement `SB051 - Gate Q: proof quality is artifact-backed` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
