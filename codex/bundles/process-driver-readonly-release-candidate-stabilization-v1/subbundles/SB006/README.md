...
## Objective
Gate B: Core driver-free and package topology guarded
...
- `proof/SB006/semantic-invariants.md` for critical gates
...
Implement `SB006 - Gate B: Core driver-free and package topology guarded` exactly as specified. Preserve the read-only driver boundary and record artifact-backed proof before marking the row complete.
