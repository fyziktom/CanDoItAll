...
- Expected behavior: Gate F: gateway cannot become runtime host is proven from current source, focused tests, release smoke, source scans, and bundle validators.
