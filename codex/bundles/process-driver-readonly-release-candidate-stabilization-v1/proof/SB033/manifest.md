...
## Proof Scope
- Critical gate: Gate K: corpus exercises production parsers/verifiers.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB033_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
