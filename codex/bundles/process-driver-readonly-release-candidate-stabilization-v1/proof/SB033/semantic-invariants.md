...
- Expected behavior: Gate K: corpus exercises production parsers/verifiers is proven from current source, focused tests, release smoke, source scans, and bundle validators.
