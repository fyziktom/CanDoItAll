...
## Proof Scope
- Critical gate: Gate L: process module driver coupling is explicit and bounded.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB036_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
