...
- Expected behavior: Gate Q: proof quality is artifact-backed is proven from current source, focused tests, release smoke, source scans, and bundle validators.
