...
- Expected behavior: Gate D: payload builder parity and hash/URI behavior preserved is proven from current source, focused tests, release smoke, source scans, and bundle validators.
