...
## Proof Scope
- Critical gate: Gate D: payload builder parity and hash/URI behavior preserved.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB012_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
