...
- Expected behavior: Gate B: Core driver-free and package topology guarded is proven from current source, focused tests, release smoke, source scans, and bundle validators.
