...
- Expected behavior: Gate E: batch orchestration remains explicit and read-only is proven from current source, focused tests, release smoke, source scans, and bundle validators.
