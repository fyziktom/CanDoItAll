...
## Proof Scope
- Critical gate: Gate G: evidence policy uniform across all lanes.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB021_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
