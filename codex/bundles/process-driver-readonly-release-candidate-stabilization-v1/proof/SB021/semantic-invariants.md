...
- Expected behavior: Gate G: evidence policy uniform across all lanes is proven from current source, focused tests, release smoke, source scans, and bundle validators.
