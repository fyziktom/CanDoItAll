...
- Expected behavior: Gate N: docs do not imply runtime host or side-effect approval is proven from current source, focused tests, release smoke, source scans, and bundle validators.
