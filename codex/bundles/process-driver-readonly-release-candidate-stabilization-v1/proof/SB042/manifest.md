...
## Proof Scope
- Critical gate: Gate N: docs do not imply runtime host or side-effect approval.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB042_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
