...
- Expected behavior: Gate I: projection planner has no persistence/UI/manager command is proven from current source, focused tests, release smoke, source scans, and bundle validators.
