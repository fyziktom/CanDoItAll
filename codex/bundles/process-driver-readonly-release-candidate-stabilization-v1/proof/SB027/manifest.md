...
## Proof Scope
- Critical gate: Gate I: projection planner has no persistence/UI/manager command.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB027_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
