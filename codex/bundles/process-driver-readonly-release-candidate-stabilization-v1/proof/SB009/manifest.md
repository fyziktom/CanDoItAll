...
## Proof Scope
- Critical gate: Gate C: split adapters preserve behavior and no-side-effect scans.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB009_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
