...
- Expected behavior: Gate C: split adapters preserve behavior and no-side-effect scans is proven from current source, focused tests, release smoke, source scans, and bundle validators.
