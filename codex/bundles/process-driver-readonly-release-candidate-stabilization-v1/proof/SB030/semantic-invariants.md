...
- Expected behavior: Gate J: aggregation remains read-only and immutable is proven from current source, focused tests, release smoke, source scans, and bundle validators.
