...
## Proof Scope
- Critical gate: Gate M: version/API governance is source-backed.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB039_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
