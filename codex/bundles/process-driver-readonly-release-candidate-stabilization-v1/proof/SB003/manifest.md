...
## Proof Scope
- Critical gate: Gate A: source-backed baseline, no report-only closure.
...
- Source assertion proof: bundle://proof/SB048/transcripts/source-scans.txt reports SB003_INV_001 and rejects runtime hooks, Core reverse dependency, side-effect APIs, scoped stubs, runtime approval claims, and UI/media drift.
