...
- Expected behavior: Gate A: source-backed baseline, no report-only closure is proven from current source, focused tests, release smoke, source scans, and bundle validators.
