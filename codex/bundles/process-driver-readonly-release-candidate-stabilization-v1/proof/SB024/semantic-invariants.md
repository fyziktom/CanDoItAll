...
- Expected behavior: Gate H: accepted/denied responses carry no-mutation and redacted audit facts is proven from current source, focused tests, release smoke, source scans, and bundle validators.
