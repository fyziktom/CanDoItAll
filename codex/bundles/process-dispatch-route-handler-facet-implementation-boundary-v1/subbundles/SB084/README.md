# SB084 - Add finalizer null outcome test
...
Add finalizer null outcome test
...
- Critical gates before SB084 must be passed.
...
5. Record proof in the execution report row for `SB084`.
...
- [ ] Execution report has a distinct `SB084` row.
...
Implement `SB084 - Add finalizer null outcome test` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB084` row.
