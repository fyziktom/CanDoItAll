# SB138 - Focused unit route tests
...
- Critical gates before SB138 must be passed.
...
5. Record proof in the execution report row for `SB138`.
...
- [ ] Execution report has a distinct `SB138` row.
...
Implement `SB138 - Focused unit route tests` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB138` row.
