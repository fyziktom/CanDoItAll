# SB043 - Add upstream materialization no-op and request tests
...
Add upstream materialization no-op and request tests
...
- Critical gates before SB043 must be passed.
...
5. Record proof in the execution report row for `SB043`.
...
- [ ] Execution report has a distinct `SB043` row.
...
Implement `SB043 - Add upstream materialization no-op and request tests` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB043` row.
