# SB097 - Add dependency surface scan for handlers
...
Add dependency surface scan for handlers
...
- Critical gates before SB097 must be passed.
...
5. Record proof in the execution report row for `SB097`.
...
- [ ] Execution report has a distinct `SB097` row.
...
Implement `SB097 - Add dependency surface scan for handlers` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB097` row.
