# SB068 - Critical Gate M: mid-route closure
...
Critical Gate M: mid-route closure
...
- Critical gates before SB068 must be passed.
...
5. Record proof in the execution report row for `SB068`.
...
- [ ] Execution report has a distinct `SB068` row.
...
Implement `SB068 - Critical Gate M: mid-route closure` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB068` row.
