# SB123 - Document residual route blockers before Core
...
Document residual route blockers before Core
...
- Critical gates before SB123 must be passed.
...
5. Record proof in the execution report row for `SB123`.
...
- [ ] Execution report has a distinct `SB123` row.
...
Implement `SB123 - Document residual route blockers before Core` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB123` row.
