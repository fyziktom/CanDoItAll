# SB095 - Add handler factory source-order assertion
...
Add handler factory source-order assertion
...
- Critical gates before SB095 must be passed.
...
5. Record proof in the execution report row for `SB095`.
...
- [ ] Execution report has a distinct `SB095` row.
...
Implement `SB095 - Add handler factory source-order assertion` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB095` row.
