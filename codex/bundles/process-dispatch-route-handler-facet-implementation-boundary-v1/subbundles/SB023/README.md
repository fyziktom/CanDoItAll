# SB023 - Define pre-execution route facet
...
Define pre-execution route facet
...
- Critical gates before SB023 must be passed.
...
5. Record proof in the execution report row for `SB023`.
...
- [ ] Execution report has a distinct `SB023` row.
...
Implement `SB023 - Define pre-execution route facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB023` row.
