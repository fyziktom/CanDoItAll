# SB071 - Move DirectAgentExecutionRouteHandler to top-level
...
Move DirectAgentExecutionRouteHandler to top-level
...
- Critical gates before SB071 must be passed.
...
5. Record proof in the execution report row for `SB071`.
...
- [ ] Execution report has a distinct `SB071` row.
...
Implement `SB071 - Move DirectAgentExecutionRouteHandler to top-level` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB071` row.
