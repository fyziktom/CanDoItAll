# SB121 - Integration dispatch route smoke rerun
...
Integration dispatch route smoke rerun
...
- Critical gates before SB121 must be passed.
...
5. Record proof in the execution report row for `SB121`.
...
- [ ] Execution report has a distinct `SB121` row.
...
Implement `SB121 - Integration dispatch route smoke rerun` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB121` row.
