# SB005 - Behavior preservation matrix for route-stage order
...
Behavior preservation matrix for route-stage order
...
- Critical gates before SB005 must be passed.
...
5. Record proof in the execution report row for `SB005`.
...
- [ ] Execution report has a distinct `SB005` row.
...
Implement `SB005 - Behavior preservation matrix for route-stage order` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB005` row.
