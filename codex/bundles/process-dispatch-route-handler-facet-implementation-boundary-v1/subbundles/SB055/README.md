# SB055 - Narrow start transition dependencies to transition/reload facets
...
Narrow start transition dependencies to transition/reload facets
...
- Critical gates before SB055 must be passed.
...
5. Record proof in the execution report row for `SB055`.
...
- [ ] Execution report has a distinct `SB055` row.
...
Implement `SB055 - Narrow start transition dependencies to transition/reload facets` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB055` row.
