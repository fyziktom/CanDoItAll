# SB026 - Define workflow route facet
...
- Critical gates before SB026 must be passed.
...
5. Record proof in the execution report row for `SB026`.
...
- [ ] Execution report has a distinct `SB026` row.
...
Implement `SB026 - Define workflow route facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB026` row.
