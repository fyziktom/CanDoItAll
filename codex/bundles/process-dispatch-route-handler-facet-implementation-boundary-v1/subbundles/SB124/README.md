# SB124 - Critical Gate V: no hidden route coupling
...
Critical Gate V: no hidden route coupling
...
- Critical gates before SB124 must be passed.
...
5. Record proof in the execution report row for `SB124`.
...
- [ ] Execution report has a distinct `SB124` row.
...
Implement `SB124 - Critical Gate V: no hidden route coupling` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB124` row.
