# SB051 - Move SubprocessRouteHandler to top-level
...
Move SubprocessRouteHandler to top-level
...
- Critical gates before SB051 must be passed.
...
5. Record proof in the execution report row for `SB051`.
...
- [ ] Execution report has a distinct `SB051` row.
...
Implement `SB051 - Move SubprocessRouteHandler to top-level` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB051` row.
