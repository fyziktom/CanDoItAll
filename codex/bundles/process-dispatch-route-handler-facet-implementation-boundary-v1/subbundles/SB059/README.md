# SB059 - Add subprocess capability-gap transition tests
...
Add subprocess capability-gap transition tests
...
- Critical gates before SB059 must be passed.
...
5. Record proof in the execution report row for `SB059`.
...
- [ ] Execution report has a distinct `SB059` row.
...
Implement `SB059 - Add subprocess capability-gap transition tests` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB059` row.
