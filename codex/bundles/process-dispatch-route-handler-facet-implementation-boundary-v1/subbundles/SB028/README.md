# SB028 - Critical Gate F: route facet contract proof
...
Critical Gate F: route facet contract proof
...
- Critical gates before SB028 must be passed.
...
5. Record proof in the execution report row for `SB028`.
...
- [ ] Execution report has a distinct `SB028` row.
...
Implement `SB028 - Critical Gate F: route facet contract proof` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB028` row.
