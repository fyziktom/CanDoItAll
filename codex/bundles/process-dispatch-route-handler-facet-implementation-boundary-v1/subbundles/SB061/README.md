# SB061 - Add terminal mirror transition tests
...
Add terminal mirror transition tests
...
- Critical gates before SB061 must be passed.
...
5. Record proof in the execution report row for `SB061`.
...
- [ ] Execution report has a distinct `SB061` row.
...
Implement `SB061 - Add terminal mirror transition tests` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB061` row.
