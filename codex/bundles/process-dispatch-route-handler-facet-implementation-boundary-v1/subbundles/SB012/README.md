# SB012 - Critical Gate C: route vocabulary parity
...
Critical Gate C: route vocabulary parity
...
- Critical gates before SB012 must be passed.
...
5. Record proof in the execution report row for `SB012`.
...
- [ ] Execution report has a distinct `SB012` row.
...
Implement `SB012 - Critical Gate C: route vocabulary parity` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB012` row.
