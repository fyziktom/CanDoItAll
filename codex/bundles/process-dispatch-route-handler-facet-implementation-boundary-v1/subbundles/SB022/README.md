# SB022 - Define transition/finalizer route facet
...
Define transition/finalizer route facet
...
- Critical gates before SB022 must be passed.
...
5. Record proof in the execution report row for `SB022`.
...
- [ ] Execution report has a distinct `SB022` row.
...
Implement `SB022 - Define transition/finalizer route facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB022` row.
