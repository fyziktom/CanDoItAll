# SB066 - Mid-route line-count review
...
- Critical gates before SB066 must be passed.
...
5. Record proof in the execution report row for `SB066`.
...
- [ ] Execution report has a distinct `SB066` row.
...
Implement `SB066 - Mid-route line-count review` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB066` row.
