# SB027 - Define direct-agent route facet
...
Define direct-agent route facet
...
- Critical gates before SB027 must be passed.
...
5. Record proof in the execution report row for `SB027`.
...
- [ ] Execution report has a distinct `SB027` row.
...
Implement `SB027 - Define direct-agent route facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB027` row.
