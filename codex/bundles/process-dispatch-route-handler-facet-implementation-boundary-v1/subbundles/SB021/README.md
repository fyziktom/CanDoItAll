# SB021 - Define minimal route logging facet
...
Define minimal route logging facet
...
- Critical gates before SB021 must be passed.
...
5. Record proof in the execution report row for `SB021`.
...
- [ ] Execution report has a distinct `SB021` row.
...
Implement `SB021 - Define minimal route logging facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB021` row.
