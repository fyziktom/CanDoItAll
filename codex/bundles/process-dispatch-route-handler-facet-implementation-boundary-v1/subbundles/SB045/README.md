# SB045 - Pre-execution source-size review
...
Pre-execution source-size review
...
- Critical gates before SB045 must be passed.
...
5. Record proof in the execution report row for `SB045`.
...
- [ ] Execution report has a distinct `SB045` row.
...
Implement `SB045 - Pre-execution source-size review` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB045` row.
