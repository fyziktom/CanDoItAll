# SB018 - Add no-collapsed-report-row guard
...
Add no-collapsed-report-row guard
...
- Critical gates before SB018 must be passed.
...
5. Record proof in the execution report row for `SB018`.
...
- [ ] Execution report has a distinct `SB018` row.
...
Implement `SB018 - Add no-collapsed-report-row guard` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB018` row.
