# SB008 - Critical Gate B: baseline proof and reopen triggers
...
Critical Gate B: baseline proof and reopen triggers
...
- Critical gates before SB008 must be passed.
...
5. Record proof in the execution report row for `SB008`.
...
- [ ] Execution report has a distinct `SB008` row.
...
Implement `SB008 - Critical Gate B: baseline proof and reopen triggers` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB008` row.
