# SB025 - Define subprocess route facet
...
- Critical gates before SB025 must be passed.
...
5. Record proof in the execution report row for `SB025`.
...
- [ ] Execution report has a distinct `SB025` row.
...
Implement `SB025 - Define subprocess route facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB025` row.
