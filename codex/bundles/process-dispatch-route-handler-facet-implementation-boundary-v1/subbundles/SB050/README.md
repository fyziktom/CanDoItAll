# SB050 - Narrow stranded recovery dependencies to recovery/finalizer facets
...
Narrow stranded recovery dependencies to recovery/finalizer facets
...
- Critical gates before SB050 must be passed.
...
5. Record proof in the execution report row for `SB050`.
...
- [ ] Execution report has a distinct `SB050` row.
...
Implement `SB050 - Narrow stranded recovery dependencies to recovery/finalizer facets` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB050` row.
