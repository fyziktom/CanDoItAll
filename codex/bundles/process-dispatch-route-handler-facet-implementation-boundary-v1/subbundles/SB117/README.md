# SB117 - Route services adapter line-count review
...
Route services adapter line-count review
...
- Critical gates before SB117 must be passed.
...
5. Record proof in the execution report row for `SB117`.
...
- [ ] Execution report has a distinct `SB117` row.
...
Implement `SB117 - Route services adapter line-count review` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB117` row.
