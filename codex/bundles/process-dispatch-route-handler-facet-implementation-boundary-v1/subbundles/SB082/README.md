# SB082 - Add competing active execution skip tests
...
Add competing active execution skip tests
...
- Critical gates before SB082 must be passed.
...
5. Record proof in the execution report row for `SB082`.
...
- [ ] Execution report has a distinct `SB082` row.
...
Implement `SB082 - Add competing active execution skip tests` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB082` row.
