# SB035 - Move DatabaseRequirementRouteHandler to top-level
...
Move DatabaseRequirementRouteHandler to top-level
...
- Critical gates before SB035 must be passed.
...
5. Record proof in the execution report row for `SB035`.
...
- [ ] Execution report has a distinct `SB035` row.
...
Implement `SB035 - Move DatabaseRequirementRouteHandler to top-level` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB035` row.
