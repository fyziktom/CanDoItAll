# SB038 - Narrow upstream materialization dependencies
...
Narrow upstream materialization dependencies
...
- Critical gates before SB038 must be passed.
...
5. Record proof in the execution report row for `SB038`.
...
- [ ] Execution report has a distinct `SB038` row.
...
Implement `SB038 - Narrow upstream materialization dependencies` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB038` row.
