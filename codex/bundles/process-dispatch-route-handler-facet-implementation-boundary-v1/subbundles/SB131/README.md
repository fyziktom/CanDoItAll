# SB131 - Scan for UI/mobile proof drift
...
Scan for UI/mobile proof drift
...
- Critical gates before SB131 must be passed.
...
5. Record proof in the execution report row for `SB131`.
...
- [ ] Execution report has a distinct `SB131` row.
...
Implement `SB131 - Scan for UI/mobile proof drift` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB131` row.
