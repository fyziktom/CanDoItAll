# SB119 - Failure closure ownership scan
...
Failure closure ownership scan
...
- Critical gates before SB119 must be passed.
...
5. Record proof in the execution report row for `SB119`.
...
- [ ] Execution report has a distinct `SB119` row.
...
Implement `SB119 - Failure closure ownership scan` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB119` row.
