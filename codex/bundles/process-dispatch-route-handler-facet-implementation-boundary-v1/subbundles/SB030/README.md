# SB030 - Define route candidate reload facet
...
Define route candidate reload facet
...
- Critical gates before SB030 must be passed.
...
5. Record proof in the execution report row for `SB030`.
...
- [ ] Execution report has a distinct `SB030` row.
...
Implement `SB030 - Define route candidate reload facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB030` row.
