# SB118 - Claim model adapter review
...
- Critical gates before SB118 must be passed.
...
5. Record proof in the execution report row for `SB118`.
...
- [ ] Execution report has a distinct `SB118` row.
...
Implement `SB118 - Claim model adapter review` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB118` row.
