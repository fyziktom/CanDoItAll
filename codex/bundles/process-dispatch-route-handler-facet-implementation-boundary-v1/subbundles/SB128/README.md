# SB128 - Process Core readiness checkpoint
...
Process Core readiness checkpoint
...
- Critical gates before SB128 must be passed.
...
5. Record proof in the execution report row for `SB128`.
...
- [ ] Execution report has a distinct `SB128` row.
...
Implement `SB128 - Process Core readiness checkpoint` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB128` row.
