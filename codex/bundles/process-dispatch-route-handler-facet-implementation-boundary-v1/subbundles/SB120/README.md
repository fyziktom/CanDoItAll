# SB120 - Route stage order golden test rerun
...
Route stage order golden test rerun
...
- Critical gates before SB120 must be passed.
...
5. Record proof in the execution report row for `SB120`.
...
- [ ] Execution report has a distinct `SB120` row.
...
Implement `SB120 - Route stage order golden test rerun` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB120` row.
