# SB064 - Add start transition reload continue-candidates tests
...
Add start transition reload continue-candidates tests
...
- Critical gates before SB064 must be passed.
...
5. Record proof in the execution report row for `SB064`.
...
- [ ] Execution report has a distinct `SB064` row.
...
Implement `SB064 - Add start transition reload continue-candidates tests` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB064` row.
