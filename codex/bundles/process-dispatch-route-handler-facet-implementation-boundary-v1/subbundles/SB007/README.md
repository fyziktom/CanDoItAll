# SB007 - Forbidden-token source scan setup
...
Forbidden-token source scan setup
...
- Critical gates before SB007 must be passed.
...
5. Record proof in the execution report row for `SB007`.
...
- [ ] Execution report has a distinct `SB007` row.
...
Implement `SB007 - Forbidden-token source scan setup` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB007` row.
