# SB024 - Define recovery route facet
...
- Critical gates before SB024 must be passed.
...
5. Record proof in the execution report row for `SB024`.
...
- [ ] Execution report has a distinct `SB024` row.
...
Implement `SB024 - Define recovery route facet` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB024` row.
