# SB062 - Critical Gate L: subprocess parity
...
Critical Gate L: subprocess parity
...
- Critical gates before SB062 must be passed.
...
5. Record proof in the execution report row for `SB062`.
...
- [ ] Execution report has a distinct `SB062` row.
...
Implement `SB062 - Critical Gate L: subprocess parity` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB062` row.
