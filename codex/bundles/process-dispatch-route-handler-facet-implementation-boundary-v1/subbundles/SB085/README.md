# SB085 - Add finalizer transition applied test
...
Add finalizer transition applied test
...
- Critical gates before SB085 must be passed.
...
5. Record proof in the execution report row for `SB085`.
...
- [ ] Execution report has a distinct `SB085` row.
...
Implement `SB085 - Add finalizer transition applied test` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB085` row.
