# SB006 - Claim/failure/finalizer dependency map
...
Claim/failure/finalizer dependency map
...
- Critical gates before SB006 must be passed.
...
5. Record proof in the execution report row for `SB006`.
...
- [ ] Execution report has a distinct `SB006` row.
...
Implement `SB006 - Claim/failure/finalizer dependency map` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB006` row.
