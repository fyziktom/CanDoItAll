# SB104 - Critical Gate R: route host/factory proof
...
Critical Gate R: route host/factory proof
...
- Critical gates before SB104 must be passed.
...
5. Record proof in the execution report row for `SB104`.
...
- [ ] Execution report has a distinct `SB104` row.
...
Implement `SB104 - Critical Gate R: route host/factory proof` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB104` row.
