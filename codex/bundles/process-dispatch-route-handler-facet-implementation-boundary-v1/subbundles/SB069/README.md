# SB069 - Move WorkflowRouteHandler to top-level
...
Move WorkflowRouteHandler to top-level
...
- Critical gates before SB069 must be passed.
...
5. Record proof in the execution report row for `SB069`.
...
- [ ] Execution report has a distinct `SB069` row.
...
Implement `SB069 - Move WorkflowRouteHandler to top-level` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB069` row.
