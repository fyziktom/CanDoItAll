# SB074 - Narrow competing guard dependencies
...
Narrow competing guard dependencies
...
- Critical gates before SB074 must be passed.
...
5. Record proof in the execution report row for `SB074`.
...
- [ ] Execution report has a distinct `SB074` row.
...
Implement `SB074 - Narrow competing guard dependencies` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB074` row.
