# SB041 - Remove dispatcher constructor dependency from pre-execution handlers
...
Remove dispatcher constructor dependency from pre-execution handlers
...
- Critical gates before SB041 must be passed.
...
5. Record proof in the execution report row for `SB041`.
...
- [ ] Execution report has a distinct `SB041` row.
...
Implement `SB041 - Remove dispatcher constructor dependency from pre-execution handlers` exactly. Preserve route behavior and route order. Do not create Process Core or production driver APIs. Record proof in the execution report under a distinct `SB041` row.
