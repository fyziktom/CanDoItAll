...
Run build plus focused process dispatch/projection/retry/artifact/finalizer smoke matrix.
...
- Implement or verify the scoped change for SB61.
...
Implement SB61 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
