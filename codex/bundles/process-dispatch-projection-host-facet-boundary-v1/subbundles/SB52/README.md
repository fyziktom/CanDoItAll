# SB52 - Gate M type leakage and file-size proof
...
Prove file sizes, alias usage, and dependency directions are acceptable before final hardening.
...
- Implement or verify the scoped change for SB52.
...
- Critical manifest under `proof/SB52/manifest.md`.
- Semantic invariants under `proof/SB52/semantic-invariants.md`.
...
Implement SB52 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
