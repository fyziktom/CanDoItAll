# SB02 - Projection source and host method inventory
...
Enumerate every IProcessArtifactProjectionHost member, consumer, side effect, and source-family owner.
...
- Implement or verify the scoped change for SB02.
...
Implement SB02 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
