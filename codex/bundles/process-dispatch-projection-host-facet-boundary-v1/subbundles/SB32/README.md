# SB32 - Gate H decision/lineage/write-request proof
...
Prove completed-decision and lineage behavior stays identical, including record-only and write-backed paths.
...
- Implement or verify the scoped change for SB32.
...
- Critical manifest under `proof/SB32/manifest.md`.
- Semantic invariants under `proof/SB32/semantic-invariants.md`.
...
Implement SB32 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
