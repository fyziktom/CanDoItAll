...
Extract file read/copy/write helpers used by projection source families with explicit side-effect naming.
...
- Implement or verify the scoped change for SB10.
...
Implement SB10 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
