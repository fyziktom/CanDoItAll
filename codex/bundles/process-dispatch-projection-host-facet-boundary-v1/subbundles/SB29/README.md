# SB29 - Completed decision projection facet
...
Extract completed-decision trust, provenance, review summary, external key, and record-only behavior.
...
- Implement or verify the scoped change for SB29.
...
Implement SB29 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
