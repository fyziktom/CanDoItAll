# SB20 - Gate E process-mock/workspace-written proof
...
Prove process mock and workspace-written projections preserve match order, exceptions, and candidate mutations.
...
- Implement or verify the scoped change for SB20.
...
- Critical manifest under `proof/SB20/manifest.md`.
- Semantic invariants under `proof/SB20/semantic-invariants.md`.
...
Implement SB20 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
