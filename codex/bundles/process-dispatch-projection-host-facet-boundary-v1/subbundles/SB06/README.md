# SB06 - Projection context dependency slimming plan
...
Review ProcessArtifactProjectionContext fields and define which dependencies move into services versus per-run context.
...
- Implement or verify the scoped change for SB06.
...
Implement SB06 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
