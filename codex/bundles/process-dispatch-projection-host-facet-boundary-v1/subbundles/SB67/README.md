# SB67 - Regression proof portability pass
...
Ensure proof paths and transcripts are portable and do not rely on local absolute paths.
...
- Implement or verify the scoped change for SB67.
...
Implement SB67 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
