...
Run scans for stubs, TODOs, broad host dependency, dispatcher dependency, UI drift, and prohibited viewport proof.
...
- Implement or verify the scoped change for SB62.
...
Implement SB62 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
