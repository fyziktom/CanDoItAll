# SB36 - Gate I first source-family migration proof
...
Prove execution, process mock, and workspace-written coordinators no longer depend on broad host and still pass projection tests.
...
- Implement or verify the scoped change for SB36.
...
- Critical foundation validation with manifest, semantic invariants, focused tests, source scans and red-team proof.
...
- Critical manifest under `proof/SB36/manifest.md`.
- Semantic invariants under `proof/SB36/semantic-invariants.md`.
- Downstream dependency check statement.
...
- Critical gate: downstream subbundles cannot continue until all proof passes.
## Suggested Agent Prompt

Implement SB36 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
