# SB11 - Artifact classification facet
...
Route content-type, artifact-kind, storage-content-kind, and storage-relative path helpers through a classification facet.
...
- Implement or verify the scoped change for SB11.
...
Implement SB11 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
