# SB14 - Project-structure artifact path facet
...
Extract governed path matching and project-structure expected path logic behind an explicit facet.
...
- Implement or verify the scoped change for SB14.
...
Implement SB14 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
