# SB16 - Gate D matcher and candidate mutation proof
...
Prove expectation matching and candidate-state updates keep exact prior behavior and errors.
...
- Implement or verify the scoped change for SB16.
...
- Critical manifest under `proof/SB16/manifest.md`.
- Semantic invariants under `proof/SB16/semantic-invariants.md`.
...
Implement SB16 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
