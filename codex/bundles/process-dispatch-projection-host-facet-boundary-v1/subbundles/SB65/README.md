# SB65 - Post-refactor dependency graph artifact
...
Generate a small dependency graph showing coordinators -> facets -> dispatcher adapter, not coordinators -> dispatcher.
...
- Implement or verify the scoped change for SB65.
...
Implement SB65 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
