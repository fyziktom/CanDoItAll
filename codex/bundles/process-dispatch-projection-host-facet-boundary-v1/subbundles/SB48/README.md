...
Fail if broad host remains above the agreed threshold or any coordinator depends on it.
...
- Implement or verify the scoped change for SB48.
...
- Critical manifest under `proof/SB48/manifest.md`.
- Semantic invariants under `proof/SB48/semantic-invariants.md`.
...
Implement SB48 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
