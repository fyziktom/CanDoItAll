# SB03 - Facet taxonomy and migration cutline
...
Classify host methods into narrow facets and define what must remain dispatcher-owned.
...
- Implement or verify the scoped change for SB03.
...
Implement SB03 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
