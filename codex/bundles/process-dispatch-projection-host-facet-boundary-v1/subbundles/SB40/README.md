# SB40 - Gate J remaining source-family migration proof
...
Prove existing-managed, response-text, and provider-native browser coordinators are host-free and behavior-equivalent.
...
- Implement or verify the scoped change for SB40.
...
- Critical manifest under `proof/SB40/manifest.md`.
- Semantic invariants under `proof/SB40/semantic-invariants.md`.
...
Implement SB40 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
