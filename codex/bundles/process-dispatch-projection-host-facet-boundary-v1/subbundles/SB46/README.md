# SB46 - DispatcherArtifactProjectionHost shrink or deletion
...
Delete DispatcherArtifactProjectionHost if unused; otherwise reduce it to a small temporary bridge with TODO-free reason.
...
- Implement or verify the scoped change for SB46.
...
Implement SB46 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
