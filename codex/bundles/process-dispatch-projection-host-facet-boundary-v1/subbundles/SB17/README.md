# SB17 - Session observation projection facet
...
Use the existing observation boundary for session file writes, browser outputs, and response text instead of host wrapper methods.
...
- Implement or verify the scoped change for SB17.
...
Implement SB17 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
