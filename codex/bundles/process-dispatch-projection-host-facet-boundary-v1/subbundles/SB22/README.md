# SB22 - Response-text projection rules facet
...
Extract response projection eligibility, path choice, overwrite rules, and content usability.
...
- Implement or verify the scoped change for SB22.
...
Implement SB22 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
