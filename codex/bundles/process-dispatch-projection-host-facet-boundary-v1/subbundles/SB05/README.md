# SB05 - Projection services aggregate design
...
Introduce a module-local ProcessArtifactProjectionServices composition record without behavior changes.
...
- Implement or verify the scoped change for SB05.
...
Implement SB05 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
