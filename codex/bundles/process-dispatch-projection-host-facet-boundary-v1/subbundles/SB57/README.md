# SB57 - Documentation-only driver-readiness facet map
...
Map projection facets to future driver concepts without introducing any production driver API.
...
- Implement or verify the scoped change for SB57.
...
Implement SB57 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
