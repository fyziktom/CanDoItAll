# SB01 - Entry branch audit and bundle repair preflight
...
Audit current maf-processes-refactor state, confirm last projection split closure, and run prepared validator before source movement.
...
- Implement or verify the scoped change for SB01.
...
Implement SB01 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
