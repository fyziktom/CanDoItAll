...
Move ExternalReferenceKeys and RecordedArtifactExpectationIds mutation into a top-level module-local candidate-state service.
...
- Implement or verify the scoped change for SB15.
...
Implement SB15 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
