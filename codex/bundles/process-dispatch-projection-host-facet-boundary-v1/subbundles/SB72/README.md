...
Run completed validator and close the initiative with no pending raw notes.
...
- Implement or verify the scoped change for SB72.
...
- Critical manifest under `proof/SB72/manifest.md`.
- Semantic invariants under `proof/SB72/semantic-invariants.md`.
...
Implement SB72 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
