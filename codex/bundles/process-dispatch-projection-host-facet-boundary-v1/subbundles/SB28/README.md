# SB28 - Gate G provider-native browser proof
...
Prove browser expected-output and discovered-output projections preserve source/target safety and duplicate handling.
...
- Implement or verify the scoped change for SB28.
...
- Critical manifest under `proof/SB28/manifest.md`.
- Semantic invariants under `proof/SB28/semantic-invariants.md`.
...
Implement SB28 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
