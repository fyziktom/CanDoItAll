...
Prove source-family positive and negative tests pass and no shallow simplification is possible.
...
- Implement or verify the scoped change for SB56.
...
- Critical manifest under `proof/SB56/manifest.md`.
- Semantic invariants under `proof/SB56/semantic-invariants.md`.
...
Implement SB56 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
