# SB18 - Process mock projection rules facet
...
Extract process-mock projection matching and source-path logic into a source-family facet.
...
- Implement or verify the scoped change for SB18.
...
Implement SB18 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
