# SB55 - Negative tests for forbidden simplification
...
Add or verify negative coverage for source-family order drift, duplicate keys, outside-workspace paths, and missing expected ids.
...
- Implement or verify the scoped change for SB55.
...
Implement SB55 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
