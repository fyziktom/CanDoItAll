# SB26 - Provider-native file copy side-effect facet
...
Isolate browser output copy/read/write side effects behind explicit side-effect helpers.
...
- Implement or verify the scoped change for SB26.
...
Implement SB26 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
