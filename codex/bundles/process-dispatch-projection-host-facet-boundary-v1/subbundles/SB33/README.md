# SB33 - Execution artifact coordinator migration to facets
...
Replace IProcessArtifactProjectionHost usage in execution artifact coordinator with narrow facets.
...
- Implement or verify the scoped change for SB33.
...
Implement SB33 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
