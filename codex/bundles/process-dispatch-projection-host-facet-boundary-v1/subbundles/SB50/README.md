# SB50 - Nested type leakage inventory
...
Inventory usages of ProcessRunAutomationDispatchService nested aliases in projection helpers and classify safe vs deferred.
...
- Implement or verify the scoped change for SB50.
...
Implement SB50 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
