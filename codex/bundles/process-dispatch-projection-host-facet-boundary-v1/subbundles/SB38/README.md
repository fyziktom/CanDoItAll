# SB38 - Response-text coordinator migration to facets
...
Replace host usage in response-text coordinator without changing target path or overwrite behavior.
...
- Implement or verify the scoped change for SB38.
...
Implement SB38 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
