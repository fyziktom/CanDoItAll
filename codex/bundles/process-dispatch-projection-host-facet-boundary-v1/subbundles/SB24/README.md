# SB24 - Gate F existing-managed/response proof
...
Prove existing-managed and response projection behavior including overwrite and duplicate handling.
...
- Implement or verify the scoped change for SB24.
...
- Critical manifest under `proof/SB24/manifest.md`.
- Semantic invariants under `proof/SB24/semantic-invariants.md`.
...
Implement SB24 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
