# SB44 - Gate K orchestrator/facade proof
...
Prove source-family order, context creation, and candidate mutation outcomes remain unchanged.
...
- Implement or verify the scoped change for SB44.
...
- Critical manifest under `proof/SB44/manifest.md`.
- Semantic invariants under `proof/SB44/semantic-invariants.md`.
...
Implement SB44 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
