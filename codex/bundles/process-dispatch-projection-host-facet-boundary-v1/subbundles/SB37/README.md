# SB37 - Existing-managed coordinator migration to facets
...
Replace host usage in existing-managed coordinator, including response reuse entrypoint.
...
- Implement or verify the scoped change for SB37.
...
Implement SB37 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
