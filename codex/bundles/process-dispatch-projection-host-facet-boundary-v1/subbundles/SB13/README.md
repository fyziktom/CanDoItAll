# SB13 - Expectation matcher facet
...
Extract ResolveArtifactExpectation and expectation-id resolution behind a narrow matcher facet.
...
- Implement or verify the scoped change for SB13.
...
Implement SB13 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
