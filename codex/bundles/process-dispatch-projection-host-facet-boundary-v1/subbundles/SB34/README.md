# SB34 - Process mock coordinator migration to facets
...
Replace host usage in process mock coordinator and preserve all exception text and path behavior.
...
- Implement or verify the scoped change for SB34.
...
Implement SB34 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
