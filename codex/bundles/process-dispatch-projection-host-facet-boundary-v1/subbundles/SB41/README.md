# SB41 - Completed decision coordinator migration to facets
...
Replace host usage in completed decision coordinator with decision and lineage facets.
...
- Implement or verify the scoped change for SB41.
...
Implement SB41 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
