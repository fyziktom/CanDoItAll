# SB19 - Workspace-written projection rules facet
...
Extract workspace-written matching, receipt paths, source full-path resolution, and source summary creation.
...
- Implement or verify the scoped change for SB19.
...
Implement SB19 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
