# SB64 - Gate P final red-team closure
...
Complete final red-team review and completed-stage validator proof.
...
- Implement or verify the scoped change for SB64.
...
- Critical manifest under `proof/SB64/manifest.md`.
- Semantic invariants under `proof/SB64/semantic-invariants.md`.
...
Implement SB64 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
