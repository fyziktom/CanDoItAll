# SB25 - Provider-native browser evidence facet
...
Extract browser output lookup, working directory, expected-output matching, and discovered-output matching.
...
- Implement or verify the scoped change for SB25.
...
Implement SB25 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
