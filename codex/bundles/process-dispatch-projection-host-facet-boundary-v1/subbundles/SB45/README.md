# SB45 - IProcessArtifactProjectionHost shrink pass
...
Remove members no longer needed after source-family migration; preserve only temporary bridge methods if any remain.
...
- Implement or verify the scoped change for SB45.
...
Implement SB45 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
