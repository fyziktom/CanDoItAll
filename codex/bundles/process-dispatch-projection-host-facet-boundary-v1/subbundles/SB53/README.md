# SB53 - Architecture tests for host/facet boundaries
...
Add tests that fail if projection coordinators use the broad host or dispatcher service directly.
...
- Implement or verify the scoped change for SB53.
...
Implement SB53 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
