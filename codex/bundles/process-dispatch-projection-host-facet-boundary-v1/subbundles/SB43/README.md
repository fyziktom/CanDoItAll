# SB43 - Projection facade wiring cleanup
...
Update ProjectExecutionArtifactsAsync to build services/facets and call the orchestrator with minimal local orchestration.
...
- Implement or verify the scoped change for SB43.
...
Implement SB43 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
