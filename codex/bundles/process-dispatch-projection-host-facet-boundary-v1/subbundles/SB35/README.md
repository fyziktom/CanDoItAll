# SB35 - Workspace-written coordinator migration to facets
...
Replace host usage in workspace-written coordinator and preserve receipt/session preference order.
...
- Implement or verify the scoped change for SB35.
...
Implement SB35 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
