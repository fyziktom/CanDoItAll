# SB08 - Gate B context and claim facet proof
...
Prove the new context/services shell preserves projection call order and claim checks.
...
- Implement or verify the scoped change for SB08.
...
- Critical manifest under `proof/SB08/manifest.md`.
...
Implement SB08 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
