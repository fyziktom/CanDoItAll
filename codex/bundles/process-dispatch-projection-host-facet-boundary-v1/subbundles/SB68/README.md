# SB68 - Gate Q portability and deprecation proof
...
Prove post-refactor docs are portable and no broad-host debt is untracked.
...
- Implement or verify the scoped change for SB68.
...
- Critical manifest under `proof/SB68/manifest.md`.
- Semantic invariants under `proof/SB68/semantic-invariants.md`.
...
Implement SB68 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
