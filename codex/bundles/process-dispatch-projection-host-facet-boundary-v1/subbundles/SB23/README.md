# SB23 - Response-to-existing-managed reuse seam
...
Make response projection reuse of existing-managed coordinator explicit without circular dependency or hidden host dependency.
...
- Implement or verify the scoped change for SB23.
...
Implement SB23 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
