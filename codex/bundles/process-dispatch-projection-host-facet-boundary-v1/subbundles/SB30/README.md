# SB30 - Lineage and recovery context facet
...
Extract lineage/recovery context helpers used across all source families.
...
- Implement or verify the scoped change for SB30.
...
Implement SB30 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
