# SB12 - Gate C path and classification parity
...
Prove path resolution, content type, artifact kind, storage kind, and no outside-workspace checks stay equivalent.
...
- Implement or verify the scoped change for SB12.
...
- Critical manifest under `proof/SB12/manifest.md`.
- Semantic invariants under `proof/SB12/semantic-invariants.md`.
...
Implement SB12 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
