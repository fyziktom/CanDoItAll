# SB21 - Existing-managed projection rules facet
...
Extract existing-managed relative path enumeration and file match behavior.
...
- Implement or verify the scoped change for SB21.
...
Implement SB21 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
