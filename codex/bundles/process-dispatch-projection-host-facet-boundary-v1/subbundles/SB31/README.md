# SB31 - Write request builder facet
...
Extract ProcessArtifactProjectionWriteRequest creation patterns to reduce duplicate source-family logic.
...
- Implement or verify the scoped change for SB31.
...
Implement SB31 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
