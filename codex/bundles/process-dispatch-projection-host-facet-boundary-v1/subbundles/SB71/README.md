...
Ensure all manifests, semantic invariants, source assertions, transcripts, and raw note coverage are present.
...
- Implement or verify the scoped change for SB71.
...
Implement SB71 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
