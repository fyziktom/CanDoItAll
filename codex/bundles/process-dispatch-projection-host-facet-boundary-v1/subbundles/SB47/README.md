# SB47 - Compatibility wrapper audit
...
Audit private wrappers left in ArtifactProjection.cs and replace with direct facet methods where safe.
...
- Implement or verify the scoped change for SB47.
...
Implement SB47 only. Preserve behavior. Update proof. Do not start the next subbundle until this subbundle is closed.
