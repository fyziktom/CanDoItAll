# SB08 - Refactor Gate B route parity
...
Run subprocess/workflow/header/hydration parity tests and source scans.
...
All previous subbundles through SB07 closed.
...
- Command transcripts under `proof/SB08/transcripts/`.
...
Implement SB08: Refactor Gate B route parity. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
