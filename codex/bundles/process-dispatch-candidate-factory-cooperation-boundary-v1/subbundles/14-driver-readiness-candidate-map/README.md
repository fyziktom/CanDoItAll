# SB14 - Driver-readiness candidate map
...
Update documentation-only map for future helper drivers; no production driver API.
...
All previous subbundles through SB13 closed.
...
- Updated proof manifest under `proof/SB14/manifest.md`.
...
Implement SB14: Driver-readiness candidate map. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
