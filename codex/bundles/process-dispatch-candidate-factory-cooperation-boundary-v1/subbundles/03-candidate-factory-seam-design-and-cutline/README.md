# SB03 - Candidate factory seam design and cutline
...
Define module-local factory/context boundaries and forbidden side effects before production movement.
...
All previous subbundles through SB02 closed.
...
Implement SB03: Candidate factory seam design and cutline. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
