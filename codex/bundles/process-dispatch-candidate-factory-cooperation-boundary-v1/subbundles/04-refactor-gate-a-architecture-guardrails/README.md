...
Add/extend architecture tests for no Process Core, no driver API, no side effects inside factory.
...
All previous subbundles through SB03 closed.
...
- Command transcripts under `proof/SB04/transcripts/`.
...
Implement SB04: Refactor Gate A architecture guardrails. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
