# SB11 - Recovery intent and manual directive assembly
...
Normalize direct-agent recovery facts for candidate factory consumption.
...
- All previous subbundles through SB10 closed.
...
Implement SB11: Recovery intent and manual directive assembly. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
