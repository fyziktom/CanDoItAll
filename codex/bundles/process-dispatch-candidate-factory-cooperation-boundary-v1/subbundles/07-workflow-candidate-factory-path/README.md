# SB07 - Workflow candidate factory path
...
Move workflow-backed DispatchCandidate construction behind factory with exact parity tests.
...
All previous subbundles through SB06 closed.
...
Implement SB07: Workflow candidate factory path. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
