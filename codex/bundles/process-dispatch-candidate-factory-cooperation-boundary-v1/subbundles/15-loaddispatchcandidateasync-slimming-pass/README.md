# SB15 - LoadDispatchCandidateAsync slimming pass
...
Remove duplicate wrappers and inline new DispatchCandidate calls; keep EF reads and side effects explicit.
...
All previous subbundles through SB14 closed.
...
- Updated proof manifest under `proof/SB15/manifest.md`.
...
Implement SB15: LoadDispatchCandidateAsync slimming pass. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
