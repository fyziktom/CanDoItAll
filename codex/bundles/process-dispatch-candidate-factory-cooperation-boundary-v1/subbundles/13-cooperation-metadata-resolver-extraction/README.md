# SB13 - Cooperation metadata resolver extraction
...
Move ResolveProcessCooperationMetadata/workspace profile rules to module-local helper.
...
All previous subbundles through SB12 closed.
...
- Updated proof manifest under `proof/SB13/manifest.md`.
...
Implement SB13: Cooperation metadata resolver extraction. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
