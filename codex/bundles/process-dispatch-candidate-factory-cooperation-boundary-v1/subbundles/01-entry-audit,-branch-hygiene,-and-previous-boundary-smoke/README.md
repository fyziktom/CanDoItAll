# SB01 - Entry audit, branch hygiene, and previous-boundary smoke
...
Record current branch SHA, line counts, helper presence, build/test baseline, no-core/no-driver/UI scans.
...
Implement SB01: Entry audit, branch hygiene, and previous-boundary smoke. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
