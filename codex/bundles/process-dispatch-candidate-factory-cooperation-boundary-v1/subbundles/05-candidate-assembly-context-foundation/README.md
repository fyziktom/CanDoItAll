# SB05 - Candidate assembly context foundation
...
Add internal assembly context/snapshots that group existing values without behavior change.
...
All previous subbundles through SB04 closed.
...
Implement SB05: Candidate assembly context foundation. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
