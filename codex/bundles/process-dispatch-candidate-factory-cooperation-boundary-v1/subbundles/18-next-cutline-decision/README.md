...
Document whether next seam is orchestration flow, cooperation/profile driver-readiness, or only then Process Core preflight.
...
All previous subbundles through SB17 closed.
...
- Updated proof manifest under `proof/SB18/manifest.md`.
...
Implement SB18: Next cutline decision. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
