# SB02 - Candidate construction inventory and field map
...
Enumerate all DispatchCandidate construction paths and complete field-map inventory.
...
All previous subbundles through SB01 closed.
...
- Updated proof manifest under `proof/SB02/manifest.md`.
...
Implement SB02: Candidate construction inventory and field map. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
