# SB12 - Refactor Gate C direct-agent parity
...
Run focused tests for missing binding, access grant/no-op, recovery id/manual directive, direct-agent candidate fields.
...
All previous subbundles through SB11 closed.
...
- Updated proof manifest under `proof/SB12/manifest.md`.
...
Implement SB12: Refactor Gate C direct-agent parity. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
