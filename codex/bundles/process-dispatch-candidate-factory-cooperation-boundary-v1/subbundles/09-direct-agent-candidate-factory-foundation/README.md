# SB09 - Direct-agent candidate factory foundation
...
Move direct-agent candidate construction into factory, keeping side effects outside.
...
Implement SB09: Direct-agent candidate factory foundation. Follow the hard constraints from `shared-prompts/implementation-prompt.md` and do not proceed to the next subbundle until the progression gate is satisfied.
