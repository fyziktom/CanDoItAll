...
async function trial(edit, repetition) {
  ...
  try {
    ...
    result = { kind: 'warm', host, editId: edit.id, category: edit.category, repetition, classification,
      success: ['hot-reload', 'browser-reload', 'enhanced-navigation', 'restart'].includes(classification), refresh, documentBefore, documentAfter, browserEvents: observed, sourceSha256: sha(original),
