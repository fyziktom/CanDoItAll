...
- Expected behavior: Production source remains free of driver registry, selector, runtime, provider, host, DI extension, manager command, and map/add hook tokens.
