...
- Expected behavior: Driver evidence vocabulary names Core descriptor families without Core referencing driver abstractions and without driver abstractions referencing Core.
