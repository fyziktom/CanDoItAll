...
- Expected behavior: Permission modes, capability scopes, side-effect operations, and denial reasons are strongly typed and read-only scopes cannot represent mutation.
