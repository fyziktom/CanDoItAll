...
- Expected behavior: The solution contains a dependency-free contract-only driver abstractions project and no runtime driver surface.
...
- Failing-first test: bundle://proof/SB006/transcripts/failing-first-contract-project-absent.txt.
