...
- Subbundle: SB006 - Gate B contract-only project dependency and solution proof
- Status: Completed
...
- Failing-first transcript: bundle://proof/SB006/transcripts/failing-first-contract-project-absent.txt proves the contract project was absent before implementation.
