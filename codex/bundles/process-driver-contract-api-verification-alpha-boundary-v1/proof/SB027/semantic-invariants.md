...
- Expected behavior: Office and business-analysis capability scopes remain read-only and cannot express external calls, storage writes, workspace writes, or process mutation.
