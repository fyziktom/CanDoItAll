...
## Deliverables
- Implement or document: Gate L: roadmap consistency proof
- Update tests/source scans where applicable
- Update execution report row for SB036
...
Implement SB036 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
