...
## Deliverables
- Implement or document: Define approved public contract surface inventory
- Update tests/source scans where applicable
- Update execution report row for SB005
...
Implement SB005 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
