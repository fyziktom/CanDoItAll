...
## Deliverables
- Implement or document: Gate C: permission and denial semantics proof
- Update tests/source scans where applicable
- Update execution report row for SB009
...
Implement SB009 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
