...
## Deliverables
- Implement or document: Add test-only .NET/Rust transcript fixture inventory
- Update tests/source scans where applicable
- Update execution report row for SB019
...
Implement SB019 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
