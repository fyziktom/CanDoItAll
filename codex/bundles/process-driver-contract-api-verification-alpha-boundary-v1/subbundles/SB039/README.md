...
## Deliverables
- Implement or document: Gate M: broad smoke and no-runtime closure
- Update tests/source scans where applicable
- Update execution report row for SB039
...
Implement SB039 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
