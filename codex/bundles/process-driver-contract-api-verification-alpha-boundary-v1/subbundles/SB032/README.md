...
## Deliverables
- Implement or document: Define next alpha implementation boundary if approved
- Update tests/source scans where applicable
- Update execution report row for SB032
...
Implement SB032 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
