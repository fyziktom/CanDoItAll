...
## Deliverables
- Implement or document: Create CanDoItAll.Processes.Drivers.Abstractions project
- Update tests/source scans where applicable
- Update execution report row for SB004
...
Implement SB004 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
