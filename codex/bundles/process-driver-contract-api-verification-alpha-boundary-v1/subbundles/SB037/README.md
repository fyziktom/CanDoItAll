...
## Objective
Run broad validation and adversarial red-team checks.
...
## Deliverables
- Implement or document: Run solution build, full unit, focused integration, source scans
- Update tests/source scans where applicable
- Update execution report row for SB037
...
Implement SB037 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
