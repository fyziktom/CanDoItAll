...
## Deliverables
- Implement or document: Define descriptor compatibility and version metadata
- Update tests/source scans where applicable
- Update execution report row for SB023
...
Implement SB023 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
