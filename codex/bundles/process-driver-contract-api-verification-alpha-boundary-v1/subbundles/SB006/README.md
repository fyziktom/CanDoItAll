...
## Objective
Introduce only a contract-level driver abstraction boundary with strict dependency and runtime-denial tests.
...
## Deliverables
- Implement or document: Gate B: contract-only project dependency and solution proof
- Update tests/source scans where applicable
- Update execution report row for SB006
...
Implement SB006 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
