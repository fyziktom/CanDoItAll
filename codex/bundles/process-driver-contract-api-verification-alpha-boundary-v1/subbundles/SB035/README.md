...
## Deliverables
- Implement or document: Refresh domain driver roadmap and release gates
- Update tests/source scans where applicable
- Update execution report row for SB035
...
Implement SB035 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
