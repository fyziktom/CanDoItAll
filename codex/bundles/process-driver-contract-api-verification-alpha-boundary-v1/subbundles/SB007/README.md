...
## Objective
Make permission and denial semantics executable and impossible to bypass through defaults.
...
## Deliverables
- Implement or document: Define permission modes and capability scope value models
- Update tests/source scans where applicable
- Update execution report row for SB007
...
Implement SB007 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
