...
## Deliverables
- Implement or document: Gate J: compatibility docs and API snapshot proof
- Update tests/source scans where applicable
- Update execution report row for SB030
...
Implement SB030 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
