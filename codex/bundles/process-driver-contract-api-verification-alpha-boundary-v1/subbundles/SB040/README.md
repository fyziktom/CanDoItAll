...
## Deliverables
- Implement or document: Complete proof index and execution report
- Update tests/source scans where applicable
- Update execution report row for SB040
...
Implement SB040 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
