...
## Deliverables
- Implement or document: Gate A: no broad Core/runtime drift baseline
- Update tests/source scans where applicable
- Update execution report row for SB003
...
Implement SB003 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
