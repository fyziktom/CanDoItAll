...
## Objective
Document package, namespace, versioning, and migration rules for future verification-only drivers.
...
## Deliverables
- Implement or document: Create migration guide for future verification-only drivers
- Update tests/source scans where applicable
- Update execution report row for SB029
...
Implement SB029 only. Preserve existing behavior, add proof, and stop if a forbidden runtime/Core/driver side effect appears.
