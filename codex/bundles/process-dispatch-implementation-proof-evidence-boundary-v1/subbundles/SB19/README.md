# SB19 - Carried implementation proof facts
...
Extract carried proof state transitions from current/historical attempts.
...
- Previous subbundle closure gate passed: `SB18`.
...
- Update proof manifest under `proof/SB19/manifest.md`.
- Update semantic invariants under `proof/SB19/semantic-invariants.md`.
- Update execution report row.

## Dependency Impact

Downstream subbundle: `SB20`.
...
No historical loading movement.

## Suggested Agent Prompt

Execute `SB19 - Carried implementation proof facts` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
