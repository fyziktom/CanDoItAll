# SB22 - Implementation artifact write satisfaction bridge
...
Extract 'recorded artifacts can satisfy workspace_write_file' logic.
...
- Previous subbundle closure gate passed: `SB21`.
...
- Update proof manifest under `proof/SB22/manifest.md`.
- Update semantic invariants under `proof/SB22/semantic-invariants.md`.
- Update execution report row.

## Dependency Impact

- Downstream subbundle: `SB23`.
...
- Preserve required-artifact behavior.

## Suggested Agent Prompt

Execute `SB22 - Implementation artifact write satisfaction bridge` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
