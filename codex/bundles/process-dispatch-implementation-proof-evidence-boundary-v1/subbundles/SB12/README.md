# SB12 - Bootstrap/scaffold sequence rules
...
Extract bootstrap/scaffold follow-up source write validation.
...
- Previous subbundle closure gate passed: `SB11`.
...
- Update proof manifest under `proof/SB12/manifest.md`.
- Update semantic invariants under `proof/SB12/semantic-invariants.md`.
...
Keep exact failure summary.

## Suggested Agent Prompt

Execute `SB12 - Bootstrap/scaffold sequence rules` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
