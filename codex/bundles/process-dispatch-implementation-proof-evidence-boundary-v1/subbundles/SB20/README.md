# SB20 - Historical carried proof resolver
...
Move pure historical proof decision into local helper; loading remains where it is.
...
- Previous subbundle closure gate passed: `SB19`.
...
- Update proof manifest under `proof/SB20/manifest.md`.
- Update semantic invariants under `proof/SB20/semantic-invariants.md`.
...
Preserve current attempt filtering.

## Suggested Agent Prompt

Execute `SB20 - Historical carried proof resolver` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
