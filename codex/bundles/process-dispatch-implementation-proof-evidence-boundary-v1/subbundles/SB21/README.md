# SB21 - Process mock implementation proof bridge
...
Extract process mock proof satisfaction decisions into explicit helper.
...
- Previous subbundle closure gate passed: `SB20`.
...
- Update proof manifest under `proof/SB21/manifest.md`.
- Update semantic invariants under `proof/SB21/semantic-invariants.md`.
- Update execution report row.

## Dependency Impact

Downstream subbundle: `SB22`.
...
Preserve process mock test semantics.

## Suggested Agent Prompt

Execute `SB21 - Process mock implementation proof bridge` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
