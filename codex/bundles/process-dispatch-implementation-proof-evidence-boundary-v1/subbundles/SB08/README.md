# SB08 - Refactor Gate B: contract/stack parity
...
Focused tests for .NET/JS/negated .NET/test/runnable signals and no-core/no-driver scan.
...
- Previous subbundle closure gate passed: `SB07`.
...
- Update proof manifest under `proof/SB08/manifest.md`.
- Update semantic invariants under `proof/SB08/semantic-invariants.md`.
...
Execute `SB08 - Refactor Gate B: contract/stack parity` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
