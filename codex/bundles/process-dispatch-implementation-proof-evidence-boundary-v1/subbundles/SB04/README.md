...
Add/extend tests/scans preventing Process Core, driver APIs, UI proof drift, and helper stubs.
...
- Previous subbundle closure gate passed: `SB03`.
...
- Update proof manifest under `proof/SB04/manifest.md`.
- Update semantic invariants under `proof/SB04/semantic-invariants.md`.
...
Execute `SB04 - Refactor Gate A: architecture guardrails` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
