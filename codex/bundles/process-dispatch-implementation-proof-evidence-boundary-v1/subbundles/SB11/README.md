# SB11 - Concrete product mutation/read rules
...
Extract mutation/read receipt qualification against candidate/detail/context.
...
- Previous subbundle closure gate passed: `SB10`.
...
- Update proof manifest under `proof/SB11/manifest.md`.
- Update semantic invariants under `proof/SB11/semantic-invariants.md`.
- Update execution report row.

## Dependency Impact

- Downstream subbundle: `SB12`.
...
- Preserve current receipt ordering.

## Suggested Agent Prompt

Execute `SB11 - Concrete product mutation/read rules` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
