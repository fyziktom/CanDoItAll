# SB09 - Receipt facts and timeline helper
...
Extract successful/failed receipt facts, latest read/mutation/validation/run receipt ordering.
...
- Previous subbundle closure gate passed: `SB08`.
...
- Update proof manifest under `proof/SB09/manifest.md`.
- Update semantic invariants under `proof/SB09/semantic-invariants.md`.
- Update execution report row.

## Dependency Impact

- Downstream subbundle: `SB10`.
...
- No candidate mutations.

## Suggested Agent Prompt

Execute `SB09 - Receipt facts and timeline helper` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
