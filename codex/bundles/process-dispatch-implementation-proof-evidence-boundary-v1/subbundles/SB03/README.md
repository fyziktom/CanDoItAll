# SB03 - Evidence vocabulary and no-core cutline
...
Define local vocabulary for implementation proof/evidence families and explicit non-goals.
...
- Previous subbundle closure gate passed: `SB02`.
...
- Update proof manifest under `proof/SB03/manifest.md`.
- Update semantic invariants under `proof/SB03/semantic-invariants.md`.
...
Execute `SB03 - Evidence vocabulary and no-core cutline` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
