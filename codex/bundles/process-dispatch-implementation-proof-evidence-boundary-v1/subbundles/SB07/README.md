# SB07 - Explicit test/runnable contract signals
...
Extract explicit test-request and runnable app contract signal detection.
...
- Previous subbundle closure gate passed: `SB06`.
...
- Update proof manifest under `proof/SB07/manifest.md`.
- Update semantic invariants under `proof/SB07/semantic-invariants.md`.
- Update execution report row.

## Dependency Impact

Downstream subbundle: `SB08`.
...
Do not change summary strings.

## Suggested Agent Prompt

Execute `SB07 - Explicit test/runnable contract signals` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
