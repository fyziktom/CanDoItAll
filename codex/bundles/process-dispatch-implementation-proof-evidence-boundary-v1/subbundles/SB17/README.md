# SB17 - DotNet host shape validation helper
...
Extract invalid runnable dotnet host shape summary integration points.
...
- Previous subbundle closure gate passed: `SB16`.
...
- Update proof manifest under `proof/SB17/manifest.md`.
- Update semantic invariants under `proof/SB17/semantic-invariants.md`.
- Update execution report row.

## Dependency Impact

- Downstream subbundle: `SB18`.
...
- Do not modify WebHostProof behavior.

## Suggested Agent Prompt

Execute `SB17 - DotNet host shape validation helper` from `codex/bundles/process-dispatch-implementation-proof-evidence-boundary-v1`. Stay inside the declared scope, update proof, and stop if any behavior parity test fails.
