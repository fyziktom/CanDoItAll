...
```text
Run the affected dependency compatibility template on every claimed OS/profile.
```
```text
Run full core/runtime regression with the capability both enabled and disabled.
```
