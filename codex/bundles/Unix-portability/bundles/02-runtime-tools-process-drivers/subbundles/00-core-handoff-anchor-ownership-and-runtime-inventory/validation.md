...
```
```text
dotnet test ./tests/Unit/CanDoItAll.Tests.Unit/CanDoItAll.Tests.Unit.csproj -c Release --filter 'FullyQualifiedName~Process|FullyQualifiedName~Runtime|FullyQualifiedName~Mcp|FullyQualifiedName~Manager|FullyQualifiedName~Plugin'
```
