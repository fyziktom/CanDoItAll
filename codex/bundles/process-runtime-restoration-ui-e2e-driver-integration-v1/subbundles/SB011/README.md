...
Implement the `Add source/API tests that required process templates are registered and visible to UI/API layers.` slice as part of `P04: Process UI route and template catalog inventory`.
...
Implement `SB011 — Add source/API tests that required process templates are registered and visible to UI/API layers.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
