...
Implement the `Add regression tests for invalid templates, missing project context, and duplicate/unsafe start attempts.` slice as part of `P06: Process run creation and persistence`.
...
Implement `SB017 — Add regression tests for invalid templates, missing project context, and duplicate/unsafe start attempts.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
