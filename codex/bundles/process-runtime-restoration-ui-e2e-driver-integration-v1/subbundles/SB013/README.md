...
Implement the `Add large-screen Playwright/app test route proof for process page or project context.` slice as part of `P05: UI process-start E2E skeleton`.
...
Implement `SB013 — Add large-screen Playwright/app test route proof for process page or project context.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
