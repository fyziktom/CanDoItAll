...
Implement the `Inventory large-screen process UI routes, project/project-structure launch entry points, and process template catalog.` slice as part of `P04: Process UI route and template catalog inventory`.
...
Implement `SB010 — Inventory large-screen process UI routes, project/project-structure launch entry points, and process template catalog.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
