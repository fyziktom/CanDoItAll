...
Implement the `Add or repair deterministic app-start smoke test / host startup proof.` slice as part of `P03: Application startup and composition baseline`.
...
Implement `SB008 — Add or repair deterministic app-start smoke test / host startup proof.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
