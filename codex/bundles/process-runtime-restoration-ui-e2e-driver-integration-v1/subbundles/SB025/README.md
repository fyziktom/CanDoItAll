...
Implement the `Define deterministic `.NET app create` scenario input/output expectations and fake-agent strategy.` slice as part of `P09: .NET software-development scenario`.
...
Implement `SB025 — Define deterministic `.NET app create` scenario input/output expectations and fake-agent strategy.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
