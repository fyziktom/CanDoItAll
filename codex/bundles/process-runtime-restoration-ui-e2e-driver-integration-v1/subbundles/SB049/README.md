...
Implement the `Update stable docs for how to launch processes from UI/API and what is currently supported.` slice as part of `P17: Docs and operator handoff`.
...
Implement `SB049 — Update stable docs for how to launch processes from UI/API and what is currently supported.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
