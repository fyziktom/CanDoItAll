...
Implement the `Run process through create/modify scenario and assert artifacts/files/evidence/status.` slice as part of `P09: .NET software-development scenario`.
...
Implement `SB026 — Run process through create/modify scenario and assert artifacts/files/evidence/status.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
