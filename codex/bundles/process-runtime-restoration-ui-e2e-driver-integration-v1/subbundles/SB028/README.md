...
Implement the `Define business-analysis process template/scenario independent of software-development domain terms.` slice as part of `P10: Generic business-analysis scenario`.
...
Implement `SB028 — Define business-analysis process template/scenario independent of software-development domain terms.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
