...
Implement the `Verify dispatcher can find eligible run/step and acquire claim.` slice as part of `P07: Dispatch/claim/route/finalizer runtime restoration`.
...
Implement `SB019 — Verify dispatcher can find eligible run/step and acquire claim.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
