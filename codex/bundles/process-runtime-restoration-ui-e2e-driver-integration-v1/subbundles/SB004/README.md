...
Implement the `Replace bundle-file architecture assertions with source-backed architecture assertions.` slice as part of `P02: Remove bundle-path coupling from tests`.
...
Implement `SB004 — Replace bundle-file architecture assertions with source-backed architecture assertions.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
