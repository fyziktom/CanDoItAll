...
Implement the `Re-evaluate whether a read-only driver host is now safe after UI/process runtime proof.` slice as part of `P14: Runtime host roadmap decision`.
