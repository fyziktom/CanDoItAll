...
Implement the `Add UI/API proof that user can select a process template and create a run.` slice as part of `P05: UI process-start E2E skeleton`.
...
Implement `SB014 — Add UI/API proof that user can select a process template and create a run.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
