...
Implement the `Run prepared/completed validators and record raw-note closure.` slice as part of `P18: Final red-team and validators`.
...
Implement `SB053 — Run prepared/completed validators and record raw-note closure.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
