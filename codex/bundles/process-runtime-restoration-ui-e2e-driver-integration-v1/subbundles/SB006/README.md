...
Implement the `Gate B: full unit proof that tests no longer require transient bundle folders.` slice as part of `P02: Remove bundle-path coupling from tests`.
