...
Implement the `Inventory web app startup path, composition registration, database/test configuration, and process module registration.` slice as part of `P03: Application startup and composition baseline`.
...
Implement `SB007 — Inventory web app startup path, composition registration, database/test configuration, and process module registration.`. Preserve all hard constraints. Produce source-backed proof and update the execution report.
