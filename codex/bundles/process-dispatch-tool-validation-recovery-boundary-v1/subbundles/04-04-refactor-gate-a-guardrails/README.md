...
Add/extend unit architecture tests proving no Process Core, no driver pack, helper purity, no MAF/Tooling regression, and viewport proof policy.
...
5. Record proof under `codex/bundles/process-dispatch-tool-validation-recovery-boundary-v1/proof/SB04/`.
