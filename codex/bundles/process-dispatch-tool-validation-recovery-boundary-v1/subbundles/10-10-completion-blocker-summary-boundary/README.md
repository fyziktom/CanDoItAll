# SB10 - Completion blocker summary aggregation
...
Create `ProcessCompletionBlockerSummary` or equivalent to collect missing upstream artifact, concrete proof, incomplete implementation, browser, quality, artifact, project-structure, external target, and shallow path blockers.
...
5. Record proof under `codex/bundles/process-dispatch-tool-validation-recovery-boundary-v1/proof/SB10/`.
...
- Do not proceed to SB11 until this subbundle's closure proof is complete.

## Suggested Agent Prompt

Implement SB10 of `process-dispatch-tool-validation-recovery-boundary-v1`. Keep scope narrow, preserve behavior, avoid Process Core and driver packs, run focused tests, and record proof before moving on.
