# SB027 - Critical Gate I: live process-run OpenAI smoke is bounded, explicit, and classified
...
## Objective
Critical Gate I: live process-run OpenAI smoke is bounded, explicit, and classified
...
5. Record proof under `proof/SB027/` if this is a critical gate, otherwise under the nearest phase proof area.
...
- [x] Execution report has an individual row for `SB027`.
- [x] Semantic Adequacy Gate proof exists for this critical gate.

## Proof Required
- Completed critical proof: bundle://proof/SB027/manifest.md and bundle://proof/SB027/semantic-invariants.md
...
Implement `SB027` for `process-driver-runtime-host-production-readiness-live-manager-e2e-v1`. Preserve read-only verification boundaries, use real source/tests, and do not collapse proof into report-only claims.
