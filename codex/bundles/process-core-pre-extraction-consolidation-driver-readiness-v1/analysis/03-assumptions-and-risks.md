...
1. Source-payload removal may accidentally break finalizer compatibility.
2. Hydration split may lose direct-agent binding defaults, recovery execution ids, or cooperation metadata.
3. Subprocess projection split may change child artifact selection or parent artifact lineage.
4. Artifact pure-rule extraction may accidentally move filesystem/storage/database behavior into a pure candidate.
5. Driver-readiness vocabulary may accidentally become a production API.
