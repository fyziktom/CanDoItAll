# SB002 — Forbidden boundary architecture tests first
...
Add or update tests that fail on Core/driver/UI drift and on collapsed report rows.
...
- Proof transcript under `bundle://proof/SB002/transcripts/`.
- Semantic invariants under `bundle://proof/SB002/semantic-invariants.md`.
- Manifest under `bundle://proof/SB002/manifest.md`.
...
- Entry gate: `Passed`; `SB001` is completed and source references exist.
- Closure gate: `Passed`; the active-bundle architecture guard test passed and source scans agree.
- Proof: `bundle://proof/SB002/manifest.md` and `bundle://proof/SB002/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB003` may run the Gate A build/test/source-scan closure.

## Suggested Agent Prompt

Implement `SB002 — Forbidden boundary architecture tests first` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
