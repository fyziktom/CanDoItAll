# SB014 — Upstream materialization facts/rules vs journal/rerun side effects
...
Keep facts/fingerprint/directive pure, journal/rerun application-local.
...
- Proof transcript under `bundle://proof/SB014/transcripts/`.
- Semantic invariants under `bundle://proof/SB014/semantic-invariants.md`.
- Manifest under `bundle://proof/SB014/manifest.md`.
...
- Closure gate: `Passed`; pure materialization facts/rules and application side effects are separated.
- Proof: `bundle://proof/SB014/manifest.md` and `bundle://proof/SB014/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB015` may run pre-execution parity gate.

## Suggested Agent Prompt

Implement `SB014 — Upstream materialization facts/rules vs journal/rerun side effects` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
