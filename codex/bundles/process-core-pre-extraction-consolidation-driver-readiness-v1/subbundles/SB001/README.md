# SB001 — Baseline branch/proof intake and active source scan
...
Record current state, line counts, and previous bundle proof. No code movement.
...
- Proof transcript under `bundle://proof/SB001/transcripts/`.
- Semantic invariants under `bundle://proof/SB001/semantic-invariants.md`.
- Manifest under `bundle://proof/SB001/manifest.md`.
...
- Entry gate: `Passed` on branch `maf-processes-refactor`; exact source references exist.
- Closure gate: `Passed`; source-shape counts, no-Core/no-driver/no-UI/no-stub scans, prepared validator, and baseline build are recorded.
- Proof: `bundle://proof/SB001/manifest.md` and `bundle://proof/SB001/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; SB002 may start with this baseline.

## Suggested Agent Prompt

Implement `SB001 — Baseline branch/proof intake and active source scan` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
