# SB016 — Subprocess lifecycle input/read model stabilization
...
Make subprocess runtime consume route-owned inputs without dispatcher aliases.
...
- Proof transcript under `bundle://proof/SB016/transcripts/`.
- Semantic invariants under `bundle://proof/SB016/semantic-invariants.md`.
- Manifest under `bundle://proof/SB016/manifest.md`.
...
- Entry gate: `Passed`; `SB015` is completed.
- Closure gate: `Passed`; subprocess runtime and projection helpers consume route-owned input without dispatcher aliases.
- Proof: `bundle://proof/SB016/manifest.md` and `bundle://proof/SB016/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB017` may proceed with projection persistence boundary proof.

## Suggested Agent Prompt

Implement `SB016 — Subprocess lifecycle input/read model stabilization` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
