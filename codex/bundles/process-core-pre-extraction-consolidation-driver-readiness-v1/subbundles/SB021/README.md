...
Prove retry, provider repair, no-progress, competing execution, finalizer detail compatibility.
...
- Proof transcript under `bundle://proof/SB021/transcripts/`.
- Semantic invariants under `bundle://proof/SB021/semantic-invariants.md`.
- Manifest under `bundle://proof/SB021/manifest.md`.
...
- Entry gate: `Passed`; `SB019` and `SB020` are completed.
- Closure gate: `Passed`; retry, provider repair, no-progress, competing execution, and finalizer detail compatibility parity were proved.
- Proof: `bundle://proof/SB021/manifest.md` and `bundle://proof/SB021/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB022` may start artifact-rule candidate hardening.

## Suggested Agent Prompt

Implement `SB021 — Gate G execution parity` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
