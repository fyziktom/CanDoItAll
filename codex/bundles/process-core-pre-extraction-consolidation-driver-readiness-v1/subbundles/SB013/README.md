# SB013 — Database requirement pure decision vs transition side effect
...
Separate pure database blocking decision from transition execution.
...
- Proof transcript under `bundle://proof/SB013/transcripts/`.
- Semantic invariants under `bundle://proof/SB013/semantic-invariants.md`.
- Manifest under `bundle://proof/SB013/manifest.md`.
...
- Closure gate: `Passed`; pure database blocking decision is separated from transition execution.
- Proof: `bundle://proof/SB013/manifest.md` and `bundle://proof/SB013/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB014` may proceed with upstream materialization pure/side-effect proof.

## Suggested Agent Prompt

Implement `SB013 — Database requirement pure decision vs transition side effect` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
