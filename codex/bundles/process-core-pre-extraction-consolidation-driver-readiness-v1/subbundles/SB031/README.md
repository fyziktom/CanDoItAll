# SB031 — Driver evidence manifest vocabulary documentation
...
Define verification-only evidence manifests for route/artifact/runtime/domain helpers.
...
- Proof transcript under `bundle://proof/SB031/transcripts/`.
- Semantic invariants under `bundle://proof/SB031/semantic-invariants.md`.
- Manifest under `bundle://proof/SB031/manifest.md`.
...
- Entry gate: `Passed`; `SB030` is completed.
- Closure gate: `Passed`; verification-only driver evidence manifest vocabulary was documented.
- Proof: `bundle://proof/SB031/manifest.md` and `bundle://proof/SB031/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB032` may document permission negative scenarios.

## Suggested Agent Prompt

Implement `SB031 — Driver evidence manifest vocabulary documentation` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
