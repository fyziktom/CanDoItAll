# SB029 — Architecture tests for future Core allow/deny lists
...
Add/adjust tests that will guard future Core dependencies but do not create Core.
...
- Proof transcript under `bundle://proof/SB029/transcripts/`.
- Semantic invariants under `bundle://proof/SB029/semantic-invariants.md`.
- Manifest under `bundle://proof/SB029/manifest.md`.
...
- Entry gate: `Passed`; `SB028` is completed.
- Closure gate: `Passed`; future Core allow/deny list and active-bundle architecture guard are in place.
- Proof: `bundle://proof/SB029/manifest.md` and `bundle://proof/SB029/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB030` may run Core rehearsal closure.

## Suggested Agent Prompt

Implement `SB029 — Architecture tests for future Core allow/deny lists` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
