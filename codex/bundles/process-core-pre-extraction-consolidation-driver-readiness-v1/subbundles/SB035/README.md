# SB035 — Final red-team and line-count review
...
Review whether a narrow Core proposal is now justified; list exact blockers if not.
...
- Proof transcript under `bundle://proof/SB035/transcripts/`.
- Semantic invariants under `bundle://proof/SB035/semantic-invariants.md`.
- Manifest under `bundle://proof/SB035/manifest.md`.
...
- Final red-team review recommends a future narrow Process Core proposal only for pure read models and deterministic rules.
- Broad Core extraction remains blocked by EF, workspace/storage/filesystem, AgentFramework, claim/transition, and finalizer coupling.
- Production helper-driver APIs remain absent and must stay out of the first Core cutline.
...
Implement `SB035 — Final red-team and line-count review` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
