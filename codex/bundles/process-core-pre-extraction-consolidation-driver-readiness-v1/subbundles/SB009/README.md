...
Prove null-finalizer no-apply, apply-on-result, transition shape, workflow/recovery/direct/subprocess parity.
...
- Proof transcript under `bundle://proof/SB009/transcripts/`.
- Semantic invariants under `bundle://proof/SB009/semantic-invariants.md`.
- Manifest under `bundle://proof/SB009/manifest.md`.
...
- Entry gate: `Passed`; `SB007` and `SB008` proof exists.
- Closure gate: `Passed`; finalizer null no-apply, non-null apply-on-result, and workflow/recovery/direct/subprocess context parity were proved.
- Proof: `bundle://proof/SB009/manifest.md` and `bundle://proof/SB009/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB010` may start hydration collaborator work.

## Suggested Agent Prompt

Implement `SB009 — Gate C finalizer parity` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
