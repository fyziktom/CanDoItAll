# SB028 — Draft test-only Core candidate contract map
...
Create bundle-only contract map for first future Core project; no production Core project.
...
- Proof transcript under `bundle://proof/SB028/transcripts/`.
- Semantic invariants under `bundle://proof/SB028/semantic-invariants.md`.
- Manifest under `bundle://proof/SB028/manifest.md`.
...
- Entry gate: `Passed`; `SB027` is completed.
- Closure gate: `Passed`; bundle-local test-only Core candidate contract map was created.
- Proof: `bundle://proof/SB028/manifest.md` and `bundle://proof/SB028/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB029` may add/validate Core allow/deny guard coverage.

## Suggested Agent Prompt

Implement `SB028 — Draft test-only Core candidate contract map` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
