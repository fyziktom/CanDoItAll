# SB008 — Constrain finalizer adapter to application edge
...
Keep dispatcher-owned finalizer context conversion in one adapter only; remove duplicate alias overloads.
...
- Proof transcript under `bundle://proof/SB008/transcripts/`.
- Semantic invariants under `bundle://proof/SB008/semantic-invariants.md`.
- Manifest under `bundle://proof/SB008/manifest.md`.
...
- Entry gate: `Passed`; `SB007` is completed.
- Closure gate: `Passed`; duplicate public dispatcher-alias overloads are removed and finalizer parity remains intact.
- Proof: `bundle://proof/SB008/manifest.md` and `bundle://proof/SB008/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB009` may run finalizer parity gate.

## Suggested Agent Prompt

Implement `SB008 — Constrain finalizer adapter to application edge` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
