# SB023 — Pure artifact matcher/satisfaction candidate map
...
Group pure matcher/satisfaction rules without moving storage/workspace/persistence.
...
- Proof transcript under `bundle://proof/SB023/transcripts/`.
- Semantic invariants under `bundle://proof/SB023/semantic-invariants.md`.
- Manifest under `bundle://proof/SB023/manifest.md`.
...
- Entry gate: `Passed`; `SB022` is completed.
- Closure gate: `Passed`; validation/projection/satisfaction paths share `ProcessArtifactExpectationSnapshot` and pure matcher/resolver rules remain side-effect free.
- Proof: `bundle://proof/SB023/manifest.md` and `bundle://proof/SB023/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB024` may run artifact parity gate.

## Suggested Agent Prompt

Implement `SB023 — Pure artifact matcher/satisfaction candidate map` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
