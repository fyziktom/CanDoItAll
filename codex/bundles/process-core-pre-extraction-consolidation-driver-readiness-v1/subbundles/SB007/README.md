# SB007 — Define finalizer intent DTOs
...
Introduce route/application finalizer intents for workflow, recovery, direct-agent, subprocess.
...
- Proof transcript under `bundle://proof/SB007/transcripts/`.
- Semantic invariants under `bundle://proof/SB007/semantic-invariants.md`.
- Manifest under `bundle://proof/SB007/manifest.md`.
...
- Entry gate: `Passed`; Gate B is completed.
- Closure gate: `Passed`; finalizer intent DTOs exist and compatibility parity passed.
- Proof: `bundle://proof/SB007/manifest.md` and `bundle://proof/SB007/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB008` may constrain adapter aliases.

## Suggested Agent Prompt

Implement `SB007 — Define finalizer intent DTOs` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
