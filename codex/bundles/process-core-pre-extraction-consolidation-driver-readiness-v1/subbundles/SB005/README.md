# SB005 — Route handler/service adapter confinement
...
Ensure route handlers and route services consume pure DTOs; adapters exist only at dispatcher/application edge.
...
- Proof transcript under `bundle://proof/SB005/transcripts/`.
- Semantic invariants under `bundle://proof/SB005/semantic-invariants.md`.
- Manifest under `bundle://proof/SB005/manifest.md`.
...
- Entry gate: `Passed`; `SB004` is completed.
- Closure gate: `Passed`; route services/handlers consume pure DTOs and adapter calls remain confined to named application-edge files.
- Proof: `bundle://proof/SB005/manifest.md` and `bundle://proof/SB005/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB006` may run route DTO parity.

## Suggested Agent Prompt

Implement `SB005 — Route handler/service adapter confinement` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
