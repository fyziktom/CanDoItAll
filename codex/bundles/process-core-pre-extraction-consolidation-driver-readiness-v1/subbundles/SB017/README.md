# SB017 — Subprocess projection persistence service boundary
...
Separate child-artifact query, gap journal, parent artifact write, and save changes.
...
- Proof transcript under `bundle://proof/SB017/transcripts/`.
- Semantic invariants under `bundle://proof/SB017/semantic-invariants.md`.
- Manifest under `bundle://proof/SB017/manifest.md`.
...
- Entry gate: `Passed`; `SB016` is completed.
- Closure gate: `Passed`; subprocess projection persistence owns child-artifact query, gap journal, parent artifact write, and save changes.
- Proof: `bundle://proof/SB017/manifest.md` and `bundle://proof/SB017/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB018` may run subprocess parity gate.

## Suggested Agent Prompt

Implement `SB017 — Subprocess projection persistence service boundary` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
