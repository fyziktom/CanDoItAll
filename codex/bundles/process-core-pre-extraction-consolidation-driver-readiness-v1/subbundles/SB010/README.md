# SB010 — Hydration query and artifact-input readback service
...
Separate EF readback and artifact-input preparation from candidate assembly.
...
- Proof transcript under `bundle://proof/SB010/transcripts/`.
- Semantic invariants under `bundle://proof/SB010/semantic-invariants.md`.
- Manifest under `bundle://proof/SB010/manifest.md`.
...
- Closure gate: `Passed`; hydration EF readback, artifact-input preparation, and candidate assembly ownership are separated.
- Proof: `bundle://proof/SB010/manifest.md` and `bundle://proof/SB010/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB011` may proceed with direct-agent binding/recovery/cooperation collaborator proof.

## Suggested Agent Prompt

Implement `SB010 — Hydration query and artifact-input readback service` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
