...
Prove subprocess/workflow/direct-agent candidate defaults, project-structure access mutation, recovery ids, cooperation metadata.
...
- Proof transcript under `bundle://proof/SB012/transcripts/`.
- Semantic invariants under `bundle://proof/SB012/semantic-invariants.md`.
- Manifest under `bundle://proof/SB012/manifest.md`.
...
- Entry gate: `Passed`; `SB010` and `SB011` are completed.
- Closure gate: `Passed`; hydration parity, direct-agent facts, project-structure access, recovery ids, and cooperation metadata were proved.
- Proof: `bundle://proof/SB012/manifest.md` and `bundle://proof/SB012/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB013` may start pre-execution purity work.

## Suggested Agent Prompt

Implement `SB012 — Gate D hydration parity` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
