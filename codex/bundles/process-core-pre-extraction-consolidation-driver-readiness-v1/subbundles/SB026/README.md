# SB026 — Move only low-risk pure wrappers to owning rules
...
Remove callers from dispatcher static facades where pure owners already exist.
...
- Proof transcript under `bundle://proof/SB026/transcripts/`.
- Semantic invariants under `bundle://proof/SB026/semantic-invariants.md`.
- Manifest under `bundle://proof/SB026/manifest.md`.
...
- Entry gate: `Passed`; `SB025` is completed.
- Closure gate: `Passed`; route eligibility and subprocess artifact mapping use owning pure rules while side-effect wrappers remain application-local.
- Proof: `bundle://proof/SB026/manifest.md` and `bundle://proof/SB026/semantic-invariants.md`.
- Downstream dependencies checked: `Passed`; `SB027` may run wrapper parity gate.

## Suggested Agent Prompt

Implement `SB026 — Move only low-risk pure wrappers to owning rules` from `process-core-pre-extraction-consolidation-driver-readiness-v1`. Preserve behavior, update tests, record proof, and do not create Process Core or production driver APIs.
