# SB22 - Managed path and product file classification consolidation
...
Deduplicate IsLikelyProductSourceOrProjectFileName/Deliverable and managed-root checks with existing path rules without changing behavior.
...
Implement SB22 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
