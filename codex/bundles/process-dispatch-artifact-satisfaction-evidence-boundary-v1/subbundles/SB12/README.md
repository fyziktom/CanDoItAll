# SB12 - Gate C: auto-satisfaction parity
...
Prove exact branch ordering and reasons for auto-satisfaction. Tests must fail if provider-native visual or response text bypasses stronger evidence rules.
...
- Manifest: bundle://proof/SB12/manifest.md.
...
Implement SB12 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
