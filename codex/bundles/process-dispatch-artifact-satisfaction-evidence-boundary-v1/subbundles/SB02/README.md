# SB02 - Artifact satisfaction source inventory
...
Classify every remaining ArtifactValidation method that participates in required-artifact satisfaction, auto-satisfaction, provider-native evidence, response text, external-target guard, and shallow managed path detection.
...
Implement SB02 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
