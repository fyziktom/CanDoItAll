# SB07 - Fresh current-attempt implementation artifact helper
...
Move RequiresFreshCurrentAttemptImplementationArtifact, HasFreshCurrentAttemptImplementationArtifact, and workspace mutation receipt artifact matching into a helper using existing implementation-proof helpers.
...
Implement SB07 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
