...
Run focused tests for screenshots, snapshots, console/evaluate outputs, declared paths, discovered outputs, empty files, and browser working-directory safety.
...
Implement SB16 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
