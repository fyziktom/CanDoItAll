...
Final no-core/no-driver/no-UI scan, anti-stub scan, proof manifest validation, and next safe dispatcher/process-service isolation recommendation.
...
- Manifest: bundle://proof/SB32/manifest.md.
- Semantic invariants: bundle://proof/SB32/semantic-invariants.md.
...
Implement SB32 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
