# SB17 - Response-text projection eligibility helper
...
Extract IsUsableProjectedResponseArtifactContent, response projectability, fallback path rules, and declared path response checks into helper boundary. File creation remains in projection layer.
...
Implement SB17 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
