# SB09 - Auto-satisfaction decision planner
...
Introduce ProcessRequiredArtifactAutoSatisfactionRules/Decision with explicit reasons for recorded, process mock, workspace write, provider-native visual, completed decision, response text, or missing.
...
Implement SB09 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
