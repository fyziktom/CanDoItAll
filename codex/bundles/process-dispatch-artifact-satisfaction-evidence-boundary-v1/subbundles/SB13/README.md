# SB13 - Provider-native browser output facts
...
Extract ResolveSuccessfulBrowserToolOutputFiles, provider-native working directory, declared-path output matching, and safe browser output path facts into local helpers without writing files.
...
Implement SB13 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
