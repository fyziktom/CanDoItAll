# SB11 - Completed-decision auto-record decision helper
...
Move ShouldAutoRecordCompletedDecisionArtifact and related decision-only satisfaction branches into a module-local helper. Do not move record-only write behavior.
...
Implement SB11 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
