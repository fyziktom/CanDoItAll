# SB14 - Provider-native visual evidence satisfaction
...
Move CanProjectProviderNativeVisualArtifact and HasProviderNativeBrowserOutputForDeclaredPath into helper boundary using provider-native rules and snapshot inputs.
...
Implement SB14 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
