# SB21 - Shallow managed artifact reference helper
...
Move ResolveShallowSharedManagedArtifactReferenceSummary, shallow path normalization, and allowed external target leaf checks into module-local helper.
...
Implement SB21 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
