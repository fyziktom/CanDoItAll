# SB19 - External target reference guard helper
...
Extract out-of-scope external-target reference scanning into a module-local helper around ProcessExternalTargetGroundingService. Preserve allowed alias behavior.
...
Implement SB19 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
