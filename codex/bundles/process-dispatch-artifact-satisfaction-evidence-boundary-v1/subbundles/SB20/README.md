# SB20 - Gate E: response and external-target parity
...
Run tests for response text deliverables, declared/fallback paths, external target alias restrictions, product source vs evidence differentiation, and missing artifact summaries.
...
- Manifest: bundle://proof/SB20/manifest.md.
...
Implement SB20 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
