...
Assess whether the extracted helpers are pure enough for later Process Core. Produce explicit not-core-yet or core-ready decision. No source movement to Core.
...
Implement SB30 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
