...
Require line-count review for ArtifactValidation/ToolValidation, focused integration tests, full solution build, and red-team scan for behavior drift.
...
- Manifest: bundle://proof/SB28/manifest.md.
- Semantic invariants: bundle://proof/SB28/semantic-invariants.md.
...
Implement SB28 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
