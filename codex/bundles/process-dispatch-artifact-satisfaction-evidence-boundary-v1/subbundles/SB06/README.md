# SB06 - Recorded/execution artifact satisfaction helper
...
Move HasRecordedExpectedArtifact and HasRecordedOrExecutionArtifactForExpectedArtifact decision logic into a module-local helper using the snapshot while keeping wrappers in ArtifactValidation.
...
Implement SB06 only. Do not skip ahead. Preserve behavior exactly. Record proof before continuing.
