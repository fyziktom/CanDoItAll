...
- Expected behavior: line-count and consumer parity remains protected by module-local helper boundaries and focused regression proof.
...
- Downstream dependency check: downstream gates may depend on this invariant because SB28 is marked completed and the source assertions include $sb-INV-001.