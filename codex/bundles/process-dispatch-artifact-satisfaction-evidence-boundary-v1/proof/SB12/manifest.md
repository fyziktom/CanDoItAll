...
- Critical gate: auto-satisfaction branch parity.
- Status: Completed.
...
- Downstream dependency check: source assertions include SB12-INV-001 and all critical invariant IDs in bundle://proof/shared/transcripts/source-assertions.txt.
