...
- Expected behavior: auto-satisfaction branch parity remains protected by module-local helper boundaries and focused regression proof.
...
- Downstream dependency check: downstream gates may depend on this invariant because SB12 is marked completed and the source assertions include $sb-INV-001.