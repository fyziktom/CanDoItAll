...
- Critical gate: provider-native browser evidence parity.
- Status: Completed.
...
- Downstream dependency check: source assertions include SB16-INV-001 and all critical invariant IDs in bundle://proof/shared/transcripts/source-assertions.txt.
