...
- Critical gate: path classification and quality validation parity.
- Status: Completed.
- Semantic contract: bundle://proof/SB24/semantic-invariants.md.
...
- Downstream dependency check: source assertions include SB24-INV-001 and all critical invariant IDs in bundle://proof/shared/transcripts/source-assertions.txt.
