...
- Expected behavior: architecture/no-core/no-driver/no-UI guard before production movement remains protected by module-local helper boundaries and focused regression proof.
...
- Downstream dependency check: downstream gates may depend on this invariant because SB04 is marked completed and the source assertions include $sb-INV-001.