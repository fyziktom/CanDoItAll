...
- Critical gate: architecture/no-core/no-driver/no-UI guard before production movement.
- Status: Completed.
...
- Downstream dependency check: source assertions include SB04-INV-001 and all critical invariant IDs in bundle://proof/shared/transcripts/source-assertions.txt.
