...
- Critical gate: final red-team closure and next cutline.
- Status: Completed.
- Semantic contract: bundle://proof/SB32/semantic-invariants.md.
...
- Downstream dependency check: source assertions include SB32-INV-001 and all critical invariant IDs in bundle://proof/shared/transcripts/source-assertions.txt.
