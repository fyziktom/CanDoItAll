...
- Critical gate: response text and external-target parity.
- Status: Completed.
- Semantic contract: bundle://proof/SB20/semantic-invariants.md.
...
- Downstream dependency check: source assertions include SB20-INV-001 and all critical invariant IDs in bundle://proof/shared/transcripts/source-assertions.txt.
