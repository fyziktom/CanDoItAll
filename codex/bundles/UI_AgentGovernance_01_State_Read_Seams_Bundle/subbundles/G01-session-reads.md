...
Copy public display collections at acceptance/mapping. Do not expose full SerializedSessionStateJson, MetadataJson, pending approval arguments, raw structured output or arbitrary exception text in a new UI snapshot. Keep existing approved display summaries/sections and do not redesign execution retention.
