...
- Generic prompt tests cover business/supplier/reporting/quality/data prompts, while project-structure launch/subprocess e2e tests preserve software-domain behavior.
