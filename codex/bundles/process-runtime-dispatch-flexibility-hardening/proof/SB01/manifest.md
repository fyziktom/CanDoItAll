...
- Driver ports exist in Processes abstractions/application, module DI wires the AgentFramework implementation, and dependency scans show no Processes-to-MAF reference.
