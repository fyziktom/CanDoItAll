...
## Objective
Run/skip live process-run smoke by strict policy as part of P03: Live process-run OpenAI smoke.
...
- Proof transcript paths under `proof/SB008/transcripts/`.
...
## Proof Captured
- Strict skip/compile path: `bundle://proof/SB008/transcripts/live-process-run-strict-skip-test.txt`.
- Live process-run OpenAI smoke pass: `bundle://proof/SB008/transcripts/live-process-run-openai-smoke.txt`.
- Budget red-team failure from the initial too-small token ceiling: `bundle://proof/SB008/transcripts/live-process-run-budget-red-team.txt`.
...
Implement SB008 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
