...
## Objective
Final source scans and proof index as part of P21: Final red-team.
...
- Proof transcript paths under `proof/SB062/transcripts/`.
...
Implement SB062 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
