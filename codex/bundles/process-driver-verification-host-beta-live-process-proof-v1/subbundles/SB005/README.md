...
## Objective
Harden live env gate source assertions as part of P02: Live OpenAI proof classification.
...
- Proof transcript paths under `proof/SB005/transcripts/`.
...
## Proof Captured
- `bundle://proof/SB005/transcripts/live-env-gate-source-assertions.txt`
- `bundle://proof/SB005/transcripts/live-specialist-smoke-two-flag-skip-test.txt`
...
Implement SB005 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
