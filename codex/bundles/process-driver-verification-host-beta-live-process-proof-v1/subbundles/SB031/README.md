...
## Objective
Add read-only verification job model as part of P11: Scheduler/workflow verification readiness.
...
- Proof transcript paths under `proof/SB031/transcripts/`.
...
Implement SB031 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
