...
## Objective
Critical Gate I manager facade as part of P09: Manager-readonly command/API facade.
...
- Proof transcript paths under `proof/SB027/transcripts/`.
- Updated execution report row.
- Critical proof manifest `proof/SB027/manifest.md` and semantic invariants `proof/SB027/semantic-invariants.md`.
...
- `bundle://proof/SB027/transcripts/gate-i-source-diff-and-anti-stub-audit.txt`
- `bundle://proof/SB027/transcripts/red-team-manager-facade-shallow-proof-rejection.txt`
- `bundle://proof/SB027/transcripts/gate-i-proof-index.txt`
- `bundle://proof/SB027/transcripts/prepared-validator-after-gate-i.txt`
...
Implement SB027 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
