...
## Objective
Reject report-only/live-skip-as-pass/generic-host traps as part of P21: Final red-team.
...
- Proof transcript paths under `proof/SB061/transcripts/`.
...
Implement SB061 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
