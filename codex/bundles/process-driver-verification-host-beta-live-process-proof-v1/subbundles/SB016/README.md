...
## Objective
Add options model and validation as part of P06: Host options and emergency disable.
...
- Proof transcript paths under `proof/SB016/transcripts/`.
...
Implement SB016 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
