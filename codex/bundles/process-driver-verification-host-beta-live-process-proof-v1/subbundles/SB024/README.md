...
## Objective
Critical Gate H durable audit as part of P08: Durable audit persistence boundary.
...
- Proof transcript paths under `proof/SB024/transcripts/`.
- Updated execution report row.
- Critical proof manifest `proof/SB024/manifest.md` and semantic invariants `proof/SB024/semantic-invariants.md`.
...
## Proof Captured
- `bundle://proof/SB024/manifest.md`
- `bundle://proof/SB024/semantic-invariants.md`
- `bundle://proof/SB024/transcripts/gate-h-source-diff-and-anti-stub-audit.txt`
- `bundle://proof/SB024/transcripts/red-team-durable-audit-shallow-proof-rejection.txt`
- `bundle://proof/SB024/transcripts/gate-h-proof-index.txt`
- `bundle://proof/SB024/transcripts/prepared-validator-after-gate-h.txt`
...
Implement SB024 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
