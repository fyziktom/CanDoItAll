...
## Objective
Update Processes README and runbook as part of P20: Docs and migration.
...
- Proof transcript paths under `proof/SB058/transcripts/`.
...
Implement SB058 for `process-driver-verification-host-beta-live-process-proof-v1`. Re-read current source first, avoid report-only closure, preserve no-mutation and Core genericity guarantees, and capture proof before updating status.
