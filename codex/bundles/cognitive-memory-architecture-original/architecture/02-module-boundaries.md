...
Recommended dependency direction after the prerequisite boundary bundle:
...
Do not add Cognitive Memory directly to the private MAF context builder. The prerequisite bundle should introduce a general MAF context contribution boundary first.
