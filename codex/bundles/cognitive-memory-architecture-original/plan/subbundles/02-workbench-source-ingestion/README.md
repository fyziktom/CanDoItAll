# Subbundle 02-workbench-source-ingestion

## Objective

Ingest ProjectObjectRecord and ProjectObjectLinkRecord as source manifests/items. Preserve X/Y and optional Z. Add source hashing and idempotency.
