# Subbundle 06-consolidation-engine

## Objective

Implement changed source scan, canonical updates, clustering, relation detection, contradiction detection, projection rebuild, and run reports.
