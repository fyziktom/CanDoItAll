# SB05: Bind finalizer recovery and script inspection to the exact run workspace bundle
...
- Review findings addressed: `FR-003`
...
- organization vs project scope differential
- recovery exact path
- script child path
- foreign scope denied
- handoff same-scope behavior
...
- Do not loosen path checks to make recovery work.
- Do not recover from historical or foreign artifacts.
- Do not create a second untracked file service.
