# SB06: Unify workspace process host and make bundle ownership/disposal explicit
...
- Review findings addressed: `FR-004`
...
- Do not stop ProcessRun-owned lifetimes as if they were ExecutionRun leases.
- Do not dispose shared services from every participant.
- Do not hide ownership in IServiceProvider.
