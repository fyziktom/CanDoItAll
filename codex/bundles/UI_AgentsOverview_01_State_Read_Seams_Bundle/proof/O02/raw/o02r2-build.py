...
projects=projects[4:]+['.mcp-state/overview-browser-fixture/OverviewBrowser.csproj']
for p in projects:
 name='o02r2-build-'+Path(p).stem
 ...
 (out/'o02r2-builds.json').write_text(json.dumps(records,indent=2))
