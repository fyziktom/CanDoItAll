...
projects=projects[2:]+['.mcp-state/overview-browser-fixture/OverviewBrowser.csproj']
for p in projects:
 name='o02r3-build-'+Path(p).stem
 ...
 (out/'o02r3-builds.json').write_text(json.dumps(records,indent=2))
