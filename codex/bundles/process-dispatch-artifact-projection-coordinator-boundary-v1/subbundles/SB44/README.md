...
Critical gate for browser-native projection migration.
...
- Proof transcript under `proof/SB44/transcripts/`.
- Source assertions under `proof/SB44/source-assertions/`.
- Semantic invariants under `proof/SB44/semantic-invariants.md`.
- Manifest under `proof/SB44/manifest.md`.
...
Implement SB44 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
