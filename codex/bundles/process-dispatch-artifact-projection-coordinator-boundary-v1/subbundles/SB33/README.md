# SB33 - Response-text projection facts
...
Extract declared path, fallback path, content, content-type and response projection facts.
...
- Proof transcript under `proof/SB33/transcripts/`.
- Source assertions under `proof/SB33/source-assertions/`.
- Semantic invariants under `proof/SB33/semantic-invariants.md`.
- Manifest under `proof/SB33/manifest.md`.
...
Implement SB33 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
