# SB47 - Migrate completed-decision path
...
Wrapper delegates completed-decision record-only path.
...
- Proof transcript under `proof/SB47/transcripts/`.
- Source assertions under `proof/SB47/source-assertions/`.
- Semantic invariants under `proof/SB47/semantic-invariants.md`.
- Manifest under `proof/SB47/manifest.md`.
...
Implement SB47 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
