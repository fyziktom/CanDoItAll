# SB09 - Execution artifact source facts
...
Extract execution artifact candidate facts, duplicate key, transient skip and expected-artifact mapping inputs.
...
- Proof transcript under `proof/SB09/transcripts/`.
...
Implement SB09 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
