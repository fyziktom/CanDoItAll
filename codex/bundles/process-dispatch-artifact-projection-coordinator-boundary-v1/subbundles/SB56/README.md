...
Close bundle, next cutline, semantic invariants, proof matrix.
...
- Proof transcript under `proof/SB56/transcripts/`.
- Source assertions under `proof/SB56/source-assertions/`.
- Semantic invariants under `proof/SB56/semantic-invariants.md`.
- Manifest under `proof/SB56/manifest.md`.
...
Implement SB56 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
