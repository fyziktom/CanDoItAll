# SB29 - Existing-managed projection coordinator
...
Coordinator owns existing managed artifact projection loop and write result application.
...
- Proof transcript under `proof/SB29/transcripts/`.
- Source assertions under `proof/SB29/source-assertions/`.
- Semantic invariants under `proof/SB29/semantic-invariants.md`.
- Manifest under `proof/SB29/manifest.md`.
...
Implement SB29 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
