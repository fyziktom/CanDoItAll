...
Critical proof that projection order and side-effect boundaries are preserved.
...
- Proof transcript under `proof/SB52/transcripts/`.
- Source assertions under `proof/SB52/source-assertions/`.
- Semantic invariants under `proof/SB52/semantic-invariants.md`.
- Manifest under `proof/SB52/manifest.md`.
...
Implement SB52 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
