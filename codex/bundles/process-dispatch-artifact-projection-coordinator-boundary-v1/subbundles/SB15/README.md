# SB15 - Process mock projection facts
...
Extract process mock source facts, matched expectations, recovery lineage, scoped relative paths.
...
- Proof transcript under `proof/SB15/transcripts/`.
...
Implement SB15 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
