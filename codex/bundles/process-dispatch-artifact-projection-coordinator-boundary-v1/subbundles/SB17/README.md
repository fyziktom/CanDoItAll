# SB17 - Process mock projection coordinator
...
Coordinator owns process mock projection loop and expectation id enforcement.
...
- Proof transcript under `proof/SB17/transcripts/`.
- Source assertions under `proof/SB17/source-assertions/`.
...
Implement SB17 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
