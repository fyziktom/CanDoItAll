# SB24 - Migrate workspace-written projection path
...
Wrapper delegates workspace-written path; preserve governed/project-structure branch order.
...
- Proof transcript under `proof/SB24/transcripts/`.
- Source assertions under `proof/SB24/source-assertions/`.
...
Implement SB24 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
