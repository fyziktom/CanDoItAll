# SB07 - Projection write outcome application helper
...
Centralize candidate ExternalReferenceKeys and RecordedArtifactExpectationIds updates.
...
- Proof transcript under `proof/SB07/transcripts/`.
...
Implement SB07 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
