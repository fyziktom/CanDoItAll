# SB39 - Provider-native browser projection facts
...
Extract browser output facts consumed by projection; reuse observation helpers.
...
- Proof transcript under `proof/SB39/transcripts/`.
- Source assertions under `proof/SB39/source-assertions/`.
- Semantic invariants under `proof/SB39/semantic-invariants.md`.
- Manifest under `proof/SB39/manifest.md`.
...
Implement SB39 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
