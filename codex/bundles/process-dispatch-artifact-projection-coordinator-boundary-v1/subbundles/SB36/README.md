# SB36 - Migrate response-text projection path
...
Wrapper delegates response-text projection path.
...
- Proof transcript under `proof/SB36/transcripts/`.
- Source assertions under `proof/SB36/source-assertions/`.
- Semantic invariants under `proof/SB36/semantic-invariants.md`.
- Manifest under `proof/SB36/manifest.md`.
...
Implement SB36 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
