...
Focused architecture guard: no Core, no driver API, no UI proof drift, source inventory current.
...
- Proof transcript under `proof/SB04/transcripts/`.
...
Implement SB04 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
