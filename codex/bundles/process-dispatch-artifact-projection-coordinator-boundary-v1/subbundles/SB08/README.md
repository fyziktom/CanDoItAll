...
Prove context/outcome helpers exist, no behavior change, no side-effect hiding.
...
- Proof transcript under `proof/SB08/transcripts/`.
...
Implement SB08 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
