# SB45 - Completed-decision record-only facts
...
Extract decision expectation facts, external key generation, completed status requirements.
...
- Proof transcript under `proof/SB45/transcripts/`.
- Source assertions under `proof/SB45/source-assertions/`.
- Semantic invariants under `proof/SB45/semantic-invariants.md`.
- Manifest under `proof/SB45/manifest.md`.
...
Implement SB45 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
