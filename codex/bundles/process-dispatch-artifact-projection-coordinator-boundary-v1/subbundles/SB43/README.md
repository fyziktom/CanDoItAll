# SB43 - Provider-native browser focused parity tests
...
Output filename, missing working directory, unsafe path, zero-length/missing file tests.
...
- Proof transcript under `proof/SB43/transcripts/`.
- Source assertions under `proof/SB43/source-assertions/`.
- Semantic invariants under `proof/SB43/semantic-invariants.md`.
- Manifest under `proof/SB43/manifest.md`.
...
Implement SB43 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
