...
Critical gate for completed-decision path.
...
- Proof transcript under `proof/SB48/transcripts/`.
- Source assertions under `proof/SB48/source-assertions/`.
- Semantic invariants under `proof/SB48/semantic-invariants.md`.
- Manifest under `proof/SB48/manifest.md`.
...
Implement SB48 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
