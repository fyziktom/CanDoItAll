...
Critical gate for process mock projection migration.
...
- Proof transcript under `proof/SB20/transcripts/`.
- Source assertions under `proof/SB20/source-assertions/`.
...
Implement SB20 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
