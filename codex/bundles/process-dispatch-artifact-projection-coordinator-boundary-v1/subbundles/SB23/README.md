# SB23 - Workspace-written projection coordinator
...
Coordinator owns workspace-written projection loop and write result application.
...
- Proof transcript under `proof/SB23/transcripts/`.
- Source assertions under `proof/SB23/source-assertions/`.
- Semantic invariants under `proof/SB23/semantic-invariants.md`.
- Manifest under `proof/SB23/manifest.md`.
...
Implement SB23 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
