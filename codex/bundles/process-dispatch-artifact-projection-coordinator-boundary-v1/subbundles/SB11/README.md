# SB11 - Execution artifact projection coordinator
...
Coordinator owns one execution artifact projection path and write coordinator call.
...
- Proof transcript under `proof/SB11/transcripts/`.
...
Implement SB11 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
