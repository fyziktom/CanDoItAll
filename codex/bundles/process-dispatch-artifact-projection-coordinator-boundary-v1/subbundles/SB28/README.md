# SB28 - Existing-managed path candidate resolver
...
Move file existence/text-content probe into explicit helper; preserve 512KB text limit behavior.
...
- Proof transcript under `proof/SB28/transcripts/`.
- Source assertions under `proof/SB28/source-assertions/`.
- Semantic invariants under `proof/SB28/semantic-invariants.md`.
- Manifest under `proof/SB28/manifest.md`.
...
Implement SB28 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
