# SB03 - Projection coordinator cutline and source ownership design
...
Define which helpers are pure, which coordinators may perform IO, and which wrappers remain.
...
- Proof transcript under `proof/SB03/transcripts/`.
...
Implement SB03 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
