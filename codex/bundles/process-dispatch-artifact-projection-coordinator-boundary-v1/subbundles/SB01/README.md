# SB01 - Entry baseline, branch hygiene, and proof inventory
...
Baseline branch, line counts, proof inventory, no-core/no-driver/no-UI scans.
...
- Proof transcript under `proof/SB01/transcripts/`.
...
Implement SB01 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
