...
Critical gate for workspace-written projection migration.
...
- Proof transcript under `proof/SB26/transcripts/`.
- Source assertions under `proof/SB26/source-assertions/`.
- Semantic invariants under `proof/SB26/semantic-invariants.md`.
- Manifest under `proof/SB26/manifest.md`.
...
Implement SB26 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
