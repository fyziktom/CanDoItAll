# SB18 - Migrate process mock projection path
...
ArtifactProjection wrapper delegates process mock path only after parity tests exist.
...
- Proof transcript under `proof/SB18/transcripts/`.
- Source assertions under `proof/SB18/source-assertions/`.
...
Implement SB18 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
