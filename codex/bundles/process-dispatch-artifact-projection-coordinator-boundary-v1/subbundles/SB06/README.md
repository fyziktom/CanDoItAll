# SB06 - Projection IO and source-read boundary design
...
Separate source file read facts from projection planning without hiding side effects.
...
- Proof transcript under `proof/SB06/transcripts/`.
...
Implement SB06 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
