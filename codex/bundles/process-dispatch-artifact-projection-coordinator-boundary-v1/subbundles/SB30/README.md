# SB30 - Migrate existing-managed projection path
...
Wrapper delegates existing-managed projection path with parity tests.
...
- Proof transcript under `proof/SB30/transcripts/`.
- Source assertions under `proof/SB30/source-assertions/`.
- Semantic invariants under `proof/SB30/semantic-invariants.md`.
- Manifest under `proof/SB30/manifest.md`.
...
Implement SB30 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
