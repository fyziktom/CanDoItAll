# SB12 - Migrate execution artifact path into coordinator
...
ProjectExecutionArtifactsAsync delegates execution-artifact loop while preserving claim checks.
...
- Proof transcript under `proof/SB12/transcripts/`.
...
Implement SB12 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
