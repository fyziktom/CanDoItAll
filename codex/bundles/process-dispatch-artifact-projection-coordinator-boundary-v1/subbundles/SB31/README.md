# SB31 - Existing-managed focused parity tests
...
Declared path, fallback response path, duplicate key, missing file, text-match scenarios.
...
- Proof transcript under `proof/SB31/transcripts/`.
- Source assertions under `proof/SB31/source-assertions/`.
- Semantic invariants under `proof/SB31/semantic-invariants.md`.
- Manifest under `proof/SB31/manifest.md`.
...
Implement SB31 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
