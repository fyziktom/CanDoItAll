# SB46 - Completed-decision record-only coordinator cleanup
...
Keep record-only path separate from storage-backed writes.
...
- Proof transcript under `proof/SB46/transcripts/`.
- Source assertions under `proof/SB46/source-assertions/`.
- Semantic invariants under `proof/SB46/semantic-invariants.md`.
- Manifest under `proof/SB46/manifest.md`.
...
Implement SB46 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
