# SB35 - Response-text projection coordinator
...
Coordinator owns response text projection loop and write outcome application.
...
- Proof transcript under `proof/SB35/transcripts/`.
- Source assertions under `proof/SB35/source-assertions/`.
- Semantic invariants under `proof/SB35/semantic-invariants.md`.
- Manifest under `proof/SB35/manifest.md`.
...
Implement SB35 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
