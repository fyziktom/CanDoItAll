# SB02 - ArtifactProjection source-path and source-family inventory
...
Enumerate every projection source path, side effect, helper, and existing test.
...
- Proof transcript under `proof/SB02/transcripts/`.
- Source assertions under `proof/SB02/source-assertions/`.
...
Implement SB02 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
