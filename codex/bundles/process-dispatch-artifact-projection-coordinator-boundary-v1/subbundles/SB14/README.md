...
Build/tests/source scan prove execution artifact path behavior and no drift.
...
- Proof transcript under `proof/SB14/transcripts/`.
...
Implement SB14 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
