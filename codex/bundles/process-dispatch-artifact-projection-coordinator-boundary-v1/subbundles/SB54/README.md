# SB54 - Broad focused regression matrix
...
Run focused projection/artifact/recovery/finalizer/observation tests and full build.
...
- Proof transcript under `proof/SB54/transcripts/`.
- Source assertions under `proof/SB54/source-assertions/`.
- Semantic invariants under `proof/SB54/semantic-invariants.md`.
- Manifest under `proof/SB54/manifest.md`.
...
Implement SB54 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
