# SB27 - Existing-managed artifact source facts
...
Extract expected managed path enumeration and projectable expectation facts.
...
- Proof transcript under `proof/SB27/transcripts/`.
- Source assertions under `proof/SB27/source-assertions/`.
- Semantic invariants under `proof/SB27/semantic-invariants.md`.
- Manifest under `proof/SB27/manifest.md`.
...
Implement SB27 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
