# SB49 - Projection orchestrator facade
...
Create module-local orchestrator that calls all source coordinators in exact current order.
...
- Proof transcript under `proof/SB49/transcripts/`.
- Source assertions under `proof/SB49/source-assertions/`.
- Semantic invariants under `proof/SB49/semantic-invariants.md`.
- Manifest under `proof/SB49/manifest.md`.
...
Implement SB49 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
