# SB37 - Response-text focused parity tests
...
Declared relative path, no-declared fallback, unusable response text, duplicate key tests.
...
- Proof transcript under `proof/SB37/transcripts/`.
- Source assertions under `proof/SB37/source-assertions/`.
- Semantic invariants under `proof/SB37/semantic-invariants.md`.
- Manifest under `proof/SB37/manifest.md`.
...
Implement SB37 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
