# SB21 - Workspace-written artifact source facts
...
Extract session/receipt writes, governed path matching facts, duplicate probe facts.
...
- Proof transcript under `proof/SB21/transcripts/`.
- Source assertions under `proof/SB21/source-assertions/`.
...
Implement SB21 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
