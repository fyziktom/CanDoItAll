...
Critical gate for existing-managed projection migration.
...
- Proof transcript under `proof/SB32/transcripts/`.
- Source assertions under `proof/SB32/source-assertions/`.
- Semantic invariants under `proof/SB32/semantic-invariants.md`.
- Manifest under `proof/SB32/manifest.md`.
...
Implement SB32 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
