# SB41 - Provider-native browser projection coordinator
...
Coordinator owns provider-native browser projection loop.
...
- Proof transcript under `proof/SB41/transcripts/`.
- Source assertions under `proof/SB41/source-assertions/`.
- Semantic invariants under `proof/SB41/semantic-invariants.md`.
- Manifest under `proof/SB41/manifest.md`.
...
Implement SB41 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
