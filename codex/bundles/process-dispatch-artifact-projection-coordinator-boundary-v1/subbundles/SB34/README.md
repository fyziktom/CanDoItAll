# SB34 - Response-text projection content builder
...
Own response markdown/text content construction and metadata classification.
...
- Proof transcript under `proof/SB34/transcripts/`.
- Source assertions under `proof/SB34/source-assertions/`.
- Semantic invariants under `proof/SB34/semantic-invariants.md`.
- Manifest under `proof/SB34/manifest.md`.
...
Implement SB34 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
