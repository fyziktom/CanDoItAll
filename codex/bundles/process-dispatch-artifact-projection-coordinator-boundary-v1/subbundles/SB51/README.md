# SB51 - Side-effect ownership scan and helper naming cleanup
...
Prove planners/adapters remain side-effect-free; coordinators own IO/DB/write operations.
...
- Proof transcript under `proof/SB51/transcripts/`.
- Source assertions under `proof/SB51/source-assertions/`.
- Semantic invariants under `proof/SB51/semantic-invariants.md`.
- Manifest under `proof/SB51/manifest.md`.
...
Implement SB51 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
