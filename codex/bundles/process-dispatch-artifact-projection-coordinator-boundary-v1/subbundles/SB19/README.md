# SB19 - Process mock negative/parity tests
...
Multiple match error, missing scoped file, invalid expectation id, duplicate key behavior.
...
- Proof transcript under `proof/SB19/transcripts/`.
- Source assertions under `proof/SB19/source-assertions/`.
...
Implement SB19 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
