# SB22 - Workspace-written path resolver and file reader
...
Explicit coordinator for source path resolution and file content reading.
...
- Proof transcript under `proof/SB22/transcripts/`.
- Source assertions under `proof/SB22/source-assertions/`.
...
Implement SB22 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
