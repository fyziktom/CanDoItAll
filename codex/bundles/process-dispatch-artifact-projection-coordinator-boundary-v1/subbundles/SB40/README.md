# SB40 - Provider-native browser safe path resolver
...
Explicit safe working-directory/path resolver and file content read boundary.
...
- Proof transcript under `proof/SB40/transcripts/`.
- Source assertions under `proof/SB40/source-assertions/`.
- Semantic invariants under `proof/SB40/semantic-invariants.md`.
- Manifest under `proof/SB40/manifest.md`.
...
Implement SB40 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
