# SB42 - Migrate provider-native browser projection path
...
Wrapper delegates provider-native browser path; preserve required evidence matching.
...
- Proof transcript under `proof/SB42/transcripts/`.
- Source assertions under `proof/SB42/source-assertions/`.
- Semantic invariants under `proof/SB42/semantic-invariants.md`.
- Manifest under `proof/SB42/manifest.md`.
...
Implement SB42 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
