# SB50 - ArtifactProjection wrapper slimming pass
...
Reduce ProjectExecutionArtifactsAsync to orchestration shell and keep public/private wrapper parity.
...
- Proof transcript under `proof/SB50/transcripts/`.
- Source assertions under `proof/SB50/source-assertions/`.
- Semantic invariants under `proof/SB50/semantic-invariants.md`.
- Manifest under `proof/SB50/manifest.md`.
...
Implement SB50 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
