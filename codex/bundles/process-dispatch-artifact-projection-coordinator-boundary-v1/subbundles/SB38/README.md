...
Critical gate for response-text projection migration.
...
- Proof transcript under `proof/SB38/transcripts/`.
- Source assertions under `proof/SB38/source-assertions/`.
- Semantic invariants under `proof/SB38/semantic-invariants.md`.
- Manifest under `proof/SB38/manifest.md`.
...
Implement SB38 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
