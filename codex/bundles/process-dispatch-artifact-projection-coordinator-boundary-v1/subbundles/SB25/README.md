# SB25 - Workspace-written focused parity tests
...
Tests for governed path match, workspace content match, receipt-only writes, missing source file.
...
- Proof transcript under `proof/SB25/transcripts/`.
- Source assertions under `proof/SB25/source-assertions/`.
- Semantic invariants under `proof/SB25/semantic-invariants.md`.
- Manifest under `proof/SB25/manifest.md`.
...
Implement SB25 only. Preserve behavior, add focused proof, and stop after recording gate evidence.
