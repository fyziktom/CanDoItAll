...
- Expected behavior: Completed decision artifact projection remains the final source family.
- Disallowed shallow implementation: A shallow pass would project completion decisions before other artifact sources.
