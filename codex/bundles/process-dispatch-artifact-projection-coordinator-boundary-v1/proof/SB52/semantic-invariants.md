# SB52 Semantic Invariants

- Invariant ID: `SB52-INV-001`
- Source raw note: Continue smaller dispatcher isolation
- Expected behavior: The projection partial is reduced to orchestration over module-local coordinators, with regression tests focused on the projection boundary.
- Disallowed shallow implementation: A shallow pass would leave the large method bodies in the facade or remove private wrapper compatibility.
