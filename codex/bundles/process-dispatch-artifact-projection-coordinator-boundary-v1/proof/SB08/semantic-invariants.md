...
- Expected behavior: Coordinators receive one explicit context and apply projection outcomes through the shared mutation helper.
- Disallowed shallow implementation: A shallow pass would duplicate mutation logic or let coordinators mutate candidates inconsistently.
