...
- Expected behavior: Response text artifact projection is delegated after existing managed artifacts and before provider-native browser artifacts.
- Disallowed shallow implementation: A shallow pass would bypass expected-artifact satisfaction rules.
