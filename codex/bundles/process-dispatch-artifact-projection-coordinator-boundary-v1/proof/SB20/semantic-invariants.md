...
- Expected behavior: Process mock artifacts are delegated after execution artifacts and before workspace-written artifacts.
- Disallowed shallow implementation: A shallow pass would fold process mock artifacts into workspace handling and blur source ownership.
