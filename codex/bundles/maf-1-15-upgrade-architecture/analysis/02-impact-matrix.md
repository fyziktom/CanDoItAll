...
| 1.13 pending session lacks binding state | Custom approval persistence/rehydration | Runtime/security | Drain/reissue or controlled trusted bridge; classify state | P0 | Confirmed |
