# SB017 - Failure closure coordinator

## Status
- Status: Completed

## Objective
Move generic dispatch failure transition, claim-lost/heartbeat-lost behavior, and run-closed failure skip into a coordinator with explicit side effects.
...
## Dependency Impact
- Preserve log messages and target statuses where asserted.

## Validation Depth
- Failure closure tests and source scan.
...
Implement SB017 from the bundle. Keep behavior identical, avoid Process Core and driver APIs, and produce the proof required above.
