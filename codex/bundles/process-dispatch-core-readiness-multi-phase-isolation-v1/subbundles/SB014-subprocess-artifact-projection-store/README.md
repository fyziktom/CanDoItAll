# SB014 - Subprocess artifact projection store

## Status
- Status: Completed

## Objective
Move `ProjectCompletedSubprocessArtifactsAsync` DB reads/writes into a subprocess projection store/coordinator with explicit SaveChanges ownership.
...
## Dependency Impact
- Preserve gap journal and projection writer behavior.

## Validation Depth
- Subprocess artifact projection integration test.
...
Implement SB014 from the bundle. Keep behavior identical, avoid Process Core and driver APIs, and produce the proof required above.
