# SB011 - Start transition/reload service boundary

## Status
Prepared.

## Objective
Move start transition, failed-start reload, continue-candidates decision, and concurrency token handling into a module-local service.
...
## Dependency Impact
Preserve reload behavior exactly.

## Validation Depth
Start transition parity tests.
...
Implement SB011 from the bundle. Keep behavior identical, avoid Process Core and driver APIs, and produce the proof required above.
