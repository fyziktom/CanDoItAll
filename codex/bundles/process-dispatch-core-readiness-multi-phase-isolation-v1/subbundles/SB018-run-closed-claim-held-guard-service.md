# SB018 - Run-closed/claim-held guard service

## Status
Prepared.

## Objective
Extract run-closed and claim-held checks from dispatcher wrappers into module-local guard service used by finalizer/failure paths.
...
## Dependency Impact
Critical gate F. Claim semantics must remain unchanged.

## Validation Depth
Claim guard tests + no direct EF write drift.
...
Implement SB018 from the bundle. Keep behavior identical, avoid Process Core and driver APIs, and produce the proof required above.
