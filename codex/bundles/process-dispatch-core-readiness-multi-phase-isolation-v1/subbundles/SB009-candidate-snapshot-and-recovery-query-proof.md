# SB009 - Candidate snapshot and recovery query proof

## Status
Prepared.

## Objective
Move recovery execution lookup, manual recovery directive, artifact recovery execution resolution, and candidate snapshot readiness into the hydration service boundary.
...
## Dependency Impact
Critical gate C. No behavior loss in recovery trigger path.

## Validation Depth
Recovery/candidate hydration tests + source scans.
...
Implement SB009 from the bundle. Keep behavior identical, avoid Process Core and driver APIs, and produce the proof required above.
