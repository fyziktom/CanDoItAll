# SB008 - Assignment and direct-agent binding split

## Status
- Status: Completed

## Objective
Split direct-agent binding, assignment resolution, project-structure read-access save, and technical-agent diagnostics into explicit service(s).
...
## Dependency Impact
- Agent save/project access remains explicit side effect.

## Validation Depth
- Focused tests for missing binding, access grant, workflow assignment, direct assignment.
...
Implement SB008 from the bundle. Keep behavior identical, avoid Process Core and driver APIs, and produce the proof required above.
