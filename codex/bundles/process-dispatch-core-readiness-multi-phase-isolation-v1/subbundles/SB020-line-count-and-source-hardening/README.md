# SB020 - Line-count and source hardening

## Status
- Status: Completed

## Objective
Set realistic line-count targets and split remaining huge partials only where behavior is already isolated.
...
## Dependency Impact
- No cosmetic line-count pass that worsens dependencies.

## Validation Depth
- Line-count report, build, source scans.
...
Implement SB020 from the bundle. Keep behavior identical, avoid Process Core and driver APIs, and produce the proof required above.
