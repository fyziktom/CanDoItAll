# SB025 — Office evidence-read lane contract rehearsal

## Status
Prepared for implementation.

## Objective
Test-only typed scenarios for existing evidence only; deny Graph, email category mutation, task creation, document writes.
...
- Updated proof material under `proof/SB025/`.
...
Implement SB025 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
