# SB022 — Contract version negotiation model

## Status
Prepared for implementation.

## Objective
Add/verify version metadata, compatibility decision facts and unsupported-version denial tests without runtime selector.
...
- Updated proof material under `proof/SB022/`.
...
Implement SB022 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
