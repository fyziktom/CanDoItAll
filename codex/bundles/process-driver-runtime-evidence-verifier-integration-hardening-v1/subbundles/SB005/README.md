# SB005 — Parser extraction for .NET and Rust

## Status
- Status: Completed

## Objective
Split deterministic transcript parsing into internal parser classes/rules; preserve diagnostic categories, severity and messages.
...
- Updated proof material under `proof/SB005/`.
...
Implement SB005 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
