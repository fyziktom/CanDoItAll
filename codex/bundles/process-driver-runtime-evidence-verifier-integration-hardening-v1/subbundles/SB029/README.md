# SB029 — Package boundary template for future drivers

## Status
Prepared for implementation.

## Objective
Document and test package naming/dependency rules for future verification-only drivers without implementing runtime host.
...
- Updated proof material under `proof/SB029/`.
...
Implement SB029 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
