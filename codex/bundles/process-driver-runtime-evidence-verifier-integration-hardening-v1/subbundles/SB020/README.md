# SB020 — Core consumer allow-list hardening

## Status
- Status: Completed

## Objective
Require every process/driver Core consumer to be listed with adapter owner and reason; fail global usings or broad directory imports.
...
- Updated proof material under `proof/SB020/`.
...
Implement SB020 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
