# SB004 — Verifier responsibility map and parity fixtures

## Status
Prepared for implementation.

## Objective
Inventory current validation, parsing, redaction, evidence normalization, audit, hash, and diagnostic categories; create golden transcript fixtures.
...
- Updated proof material under `proof/SB004/`.
...
Implement SB004 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
