# SB013 — Observation envelope lifecycle model

## Status
Prepared for implementation.

## Objective
Add explicit ObservedAt/source lane/denial/diagnostic/evidence/audit invariants; fix deterministic timestamp ambiguity if needed.
...
- Updated proof material under `proof/SB013/`.
...
Implement SB013 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
