# SB040 — Stable Core vNext scorecard

## Status
Prepared for implementation.

## Objective
Update Core roadmap: what is stable, what remains module-local, what descriptor families are candidates.
...
- Updated proof material under `proof/SB040/`.
...
Implement SB040 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
