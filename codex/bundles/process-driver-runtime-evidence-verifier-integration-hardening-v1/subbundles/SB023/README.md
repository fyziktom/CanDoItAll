# SB023 — Diagnostic taxonomy compatibility

## Status
- Status: Completed

## Objective
Separate stable public diagnostic categories from alpha-specific parsing details; add old/new category compatibility tests.
...
- Updated proof material under `proof/SB023/`.
...
Implement SB023 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
