# SB043 — Broad build/unit/focused integration matrix

## Status
Prepared for implementation.

## Objective
Run solution build --no-restore, full unit tests, focused driver/process/core tests, adapter tests and malicious corpus tests.
...
- Updated proof material under `proof/SB043/`.
...
Implement SB043 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
