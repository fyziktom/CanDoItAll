# SB008 — Transcript hash and evidence hash normalization service

## Status
- Status: Completed

## Objective
Centralize SHA-256 validation/normalization; add mismatch, duplicate, malformed and missing-hash negative tests.
...
- Phase: P03 — Evidence Hash, URI, And Payload Policy Hardening
...
- Updated proof material under `proof/SB008/`.
...
Implement SB008 for `process-driver-runtime-evidence-verifier-integration-hardening-v1`. Keep changes within scope, preserve all previous behavior, and record artifact-backed proof. Stop if any forbidden runtime/Core/driver/UI boundary is crossed.
