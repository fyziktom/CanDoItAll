...
- Raw notes: Verify after Codex crash from real code
...
- Representative after SHA-256: 68AAB0B844706C3D66F89B86926723CB6BB2730C7DBFCE92D243B74C61BB427E for repo://tests/CanDoItAll.Tests.Unit/ProcessDriverContractPrerequisitesVerificationTests.cs and repo://tests/CanDoItAll.Tests.Unit/ProcessDriverTranscriptVerificationAlphaTests.cs
- Failing-first transcript: bundle://proof/SB001/transcripts/focused-transcript-alpha-tests.txt
- Passing transcript: bundle://proof/SB002/transcripts/process-driver-contract-prerequisites-after-runtime-evidence-refactor.txt
- Passing transcript: bundle://proof/SB003/transcripts/closure-proof-index.txt
...
- Production source proof: repo://tests/CanDoItAll.Tests.Unit/ProcessDriverContractPrerequisitesVerificationTests.cs and repo://tests/CanDoItAll.Tests.Unit/ProcessDriverTranscriptVerificationAlphaTests.cs
