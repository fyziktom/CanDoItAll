...
Add/extend architecture tests and source scans before production movement.
...
5. Record source assertions and command transcripts under `proof/SB04`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB04.
...
- Source assertion file under `proof/SB04/source-assertions/`.
- Command transcript under `proof/SB04/transcripts/`.
...
- Critical foundation. Downstream work must not start until all proof passes and the execution report marks SB04 completed.
