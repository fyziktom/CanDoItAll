# SB07 - Validation context and result builder

## Objective

Extract pure builders for validation context/result and diagnostic payload construction.
...
5. Record source assertions and command transcripts under `proof/SB07`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB07.
...
- Source assertion file under `proof/SB07/source-assertions/`.
- Command transcript under `proof/SB07/transcripts/`.
