# SB12 - Refactor Gate C finalizer parity

## Objective

Run focused finalizer/artifact/recovery/invariant parity proof.
...
5. Record source assertions and command transcripts under `proof/SB12`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB12.
...
- Source assertion file under `proof/SB12/source-assertions/`.
- Command transcript under `proof/SB12/transcripts/`.
...
- Critical foundation. Downstream work must not start until all proof passes and the execution report marks SB12 completed.
