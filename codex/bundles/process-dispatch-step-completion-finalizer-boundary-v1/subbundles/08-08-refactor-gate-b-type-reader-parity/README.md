# SB08 - Refactor Gate B type/reader parity

## Objective

Prove type and content-reader extraction parity before orchestration movement.
...
5. Record source assertions and command transcripts under `proof/SB08`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB08.
...
- Source assertion file under `proof/SB08/source-assertions/`.
- Command transcript under `proof/SB08/transcripts/`.
...
- Critical foundation. Downstream work must not start until all proof passes and the execution report marks SB08 completed.
