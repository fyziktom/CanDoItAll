# SB14 - Line-count and hotspot rebalance

## Objective

Review helper sizes, line counts, accidental monolith moves, and rebalance if needed.
...
- Line-count/hotspot report.
- Helper size guard.
- Rebalance if any helper grew into monolith.
...
5. Record source assertions and command transcripts under `proof/SB14`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB14.
...
- Source assertion file under `proof/SB14/source-assertions/`.
- Command transcript under `proof/SB14/transcripts/`.
