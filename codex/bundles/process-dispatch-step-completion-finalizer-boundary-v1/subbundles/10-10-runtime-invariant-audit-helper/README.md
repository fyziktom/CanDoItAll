# SB10 - Runtime invariant audit helper

## Objective

Extract invariant violation construction from persistence, preserving severe-blocking semantics.
...
- Runtime invariant audit builder.
- Severe invariant blocking tests.
...
5. Record source assertions and command transcripts under `proof/SB10`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB10.
...
- Source assertion file under `proof/SB10/source-assertions/`.
- Command transcript under `proof/SB10/transcripts/`.
...
- Critical foundation. Downstream work must not start until all proof passes and the execution report marks SB10 completed.
