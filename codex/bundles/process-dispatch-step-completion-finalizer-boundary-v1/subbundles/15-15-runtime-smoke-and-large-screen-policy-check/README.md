# SB15 - Runtime smoke and large-screen policy check

## Objective

Run runtime smoke, build, and proof-path scans; browser proof remains N/A.
...
5. Record source assertions and command transcripts under `proof/SB15`.
...
- Source assertion file under `proof/SB15/source-assertions/`.
- Command transcript under `proof/SB15/transcripts/`.
