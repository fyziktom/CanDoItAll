# SB03 - Finalizer boundary design and cutline

## Objective

Define exact local-helper boundaries and decide what must remain dispatcher-owned.
...
5. Record source assertions and command transcripts under `proof/SB03`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB03.
...
- Source assertion file under `proof/SB03/source-assertions/`.
- Command transcript under `proof/SB03/transcripts/`.
