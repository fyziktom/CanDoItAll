# SB06 - Artifact content reader extraction

## Objective

Extract content reader interface/results and workspace/storage-backed readers into module-local files.
...
- Content reader helper files.
- Workspace/storage fallback tests.
- No behavior drift.
...
5. Record source assertions and command transcripts under `proof/SB06`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB06.
...
- Source assertion file under `proof/SB06/source-assertions/`.
- Command transcript under `proof/SB06/transcripts/`.
...
- Critical foundation. Downstream work must not start until all proof passes and the execution report marks SB06 completed.
