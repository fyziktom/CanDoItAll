# SB09 - Artifact validation orchestration helper

## Objective

Move the validation orchestration around required artifacts into a local helper while keeping persistence boundaries guarded.
...
- Validation orchestration helper.
- Required artifact parity tests.
...
5. Record source assertions and command transcripts under `proof/SB09`.
6. Update `reviews/01-execution-report.md`.
7. Stop if the progression gate fails.

## Acceptance Checklist

- [x] Scope stayed within SB09.
...
- Source assertion file under `proof/SB09/source-assertions/`.
- Command transcript under `proof/SB09/transcripts/`.
