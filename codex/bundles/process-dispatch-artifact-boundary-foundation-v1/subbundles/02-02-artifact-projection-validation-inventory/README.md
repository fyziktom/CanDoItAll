# SB02 - Artifact/projection/validation inventory
...
Classify all relevant methods and side effects in artifact/projection/validation partials.
...
- Proof artifacts under `proof/SB02/`.
...
No code movement except inventory/proof updates.
...
- `proof/SB02/transcripts/*`
- `proof/SB02/source-assertions/*`
...
Execute SB02 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
