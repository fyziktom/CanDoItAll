# SB08 - Refactor Gate B projection parity
...
Run parity, artifact-lineage, duplicate suppression, and line-count proof.
...
- Proof artifacts under `proof/SB08/`.
...
- `proof/SB08/transcripts/*`
- `proof/SB08/source-assertions/*`
...
Execute SB08 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
