# SB10 - Artifact validation rule service foundation
...
Extract selected validation rules with negative tests.
...
- Proof artifacts under `proof/SB10/`.
...
Do not move step transition/finalization ownership.
...
- `proof/SB10/transcripts/*`
- `proof/SB10/source-assertions/*`
...
Execute SB10 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
