# SB04 - Refactor Gate A guardrails
...
- Proof artifacts under `proof/SB04/`.
...
- `proof/SB04/transcripts/*`
- `proof/SB04/source-assertions/*`
...
Execute SB04 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
