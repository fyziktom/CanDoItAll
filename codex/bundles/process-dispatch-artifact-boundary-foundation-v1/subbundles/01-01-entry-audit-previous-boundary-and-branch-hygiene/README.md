# SB01 - Entry audit, previous boundary smoke, branch hygiene
...
Confirm previous execution snapshot boundary remains intact and current branch is safe before artifact work.
...
No production artifact movement.
...
- `proof/SB01/transcripts/*`
- `proof/SB01/source-assertions/*`
...
Execute SB01 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
