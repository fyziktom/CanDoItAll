# SB03 - Artifact evidence seam design
...
- Proof artifacts under `proof/SB03/`.
...
No production behavior movement.
...
- `proof/SB03/transcripts/*`
- `proof/SB03/source-assertions/*`
...
Execute SB03 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
