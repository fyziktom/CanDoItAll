# SB11 - Refactor Gate C runtime smoke
...
Run build, unit tests, process-filtered integration, source scans, and size review.
...
- Proof artifacts under `proof/SB11/`.
...
- `proof/SB11/transcripts/*`
- `proof/SB11/source-assertions/*`
...
Execute SB11 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
