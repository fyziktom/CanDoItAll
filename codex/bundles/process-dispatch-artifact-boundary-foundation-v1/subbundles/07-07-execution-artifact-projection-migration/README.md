# SB07 - First projection path migration
...
Migrate execution artifact projection through planner while preserving behavior.
...
- Proof artifacts under `proof/SB07/`.
...
Only execution artifact source path, not all projection sources.
...
Execute SB07 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
