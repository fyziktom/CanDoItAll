# SB05 - Expectation matcher and lineage helper foundation
...
Extract pure matcher/lineage helpers with unit tests.
...
- Proof artifacts under `proof/SB05/`.
...
Do not move storage/DB recording.
...
Execute SB05 from `process-dispatch-artifact-boundary-foundation-v1`. Stay strictly within scope, preserve process runtime behavior, and record proof before moving on.
