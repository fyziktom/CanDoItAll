# SB03 - Design module-local boundary and no-production-movement cutline
...
Boundary design and cutline before production movement.
...
- Previous subbundle completed: SB02.
...
Implement SB03 from `process-dispatch-pre-execution-guard-materialization-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
