# SB06 - Migrate database requirement blocking through local blocker
...
Database requirement blocker/coordinator used by dispatcher.
...
- Previous subbundle completed: SB05.
...
Implement SB06 from `process-dispatch-pre-execution-guard-materialization-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
