# SB13 - Side-effect orchestrator for upstream materialization
...
Side-effect orchestrator for materialization request.
...
- Previous subbundle completed: SB12.
...
Implement SB13 from `process-dispatch-pre-execution-guard-materialization-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
