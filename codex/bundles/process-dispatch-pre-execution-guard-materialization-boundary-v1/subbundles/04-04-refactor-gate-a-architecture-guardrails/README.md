...
Architecture tests and source scans that lock scope.
...
- Previous subbundle completed: SB03.
...
Implement SB04 from `process-dispatch-pre-execution-guard-materialization-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
