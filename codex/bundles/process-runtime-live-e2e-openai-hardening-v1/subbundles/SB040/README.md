# SB040 — Core domain-leakage scan

## Status
Prepared.

## Objective
Scan Core for .NET/Office/business/driver/module/runtime leakage.
...
Implement SB040 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
