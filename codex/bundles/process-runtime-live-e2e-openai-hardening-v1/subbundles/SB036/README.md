# SB036 — Gate L UI recovery/artifact closure

## Status
Prepared.

## Objective
Force deterministic missing/blocked condition and verify UI recovery diagnostics.
...
- `proof/SB036/manifest.md` and `proof/SB036/semantic-invariants.md` with shallow-pass trap, adversarial negative proof, semantic positive proof, and changed-file hashes.
...
Implement SB036 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
