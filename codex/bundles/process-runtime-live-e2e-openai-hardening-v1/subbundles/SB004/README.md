# SB004 — Web app startup inventory

## Status
Completed.

## Objective
Inventory web composition, module assemblies, process module registration, API maps, health route, managed files.
...
## Proof Required
- Source assertion transcript: `bundle://proof/SB004/transcripts/startup-composition-source-assertions.txt`
- Test transcript: `bundle://proof/SB004/transcripts/startup-composition-tests.txt`
- Test result: `bundle://proof/SB004/test-results/SB004-startup-composition.trx`
- Anti-stub scan: `bundle://proof/SB004/transcripts/anti-stub-and-runtime-host-drift-scan.txt`
- No transient bundle-path scan: `bundle://proof/SB004/transcripts/no-transient-bundle-path-scan.txt`
- Inventory: `bundle://proof/SB004/startup-composition-inventory.md`
...
Implement SB004 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
