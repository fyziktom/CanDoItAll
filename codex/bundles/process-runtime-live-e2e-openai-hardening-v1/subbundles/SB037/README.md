# SB037 — Current runtime ownership matrix

## Status
Prepared.

## Objective
Document what is needed now vs future-gated: DI, scheduler, workflow, manager, runtime host.
...
Implement SB037 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
