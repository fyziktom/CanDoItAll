# SB019 — .NET create process scenario

## Status
Prepared.

## Objective
Start deterministic .NET app creation process and assert generated managed output files.
...
Implement SB019 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
