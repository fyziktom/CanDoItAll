# SB014 — Dispatch claim and route proof

## Status
Prepared.

## Objective
Drain/execute outbox and prove claim lease, route selection, finalizer transition, artifact projection.
...
Implement SB014 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
