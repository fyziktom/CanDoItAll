# SB038 — Runtime host non-approval guards

## Status
Prepared.

## Objective
Add/refresh tests rejecting registry/selector/driver DI/manager command until future approval.
...
Implement SB038 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
