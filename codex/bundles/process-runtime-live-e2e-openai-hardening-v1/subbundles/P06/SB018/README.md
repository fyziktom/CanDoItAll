# SB018 — Gate F MAF/direct-agent closure

## Status
Prepared.

## Objective
Prove both routes integrate with dispatch/finalizer/artifact validation.
...
- `proof/SB018/manifest.md` and `proof/SB018/semantic-invariants.md` with shallow-pass trap, adversarial negative proof, semantic positive proof, and changed-file hashes.
...
Implement SB018 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
