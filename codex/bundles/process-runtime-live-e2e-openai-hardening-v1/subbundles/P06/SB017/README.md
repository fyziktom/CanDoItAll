# SB017 — Direct-agent execution proof

## Status
Prepared.

## Objective
Run focused direct-agent route with deterministic provider and process tools.
...
Implement SB017 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
