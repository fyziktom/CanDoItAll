# SB016 — Workflow-backed role proof

## Status
Prepared.

## Objective
Run focused process role through MAF workflow-backed execution under process ownership.
...
Implement SB016 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
