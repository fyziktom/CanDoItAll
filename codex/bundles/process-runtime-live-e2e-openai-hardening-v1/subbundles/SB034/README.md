# SB034 — Run detail UI proof

## Status
Prepared.

## Objective
Open run detail after launch and inspect steps, statuses, artifacts, diagnostics.
...
Implement SB034 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
