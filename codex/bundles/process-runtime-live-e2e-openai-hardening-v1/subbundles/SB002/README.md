# SB002 — Transient bundle path dependency scan

## Status
Completed.

## Objective
Scan long-lived source/tests for `codex/bundles/<bundle-name>` and classify every hit.
...
## Proof Required
- Source assertion transcript: `bundle://proof/SB002/transcripts/source-assertion-scan.txt`
- Test transcript: `bundle://proof/SB002/transcripts/focused-fixture-consumer-tests.txt`
...
- No transient bundle-path scan/classification: `bundle://proof/SB002/transcripts/transient-path-classification-scan.txt`
- Classification: `bundle://proof/SB002/transient-path-classification.md`
...
Implement SB002 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
