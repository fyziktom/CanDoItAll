# SB022 — OpenAI live smoke configuration gate

## Status
Prepared.

## Objective
Add opt-in flag/key/model/budget/timeout guard. Skip cleanly if absent.
...
Implement SB022 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
