# SB013 — Run and step persistence proof

## Status
Prepared.

## Objective
Start process and verify run/step records, status, outbox, work briefs, project association.
...
Implement SB013 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
