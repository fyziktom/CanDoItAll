# SB024 — Gate H live provider closure

## Status
Prepared.

## Objective
Record pass or explicit opt-in skip; deterministic proof must still pass.
...
- `proof/SB024/manifest.md` and `proof/SB024/semantic-invariants.md` with shallow-pass trap, adversarial negative proof, semantic positive proof, and changed-file hashes.
...
Implement SB024 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
