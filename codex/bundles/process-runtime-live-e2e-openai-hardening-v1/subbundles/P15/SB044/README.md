# SB044 — Large-screen UI final smoke

## Status
Prepared.

## Objective
Run Playwright large desktop for global process launch, project launch, run detail.
...
Implement SB044 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
