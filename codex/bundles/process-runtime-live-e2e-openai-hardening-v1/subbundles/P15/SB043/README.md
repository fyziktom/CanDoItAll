# SB043 — Release build/unit/focused matrix

## Status
Prepared.

## Objective
Run build, full unit, focused process runtime, focused driver diagnostics, focused scheduler/workflow tests.
...
Implement SB043 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
