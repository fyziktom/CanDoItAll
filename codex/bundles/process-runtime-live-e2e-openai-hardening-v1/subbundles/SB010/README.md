...
## Objective
Verify `/projects/{projectId}/processes` preserves project context and launch plan context.
...
## Proof Required
- Source assertion transcript: `bundle://proof/SB010/transcripts/project-scoped-process-launch-source-assertions.txt`.
- Test transcript: `bundle://proof/SB010/transcripts/project-scoped-process-launch-playwright.txt`.
- Test result: `bundle://proof/SB010/test-results/SB010-project-scoped-process-launch.trx`.
- Anti-stub scan: `bundle://proof/SB010/transcripts/anti-stub-and-runtime-host-drift-scan.txt`.
...
- Large desktop Playwright proof passed for `/projects/{projectId}/processes`.
- Screenshots: `bundle://proof/SB010/screenshots`.
...
Implement SB010 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
