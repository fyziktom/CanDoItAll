# SB006 — Gate B app-start closure

## Status
Completed.

## Objective
Build web/app, run startup smoke, verify /health and /api/processes/templates, no UI/media drift.
...
## Proof Required
- Source assertion transcript: `bundle://proof/SB006/transcripts/startup-critical-source-assertions.txt`
- Test transcript: `bundle://proof/SB006/transcripts/startup-critical-integration-tests.txt`
- Build transcript: `bundle://proof/SB006/transcripts/web-build-no-restore.txt`
- Anti-stub scan: `bundle://proof/SB006/transcripts/anti-stub-and-runtime-host-drift-scan.txt`
- No transient bundle-path scan: `bundle://proof/SB006/transcripts/no-transient-bundle-path-scan.txt`
- No UI/media drift scan: `bundle://proof/SB006/transcripts/no-ui-media-drift-scan.txt`
- `bundle://proof/SB006/manifest.md` and `bundle://proof/SB006/semantic-invariants.md` with shallow-pass trap, adversarial negative proof, semantic positive proof, and changed-file hashes.
...
Implement SB006 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
