# SB028 — Scheduler process target proof

## Status
Prepared.

## Objective
Create/launch scheduler plan targeting a process and verify it calls process service path.
...
Implement SB028 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
