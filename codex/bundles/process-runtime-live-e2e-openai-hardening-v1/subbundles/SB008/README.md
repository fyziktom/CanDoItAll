...
## Objective
Run Playwright on `/processes` large desktop and capture template selected, launch plan, run selected screenshots.
...
## Proof Required
- Large-desktop process launch proof: `bundle://proof/SB008/large-desktop-process-launch-proof.md`
- Proof manifest: `bundle://proof/SB008/manifest.md`
- Source assertion transcript: `bundle://proof/SB008/transcripts/large-desktop-process-launch-source-assertions.txt`
...
- Browser screenshots: `bundle://proof/SB008/screenshots`
- Anti-stub scan: `bundle://proof/SB008/transcripts/anti-stub-and-runtime-host-drift-scan.txt`
...
- Large desktop Playwright proof captured for `/processes` with template selected, launch plan created, and run selected screenshots under `bundle://proof/SB008/screenshots`.
...
Implement SB008 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
