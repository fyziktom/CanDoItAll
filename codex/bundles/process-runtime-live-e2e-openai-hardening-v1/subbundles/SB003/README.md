# SB003 — Gate A stable test fixtures closure

## Status
Completed.

## Objective
Replace transient bundle-path assertions with stable fixtures/source scans and prove full unit remains clean.
...
## Proof Required
- Source assertion transcript: `bundle://proof/SB003/transcripts/no-transient-bundle-path-scan.txt`
- Test transcript: `bundle://proof/SB003/transcripts/gate-a-focused-unit-tests.txt`
- Full unit transcript: `bundle://proof/SB003/transcripts/full-unit-rerun-no-build.txt`
- Anti-stub scan: `bundle://proof/SB003/transcripts/anti-stub-and-runtime-host-drift-scan.txt`
- No transient bundle-path scan: `bundle://proof/SB003/transcripts/no-transient-bundle-path-scan.txt`
- `bundle://proof/SB003/manifest.md` and `bundle://proof/SB003/semantic-invariants.md` with shallow-pass trap, adversarial negative proof, semantic positive proof, and changed-file hashes.
...
Implement SB003 in `process-runtime-live-e2e-openai-hardening-v1`. Keep the process runtime source-backed, avoid transient bundle paths, preserve generic Process Core, and capture artifact-backed proof before moving on.
