...
- `architecture/03-driver-readiness-position.md`
- `inventories/03-driver-readiness-candidate-map.md`
...
1. 1. Update driver readiness map with actual helper names and candidate facts.
