# SB02: api-tool-models-operation-contract-fields
...
Operation contract and target scope fields remain visible through API/tool/read surfaces.
...
- Updated proof manifest: proof/SB02/manifest.md.
...
- Source assertions, adversarial negative proof, semantic positive proof, anti-stub audit, changed-file hashes, and focused tests are recorded under bundle://proof/SB02/.
...
- reviews/01-execution-report.md includes the SB02 gate row.
...
SB02 is closed. Reopen only if the cited source references or validation transcripts no longer prove the typed process runtime contract.
