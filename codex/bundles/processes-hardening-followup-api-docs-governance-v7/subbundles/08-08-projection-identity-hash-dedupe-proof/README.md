# SB08: projection-identity-hash-dedupe-proof
...
Projection identity hash dedupe is visible through persisted and read surfaces.
...
- Updated proof manifest: proof/SB08/manifest.md.
...
- Source assertions, adversarial negative proof, semantic positive proof, anti-stub audit, changed-file hashes, and focused tests are recorded under bundle://proof/SB08/.
...
- reviews/01-execution-report.md includes the SB08 gate row.
...
SB08 is closed. Reopen only if the cited source references or validation transcripts no longer prove the typed process runtime contract.
