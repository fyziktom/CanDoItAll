# SB07: authoritative-grounding-ledger-policy
...
Grounding ledger policy remains backed by persisted artifact lineage.
...
- Updated proof manifest: proof/SB07/manifest.md.
...
- Source assertions, adversarial negative proof, semantic positive proof, anti-stub audit, changed-file hashes, and focused tests are recorded under bundle://proof/SB07/.
...
- reviews/01-execution-report.md includes the SB07 gate row.
...
SB07 is closed. Reopen only if the cited source references or validation transcripts no longer prove the typed process runtime contract.
