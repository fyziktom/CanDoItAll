# SB004 - EF audit entity configuration and indexes

## Status
- Completed

## Objective
Add explicit EF configuration for ProcessVerificationAuditEntry, indexes for run/step/lane/recorded time, and model registry proof.
...
Migration/bootstrap focused tests.
...
Implement SB004 as a code-first slice. Do not close with report-only proof. Make source/test changes first, then record concise evidence.
