# SB016 - Manager readback API surface

## Status
Prepared.

## Objective
Add/complete API or service endpoint returning diagnostics, audit id/hash, denial code/category, no-mutation flags, evidence counts.
...
Implement SB016 as a code-first slice. Do not close with report-only proof. Make source/test changes first, then record concise evidence.
