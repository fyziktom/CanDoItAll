# SB025 - Sandbox allow-list contract matrix

## Status
Prepared.

## Objective
Model command/file/network/Office/CRM/workspace/storage/process mutation surfaces and default denial matrix.
...
Implement SB025 as a code-first slice. Do not close with report-only proof. Make source/test changes first, then record concise evidence.
