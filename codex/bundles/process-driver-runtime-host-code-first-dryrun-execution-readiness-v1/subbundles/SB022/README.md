# SB022 - Dry-run execution host contract model

## Status
Prepared.

## Objective
Add typed dry-run execution request/result models for future effectful driver calls; all effects denied by default.
...
Implement SB022 as a code-first slice. Do not close with report-only proof. Make source/test changes first, then record concise evidence.
