# SB019 - Live OpenAI process-run budget policy

## Status
- Completed

## Objective
Require explicit model, token budget, timeout; lower default budget or make default invalid for live proof.
...
Live test skip/pass classification test.
...
Implement SB019 as a code-first slice. Do not close with report-only proof. Make source/test changes first, then record concise evidence.
