# SB020 - Live process-run artifact/diagnostic proof

## Status
Prepared.

## Objective
Extend live smoke to verify process-run artifact/diagnostic or finalizer marker readback, not only usage observation.
...
## Deliverables / Scope
Integration test code required.
...
Implement SB020 as a code-first slice. Do not close with report-only proof. Make source/test changes first, then record concise evidence.
