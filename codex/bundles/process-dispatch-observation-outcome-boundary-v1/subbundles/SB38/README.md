# SB38 - ToolValidation wrapper slimming pass 2
...
Move residual session/log helper wrappers to observation helper wrappers.
...
- Record source assertions and command transcripts under `proof/SB38/`.
...
Implement SB38: ToolValidation wrapper slimming pass 2. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
