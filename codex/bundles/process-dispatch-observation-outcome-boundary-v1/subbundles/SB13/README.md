# SB13 - Wire observation snapshot into ToolValidation wrappers
...
Replace direct parsing calls with observation snapshot where safe.
...
- Record source assertions and command transcripts under `proof/SB13/`.
...
Implement SB13: Wire observation snapshot into ToolValidation wrappers. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
