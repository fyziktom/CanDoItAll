# SB18 - Declared branch selection facts
...
Extract branch key/title/id selection inputs and branch outcome resolution helpers.
...
- Record source assertions and command transcripts under `proof/SB18/`.
...
Implement SB18: Declared branch selection facts. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
