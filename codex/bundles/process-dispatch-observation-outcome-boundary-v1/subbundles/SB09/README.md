# SB09 - Execution log observation model
...
Add internal observation records for execution log tool invocations.
...
- Record source assertions and command transcripts under `proof/SB09/`.
...
Implement SB09: Execution log observation model. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
