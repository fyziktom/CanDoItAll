# SB36 - Gate I retry/no-progress parity
...
Run retry/no-progress focused tests.
...
- Record source assertions and command transcripts under `proof/SB36/`.
...
Implement SB36: Gate I retry/no-progress parity. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
