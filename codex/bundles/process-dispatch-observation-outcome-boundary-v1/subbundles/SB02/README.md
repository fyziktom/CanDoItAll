# SB02 - Live source inventory for observation/outcome hotspots
...
Map session parsing, execution-log parsing, declared outcome, completion status, completion reason, retry consumers.
...
- Record source assertions and command transcripts under `proof/SB02/`.
...
Implement SB02: Live source inventory for observation/outcome hotspots. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
