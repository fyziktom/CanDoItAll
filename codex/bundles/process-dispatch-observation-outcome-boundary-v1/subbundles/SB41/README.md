...
Map observation/outcome/decision evidence concepts for future drivers.
...
- Record source assertions and command transcripts under `proof/SB41/`.
...
Implement SB41: Documentation-only driver-readiness map. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
