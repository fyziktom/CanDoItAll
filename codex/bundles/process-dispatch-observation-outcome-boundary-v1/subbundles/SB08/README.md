# SB08 - Gate B session observation parity
...
Run focused parser tests and source scans.
...
- Record source assertions and command transcripts under `proof/SB08/`.
...
Implement SB08: Gate B session observation parity. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
