# SB40 - Gate J line-count/source boundary proof
...
Run source scans, build, and focused tests.
...
- Record source assertions and command transcripts under `proof/SB40/`.
...
Implement SB40: Gate J line-count/source boundary proof. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
