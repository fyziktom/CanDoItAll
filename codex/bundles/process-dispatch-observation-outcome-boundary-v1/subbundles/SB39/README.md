# SB39 - Line-count and source hotspot review
...
Target ToolValidation.cs below 1350 lines if safe; otherwise record justified residual.
...
- Record source assertions and command transcripts under `proof/SB39/`.
...
Implement SB39: Line-count and source hotspot review. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
