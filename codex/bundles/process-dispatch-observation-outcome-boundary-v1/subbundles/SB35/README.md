# SB35 - Retry reason aggregator observation cleanup
...
Use observation snapshots in retry reason aggregator and wrappers.
...
- Record source assertions and command transcripts under `proof/SB35/`.
...
Implement SB35: Retry reason aggregator observation cleanup. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
