# SB17 - Declared outcome parser helper
...
Extract TryResolveDeclaredStepOutcome and status mapping helpers.
...
- Record source assertions and command transcripts under `proof/SB17/`.
...
Implement SB17: Declared outcome parser helper. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
