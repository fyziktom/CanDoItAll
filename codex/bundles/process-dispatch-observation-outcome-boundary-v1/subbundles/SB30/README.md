# SB30 - Declared outcome reason builder helper
...
Extract BuildDeclaredStepOutcomeReason and reason normalization.
...
- Record source assertions and command transcripts under `proof/SB30/`.
...
Implement SB30: Declared outcome reason builder helper. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
