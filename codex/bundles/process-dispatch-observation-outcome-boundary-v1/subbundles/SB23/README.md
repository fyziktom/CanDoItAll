# SB23 - Context-validation error classification
...
Extract context validation error group mapping to failed/blocked/completed outcomes.
...
- Record source assertions and command transcripts under `proof/SB23/`.
...
Implement SB23: Context-validation error classification. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
