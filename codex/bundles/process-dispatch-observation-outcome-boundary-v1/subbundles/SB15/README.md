# SB15 - Wire observation snapshot into Concurrency/Execution consumers
...
Use snapshot for response/error/no-progress consumers where safe.
...
- Record source assertions and command transcripts under `proof/SB15/`.
...
Implement SB15: Wire observation snapshot into Concurrency/Execution consumers. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
