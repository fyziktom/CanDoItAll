# SB03 - Boundary design and test matrix repair
...
Finalize module-local cutline and create focused test inventory before code movement.
...
- Record source assertions and command transcripts under `proof/SB03/`.
...
Implement SB03: Boundary design and test matrix repair. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
