# SB33 - No-progress observation consumer cleanup
...
Replace direct parsing inputs with observation/facts where safe.
...
- Record source assertions and command transcripts under `proof/SB33/`.
...
Implement SB33: No-progress observation consumer cleanup. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
