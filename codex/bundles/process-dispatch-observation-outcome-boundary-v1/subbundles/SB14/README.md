# SB14 - Wire observation snapshot into ArtifactValidation consumers
...
Use snapshot for browser/quality/session evidence consumers where safe.
...
- Record source assertions and command transcripts under `proof/SB14/`.
...
Implement SB14: Wire observation snapshot into ArtifactValidation consumers. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
