# SB43 - Broad focused smoke matrix
...
Run selected tests across artifact, retry, provider, subprocess, materialization, finalizer.
...
- Record source assertions and command transcripts under `proof/SB43/`.
...
Implement SB43: Broad focused smoke matrix. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
