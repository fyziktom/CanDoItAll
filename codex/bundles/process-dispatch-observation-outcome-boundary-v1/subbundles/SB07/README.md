# SB07 - Session file read/write/stat extraction
...
Move file content extraction and result content parser into helper.
...
- Record source assertions and command transcripts under `proof/SB07/`.
...
Implement SB07: Session file read/write/stat extraction. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
