# SB04 - Gate A architecture/no-core/no-driver guardrails
...
Add/repair architecture guardrails and prepared validation proof.
...
- Record source assertions and command transcripts under `proof/SB04/`.
...
Implement SB04: Gate A architecture/no-core/no-driver guardrails. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
