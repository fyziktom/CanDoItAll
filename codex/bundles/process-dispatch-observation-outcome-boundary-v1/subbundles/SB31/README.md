# SB31 - Retry/blocker reason fragments
...
Extract missing tools/critical failures/blocker fragments without changing text.
...
- Record source assertions and command transcripts under `proof/SB31/`.
...
Implement SB31: Retry/blocker reason fragments. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
