# SB47 - Completed-stage validator
...
Run completed-stage bundle validator and repair bundle if needed.
...
- Record source assertions and command transcripts under `proof/SB47/`.
...
Implement SB47: Completed-stage validator. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
