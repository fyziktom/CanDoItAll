# SB05 - Session observation model skeleton
...
Add internal observation records for session tool calls/results/files/assistant text.
...
- Record source assertions and command transcripts under `proof/SB05/`.
...
Implement SB05: Session observation model skeleton. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
