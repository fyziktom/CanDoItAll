# SB06 - Session tool-name and tool-result extraction
...
Move successful session tool name/result text parsing into helper.
...
Implement SB06: Session tool-name and tool-result extraction. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
