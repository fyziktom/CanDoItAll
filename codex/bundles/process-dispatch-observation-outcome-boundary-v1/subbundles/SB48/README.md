...
Write final review and next recommended seam.
...
- Record source assertions and command transcripts under `proof/SB48/`.
...
Implement SB48: Final closure and next cutline. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
