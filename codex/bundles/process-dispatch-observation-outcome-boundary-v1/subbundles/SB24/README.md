# SB24 - Gate F disposition/context parity
...
Run explicit disposition and context-validation tests.
...
- Record source assertions and command transcripts under `proof/SB24/`.
...
Implement SB24: Gate F disposition/context parity. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
