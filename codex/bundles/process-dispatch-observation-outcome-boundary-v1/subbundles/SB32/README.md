# SB32 - Gate H completion reason parity
...
Run reason-text snapshot tests.
...
- Record source assertions and command transcripts under `proof/SB32/`.
...
Implement SB32: Gate H completion reason parity. Keep the change module-local, behavior-preserving, and proof-backed. Do not start the next subbundle until this progression gate is closed.
