# SB36 - Historical carried proof query coordinator

## Status
Prepared.

## Objective
Move historical execution query/detail fetch into explicit coordinator.
...
## Deliverables
- ProcessHistoricalCarriedProofQueryCoordinator
...
1. Implement or document: ProcessHistoricalCarriedProofQueryCoordinator
...
## Proof Required
- Tests/source proof for ordering and Take=20 preservation
...
Implement SB36 only. Keep work module-local, preserve behavior, update proof, and do not start later subbundles until this gate is closed.
