# SB05 - Execution attempt context snapshot

## Status
- Completed

## Objective
Introduce module-local attempt context/facts for per-attempt state.
...
1. Implement or document: ProcessExecutionAttemptContext
2. Implement or document: ProcessExecutionLoopState
...
## Proof Required
- Build proof
- No behavior movement beyond model introduction
...
Implement SB05 only. Keep work module-local, preserve behavior, update proof, and do not start later subbundles until this gate is closed.
