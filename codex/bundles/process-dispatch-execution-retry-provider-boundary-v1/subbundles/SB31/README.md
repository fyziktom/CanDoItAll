# SB31 - Provider health probe coordinator

## Status
- Completed

## Objective
Move health probe loop with timeout/cancellation behavior into coordinator.
...
## Deliverables
- ProcessProviderHealthProbeCoordinator
...
1. Implement or document: ProcessProviderHealthProbeCoordinator
...
## Proof Required
- Tests with fake execution client/health results where available; source proof otherwise
...
Implement SB31 only. Keep work module-local, preserve behavior, update proof, and do not start later subbundles until this gate is closed.
