# SB34 - Provider repair facade integration

## Status
Prepared.

## Objective
Wire TryRepairAssignedAgentProvidersAsync through provider recovery facade while preserving wrapper.
...
1. Implement or document: ProcessProviderRepairCoordinator
...
## Proof Required
- Focused provider recovery tests or source assertions
...
Implement SB34 only. Keep work module-local, preserve behavior, update proof, and do not start later subbundles until this gate is closed.
