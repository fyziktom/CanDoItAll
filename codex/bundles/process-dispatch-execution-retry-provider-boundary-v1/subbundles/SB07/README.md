# SB07 - Observed-active outcome builder

## Status
Prepared.

## Objective
Extract CreateObservedActiveAutomationExecutionOutcome and active-run message formatting.
...
## Deliverables
- ProcessObservedExecutionOutcomeBuilder
...
1. Implement or document: ProcessObservedExecutionOutcomeBuilder
...
## Proof Required
- Focused tests for InProgress outcome text and attempt number
...
Implement SB07 only. Keep work module-local, preserve behavior, update proof, and do not start later subbundles until this gate is closed.
