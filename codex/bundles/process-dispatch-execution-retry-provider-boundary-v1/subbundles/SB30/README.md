# SB30 - Fallback provider ordering rules

## Status
Prepared.

## Objective
Extract provider fallback ordering/model normalization.
...
## Deliverables
- ProcessProviderFallbackSelectionRules
...
1. Implement or document: ProcessProviderFallbackSelectionRules
...
## Proof Required
- Tests for provider ordering, failed provider exclusion, default model normalization
...
Implement SB30 only. Keep work module-local, preserve behavior, update proof, and do not start later subbundles until this gate is closed.
