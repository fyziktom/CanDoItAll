...
## Objective
Prove response resolver and active outcome behavior unchanged.
...
1. Implement or document: Gate B manifest
2. Implement or document: Line-count update
...
Implement SB08 only. Keep work module-local, preserve behavior, update proof, and do not start later subbundles until this gate is closed.
