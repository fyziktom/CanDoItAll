...
- Browser verification will continue to use a local development URL and the active managed SQLite profile.
- A focused component test is sufficient for the first-render regression without adding broader UI test coverage.
