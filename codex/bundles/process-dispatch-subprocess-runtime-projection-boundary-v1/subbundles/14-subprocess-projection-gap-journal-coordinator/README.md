# SB14 - Subprocess Projection Gap Journal Coordinator
...
Extract projection-gap fingerprint and journal dedupe/write into an explicit side-effect coordinator.
...
- Manifest under `proof/SB14/manifest.md`.
- Semantic invariants under `proof/SB14/semantic-invariants.md`.
- Command transcripts under `proof/SB14/transcripts/`.

## Dependency Impact

- Feeds SB15. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB14 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
