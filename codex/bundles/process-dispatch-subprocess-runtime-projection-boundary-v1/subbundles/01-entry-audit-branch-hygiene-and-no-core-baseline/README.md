# SB01 - Entry Audit Branch Hygiene And No Core Baseline
...
Establish branch hygiene, source inventory, previous bundle closure, and no-core/no-driver/no-UI baselines before any production movement.
...
- Feeds SB02. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB01 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
