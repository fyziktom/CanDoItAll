# SB22 - Runtime Smoke And Focused Test Battery
...
Run full build and targeted tests for subprocess route, artifact projection, upstream materialization, finalizer, and candidate factory interactions.
...
- Manifest under `proof/SB22/manifest.md`.
- Semantic invariants under `proof/SB22/semantic-invariants.md`.
- Command transcripts under `proof/SB22/transcripts/`.

## Dependency Impact

- Feeds SB23. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB22 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
