# SB17 - Project Completed Subprocess Artifacts Migration
...
Migrate ProjectCompletedSubprocessArtifactsAsync through the new helpers/coordinators while keeping claim checks and SaveChanges behavior explicit.
...
- Manifest under `proof/SB17/manifest.md`.
- Semantic invariants under `proof/SB17/semantic-invariants.md`.
- Command transcripts under `proof/SB17/transcripts/`.

## Dependency Impact

- Feeds SB18. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB17 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
