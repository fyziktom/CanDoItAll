# SB13 - Subprocess Projection Plan And Lineage Builder
...
Create a typed projection plan for parent-scoped subprocess artifacts: key, lineage, provenance, review summary, sensitivity, and markdown content.
...
- Manifest under `proof/SB13/manifest.md`.
- Semantic invariants under `proof/SB13/semantic-invariants.md`.
- Command transcripts under `proof/SB13/transcripts/`.

## Dependency Impact

- Feeds SB14. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB13 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
