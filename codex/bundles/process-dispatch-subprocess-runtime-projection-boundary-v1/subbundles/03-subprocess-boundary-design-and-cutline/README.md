# SB03 - Subprocess Boundary Design And Cutline
...
Define the module-local boundary: lifecycle facts, terminal status rules, capability-gap observation, artifact projection, and side-effect coordinators.
...
- Manifest under `proof/SB03/manifest.md`.
- Semantic invariants under `proof/SB03/semantic-invariants.md`.
- Command transcripts under `proof/SB03/transcripts/`.

## Dependency Impact

Feeds SB04. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB03 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
