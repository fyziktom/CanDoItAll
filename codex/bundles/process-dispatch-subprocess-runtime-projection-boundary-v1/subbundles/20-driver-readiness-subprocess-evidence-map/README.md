# SB20 - Driver Readiness Subprocess Evidence Map
...
Document future driver-readiness vocabulary for subprocess evidence/delegated process results without adding production driver APIs.
...
- Manifest under `proof/SB20/manifest.md`.
- Semantic invariants under `proof/SB20/semantic-invariants.md`.
- Command transcripts under `proof/SB20/transcripts/`.

## Dependency Impact

- Feeds SB21. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB20 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
