# SB11 - Subprocess Artifact Projection Inventory And Source Map
...
Classify parent expectations, child artifacts, mapper calls, projection gap paths, and current direct DB/file writes.
...
- Command transcripts under `proof/SB11/transcripts/`.

## Dependency Impact

Feeds SB12. If this subbundle changes route/projection semantics, reopen the previous gate.
...
Implement SB11 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
