# SB19 - Refactor Gate D Dispatch Loop Parity
...
Run focused dispatch route/subprocess integration tests and line-count scans after the facade integration.
...
- Manifest under `proof/SB19/manifest.md`.
- Semantic invariants under `proof/SB19/semantic-invariants.md`.
- Command transcripts under `proof/SB19/transcripts/`.
...
Implement SB19 only. Keep changes module-local. Preserve subprocess dispatch/projection behavior. Do not start Process Core or production driver APIs. Record proof before moving to the next subbundle.
