...
- Build transcript: `bundle://proof/SB08/transcripts/build.txt`.
- Passing transcript: `bundle://proof/SB08/transcripts/focused-tests.txt`.
- Semantic positive proof transcript: `bundle://proof/SB08/transcripts/focused-tests.txt`.
- Source scan transcript: `bundle://proof/SB08/transcripts/source-scan.txt`.
