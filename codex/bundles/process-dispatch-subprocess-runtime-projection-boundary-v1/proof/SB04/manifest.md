...
- Build transcript: `bundle://proof/SB04/transcripts/build.txt`.
- Passing transcript: `bundle://proof/SB04/transcripts/focused-tests.txt`.
- Semantic positive proof transcript: `bundle://proof/SB04/transcripts/focused-tests.txt`.
- Source scan transcript: `bundle://proof/SB04/transcripts/source-scan.txt`.
