...
Line-count and boundary review
...
- Semantic invariants: `bundle://proof/SB23/semantic-invariants.md`.
- Build transcript: `bundle://proof/SB23/transcripts/build.txt`.
- Passing transcript: `bundle://proof/SB23/transcripts/focused-tests.txt`.
- Semantic positive proof transcript: `bundle://proof/SB23/transcripts/focused-tests.txt`.
- Source scan transcript: `bundle://proof/SB23/transcripts/source-scan.txt`.
- Anti-stub audit transcript: `bundle://proof/SB23/transcripts/anti-stub.txt`.
