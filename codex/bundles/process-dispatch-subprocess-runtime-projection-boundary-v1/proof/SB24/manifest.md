...
Final red-team and next boundary
...
- Semantic invariants: `bundle://proof/SB24/semantic-invariants.md`.
- Build transcript: `bundle://proof/SB24/transcripts/build.txt`.
- Passing transcript: `bundle://proof/SB24/transcripts/focused-tests.txt`.
- Semantic positive proof transcript: `bundle://proof/SB24/transcripts/focused-tests.txt`.
- Source scan transcript: `bundle://proof/SB24/transcripts/source-scan.txt`.
- Anti-stub audit transcript: `bundle://proof/SB24/transcripts/anti-stub.txt`.
