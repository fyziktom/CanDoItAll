...
- Build transcript: `bundle://proof/SB19/transcripts/build.txt`.
- Passing transcript: `bundle://proof/SB19/transcripts/focused-tests.txt`.
- Semantic positive proof transcript: `bundle://proof/SB19/transcripts/focused-tests.txt`.
- Source scan transcript: `bundle://proof/SB19/transcripts/source-scan.txt`.
- Anti-stub audit transcript: `bundle://proof/SB19/transcripts/anti-stub.txt`.
