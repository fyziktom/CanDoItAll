...
- Expected behavior: The finalizer and failure closure proof gate remains module-local, typed, and validated by build, focused tests, route-order scan, and source scans.
