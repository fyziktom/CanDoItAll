...
- Expected behavior: The final red-team proof closure and next bundle cutline gate remains module-local, typed, and validated by build, focused tests, route-order scan, and source scans.
