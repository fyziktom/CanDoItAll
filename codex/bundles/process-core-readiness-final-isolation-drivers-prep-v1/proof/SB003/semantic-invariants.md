...
- Expected behavior: The baseline architecture guard gate remains module-local, typed, and validated by build, focused tests, route-order scan, and source scans.
