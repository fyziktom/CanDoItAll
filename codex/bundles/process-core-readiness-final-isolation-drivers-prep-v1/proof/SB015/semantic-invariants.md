...
- Expected behavior: The subprocess runtime and projection proof gate remains module-local, typed, and validated by build, focused tests, route-order scan, and source scans.
