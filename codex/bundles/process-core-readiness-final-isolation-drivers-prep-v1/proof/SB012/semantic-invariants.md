...
- Expected behavior: The pre-execution and start transition proof gate remains module-local, typed, and validated by build, focused tests, route-order scan, and source scans.
