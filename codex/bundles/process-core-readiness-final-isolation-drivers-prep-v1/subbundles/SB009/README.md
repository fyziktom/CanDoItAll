# SB009 - Gate C: hydration parity proof
...
Prove subprocess/workflow/direct-agent candidate creation parity, direct-agent binding diagnostics, and recovery selection behavior.

## Covered Inputs

- Raw user request in `inputs/raw-user-request.md`.
- Current-state analysis in `analysis/01-current-state-review.md`.
- Phase: P3 - Candidate hydration decomposition
...
7. If this is a critical gate, create `proof/SB009/manifest.md` and `proof/SB009/semantic-invariants.md`.
...
Implement SB009: Gate C: hydration parity proof. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
