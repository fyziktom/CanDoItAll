# SB012 - Gate D: pre-execution/start transition proof
...
Prove database requirement, materialization request, block transition, start transition reload, and route order parity.

## Covered Inputs

- Raw user request in `inputs/raw-user-request.md`.
- Current-state analysis in `analysis/01-current-state-review.md`.
- Phase: P4 - Pre-execution and transition services
...
7. If this is a critical gate, create `proof/SB012/manifest.md` and `proof/SB012/semantic-invariants.md`.
...
Implement SB012: Gate D: pre-execution/start transition proof. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
