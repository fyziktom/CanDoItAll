# SB010 - Pre-execution materialization service boundary
...
Move missing upstream artifact block/request orchestration into a service with explicit transition and journal dependencies.
...
7. If this is a critical gate, create `proof/SB010/manifest.md` and `proof/SB010/semantic-invariants.md`.
...
Implement SB010: Pre-execution materialization service boundary. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
