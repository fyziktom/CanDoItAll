...
Add/repair architecture tests and source scans: no Core, no driver API, no UI/mobile proof, route order preserved, no collapsed execution report rows.

## Covered Inputs

- Raw user request in `inputs/raw-user-request.md`.
- Current-state analysis in `analysis/01-current-state-review.md`.
- Phase: P1 - Baseline and guardrails
...
7. If this is a critical gate, create `proof/SB003/manifest.md` and `proof/SB003/semantic-invariants.md`.
...
Implement SB003: Gate A: baseline architecture guard. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
