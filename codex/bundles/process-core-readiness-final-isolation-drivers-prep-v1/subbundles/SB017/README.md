# SB017 - Failure closure service boundary
...
Move generic failure transition, claim-lost, heartbeat-lost, run-closed and claim-held checks into a typed failure closure service.
...
7. If this is a critical gate, create `proof/SB017/manifest.md` and `proof/SB017/semantic-invariants.md`.
...
Implement SB017: Failure closure service boundary. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
