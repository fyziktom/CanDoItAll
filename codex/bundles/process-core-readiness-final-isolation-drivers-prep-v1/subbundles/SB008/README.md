# SB008 - Hydration direct-agent binding split
...
Move direct-agent binding, project-structure access mutation, manual recovery directive, and recovery execution selection into explicit collaborators with tests.
...
7. If this is a critical gate, create `proof/SB008/manifest.md` and `proof/SB008/semantic-invariants.md`.
...
Implement SB008: Hydration direct-agent binding split. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
