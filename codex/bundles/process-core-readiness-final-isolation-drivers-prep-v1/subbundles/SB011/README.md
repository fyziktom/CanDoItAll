# SB011 - Start transition and reload service boundary
...
Move start-transition and reload-after-start-failure behavior out of route handler service forwarding into a typed service.
...
7. If this is a critical gate, create `proof/SB011/manifest.md` and `proof/SB011/semantic-invariants.md`.
...
Implement SB011: Start transition and reload service boundary. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
