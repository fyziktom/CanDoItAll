# SB001 - Entry audit and proof repair
...
Review latest route-service/model bundle proof, fix malformed links or incomplete proof metadata, and establish current branch baseline.
...
7. If this is a critical gate, create `proof/SB001/manifest.md` and `proof/SB001/semantic-invariants.md`.
...
Implement SB001: Entry audit and proof repair. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
