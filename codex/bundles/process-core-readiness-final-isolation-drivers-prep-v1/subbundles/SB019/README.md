# SB019 - Static wrapper burn-down inventory and migration
...
Identify dispatcher static methods that only forward to extracted rule classes and move consumers to the rule classes directly.
...
7. If this is a critical gate, create `proof/SB019/manifest.md` and `proof/SB019/semantic-invariants.md`.
...
Implement SB019: Static wrapper burn-down inventory and migration. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
