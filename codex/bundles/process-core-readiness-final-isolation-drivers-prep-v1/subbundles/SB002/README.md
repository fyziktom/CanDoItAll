# SB002 - Hotspot line-count and adapter inventory
...
Capture line counts, adapter calls, dispatcher forwarding calls, nested model aliases, route handlers, hydration dependencies, and subprocess/finalizer dependencies.
...
7. If this is a critical gate, create `proof/SB002/manifest.md` and `proof/SB002/semantic-invariants.md`.
...
Implement SB002: Hotspot line-count and adapter inventory. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
