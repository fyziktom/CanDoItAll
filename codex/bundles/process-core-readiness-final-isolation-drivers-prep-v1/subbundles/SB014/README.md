# SB014 - Subprocess artifact projection persistence service
...
Split child artifact read, missing expectation selection, gap journal, parent projection write, and SaveChanges orchestration.
...
7. If this is a critical gate, create `proof/SB014/manifest.md` and `proof/SB014/semantic-invariants.md`.
...
Implement SB014: Subprocess artifact projection persistence service. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
