# SB018 - Gate F: finalizer/failure proof
...
Prove workflow, direct-agent, subprocess, recovery finalizer application and failure closure behavior.
...
7. If this is a critical gate, create `proof/SB018/manifest.md` and `proof/SB018/semantic-invariants.md`.
...
Implement SB018: Gate F: finalizer/failure proof. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
