# SB020 - Artifact validation residual pure-rule extraction
...
Move pure rule families still trapped behind dispatcher wrappers into module-local rule services; do not touch file/EF/storage code.
...
7. If this is a critical gate, create `proof/SB020/manifest.md` and `proof/SB020/semantic-invariants.md`.
...
Implement SB020: Artifact validation residual pure-rule extraction. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
