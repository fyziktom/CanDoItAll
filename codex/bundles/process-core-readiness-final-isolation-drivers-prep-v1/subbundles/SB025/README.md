# SB025 - Core readiness decision and extraction candidate list
...
Produce a current-state go/no-go matrix listing Core candidates, application-local owners, and blockers.
...
7. If this is a critical gate, create `proof/SB025/manifest.md` and `proof/SB025/semantic-invariants.md`.
...
Implement SB025: Core readiness decision and extraction candidate list. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
