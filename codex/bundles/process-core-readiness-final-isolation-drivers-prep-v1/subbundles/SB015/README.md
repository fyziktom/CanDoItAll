# SB015 - Gate E: subprocess runtime/projection proof
...
Prove child-run observation, capability-gap block, terminal mirror, completed projection, parent finalizer handoff, and journal behavior.
...
7. If this is a critical gate, create `proof/SB015/manifest.md` and `proof/SB015/semantic-invariants.md`.
...
Implement SB015: Gate E: subprocess runtime/projection proof. Preserve behavior, avoid Process Core and production driver APIs, update proof artifacts, and close the execution report row.
