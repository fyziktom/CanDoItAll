...
Update documentation-only map for browser evidence; no production driver API.
...
- architecture/driver-readiness-map.md
...
5. Capture command transcripts under bundle://proof/SB37/transcripts/ when the subbundle produces proof.
...
Implement SB37 only. Do not jump ahead. Preserve behavior and update proof before moving on.
