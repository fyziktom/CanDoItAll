...
Replace private dispatcher calls with explicit host methods or pure helper calls.
...
5. Capture command transcripts under bundle://proof/SB14/transcripts/ when the subbundle produces proof.
...
Implement SB14 only. Do not jump ahead. Preserve behavior and update proof before moving on.
