...
Run build plus focused tests across projection, artifact validation, execution/retry, observation and subprocess flows.
...
5. Capture command transcripts under bundle://proof/SB61/transcripts/ when the subbundle produces proof.
...
Implement SB61 only. Do not jump ahead. Preserve behavior and update proof before moving on.
