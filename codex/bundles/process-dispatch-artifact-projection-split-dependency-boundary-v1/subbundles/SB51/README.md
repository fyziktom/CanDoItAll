...
Reduce `ArtifactProjection.cs` to facade plus small compatibility wrappers; target under 220 lines.
...
5. Capture command transcripts under bundle://proof/SB51/transcripts/ when the subbundle produces proof.
...
Implement SB51 only. Do not jump ahead. Preserve behavior and update proof before moving on.
