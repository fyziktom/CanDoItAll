...
Verify file reads/logging remain explicit and not hidden in pure rules.
...
5. Capture command transcripts under bundle://proof/SB21/transcripts/ when the subbundle produces proof.
...
Implement SB21 only. Do not jump ahead. Preserve behavior and update proof before moving on.
