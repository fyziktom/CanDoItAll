...
Create explicit helper for projection file reads/copies if it keeps side effects visible.
...
- ProcessArtifactProjectionFileIO.cs
...
5. Capture command transcripts under bundle://proof/SB28/transcripts/ when the subbundle produces proof.
...
Implement SB28 only. Do not jump ahead. Preserve behavior and update proof before moving on.
