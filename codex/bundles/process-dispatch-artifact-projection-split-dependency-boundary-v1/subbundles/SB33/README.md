...
Split discovered-output projection path/copy/write logic while preserving matching and expectation recording.
...
- ProcessProviderNativeBrowserDiscoveredOutputProjection.cs

## Dependency Impact

- Phase G production movement or proof step. Downstream subbundles depend on behavior-preserving completion of this slice.
...
5. Capture command transcripts under bundle://proof/SB33/transcripts/ when the subbundle produces proof.
...
Implement SB33 only. Do not jump ahead. Preserve behavior and update proof before moving on.
