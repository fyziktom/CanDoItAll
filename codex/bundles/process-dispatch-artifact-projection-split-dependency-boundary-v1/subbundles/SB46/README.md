...
Move remaining nested helper types that belong to projection into top-level internal files.
...
5. Capture command transcripts under bundle://proof/SB46/transcripts/ when the subbundle produces proof.
...
Implement SB46 only. Do not jump ahead. Preserve behavior and update proof before moving on.
