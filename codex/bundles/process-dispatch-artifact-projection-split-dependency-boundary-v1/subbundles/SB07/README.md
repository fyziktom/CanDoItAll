...
Create internal `ProcessArtifactProjectionHost` or equivalent explicit dependency surface; no broad dispatcher object.
...
- ProcessArtifactProjectionHost.cs

## Dependency Impact

- Phase B production movement or proof step. Downstream subbundles depend on behavior-preserving completion of this slice.
...
5. Capture command transcripts under bundle://proof/SB07/transcripts/ when the subbundle produces proof.
...
Implement SB07 only. Do not jump ahead. Preserve behavior and update proof before moving on.
