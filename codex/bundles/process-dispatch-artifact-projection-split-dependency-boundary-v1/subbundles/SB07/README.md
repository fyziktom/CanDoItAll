...
This subbundle is part of Phase B: Context, host and candidate state boundary. Downstream subbundles depend on its proof. If this subbundle changes behavior or weakens boundaries, reopen it before continuing.
