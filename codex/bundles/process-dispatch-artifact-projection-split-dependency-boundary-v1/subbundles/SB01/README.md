...
Branch `maf-processes-refactor` checked out and latest branch state pulled.
...
This subbundle is part of Phase A: Baseline, inventory and guardrails. Downstream subbundles depend on its proof. If this subbundle changes behavior or weakens boundaries, reopen it before continuing.
