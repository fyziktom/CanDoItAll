...
Capture current branch SHA, previous bundle proof, line counts and exact source shape.
...
- Current branch state is readable and raw inputs are preserved under bundle://inputs/.
...
- inputs/branch-current-state.md
- inventories/source-hotspots.md

## Dependency Impact

- Phase A production movement or proof step. Downstream subbundles depend on behavior-preserving completion of this slice.
...
5. Capture command transcripts under bundle://proof/SB01/transcripts/ when the subbundle produces proof.
...
Implement SB01 only. Do not jump ahead. Preserve behavior and update proof before moving on.
