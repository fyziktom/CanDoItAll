...
Move response-text coordinator into top-level internal class.
...
5. Capture command transcripts under bundle://proof/SB25/transcripts/ when the subbundle produces proof.
...
Implement SB25 only. Do not jump ahead. Preserve behavior and update proof before moving on.
