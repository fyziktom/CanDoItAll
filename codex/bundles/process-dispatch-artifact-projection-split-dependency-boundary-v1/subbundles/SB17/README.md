...
Preserve throw vs log behavior, multiple-match behavior and scoped path behavior.
...
- process mock helper tests

## Dependency Impact

- Phase D production movement or proof step. Downstream subbundles depend on behavior-preserving completion of this slice.
...
5. Capture command transcripts under bundle://proof/SB17/transcripts/ when the subbundle produces proof.
...
Implement SB17 only. Do not jump ahead. Preserve behavior and update proof before moving on.
