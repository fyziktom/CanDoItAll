...
Add/verify expected output, discovered output, outside workspace and duplicate key tests.
...
5. Capture command transcripts under bundle://proof/SB36/transcripts/ when the subbundle produces proof.
...
Implement SB36 only. Do not jump ahead. Preserve behavior and update proof before moving on.
