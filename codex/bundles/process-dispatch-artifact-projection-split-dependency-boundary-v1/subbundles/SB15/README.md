...
Add/verify transient skip, missing file skip, matched expectation, storage kind and candidate state tests.
...
5. Capture command transcripts under bundle://proof/SB15/transcripts/ when the subbundle produces proof.
...
Implement SB15 only. Do not jump ahead. Preserve behavior and update proof before moving on.
