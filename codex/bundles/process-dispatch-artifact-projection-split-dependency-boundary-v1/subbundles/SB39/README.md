...
Move completed-decision record-only coordinator into top-level internal class.
...
5. Capture command transcripts under bundle://proof/SB39/transcripts/ when the subbundle produces proof.
...
Implement SB39 only. Do not jump ahead. Preserve behavior and update proof before moving on.
