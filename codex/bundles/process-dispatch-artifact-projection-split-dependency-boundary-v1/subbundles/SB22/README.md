...
Move existing-managed coordinator into top-level internal class.
...
Implement SB22 only. Do not jump ahead. Preserve behavior and update proof before moving on.
