...
Move `ArtifactProjectionCoordinatorContext` to a top-level internal module-local file with no nested dispatcher dependency.
...
5. Capture command transcripts under bundle://proof/SB05/transcripts/ when the subbundle produces proof.
...
Implement SB05 only. Do not jump ahead. Preserve behavior and update proof before moving on.
