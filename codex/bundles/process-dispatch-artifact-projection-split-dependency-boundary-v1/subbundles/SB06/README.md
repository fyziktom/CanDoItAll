...
Move `ProcessArtifactProjectionCandidateState` to a top-level internal helper with focused tests.
...
5. Capture command transcripts under bundle://proof/SB06/transcripts/ when the subbundle produces proof.
...
Implement SB06 only. Do not jump ahead. Preserve behavior and update proof before moving on.
