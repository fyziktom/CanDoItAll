...
Verify no source-family coordinator classes remain nested in dispatch partial.
...
5. Capture command transcripts under bundle://proof/SB48/transcripts/ when the subbundle produces proof.
...
Implement SB48 only. Do not jump ahead. Preserve behavior and update proof before moving on.
