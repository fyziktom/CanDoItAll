...
No TODO/stub/default returns in moved projection files; no UI/mobile proof artifacts.
...
Implement SB62 only. Do not jump ahead. Preserve behavior and update proof before moving on.
