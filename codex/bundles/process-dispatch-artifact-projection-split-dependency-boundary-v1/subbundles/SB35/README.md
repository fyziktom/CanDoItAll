...
Source scan proves `File.Copy` and directory creation are only in explicit browser/file IO components.
...
5. Capture command transcripts under bundle://proof/SB35/transcripts/ when the subbundle produces proof.
...
Implement SB35 only. Do not jump ahead. Preserve behavior and update proof before moving on.
