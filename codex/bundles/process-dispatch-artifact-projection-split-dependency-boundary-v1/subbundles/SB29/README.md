...
Centralize `ProcessArtifactProjectionWriteRequest` assembly without changing fields.
...
- ProcessArtifactProjectionWriteRequestBuilder.cs
...
5. Capture command transcripts under bundle://proof/SB29/transcripts/ when the subbundle produces proof.
...
Implement SB29 only. Do not jump ahead. Preserve behavior and update proof before moving on.
