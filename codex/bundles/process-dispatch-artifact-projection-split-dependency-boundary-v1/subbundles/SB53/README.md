...
No newly created projection coordinator file should exceed 450 lines unless justified in review.
...
5. Capture command transcripts under bundle://proof/SB53/transcripts/ when the subbundle produces proof.
...
Implement SB53 only. Do not jump ahead. Preserve behavior and update proof before moving on.
