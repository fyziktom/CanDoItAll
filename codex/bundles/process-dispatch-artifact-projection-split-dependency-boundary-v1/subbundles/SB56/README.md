# SB56 - Gate J - line count and regression proof
...
Build, unit, integration, source scans and line-count gates pass.
...
- proof/SB56/manifest.md

## Dependency Impact

- Phase J critical foundation. Downstream subbundles must stop if this gate fails or proof is weakened.
...
5. Capture command transcripts under bundle://proof/SB56/transcripts/ when the subbundle produces proof.
...
- Artifact-backed manifest at bundle://proof/SB56/manifest.md. - Semantic invariant contract at bundle://proof/SB56/semantic-invariants.md or .json. - Semantic Adequacy Gate: shallow-pass trap, adversarial negative proof, semantic positive proof, anti-stub audit, and raw-note literal closure.
...
- Do not proceed downstream until bundle://proof/SB56/manifest.md, semantic invariants, required transcripts, execution-report rows, and downstream dependency decision are complete.

## Suggested Agent Prompt

Implement SB56 only. Do not jump ahead. Preserve behavior and update proof before moving on.
