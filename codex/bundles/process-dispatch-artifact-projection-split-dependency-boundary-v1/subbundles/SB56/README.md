...
This subbundle is part of Phase J: Line-count, wrapper and compatibility cleanup. Downstream subbundles depend on its proof. If this subbundle changes behavior or weakens boundaries, reopen it before continuing.
