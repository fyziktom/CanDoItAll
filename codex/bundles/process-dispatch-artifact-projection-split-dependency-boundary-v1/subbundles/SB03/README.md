...
Map every private dispatcher method called by nested coordinators and classify it as pure, side-effectful or legacy wrapper.
...
- inventories/current-dependency-surface.md
...
5. Capture command transcripts under bundle://proof/SB03/transcripts/ when the subbundle produces proof.
...
Implement SB03 only. Do not jump ahead. Preserve behavior and update proof before moving on.
