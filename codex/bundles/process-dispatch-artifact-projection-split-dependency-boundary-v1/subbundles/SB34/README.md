...
Move/verify output directory preflight remains explicit and safe inside workspace.
...
- ProcessProviderNativeBrowserDirectoryPreflight.cs
...
5. Capture command transcripts under bundle://proof/SB34/transcripts/ when the subbundle produces proof.
...
Implement SB34 only. Do not jump ahead. Preserve behavior and update proof before moving on.
