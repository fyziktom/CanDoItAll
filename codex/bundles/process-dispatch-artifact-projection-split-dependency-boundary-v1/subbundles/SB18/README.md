# SB18 - Gate D - execution/process mock parity
...
- Phase D critical foundation. Downstream subbundles must stop if this gate fails or proof is weakened.
...
5. Capture command transcripts under bundle://proof/SB18/transcripts/ when the subbundle produces proof.
...
- Artifact-backed manifest at bundle://proof/SB18/manifest.md. - Semantic invariant contract at bundle://proof/SB18/semantic-invariants.md or .json. - Semantic Adequacy Gate: shallow-pass trap, adversarial negative proof, semantic positive proof, anti-stub audit, and raw-note literal closure.
...
- Do not proceed downstream until bundle://proof/SB18/manifest.md, semantic invariants, required transcripts, execution-report rows, and downstream dependency decision are complete.

## Suggested Agent Prompt

Implement SB18 only. Do not jump ahead. Preserve behavior and update proof before moving on.
