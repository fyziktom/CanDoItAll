...
Preserve response coordinator's reuse of existing-managed coordinator through explicit dependency, not nested private access.
...
Implement SB23 only. Do not jump ahead. Preserve behavior and update proof before moving on.
