# SB12 - Gate C - source family order proof
...
Source scan and tests prove exact source-family order and no UI/Core/driver drift.
...
- Phase C critical foundation. Downstream subbundles must stop if this gate fails or proof is weakened.
...
5. Capture command transcripts under bundle://proof/SB12/transcripts/ when the subbundle produces proof.
...
- Artifact-backed manifest at bundle://proof/SB12/manifest.md. - Semantic invariant contract at bundle://proof/SB12/semantic-invariants.md or .json. - Semantic Adequacy Gate: shallow-pass trap, adversarial negative proof, semantic positive proof, anti-stub audit, and raw-note literal closure.
...
- Do not proceed downstream until bundle://proof/SB12/manifest.md, semantic invariants, required transcripts, execution-report rows, and downstream dependency decision are complete.

## Suggested Agent Prompt

Implement SB12 only. Do not jump ahead. Preserve behavior and update proof before moving on.
