...
Keep governed path and heuristic matching branch order unchanged.
...
Implement SB20 only. Do not jump ahead. Preserve behavior and update proof before moving on.
