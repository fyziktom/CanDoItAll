...
Keep only necessary wrapper methods in `ArtifactProjection.cs`; mark every wrapper with owning consumer.
...
5. Capture command transcripts under bundle://proof/SB49/transcripts/ when the subbundle produces proof.
...
Implement SB49 only. Do not jump ahead. Preserve behavior and update proof before moving on.
