...
Every top-level coordinator dependency must be explicit in constructor/context/host.
...
5. Capture command transcripts under bundle://proof/SB47/transcripts/ when the subbundle produces proof.
...
Implement SB47 only. Do not jump ahead. Preserve behavior and update proof before moving on.
