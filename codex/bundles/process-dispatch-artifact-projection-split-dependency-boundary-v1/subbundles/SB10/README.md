...
Create `ProcessArtifactProjectionOrchestrator` preserving seven-family order.
...
5. Capture command transcripts under bundle://proof/SB10/transcripts/ when the subbundle produces proof.
...
Implement SB10 only. Do not jump ahead. Preserve behavior and update proof before moving on.
