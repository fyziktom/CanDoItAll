...
Verify all coordinator candidate mutations go through `ProcessArtifactProjectionCandidateState`.
...
5. Capture command transcripts under bundle://proof/SB41/transcripts/ when the subbundle produces proof.
...
Implement SB41 only. Do not jump ahead. Preserve behavior and update proof before moving on.
