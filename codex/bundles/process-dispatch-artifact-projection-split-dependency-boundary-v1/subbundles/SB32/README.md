...
Split expected-output projection path/copy/write logic while preserving browser tool mapping.
...
- ProcessProviderNativeBrowserExpectedOutputProjection.cs
...
5. Capture command transcripts under bundle://proof/SB32/transcripts/ when the subbundle produces proof.
...
Implement SB32 only. Do not jump ahead. Preserve behavior and update proof before moving on.
