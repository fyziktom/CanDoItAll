...
Run all projection-focused integration tests and record exact filters.
...
5. Capture command transcripts under bundle://proof/SB55/transcripts/ when the subbundle produces proof.
...
Implement SB55 only. Do not jump ahead. Preserve behavior and update proof before moving on.
