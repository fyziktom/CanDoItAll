...
`ProjectExecutionArtifactsAsync` delegates to orchestrator while keeping behavior unchanged.
...
- ArtifactProjection.cs slim facade
...
5. Capture command transcripts under bundle://proof/SB11/transcripts/ when the subbundle produces proof.
...
Implement SB11 only. Do not jump ahead. Preserve behavior and update proof before moving on.
