...
Delete the nested coordinator file or reduce to a documented compatibility shim under 80 lines.
...
- file deletion/shim proof

## Dependency Impact

- Phase J production movement or proof step. Downstream subbundles depend on behavior-preserving completion of this slice.
...
5. Capture command transcripts under bundle://proof/SB52/transcripts/ when the subbundle produces proof.
...
Implement SB52 only. Do not jump ahead. Preserve behavior and update proof before moving on.
