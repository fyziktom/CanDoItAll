# SB08 - Gate B - context/host parity
...
Prove context creation, candidate mutation and no broad dispatch-service dependency for moved components.
...
- Phase B critical foundation. Downstream subbundles must stop if this gate fails or proof is weakened.
...
5. Capture command transcripts under bundle://proof/SB08/transcripts/ when the subbundle produces proof.
...
- Artifact-backed manifest at bundle://proof/SB08/manifest.md. - Semantic invariant contract at bundle://proof/SB08/semantic-invariants.md or .json. - Semantic Adequacy Gate: shallow-pass trap, adversarial negative proof, semantic positive proof, anti-stub audit, and raw-note literal closure.
...
- Do not proceed downstream until bundle://proof/SB08/manifest.md, semantic invariants, required transcripts, execution-report rows, and downstream dependency decision are complete.

## Suggested Agent Prompt

Implement SB08 only. Do not jump ahead. Preserve behavior and update proof before moving on.
