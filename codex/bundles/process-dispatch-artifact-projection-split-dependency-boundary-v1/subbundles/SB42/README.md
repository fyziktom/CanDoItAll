...
Verify external reference key duplicate logic is unchanged across all families.
...
5. Capture command transcripts under bundle://proof/SB42/transcripts/ when the subbundle produces proof.
...
Implement SB42 only. Do not jump ahead. Preserve behavior and update proof before moving on.
