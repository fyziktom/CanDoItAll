...
Enumerate every projection family, helper, side effect, candidate mutation and test surface.
...
- inventories/projection-source-family-inventory.md
...
5. Capture command transcripts under bundle://proof/SB02/transcripts/ when the subbundle produces proof.
...
Implement SB02 only. Do not jump ahead. Preserve behavior and update proof before moving on.
