...
Introduce internal module-local source coordinator abstraction, if useful, with no public exposure and no driver vocabulary.
...
- IProcessArtifactProjectionSourceCoordinator.cs

## Dependency Impact

- Phase C production movement or proof step. Downstream subbundles depend on behavior-preserving completion of this slice.
...
5. Capture command transcripts under bundle://proof/SB09/transcripts/ when the subbundle produces proof.
...
Implement SB09 only. Do not jump ahead. Preserve behavior and update proof before moving on.
