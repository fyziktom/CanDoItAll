...
This subbundle is part of Phase C: Orchestrator skeleton and source-family order lock. Downstream subbundles depend on its proof. If this subbundle changes behavior or weakens boundaries, reopen it before continuing.
