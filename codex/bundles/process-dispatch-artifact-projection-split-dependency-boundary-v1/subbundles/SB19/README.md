...
Move workspace-written coordinator into a top-level internal class.
...
5. Capture command transcripts under bundle://proof/SB19/transcripts/ when the subbundle produces proof.
...
Implement SB19 only. Do not jump ahead. Preserve behavior and update proof before moving on.
