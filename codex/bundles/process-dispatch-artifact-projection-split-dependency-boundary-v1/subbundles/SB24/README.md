# SB24 - Gate E - workspace/existing parity
...
Focused tests and source scans prove workspace/existing families are top-level and behavior equivalent.
...
- proof/SB24/manifest.md

## Dependency Impact

- Phase E critical foundation. Downstream subbundles must stop if this gate fails or proof is weakened.
...
5. Capture command transcripts under bundle://proof/SB24/transcripts/ when the subbundle produces proof.
...
- Artifact-backed manifest at bundle://proof/SB24/manifest.md. - Semantic invariant contract at bundle://proof/SB24/semantic-invariants.md or .json. - Semantic Adequacy Gate: shallow-pass trap, adversarial negative proof, semantic positive proof, anti-stub audit, and raw-note literal closure.
...
- Do not proceed downstream until bundle://proof/SB24/manifest.md, semantic invariants, required transcripts, execution-report rows, and downstream dependency decision are complete.

## Suggested Agent Prompt

Implement SB24 only. Do not jump ahead. Preserve behavior and update proof before moving on.
