...
This subbundle is part of Phase E: Workspace-written and existing-managed coordinator split. Downstream subbundles depend on its proof. If this subbundle changes behavior or weakens boundaries, reopen it before continuing.
