...
Preserve declared path, fallback path, target write, existing target reuse and candidate mutation behavior.
...
5. Capture command transcripts under bundle://proof/SB26/transcripts/ when the subbundle produces proof.
...
Implement SB26 only. Do not jump ahead. Preserve behavior and update proof before moving on.
