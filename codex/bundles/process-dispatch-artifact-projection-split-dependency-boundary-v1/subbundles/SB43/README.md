...
Verify throw/log behavior matches previous behavior across source families.
...
5. Capture command transcripts under bundle://proof/SB43/transcripts/ when the subbundle produces proof.
...
Implement SB43 only. Do not jump ahead. Preserve behavior and update proof before moving on.
