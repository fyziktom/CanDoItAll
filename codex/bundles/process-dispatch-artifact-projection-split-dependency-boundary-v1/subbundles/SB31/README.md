...
Move provider-native browser coordinator into top-level internal class.
...
5. Capture command transcripts under bundle://proof/SB31/transcripts/ when the subbundle produces proof.
...
Implement SB31 only. Do not jump ahead. Preserve behavior and update proof before moving on.
