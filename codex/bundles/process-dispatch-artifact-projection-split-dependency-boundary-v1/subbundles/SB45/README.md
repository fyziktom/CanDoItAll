...
Remove `new Coordinator(this)` style usage from all projection coordinators.
...
- constructor dependency proof

## Dependency Impact

- Phase I production movement or proof step. Downstream subbundles depend on behavior-preserving completion of this slice.
...
5. Capture command transcripts under bundle://proof/SB45/transcripts/ when the subbundle produces proof.
...
Implement SB45 only. Do not jump ahead. Preserve behavior and update proof before moving on.
