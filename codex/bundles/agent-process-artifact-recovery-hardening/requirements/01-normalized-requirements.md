...
| REQ-013 | Technology guidance must live in explicitly scoped agents, skills, or tools, while reusable seed examples stay neutral. | 07 | Seed asset scans and reviewed seed-builder/normalizer changes. |
...
| REQ-015 | Globally seeded skills/resources must not embed one sample app, fixed project name, vendor fixture, or one-off task workflow as default guidance. | 08 | Seed asset scans, static regression test, and generic stale built-in inline skill retirement. |
