# Codex Prompt: 03 - Contract Validation, Repair, and Typed Execution Runner

You are implementing subbundle `03-contract-validation-repair-runner` of the CanDoItAll MAF stabilization work.
...
Implement validation as reusable runtime infrastructure, not as scattered one-off parsing. Keep prompt-only JSON insufficient for any machine-critical path.
...
```text
Subbundle: 03-contract-validation-repair-runner
