...
Final red-team and next cutline.
...
- Review helper boundaries, route parity, line counts, no stubs, no Process Core/driver API, and propose next seam.
...
- Transcript under `proof/SB16/transcripts/`.
- Source assertions under `proof/SB16/source-assertions/`.
- Semantic invariants under `proof/SB16/semantic-invariants.md`.
- Manifest under `proof/SB16/manifest.md`.
...
- Final closure requires SB16 closure gate, completed-stage bundle validation, and red-team proof.

## Suggested Agent Prompt

Implement SB16 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
