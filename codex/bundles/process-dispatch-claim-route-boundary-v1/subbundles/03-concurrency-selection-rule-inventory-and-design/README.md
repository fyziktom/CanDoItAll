# SB03 - Concurrency selection inventory and design
...
Concurrency selection inventory and design.
...
- Map Concurrency.cs methods into pure rule helpers versus async adapter/service calls.
...
- Transcript under `proof/SB03/transcripts/`.
- Source assertions under `proof/SB03/source-assertions/`.
...
- Do not start SB04 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB03 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
