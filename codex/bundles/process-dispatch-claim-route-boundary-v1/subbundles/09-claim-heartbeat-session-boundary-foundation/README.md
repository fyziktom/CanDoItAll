# SB09 - Claim/heartbeat session boundary
...
Claim/heartbeat session boundary.
...
Introduce module-local helper around in-memory guard, durable claim, heartbeat, lease renewal, and claim-lost surfacing.
...
- Transcript under `proof/SB09/transcripts/`.
- Source assertions under `proof/SB09/source-assertions/`.
...
Do not start SB10 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB09 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
