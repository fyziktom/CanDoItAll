...
Document dispatch route/evidence intent taxonomy for future helper drivers without production API.
...
- Transcript under `proof/SB14/transcripts/`.
- Source assertions under `proof/SB14/source-assertions/`.
...
Do not start SB15 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB14 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
