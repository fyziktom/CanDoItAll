# SB06 - Execution run selection helper foundation
...
Execution run selection helper foundation.
...
Extract pure blocking/stale/recoverable/current-attempt selection rules.
...
- Transcript under `proof/SB06/transcripts/`.
- Source assertions under `proof/SB06/source-assertions/`.
...
Do not start SB07 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB06 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
