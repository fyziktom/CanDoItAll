# SB15 - Runtime smoke and proof policy
...
Runtime smoke and proof policy.
...
Run full build, focused dispatch integration tests, unit architecture tests, no UI/mobile proof scans.
...
- Transcript under `proof/SB15/transcripts/`.
- Source assertions under `proof/SB15/source-assertions/`.
...
Do not start SB16 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB15 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
