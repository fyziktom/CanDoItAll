# SB10 - Start transition and fresh-skip planner
...
Start transition and fresh-skip planner.
...
- Extract start-transition request builder and fresh-recovery skip decision wrapper.
...
- Transcript under `proof/SB10/transcripts/`.
- Source assertions under `proof/SB10/source-assertions/`.
- Semantic invariants under `proof/SB10/semantic-invariants.md`.
- Manifest under `proof/SB10/manifest.md`.
...
- Do not start SB11 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB10 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
