# SB13 - Finalizer context factory
...
- Extract context construction for direct-agent and manager-recovery finalization; optional workflow/subprocess contexts if present.
...
- Transcript under `proof/SB13/transcripts/`.
- Source assertions under `proof/SB13/source-assertions/`.
...
- Do not start SB14 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB13 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
