# SB07 - Migrate concurrency wrappers
...
Keep existing wrapper names while delegating to the new selection helper and proving parity.
...
- Transcript under `proof/SB07/transcripts/`.
- Source assertions under `proof/SB07/source-assertions/`.
...
Do not start SB08 until this subbundle's closure gate passes.

## Suggested Agent Prompt

Implement SB07 of `process-dispatch-claim-route-boundary-v1`. Preserve behavior, record proof, and do not broaden scope.
