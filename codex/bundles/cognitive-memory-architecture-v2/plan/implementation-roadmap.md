...
## Phase 10.5: Interactive Memory Probing Workbench

Recommended placement: after recall traces, consolidation basics, MAF integration boundary, and human review UI; before or alongside full Epistemic Drive implementation.

Deliverables:

- probe session and turn records,
- manual probe question flow,
- recall-backed answers with trace/source/confidence,
- feedback/correction actions,
- correction evidence and review item creation,
- regression test creation from failed probes,
- probe evidence ingestion into Epistemic Drive,
- Dialogue Workbench UI,
- Docker context-separation probe fixture.

Exit criteria:

- user can ask memory a question and inspect why it answered,
- user correction creates evidence/review, not direct truth mutation,
- failed probe can become a replayable regression test,
- Epistemic Drive can consume probe evidence,
- browser proof exists for answer/trace/correction/regression flow.
