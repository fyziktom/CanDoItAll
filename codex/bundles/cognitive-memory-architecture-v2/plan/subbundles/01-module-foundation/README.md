# Subbundle 01-module-foundation

## Objective

Create the Cognitive Memory module, EF entities, configuration classes, repositories, and service registration. Do not implement advanced recall yet.
