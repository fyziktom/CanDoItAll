# Subbundle 05-recall-orchestrator

## Objective

Implement staged recall with lexical/vector/graph channels, activation scoring, context-pack generation, and recall trace persistence.
