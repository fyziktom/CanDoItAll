...
## Probe Evidence Consumption

Consolidation should consume probe evidence after normal source, staleness, contradiction, and activation processing. Probe evidence can:

- create or update knowledge gap records,
- create contradiction/supersession candidates,
- adjust confidence calibration records,
- enqueue human review items,
- refresh coverage maps,
- request new probing questions,
