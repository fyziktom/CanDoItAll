...
16. `plan/01-phase-plan.md`
17. `subbundles/*/README.md`
18. `validation/test-and-quality-plan.md`
...
10. `subbundles/13-interactive-memory-probing-workbench`
11. `subbundles/09-distributed-idle-compute`
12. `subbundles/10-cross-project-memory`
13. `subbundles/12-epistemic-drive-engine`
14. `subbundles/11-validation-and-architecture-closure`

Root validation closure remains named `11-validation-and-architecture-closure` for compatibility with the existing bundle. Run `13-interactive-memory-probing-workbench` immediately after recall/consolidation/MAF/review basics where possible. Then run distributed/cross-project extensions as needed, run `12-epistemic-drive-engine`, and finally close validation.
