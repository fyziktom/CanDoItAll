...
| 20-architecture-integration-closure | Ready | Not started | Checked | Must run before final validation closure | Confirms neuro patch integration, traceability, diagrams, phase order, and safety invariants. |
