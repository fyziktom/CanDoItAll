...
public enum SelfRegulationOutcomeKind
{
    ...
    ReviewDisagreed = 10,
    ReviewConfirmed = 11,
    ProfessorReviewDisagreed = 12,
    ProfessorReviewConfirmed = 13
}
...
public sealed record CalibrationAggregateRecord(
    ...
    double AbstentionFalsePositiveRate,
...
public sealed record SelfRegulationOutcomeRecord(
    ...
    IReadOnlyList<Guid> CreatedReplayJobIds,
    DateTimeOffset ObservedAtUtc,
    IReadOnlyDictionary<string, string> Metadata);
