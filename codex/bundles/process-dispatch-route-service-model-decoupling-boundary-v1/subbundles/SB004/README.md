# SB004 - Gate A: no-Core/no-driver/no-UI guardrails
...
Gate A: no-Core/no-driver/no-UI guardrails.
...
- [ ] Execution report contains a row for SB004.
...
- Critical manifest and semantic-invariants file for SB004.
