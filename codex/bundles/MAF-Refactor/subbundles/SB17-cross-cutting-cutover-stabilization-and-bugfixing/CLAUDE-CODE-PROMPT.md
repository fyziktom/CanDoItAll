# Claude Code execution prompt — SB17-cross-cutting-cutover-stabilization-and-bugfixing
...
<constraints>
- Work only on `SB17-cross-cutting-cutover-stabilization-and-bugfixing`.
