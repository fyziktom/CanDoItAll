...
Gate A: architecture guardrails before movement as part of Phase A: Entry audit, current-state proof and guardrails.
...
6. Record proof under `proof/SB04/`.
...
- `proof/SB04/semantic-invariants.md` for critical gates or production movement.
- `proof/SB04/transcripts/` with build/test/source-scan output.
