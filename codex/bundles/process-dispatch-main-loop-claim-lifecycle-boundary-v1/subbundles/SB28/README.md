...
Gate D: claim/heartbeat proof as part of Phase C: Claim coordinator and heartbeat lifecycle.
...
6. Record proof under `proof/SB28/`.
...
- [x] Execution report row for `SB28` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB28/manifest.md`
- `proof/SB28/semantic-invariants.md` for critical gates or production movement.
- `proof/SB28/transcripts/` with build/test/source-scan output.
...
Execute `SB28 - Gate D: claim/heartbeat proof` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
