# SB15 - Claim held/release parity tests
...
Claim held/release parity tests as part of Phase B: Claim lease policy and claim store foundation.
...
6. Record proof under `proof/SB15/`.
...
- [x] Execution report row for `SB15` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB15/manifest.md`
- `proof/SB15/semantic-invariants.md` for critical gates or production movement.
- `proof/SB15/transcripts/` with build/test/source-scan output.
...
Execute `SB15 - Claim held/release parity tests` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
