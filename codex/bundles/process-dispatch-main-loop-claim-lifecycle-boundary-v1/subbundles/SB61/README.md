...
Run-closed guard handler as part of Phase G: Direct-agent route and finalizer handoff.
...
6. Record proof under `proof/SB61/`.
...
- [x] Execution report row for `SB61` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB61/manifest.md`
- `proof/SB61/semantic-invariants.md` for critical gates or production movement.
- `proof/SB61/transcripts/` with build/test/source-scan output.
...
Execute `SB61 - Run-closed guard handler` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
