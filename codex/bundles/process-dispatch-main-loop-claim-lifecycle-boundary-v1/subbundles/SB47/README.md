# SB47 - Pre-execution red-team pass
...
Pre-execution red-team pass as part of Phase E: Pre-execution route handlers.
...
6. Record proof under `proof/SB47/`.
...
- [x] Execution report row for `SB47` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB47/manifest.md`
- `proof/SB47/semantic-invariants.md` for critical gates or production movement.
- `proof/SB47/transcripts/` with build/test/source-scan output.
...
Execute `SB47 - Pre-execution red-team pass` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
