...
Route source scan as part of Phase F: Start/workflow/subprocess route handlers.
...
6. Record proof under `proof/SB57/`.
...
- [x] Execution report row for `SB57` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB57/manifest.md`
- `proof/SB57/semantic-invariants.md` for critical gates or production movement.
- `proof/SB57/transcripts/` with build/test/source-scan output.
...
Execute `SB57 - Route source scan` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
