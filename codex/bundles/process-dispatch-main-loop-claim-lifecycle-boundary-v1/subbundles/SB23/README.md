# SB23 - Heartbeat claim-lost propagation tests
...
Heartbeat claim-lost propagation tests as part of Phase C: Claim coordinator and heartbeat lifecycle.
...
6. Record proof under `proof/SB23/`.
...
- [x] Execution report row for `SB23` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB23/manifest.md`
- `proof/SB23/semantic-invariants.md` for critical gates or production movement.
- `proof/SB23/transcripts/` with build/test/source-scan output.
...
Execute `SB23 - Heartbeat claim-lost propagation tests` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
