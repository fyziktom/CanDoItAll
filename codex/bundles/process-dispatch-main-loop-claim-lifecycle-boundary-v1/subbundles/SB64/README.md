# SB64 - Finalizer context preservation scan
...
Finalizer context preservation scan as part of Phase G: Direct-agent route and finalizer handoff.
...
6. Record proof under `proof/SB64/`.
...
- [x] Execution report row for `SB64` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB64/manifest.md`
- `proof/SB64/semantic-invariants.md` for critical gates or production movement.
- `proof/SB64/transcripts/` with build/test/source-scan output.
...
Execute `SB64 - Finalizer context preservation scan` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
