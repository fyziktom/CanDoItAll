# SB05 - Claim lifecycle behavior inventory
...
Claim lifecycle behavior inventory as part of Phase A: Entry audit, current-state proof and guardrails.
...
6. Record proof under `proof/SB05/`.
...
- [x] Execution report row for `SB05` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB05/manifest.md`
- `proof/SB05/semantic-invariants.md` for critical gates or production movement.
- `proof/SB05/transcripts/` with build/test/source-scan output.
...
Execute `SB05 - Claim lifecycle behavior inventory` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
