...
Renew callback isolation as part of Phase C: Claim coordinator and heartbeat lifecycle.
...
6. Record proof under `proof/SB22/`.
...
- [x] Execution report row for `SB22` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB22/manifest.md`
- `proof/SB22/semantic-invariants.md` for critical gates or production movement.
- `proof/SB22/transcripts/` with build/test/source-scan output.
...
Execute `SB22 - Renew callback isolation` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
