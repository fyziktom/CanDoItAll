# SB45 - Route side-effect naming scan
...
Route side-effect naming scan as part of Phase E: Pre-execution route handlers.
...
6. Record proof under `proof/SB45/`.
...
- [x] Execution report row for `SB45` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB45/manifest.md`
- `proof/SB45/semantic-invariants.md` for critical gates or production movement.
- `proof/SB45/transcripts/` with build/test/source-scan output.
...
Execute `SB45 - Route side-effect naming scan` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
