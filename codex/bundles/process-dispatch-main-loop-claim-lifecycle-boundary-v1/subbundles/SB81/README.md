...
Remove obsolete wrappers as part of Phase I: Main loop facade slimming and source hardening.
...
6. Record proof under `proof/SB81/`.
...
- [x] Execution report row for `SB81` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB81/manifest.md`
- `proof/SB81/semantic-invariants.md` for critical gates or production movement.
- `proof/SB81/transcripts/` with build/test/source-scan output.
...
Execute `SB81 - Remove obsolete wrappers` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
