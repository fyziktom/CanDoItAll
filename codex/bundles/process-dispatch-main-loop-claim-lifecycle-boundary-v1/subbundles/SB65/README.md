# SB65 - Direct route line-count review
...
Direct route line-count review as part of Phase G: Direct-agent route and finalizer handoff.
...
6. Record proof under `proof/SB65/`.
...
- [x] Execution report row for `SB65` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB65/manifest.md`
- `proof/SB65/semantic-invariants.md` for critical gates or production movement.
- `proof/SB65/transcripts/` with build/test/source-scan output.
...
Execute `SB65 - Direct route line-count review` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
