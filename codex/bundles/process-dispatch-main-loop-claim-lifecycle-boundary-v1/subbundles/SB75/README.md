# SB75 - Exception logging parity tests
...
Exception logging parity tests as part of Phase H: Exception closure and failure transition boundary.
...
6. Record proof under `proof/SB75/`.
...
- [x] Execution report row for `SB75` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB75/manifest.md`
- `proof/SB75/semantic-invariants.md` for critical gates or production movement.
- `proof/SB75/transcripts/` with build/test/source-scan output.
...
Execute `SB75 - Exception logging parity tests` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
