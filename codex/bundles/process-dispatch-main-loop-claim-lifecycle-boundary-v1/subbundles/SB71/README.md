# SB71 - Heartbeat-lost exception handler extraction
...
Heartbeat-lost exception handler extraction as part of Phase H: Exception closure and failure transition boundary.
...
6. Record proof under `proof/SB71/`.
...
- [x] Execution report row for `SB71` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB71/manifest.md`
- `proof/SB71/semantic-invariants.md` for critical gates or production movement.
- `proof/SB71/transcripts/` with build/test/source-scan output.
...
Execute `SB71 - Heartbeat-lost exception handler extraction` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
