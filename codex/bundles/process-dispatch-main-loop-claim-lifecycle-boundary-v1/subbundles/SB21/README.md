# SB21 - Heartbeat coordinator context
...
Heartbeat coordinator context as part of Phase C: Claim coordinator and heartbeat lifecycle.
...
6. Record proof under `proof/SB21/`.
...
- `proof/SB21/semantic-invariants.md` for critical gates or production movement.
- `proof/SB21/transcripts/` with build/test/source-scan output.
