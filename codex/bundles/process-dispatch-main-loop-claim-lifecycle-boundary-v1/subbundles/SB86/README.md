# SB86 - Full solution build and focused smoke
...
Full solution build and focused smoke as part of Phase I: Main loop facade slimming and source hardening.
...
6. Record proof under `proof/SB86/`.
...
- [x] Execution report row for `SB86` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB86/manifest.md`
- `proof/SB86/semantic-invariants.md` for critical gates or production movement.
- `proof/SB86/transcripts/` with build/test/source-scan output.
...
Execute `SB86 - Full solution build and focused smoke` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
