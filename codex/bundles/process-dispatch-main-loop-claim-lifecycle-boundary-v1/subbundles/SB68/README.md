...
Gate H: direct route proof as part of Phase G: Direct-agent route and finalizer handoff.
...
6. Record proof under `proof/SB68/`.
...
- [x] Execution report row for `SB68` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB68/manifest.md`
- `proof/SB68/semantic-invariants.md` for critical gates or production movement.
- `proof/SB68/transcripts/` with build/test/source-scan output.
...
Execute `SB68 - Gate H: direct route proof` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
