...
Claim coordinator facade as part of Phase C: Claim coordinator and heartbeat lifecycle.
...
6. Record proof under `proof/SB19/`.
...
- [x] Execution report row for `SB19` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB19/manifest.md`
- `proof/SB19/semantic-invariants.md` for critical gates or production movement.
- `proof/SB19/transcripts/` with build/test/source-scan output.
...
Execute `SB19 - Claim coordinator facade` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
