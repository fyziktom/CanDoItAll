# SB72 - Hydration-failure exception path extraction
...
Hydration-failure exception path extraction as part of Phase H: Exception closure and failure transition boundary.
...
6. Record proof under `proof/SB72/`.
...
- [x] Execution report row for `SB72` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB72/manifest.md`
- `proof/SB72/semantic-invariants.md` for critical gates or production movement.
- `proof/SB72/transcripts/` with build/test/source-scan output.
...
Execute `SB72 - Hydration-failure exception path extraction` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
