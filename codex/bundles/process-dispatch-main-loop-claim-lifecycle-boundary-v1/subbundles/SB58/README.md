...
Gate G: subprocess/workflow/start proof as part of Phase F: Start/workflow/subprocess route handlers.
...
6. Record proof under `proof/SB58/`.
...
- [x] Execution report row for `SB58` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB58/manifest.md`
- `proof/SB58/semantic-invariants.md` for critical gates or production movement.
- `proof/SB58/transcripts/` with build/test/source-scan output.
...
Execute `SB58 - Gate G: subprocess/workflow/start proof` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
