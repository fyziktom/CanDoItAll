# SB74 - Failure transition coordinator
...
Failure transition coordinator as part of Phase H: Exception closure and failure transition boundary.
...
6. Record proof under `proof/SB74/`.
...
- [x] Execution report row for `SB74` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB74/manifest.md`
- `proof/SB74/semantic-invariants.md` for critical gates or production movement.
- `proof/SB74/transcripts/` with build/test/source-scan output.
...
Execute `SB74 - Failure transition coordinator` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
