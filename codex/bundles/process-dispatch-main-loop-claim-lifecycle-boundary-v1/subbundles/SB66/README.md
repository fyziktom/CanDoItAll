# SB66 - Execution/finalizer integration smoke
...
Execution/finalizer integration smoke as part of Phase G: Direct-agent route and finalizer handoff.
...
6. Record proof under `proof/SB66/`.
...
- [x] Execution report row for `SB66` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB66/manifest.md`
- `proof/SB66/semantic-invariants.md` for critical gates or production movement.
- `proof/SB66/transcripts/` with build/test/source-scan output.
...
Execute `SB66 - Execution/finalizer integration smoke` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
