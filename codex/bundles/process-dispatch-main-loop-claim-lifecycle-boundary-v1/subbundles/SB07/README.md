# SB07 - Test matrix design and fixture audit
...
Test matrix design and fixture audit as part of Phase A: Entry audit, current-state proof and guardrails.
...
6. Record proof under `proof/SB07/`.
...
- [x] Execution report row for `SB07` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB07/manifest.md`
- `proof/SB07/semantic-invariants.md` for critical gates or production movement.
- `proof/SB07/transcripts/` with build/test/source-scan output.
...
Execute `SB07 - Test matrix design and fixture audit` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
