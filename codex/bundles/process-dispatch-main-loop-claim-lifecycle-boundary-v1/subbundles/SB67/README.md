# SB67 - Direct route red-team pass
...
Direct route red-team pass as part of Phase G: Direct-agent route and finalizer handoff.
...
6. Record proof under `proof/SB67/`.
...
- [x] Execution report row for `SB67` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB67/manifest.md`
- `proof/SB67/semantic-invariants.md` for critical gates or production movement.
- `proof/SB67/transcripts/` with build/test/source-scan output.
...
Execute `SB67 - Direct route red-team pass` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
