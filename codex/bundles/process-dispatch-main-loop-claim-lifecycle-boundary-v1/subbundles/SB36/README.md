# SB36 - Route gate integration smoke
...
Route gate integration smoke as part of Phase D: Dispatch route context and route-order contracts.
...
6. Record proof under `proof/SB36/`.
...
- [x] Execution report row for `SB36` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB36/manifest.md`
- `proof/SB36/semantic-invariants.md` for critical gates or production movement.
- `proof/SB36/transcripts/` with build/test/source-scan output.
...
Execute `SB36 - Route gate integration smoke` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
