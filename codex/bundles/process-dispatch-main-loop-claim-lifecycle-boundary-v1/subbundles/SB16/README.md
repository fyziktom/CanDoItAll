...
Gate C: claim store proof as part of Phase B: Claim lease policy and claim store foundation.
...
6. Record proof under `proof/SB16/`.
...
- [x] Execution report row for `SB16` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB16/manifest.md`
- `proof/SB16/semantic-invariants.md` for critical gates or production movement.
- `proof/SB16/transcripts/` with build/test/source-scan output.
...
Execute `SB16 - Gate C: claim store proof` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
