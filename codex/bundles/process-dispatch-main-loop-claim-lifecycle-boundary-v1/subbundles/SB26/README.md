...
Claim lease source scan as part of Phase C: Claim coordinator and heartbeat lifecycle.
...
6. Record proof under `proof/SB26/`.
...
- [x] Execution report row for `SB26` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB26/manifest.md`
- `proof/SB26/semantic-invariants.md` for critical gates or production movement.
- `proof/SB26/transcripts/` with build/test/source-scan output.
...
Execute `SB26 - Claim lease source scan` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
