# SB13 - Claim acquisition parity tests
...
Claim acquisition parity tests as part of Phase B: Claim lease policy and claim store foundation.
...
6. Record proof under `proof/SB13/`.
...
- [x] Execution report row for `SB13` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB13/manifest.md`
- `proof/SB13/semantic-invariants.md` for critical gates or production movement.
- `proof/SB13/transcripts/` with build/test/source-scan output.
...
Execute `SB13 - Claim acquisition parity tests` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
