# SB27 - Line-count review after claim movement
...
Line-count review after claim movement as part of Phase C: Claim coordinator and heartbeat lifecycle.
...
6. Record proof under `proof/SB27/`.
...
- [x] Execution report row for `SB27` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB27/manifest.md`
- `proof/SB27/semantic-invariants.md` for critical gates or production movement.
- `proof/SB27/transcripts/` with build/test/source-scan output.
...
Execute `SB27 - Line-count review after claim movement` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
