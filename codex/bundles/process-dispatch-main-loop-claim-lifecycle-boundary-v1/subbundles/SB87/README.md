# SB87 - Final dispatch-loop red-team
...
Final dispatch-loop red-team as part of Phase I: Main loop facade slimming and source hardening.
...
6. Record proof under `proof/SB87/`.
...
- [x] Execution report row for `SB87` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB87/manifest.md`
- `proof/SB87/semantic-invariants.md` for critical gates or production movement.
- `proof/SB87/transcripts/` with build/test/source-scan output.
...
Execute `SB87 - Final dispatch-loop red-team` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
