...
Route order unit tests as part of Phase D: Dispatch route context and route-order contracts.
...
6. Record proof under `proof/SB33/`.
...
- [x] Execution report row for `SB33` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB33/manifest.md`
- `proof/SB33/semantic-invariants.md` for critical gates or production movement.
- `proof/SB33/transcripts/` with build/test/source-scan output.
...
Execute `SB33 - Route order unit tests` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
