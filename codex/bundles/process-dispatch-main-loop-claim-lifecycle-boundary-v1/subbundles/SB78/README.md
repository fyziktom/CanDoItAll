...
Gate I: exception closure proof as part of Phase H: Exception closure and failure transition boundary.
...
6. Record proof under `proof/SB78/`.
...
- [x] Execution report row for `SB78` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB78/manifest.md`
- `proof/SB78/semantic-invariants.md` for critical gates or production movement.
- `proof/SB78/transcripts/` with build/test/source-scan output.
...
Execute `SB78 - Gate I: exception closure proof` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
