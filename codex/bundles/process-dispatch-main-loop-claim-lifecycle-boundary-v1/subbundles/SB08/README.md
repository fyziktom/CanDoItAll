...
Gate B: baseline proof and reopen triggers as part of Phase A: Entry audit, current-state proof and guardrails.
...
6. Record proof under `proof/SB08/`.
...
- [x] Execution report row for `SB08` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB08/manifest.md`
- `proof/SB08/semantic-invariants.md` for critical gates or production movement.
- `proof/SB08/transcripts/` with build/test/source-scan output.
...
Execute `SB08 - Gate B: baseline proof and reopen triggers` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
