# SB09 - Claim lease option snapshot
...
Claim lease option snapshot as part of Phase B: Claim lease policy and claim store foundation.
...
6. Record proof under `proof/SB09/`.
...
- [x] Execution report row for `SB09` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB09/manifest.md`
- `proof/SB09/semantic-invariants.md` for critical gates or production movement.
- `proof/SB09/transcripts/` with build/test/source-scan output.
...
Execute `SB09 - Claim lease option snapshot` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
