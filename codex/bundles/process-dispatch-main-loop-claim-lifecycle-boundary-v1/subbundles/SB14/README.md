...
Claim renew parity tests as part of Phase B: Claim lease policy and claim store foundation.
...
6. Record proof under `proof/SB14/`.
...
- [x] Execution report row for `SB14` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB14/manifest.md`
- `proof/SB14/semantic-invariants.md` for critical gates or production movement.
- `proof/SB14/transcripts/` with build/test/source-scan output.
...
Execute `SB14 - Claim renew parity tests` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
