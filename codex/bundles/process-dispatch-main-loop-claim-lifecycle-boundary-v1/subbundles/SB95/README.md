# SB95 - Manager/architect/QA self-review
...
Manager/architect/QA self-review as part of Phase J: Driver-readiness docs, smoke matrix and final red-team closure.
...
6. Record proof under `proof/SB95/`.
...
- [x] Execution report row for `SB95` is updated.
- [x] Critical gate proof exists if this is a gate.

## Proof Required

- `proof/SB95/manifest.md`
- `proof/SB95/semantic-invariants.md` for critical gates or production movement.
- `proof/SB95/transcripts/` with build/test/source-scan output.
...
Execute `SB95 - Manager/architect/QA self-review` only. Preserve current behavior. Do not start Process Core or driver APIs. Update proof and execution report before proceeding.
