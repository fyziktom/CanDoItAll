# SB13 - Runtime smoke and large-screen proof policy check
...
- Updated proof manifest under `proof/SB13`.
- Updated execution report row.

## Dependency Impact

- Downstream dependency: SB14. If this subbundle changes semantics or cannot prove parity, downstream work must stop and reopen this subbundle.
...
Browser proof remains N/A unless UI changed.
...
- [x] SB13 closure criteria satisfied where applicable.
...
- SB13 closure: pass all focused proof for this subbundle before moving to SB14.

## Suggested Agent Prompt

Implement SB13 only. Keep changes small, preserve validation behavior, and record proof before proceeding.
