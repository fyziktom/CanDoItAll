# SB04 - Refactor Gate A: guardrails and failing-first tests
...
- Updated proof manifest under `proof/SB04`.
...
Implement SB04 only. Keep changes small, preserve validation behavior, and record proof before proceeding.
