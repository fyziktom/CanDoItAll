# SB07 - Title, slug, and text-content matching extraction
...
- Updated proof manifest under `proof/SB07`.
- Updated execution report row.

## Dependency Impact

- Downstream dependency: SB08. If this subbundle changes semantics or cannot prove parity, downstream work must stop and reopen this subbundle.
...
Preserve matching order exactly.
...
- [x] SB07 closure criteria satisfied where applicable.
...
- SB07 closure: pass all focused proof for this subbundle before moving to SB08.

## Suggested Agent Prompt

Implement SB07 only. Keep changes small, preserve validation behavior, and record proof before proceeding.
