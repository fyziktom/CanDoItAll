# SB03 - Validation snapshot and rule seam design
...
- Updated proof manifest under `proof/SB03`.
- Updated execution report row.

## Dependency Impact

- Downstream dependency: SB04. If this subbundle changes semantics or cannot prove parity, downstream work must stop and reopen this subbundle.
...
No broad code movement; design plus tests only if possible.
...
- [x] SB03 closure criteria satisfied where applicable.
...
- SB03 closure: pass all focused proof for this subbundle before moving to SB04.

## Suggested Agent Prompt

Implement SB03 only. Keep changes small, preserve validation behavior, and record proof before proceeding.
