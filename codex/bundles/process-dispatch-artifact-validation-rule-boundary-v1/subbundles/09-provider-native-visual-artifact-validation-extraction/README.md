# SB09 - Provider-native visual artifact validation extraction
...
- Updated proof manifest under `proof/SB09`.
...
Keep expected/discovered projection modes unchanged.
...
Implement SB09 only. Keep changes small, preserve validation behavior, and record proof before proceeding.
