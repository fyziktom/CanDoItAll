...
Rozděl je do jednotlivých fází, aby codex mohl pracovat déle. Nyní to měl hotové rychle (za 30minut) a jsou to celkem malé změny. Naplánuj jich více ať může pracovat alespoň pár hodin. Nicméně je potřeba vynucovat co několik subbndlů ještě další refaktoring. díky tomu je možné naplánovat více kroků.
