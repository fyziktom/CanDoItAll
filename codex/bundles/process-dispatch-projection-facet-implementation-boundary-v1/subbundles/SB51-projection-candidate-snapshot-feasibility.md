# SB51 - Projection candidate snapshot feasibility
...
Evaluate read-only candidate snapshot feasibility for projection coordinators.
...
ProcessArtifactProjectionContext.cs; DispatchCandidate usages
...
5. Record proof under `proof/SB51/` during implementation.
...
Implement SB51 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
