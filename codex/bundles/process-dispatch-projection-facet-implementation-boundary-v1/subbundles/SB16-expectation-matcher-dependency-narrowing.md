# SB16 - Expectation matcher dependency narrowing
...
Ensure matcher facet does not also own file IO, session observation, or candidate mutation.
...
ProcessArtifactProjectionFacets.cs; projection coordinators

## Deliverables

Narrowed matcher usage.
...
Source scan rejects matcher using File/Directory/RecordArtifact.
...
5. Record proof under `proof/SB16/` during implementation.
...
Implement SB16 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
