# SB22 - Extract response-text rules facet
...
Move response-text projection rules into a focused implementation.
...
ProcessResponseTextArtifactSatisfactionRules.cs; ProcessRunAutomationDispatchService.ArtifactProjectionServices.cs

## Deliverables

Response-text rules implementation.
...
Tests for declared/fallback response-text artifact path and content eligibility.
...
5. Record proof under `proof/SB22/` during implementation.
...
Implement SB22 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
