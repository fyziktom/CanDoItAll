# SB26 - Extract lineage factory facet
...
Move projection lineage factory implementation into focused module-local class.
...
- Lineage factory implementation.
## Dependency Impact
...
- Lineage identity and recovery lineage tests pass.
...
5. Record proof under `proof/SB26/` during implementation.
...
Implement SB26 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
