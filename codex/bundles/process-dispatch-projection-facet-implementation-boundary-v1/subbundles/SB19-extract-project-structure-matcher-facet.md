# SB19 - Extract project-structure matcher facet
...
Move governed project-structure path matching facade into focused implementation.
...
ProcessProjectStructureArtifactPathRules.cs; ProcessRunAutomationDispatchService.ArtifactProjectionServices.cs

## Deliverables

Project-structure matcher implementation.
...
Tests for governed expected artifact path and path matching.
...
5. Record proof under `proof/SB19/` during implementation.
...
Implement SB19 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
