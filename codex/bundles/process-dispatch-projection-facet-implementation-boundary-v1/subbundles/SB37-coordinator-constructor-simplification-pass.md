# SB37 - Coordinator constructor simplification pass
...
Remove redundant facet parameters or composite dependencies from coordinators.
...
all projection source coordinators

## Deliverables

Constructor signatures reduced to exact dependencies.
...
5. Record proof under `proof/SB37/` during implementation.
...
Implement SB37 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
