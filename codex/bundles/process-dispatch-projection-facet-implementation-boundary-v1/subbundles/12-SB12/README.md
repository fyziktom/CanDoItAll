...
Validate claim/path split and prove projection source coordinators still run in same order.
...
- Build + integration projection tests + no broad host scan.
...
5. Record proof under `proof/SB12/` during implementation.
...
- Critical proof manifest: bundle://proof/SB12/manifest.md.
...
Implement SB12 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
