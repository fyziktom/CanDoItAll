...
Review if next step should still avoid Process Core.
...
- bundle://reviews/02-architect-self-review.md
## Deliverables
...
- Must make explicit recommendation.
...
5. Record proof under `proof/SB77/` during implementation.
...
Implement SB77 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
