# SB59 - Architecture test: no dispatcher injection into coordinators
...
Reject `ProcessRunAutomationDispatchService` constructor parameters in projection source coordinators.
...
5. Record proof under `proof/SB59/` during implementation.
...
Implement SB59 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
