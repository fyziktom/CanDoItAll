...
Run red-team against shallow implementation risks.
...
- bundle://reviews/03-final-red-team-review.md
## Deliverables
...
5. Record proof under `proof/SB78/` during implementation.
...
Implement SB78 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
