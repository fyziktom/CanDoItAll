# SB17 - Extract process mock projection rules facet
...
Move process-mock artifact projection lookup/matching into a focused implementation.
...
ProcessRunAutomationDispatchService.ImplementationProofBridges.cs; ProcessRunAutomationDispatchService.ArtifactProjectionServices.cs

## Deliverables

Process mock rules facet implementation.
...
Process mock projection tests pass.
...
5. Record proof under `proof/SB17/` during implementation.
...
Implement SB17 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
