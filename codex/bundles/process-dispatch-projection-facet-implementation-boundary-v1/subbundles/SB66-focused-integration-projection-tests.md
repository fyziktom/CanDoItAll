# SB66 - Focused integration projection tests
...
Run focused projection integration tests and record transcript.
...
5. Record proof under `proof/SB66/` during implementation.
...
Implement SB66 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
