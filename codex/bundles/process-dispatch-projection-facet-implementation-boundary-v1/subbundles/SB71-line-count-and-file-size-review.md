# SB71 - Line-count and file-size review
...
Record line counts for projection files and top dispatcher partials.
...
Any large file above target documented.
...
5. Record proof under `proof/SB71/` during implementation.
...
Implement SB71 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
