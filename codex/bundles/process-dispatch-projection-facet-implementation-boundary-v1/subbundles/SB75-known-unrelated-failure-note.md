# SB75 - Known unrelated failure note
...
Document unrelated test failures if broad suites fail due to historical fixtures.
...
reviews/04-known-unrelated-failures.md

## Deliverables

Known failure note or N/A.
...
Must not hide bundle-specific failure.
...
5. Record proof under `proof/SB75/` during implementation.
...
Implement SB75 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
