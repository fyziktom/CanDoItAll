...
Final closure gate for SB01-SB84.
...
- Completed validator + red-team + build/test proof.
...
5. Record proof under `proof/SB84/` during implementation.
...
- Critical proof manifest: bundle://proof/SB84/manifest.md.
- Semantic invariant contract: bundle://proof/SB84/semantic-invariants.md.
...
Implement SB84 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
