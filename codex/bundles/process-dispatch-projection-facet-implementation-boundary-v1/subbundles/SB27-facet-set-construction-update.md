# SB27 - Facet set construction update
...
Construct `ProcessArtifactProjectionFacetSet` from focused implementations instead of all-facet implementation.
...
ProcessArtifactProjectionOrchestrator.cs; ProcessRunAutomationDispatchService.ArtifactProjection.cs

## Deliverables

Facet-set factory wiring.
...
Build and projection tests pass.
...
5. Record proof under `proof/SB27/` during implementation.
...
Implement SB27 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
