# SB36 - Gate G: all coordinator dependency proof
...
Validate all source coordinators against exact facet-consumption matrix.
...
- Unit architecture tests for no coordinator over-dependency.
...
5. Record proof under `proof/SB36/` during implementation.
...
- Critical proof manifest: bundle://proof/SB36/manifest.md.
...
Implement SB36 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
