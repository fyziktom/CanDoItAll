# SB80 - Gate R: red-team and manager proof
...
Validate reviews before completed validator.
...
5. Record proof under `proof/SB80/` during implementation.
...
- Critical proof manifest: bundle://proof/SB80/manifest.md.
- Semantic invariant contract: bundle://proof/SB80/semantic-invariants.md.
...
Implement SB80 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
