# SB72 - Gate P: final source hardening
...
Validate source scans and line count review.
...
5. Record proof under `proof/SB72/` during implementation.
...
- Critical proof manifest: bundle://proof/SB72/manifest.md.
- Semantic invariant contract: bundle://proof/SB72/semantic-invariants.md.
...
Implement SB72 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
