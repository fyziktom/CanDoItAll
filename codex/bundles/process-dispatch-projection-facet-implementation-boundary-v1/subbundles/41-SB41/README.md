# SB41 - All-facet implementation removal plan
...
Identify remaining all-facet implementation or temporary service shim.
...
5. Record proof under `proof/SB41/` during implementation.
...
Implement SB41 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
