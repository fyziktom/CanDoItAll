# SB21 - Session observation dependency cleanup
...
Remove duplicate or stale session parsing calls from projection services implementation.
...
- repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessAutomationObservationSnapshot.cs
## Deliverables

- Clean session observation call sites.
## Dependency Impact
...
- No behavior change; source scan for old duplicate wrappers.
...
5. Record proof under `proof/SB21/` during implementation.
...
Implement SB21 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
