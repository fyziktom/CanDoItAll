# SB10 - Extract path resolver facet implementation
...
Move path resolution wrappers into a top-level path resolver implementation, using existing static helpers only where needed.
...
src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactProjectionServices.cs; src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactProjection.cs
...
Focused tests for workspace safety and expected managed paths.
...
5. Record proof under `proof/SB10/` during implementation.
...
Implement SB10 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
