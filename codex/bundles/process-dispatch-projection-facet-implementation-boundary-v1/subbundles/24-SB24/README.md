# SB24 - Gate E: project/session/response/browser proof
...
Validate specialized facets before decision and lineage movement.
...
- Build + focused tests + no all-facet class scan.
...
5. Record proof under `proof/SB24/` during implementation.
...
- Critical proof manifest: bundle://proof/SB24/manifest.md.
...
Implement SB24 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
