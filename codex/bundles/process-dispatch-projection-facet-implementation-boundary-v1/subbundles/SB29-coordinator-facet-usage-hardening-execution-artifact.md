# SB29 - Coordinator facet usage hardening: execution artifact
...
Confirm execution artifact coordinator consumes only the facets it needs and no dispatcher service or broad host.
...
src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessExecutionArtifactProjectionCoordinator.cs
...
5. Record proof under `proof/SB29/` during implementation.
...
Implement SB29 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
