# SB60 - Gate M: projection architecture tests
...
Validate projection-specific guardrails.
...
5. Record proof under `proof/SB60/` during implementation.
...
- Critical proof manifest: bundle://proof/SB60/manifest.md.
- Semantic invariant contract: bundle://proof/SB60/semantic-invariants.md.
...
Implement SB60 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
