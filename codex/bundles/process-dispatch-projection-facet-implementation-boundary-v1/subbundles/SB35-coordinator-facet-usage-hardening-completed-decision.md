# SB35 - Coordinator facet usage hardening: completed decision
...
Confirm completed decision coordinator consumes only the facets it needs and no dispatcher service or broad host.
...
src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessCompletedDecisionArtifactCoordinator.cs
...
5. Record proof under `proof/SB35/` during implementation.
...
Implement SB35 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
