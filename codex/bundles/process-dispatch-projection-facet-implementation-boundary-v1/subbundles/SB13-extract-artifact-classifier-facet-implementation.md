# SB13 - Extract artifact classifier facet implementation
...
Move artifact kind, storage kind, content type, transient detection, storage path, text decode wrappers behind a focused classifier implementation.
...
ProcessArtifactKindClassificationRules.cs; ProcessStorageContentKindRules.cs; ProcessRunAutomationDispatchService.ArtifactProjectionServices.cs
...
Unit tests around content type/kind/storage classification.
...
5. Record proof under `proof/SB13/` during implementation.
...
Implement SB13 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
