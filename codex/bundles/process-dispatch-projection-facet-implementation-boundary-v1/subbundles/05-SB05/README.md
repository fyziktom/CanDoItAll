# SB05 - Create projection facet service factory cutline
...
Define how dispatcher facade creates a facet set from small implementations without using a single all-facet class.
...
- Design note and initial factory skeleton if needed.
## Dependency Impact
...
- Build must pass; no behavior routing changed.
...
5. Record proof under `proof/SB05/` during implementation.
...
Implement SB05 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
