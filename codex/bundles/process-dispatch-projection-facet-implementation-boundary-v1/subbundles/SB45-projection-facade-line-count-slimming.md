# SB45 - Projection facade line-count slimming
...
Reduce `ArtifactProjection.cs` to facade plus unavoidable local helpers; no functional changes.
...
Line count target: ideally under 330 lines or documented exception.
...
5. Record proof under `proof/SB45/` during implementation.
...
Implement SB45 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
