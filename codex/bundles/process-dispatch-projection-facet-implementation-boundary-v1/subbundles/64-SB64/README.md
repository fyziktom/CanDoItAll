# SB64 - Gate N: no-core/no-driver proof
...
Validate no Process Core and no production drivers.
...
- bundle://templates/source-scan-template.md
## Deliverables
...
5. Record proof under `proof/SB64/` during implementation.
...
- Critical proof manifest: bundle://proof/SB64/manifest.md.
- Semantic invariant contract: bundle://proof/SB64/semantic-invariants.md.
...
Implement SB64 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
