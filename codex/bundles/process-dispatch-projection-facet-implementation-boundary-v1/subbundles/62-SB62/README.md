# SB62 - Map projection facets to future driver boundary
...
Document which facets could become driver services later and which must remain process-owned.
...
5. Record proof under `proof/SB62/` during implementation.
...
Implement SB62 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
