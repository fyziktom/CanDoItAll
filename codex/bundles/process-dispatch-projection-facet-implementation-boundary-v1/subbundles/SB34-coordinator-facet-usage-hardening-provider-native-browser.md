# SB34 - Coordinator facet usage hardening: provider-native browser
...
Confirm provider-native browser coordinator consumes only the facets it needs and no dispatcher service or broad host.
...
src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessProviderNativeBrowserArtifactProjectionCoordinator.cs
...
5. Record proof under `proof/SB34/` during implementation.
...
Implement SB34 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
