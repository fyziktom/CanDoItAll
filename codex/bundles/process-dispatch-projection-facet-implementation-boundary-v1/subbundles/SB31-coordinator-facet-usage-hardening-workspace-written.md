# SB31 - Coordinator facet usage hardening: workspace-written
...
Confirm workspace-written coordinator consumes only the facets it needs and no dispatcher service or broad host.
...
src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessWorkspaceWrittenArtifactProjectionCoordinator.cs
...
5. Record proof under `proof/SB31/` during implementation.
...
Implement SB31 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
