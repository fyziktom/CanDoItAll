# SB11 - Path safety helper consolidation
...
If low-risk, move duplicate path-safety logic into module-local static helper rules; otherwise document why deferred.
...
src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessScopedManagedArtifactPathRules.cs; ProcessRunAutomationDispatchService.ArtifactProjection.cs

## Deliverables

Path helper cleanup or documented deferral.
...
No behavior change; existing projection tests pass.
...
5. Record proof under `proof/SB11/` during implementation.
...
Implement SB11 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
