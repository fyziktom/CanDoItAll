# SB32 - Coordinator facet usage hardening: existing managed
...
Confirm existing managed coordinator consumes only the facets it needs and no dispatcher service or broad host.
...
src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessExistingManagedArtifactProjectionCoordinator.cs
...
5. Record proof under `proof/SB32/` during implementation.
...
Implement SB32 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
