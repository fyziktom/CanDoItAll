# SB47 - Projection coordinator file size review
...
Ensure no new coordinator became a new mini-monolith without explicit reason.
...
source coordinator files

## Deliverables

Line count and responsibility review.
...
Warnings above 350 lines require justification.
...
5. Record proof under `proof/SB47/` during implementation.
...
Implement SB47 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
