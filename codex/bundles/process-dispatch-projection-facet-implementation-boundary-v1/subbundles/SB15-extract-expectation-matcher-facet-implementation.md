# SB15 - Extract expectation matcher facet implementation
...
Move expectation matching wrappers into focused expectation matcher implementation.
...
ProcessArtifactExpectationMatcher.cs; ProcessArtifactTextMatchRules.cs; ProcessRunAutomationDispatchService.ArtifactProjectionServices.cs
...
Focused matching tests for declared path, text match, browser visual, and narrative/source cases.
...
5. Record proof under `proof/SB15/` during implementation.
...
Implement SB15 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
