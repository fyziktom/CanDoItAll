# SB65 - Focused unit projection tests
...
Run focused projection unit tests and record transcript.
...
5. Record proof under `proof/SB65/` during implementation.
...
Implement SB65 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
