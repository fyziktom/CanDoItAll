# SB69 - Source scan: no Core, driver, UI, stubs
...
Run final source scan for prohibited tokens and UI drift.
...
src; tests; codex/bundles/current
...
5. Record proof under `proof/SB69/` during implementation.
...
Implement SB69 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
