# SB57 - Architecture test: no broad host resurrection
...
Add or update test that fails if `IProcessArtifactProjectionHost` or broad host adapter returns.
...
ProcessAgentExecutionBoundaryArchitectureTests.cs
...
Test must fail on broad-host string fixture.
...
5. Record proof under `proof/SB57/` during implementation.
...
Implement SB57 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
