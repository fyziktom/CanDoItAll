# SB68 - Gate O: build and focused tests
...
Validate all test/build proof before final scans.
...
5. Record proof under `proof/SB68/` during implementation.
...
- Critical proof manifest: bundle://proof/SB68/manifest.md.
...
Implement SB68 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
