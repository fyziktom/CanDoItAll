# SB79 - Manager review and downstream cutline
...
Write next recommended cutline for future bundle.
...
- bundle://reviews/05-manager-cutline.md
## Deliverables
...
- Must not silently start next work.
...
5. Record proof under `proof/SB79/` during implementation.
...
Implement SB79 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
