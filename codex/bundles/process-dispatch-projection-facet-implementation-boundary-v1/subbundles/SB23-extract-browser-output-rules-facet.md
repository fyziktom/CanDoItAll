# SB23 - Extract browser-output rules facet
...
Move browser output matching/title/tool-name rules into focused implementation.
...
ProcessArtifactProviderNativeVisualValidationRules.cs; ProcessProviderNativeBrowserOutputFacts.cs

## Deliverables

Browser-output rules implementation.
...
Provider-native browser projection tests pass.
...
5. Record proof under `proof/SB23/` during implementation.
...
Implement SB23 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
