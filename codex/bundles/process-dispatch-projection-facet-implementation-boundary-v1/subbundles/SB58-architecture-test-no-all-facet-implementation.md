# SB58 - Architecture test: no all-facet implementation
...
Add or update test that rejects classes implementing too many projection facet interfaces.
...
5. Record proof under `proof/SB58/` during implementation.
...
Implement SB58 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
