...
ExitCode 0 or documented pre-existing warnings only.
...
5. Record proof under `proof/SB67/` during implementation.
...
Implement SB67 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
