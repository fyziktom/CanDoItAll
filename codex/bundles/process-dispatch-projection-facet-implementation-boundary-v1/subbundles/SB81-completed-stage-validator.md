# SB81 - Completed-stage validator
...
5. Record proof under `proof/SB81/` during implementation.
...
Implement SB81 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
