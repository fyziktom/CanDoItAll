...
Create proof index mapping requirements to transcripts.
...
5. Record proof under `proof/SB82/` during implementation.
...
Implement SB82 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
