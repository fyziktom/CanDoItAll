# SB39 - Projection duplicate handling audit
...
Audit duplicate external reference handling after facet split.
...
ProcessArtifactProjectionCandidateStateUpdater; coordinators

## Deliverables

Duplicate handling notes/tests.
...
Focused duplicate handling tests.
...
5. Record proof under `proof/SB39/` during implementation.
...
Implement SB39 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
