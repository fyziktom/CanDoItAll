# SB50 - Projection expectation read-only view feasibility
...
Evaluate whether a local read-only view can replace `DispatchArtifactExpectation` in pure helpers without changing behavior.
...
- repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactProjectionUtilities.cs
## Deliverables

- Decision record: implement or defer.
## Dependency Impact

- Phase: P7 Model alias readiness.
...
5. Record proof under `proof/SB50/` during implementation.
...
Implement SB50 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
