# SB38 - Projection source-family order assertion hardening
...
Strengthen test/source scan that verifies source-family order.
...
- Adversarial negative proof or source scan.
...
5. Record proof under `proof/SB38/` during implementation.
...
Implement SB38 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
