# SB70 - Source scan: projection facet boundaries
...
Run source scan for no broad host, no all-facet implementation, no dispatcher service constructor in coordinators.
...
5. Record proof under `proof/SB70/` during implementation.
...
Implement SB70 only. Preserve behavior. Do not start downstream work early. Record proof before continuing.
