...
{
    public static AgentProcessCooperationMetadata ResolveProcessCooperationMetadata(
        ...
        IReadOnlyList<ProcessRunAutomationDispatchService.DispatchBranchOutcome> branchOutcomes,
    ...
    public static AgentProcessCooperationMode ResolveCooperationMode(
    ...
    public static AgentWorkspaceToolProfileKind ResolveWorkspaceToolProfile(
        ProcessStepRun stepRun,
        ProcessWorkBrief? workBrief,
        ProcessRoleRequirement? role,
        ProcessRunAssignment? assignment,
