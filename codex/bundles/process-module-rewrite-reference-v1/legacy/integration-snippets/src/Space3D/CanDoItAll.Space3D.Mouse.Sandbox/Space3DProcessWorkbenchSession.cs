...
namespace CanDoItAll.Space3D.Mouse.Sandbox;

public sealed class Space3DProcessWorkbenchSession
{
    ...
    private readonly List<Space3DProcessCommandLogEntry> commandLog = [];
    ...
    public Space3DProcessWorkbenchSession(ProcessWebGlSceneAdapter sceneAdapter)
    {
    ...
    public string ProjectionMode => WebGlWorkbenchCameraViewModes.ResolveProjectionMode(CameraViewMode);
    ...
    public IReadOnlyList<Space3DProcessCommandLogEntry> CommandLog => commandLog;
    ...
    public void RecordMouseAction(string title, string detail)
        => RecordCommand(title, detail);

    private void RecordCommand(string title, string detail)
    {
        commandLog.Insert(0, new Space3DProcessCommandLogEntry(DateTimeOffset.UtcNow, title, detail));
...
public sealed record Space3DProcessCommandLogEntry(
