# Blazor backend and frontend feature addition
Add coordinated backend and frontend behavior for a Blazor SSR, WASM, or WASM PWA app with full runtime proof.
