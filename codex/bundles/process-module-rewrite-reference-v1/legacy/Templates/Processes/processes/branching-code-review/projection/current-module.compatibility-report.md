# Compatibility report — Branching code review and merge governance

**Process key:** `branching-code-review`  
...
- Route-specific merge approvals are used instead of an unsupported OR-join across mutually exclusive review lanes.
