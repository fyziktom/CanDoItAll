...
**Seniority:** Senior engineering manager, release approver, or delegated branch steward  
**Minimum years in primary discipline:** 7  
**Minimum years in software delivery:** 9

## Summary
Go / no-go owner for merging reviewed changes into the governed integration branch.

## Purpose
Approve merge only when review routing, validation evidence, and residual risk framing are explicit.

## Staffing intent
Decision owner for controlled merge progression after review and validation lanes complete.

## Snapshot summary
Decision owner for controlled merge progression after review and validation lanes complete.

## Domain tags
merge, branch-governance, residual-risk
