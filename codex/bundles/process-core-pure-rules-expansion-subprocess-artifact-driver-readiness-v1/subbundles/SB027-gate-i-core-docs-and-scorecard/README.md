...
## Objective
Prove docs match implemented Core and no broad extraction was implied.
...
4. Run the subbundle proof commands and store transcripts under `proof/SB027/transcripts/`.
...
- [ ] Execution report has an individual `SB027` row.
...
Implement `SB027 - Gate I - Core docs and scorecard` exactly as scoped. Preserve existing process behavior, keep Core pure, keep driver work docs/tests-only, and record proof before proceeding.
