...
## Deliverables
- Core resolver
- Module-local adapter wrapper
- No database/filesystem writes in Core
...
## Validation Depth
- Source artifact selection parity tests
- Subprocess projection integration tests
...
4. Run the subbundle proof commands and store transcripts under `proof/SB008/transcripts/`.
...
- [ ] Execution report has an individual `SB008` row.
