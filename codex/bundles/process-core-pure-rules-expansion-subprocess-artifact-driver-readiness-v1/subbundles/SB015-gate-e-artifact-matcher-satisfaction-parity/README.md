...
## Objective
Prove moved artifact matching rules preserve validation, satisfaction, and projection behavior.
...
4. Run the subbundle proof commands and store transcripts under `proof/SB015/transcripts/`.
...
- [ ] Execution report has an individual `SB015` row.
...
Implement `SB015 - Gate E - artifact matcher/satisfaction parity` exactly as scoped. Preserve existing process behavior, keep Core pure, keep driver work docs/tests-only, and record proof before proceeding.
