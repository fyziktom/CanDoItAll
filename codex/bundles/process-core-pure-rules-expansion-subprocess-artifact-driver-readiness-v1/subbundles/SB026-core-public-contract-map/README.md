# SB026 - Core public contract map

## Status
Prepared.

## Objective
Document Core namespaces/types and module adapters for future contributors.
...
## Deliverables
- Contract map
- Examples of allowed/forbidden usage
- No driver API
...
## Validation Depth
- Docs scan
- Architecture tests for docs not production API
...
4. Run the subbundle proof commands and store transcripts under `proof/SB026/transcripts/`.
...
- [ ] Execution report has an individual `SB026` row.
...
Implement `SB026 - Core public contract map` exactly as scoped. Preserve existing process behavior, keep Core pure, keep driver work docs/tests-only, and record proof before proceeding.
