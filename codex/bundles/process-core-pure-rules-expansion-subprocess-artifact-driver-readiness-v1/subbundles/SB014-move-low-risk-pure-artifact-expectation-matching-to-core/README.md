...
- Module adapter for legacy call sites
- No File/Directory/Storage/Workspace
...
4. Run the subbundle proof commands and store transcripts under `proof/SB014/transcripts/`.
...
- [ ] Execution report has an individual `SB014` row.
