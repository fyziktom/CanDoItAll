...
## Objective
Prove Core public API is small, pure, stable, and not leaking application concerns.
...
4. Run the subbundle proof commands and store transcripts under `proof/SB021/transcripts/`.
...
- [ ] Execution report has an individual `SB021` row.
...
Implement `SB021 - Gate G - public API hygiene proof` exactly as scoped. Preserve existing process behavior, keep Core pure, keep driver work docs/tests-only, and record proof before proceeding.
