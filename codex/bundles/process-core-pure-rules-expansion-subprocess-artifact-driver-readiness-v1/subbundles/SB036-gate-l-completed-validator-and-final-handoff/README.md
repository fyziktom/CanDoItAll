...
## Objective
Run completed-stage validator and produce final handoff proof.
...
4. Run the subbundle proof commands and store transcripts under `proof/SB036/transcripts/`.
...
- [ ] Execution report has an individual `SB036` row.
...
Implement `SB036 - Gate L - completed validator and final handoff` exactly as scoped. Preserve existing process behavior, keep Core pure, keep driver work docs/tests-only, and record proof before proceeding.
