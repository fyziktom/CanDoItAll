# SB025 - Update Core extraction scorecard

## Status
- Status: `Completed`
## Objective
Reflect which Core families moved and what remains blocked.
...
- `repo://codex/bundles/process-core-pre-extraction-consolidation-driver-readiness-v1/architecture/03-final-core-readiness-decision-template.md`

## Deliverables
- Updated scorecard
- Do-not-move table
- Next candidates table
...
## Validation Depth
- Docs review
- Source scan no production change unless docs only
...
4. Run the subbundle proof commands and store transcripts under `proof/SB025/transcripts/`.
...
- [ ] Execution report has an individual `SB025` row.
...
Implement `SB025 - Update Core extraction scorecard` exactly as scoped. Preserve existing process behavior, keep Core pure, keep driver work docs/tests-only, and record proof before proceeding.
