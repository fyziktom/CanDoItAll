...
- Line-count and source-token baseline
- Proof of current `CanDoItAll.Processes.Core` dependency shape
...
4. Run the subbundle proof commands and store transcripts under `proof/SB001/transcripts/`.
...
- [ ] Execution report has an individual `SB001` row.
