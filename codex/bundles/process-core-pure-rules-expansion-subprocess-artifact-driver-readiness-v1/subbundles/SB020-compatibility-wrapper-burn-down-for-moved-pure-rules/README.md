...
## Validation Depth
- Focused unit tests
- Source scan for removed wrappers
...
4. Run the subbundle proof commands and store transcripts under `proof/SB020/transcripts/`.
...
- [ ] Execution report has an individual `SB020` row.
