# Refactor Gate A: coordinator guardrails before production migration
...
Refactor Gate A: prove the hardened coordinator boundary is safe before migrating the remaining write paths.
...
- No mobile/small/medium proof scan.
- Line-count update.
...
- Full build if source moved.

## Implementation Steps

- Run architecture tests.
- Run focused artifact projection tests.
- Record line counts.
...
- Gate A passed.
- No UI proof artifacts.
- No source semantic leakage into coordinator.
