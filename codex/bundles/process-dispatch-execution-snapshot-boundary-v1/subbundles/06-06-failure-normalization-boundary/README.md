...
Normalize AgentFramework execution failures inside the client; dispatcher catches/uses process-owned failure types.
...
- Client + Execution.cs error handling; no behavior weakening.
...
- Failure tests for chat-run and run failure paths; scan dispatcher for AgentChatRunFailedException/AgentRunFailedException.
...
5. Record transcripts under `proof/SB06/transcripts/`.
...
- Create proof manifest at `proof/SB06/manifest.md`, semantic invariants at `proof/SB06/semantic-invariants.md`, command transcripts under `proof/SB06/transcripts/`, and source assertions under `proof/SB06/source-assertions/`.
