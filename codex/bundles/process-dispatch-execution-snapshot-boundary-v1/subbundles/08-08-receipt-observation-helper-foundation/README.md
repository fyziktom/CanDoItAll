...
Add a small helper that consumes process snapshots to resolve successful tools, provider metadata, and receipt families.
...
- New helper and tests; avoid moving artifact validation/projection wholesale.
...
- Helper unit tests against synthetic snapshots; no AgentFramework references in helper.
...
5. Record transcripts under `proof/SB08/transcripts/`.
...
- Create proof manifest at `proof/SB08/manifest.md`, semantic invariants at `proof/SB08/semantic-invariants.md`, command transcripts under `proof/SB08/transcripts/`, and source assertions under `proof/SB08/source-assertions/`.
