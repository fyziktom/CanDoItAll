...
Stop and verify contracts are neutral before any dispatcher migration. Add failing-first architecture scans.
...
5. Record transcripts under `proof/SB03/transcripts/`.
