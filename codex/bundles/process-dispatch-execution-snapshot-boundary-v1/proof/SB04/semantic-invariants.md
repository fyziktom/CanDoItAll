...
- Expected behavior: ProcessAutomationExecutionClient maps AgentFramework execution runtime data to process snapshots and preserves catalog/editor pass-through behavior.
...
- Passing test: bundle://proof/SB04/transcripts/execution-client-tests.txt
