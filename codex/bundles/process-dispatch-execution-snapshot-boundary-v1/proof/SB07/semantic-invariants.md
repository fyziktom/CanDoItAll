...
- Expected behavior: Dispatcher partials outside the execution client no longer consume old AgentFramework execution result/detail/query/exception tokens.
...
- Passing test: bundle://proof/SB07/transcripts/processes-module-build.txt
- Changed source files: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.Execution.cs, repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ExecutionSnapshotMetadata.cs
