# SB27 - Line-count review and reopen pass
...
Line-count review and reopen pass.
...
6. Record proof under `proof/SB27/` during execution.
...
- `proof/SB27/manifest.md`
- `proof/SB27/semantic-invariants.md`
...
Do not start SB28 until this subbundle's acceptance checklist is complete. Critical gates must include an explicit downstream dependency decision.

## Suggested Agent Prompt

Implement SB27 from `process-dispatch-artifact-validation-residual-boundary-v1`. Follow the exact source references and do not broaden scope. Preserve behavior, keep changes module-local, and record the required proof artifacts before proceeding.
