# SB23 - Provider-native declared-path bridge cleanup
...
Provider-native declared-path bridge cleanup.
...
6. Record proof under `proof/SB23/` during execution.
...
- `proof/SB23/manifest.md`
- `proof/SB23/semantic-invariants.md`
...
- Do not start SB24 until this subbundle's acceptance checklist is complete. Critical gates must include an explicit downstream dependency decision.
## Suggested Agent Prompt

Implement SB23 from `process-dispatch-artifact-validation-residual-boundary-v1`. Follow the exact source references and do not broaden scope. Preserve behavior, keep changes module-local, and record the required proof artifacts before proceeding.
