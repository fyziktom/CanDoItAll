# SB03 - Helper cutline and ownership design
...
Helper cutline and ownership design.
...
Baseline, inventory, source assertions, and architecture guardrails before production movement.
...
6. Record proof under `proof/SB03/` during execution.
...
Do not start SB04 until this subbundle's acceptance checklist is complete. Critical gates must include an explicit downstream dependency decision.

## Suggested Agent Prompt

Implement SB03 from `process-dispatch-artifact-validation-residual-boundary-v1`. Follow the exact source references and do not broaden scope. Preserve behavior, keep changes module-local, and record the required proof artifacts before proceeding.
