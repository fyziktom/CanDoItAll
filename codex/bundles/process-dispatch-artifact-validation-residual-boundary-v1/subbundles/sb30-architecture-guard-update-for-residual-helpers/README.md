# SB30 - Architecture guard update for residual helpers
...
Architecture guard update for residual helpers.
...
6. Record proof under `proof/SB30/` during execution.
...
- `proof/SB30/semantic-invariants.md`
...
Do not start SB31 until this subbundle's acceptance checklist is complete. Critical gates must include an explicit downstream dependency decision.

## Suggested Agent Prompt

Implement SB30 from `process-dispatch-artifact-validation-residual-boundary-v1`. Follow the exact source references and do not broaden scope. Preserve behavior, keep changes module-local, and record the required proof artifacts before proceeding.
