...
Final manager/architect/QA self-review.
...
6. Record proof under `proof/SB36/` during execution.
...
- `proof/SB36/manifest.md`
- `proof/SB36/semantic-invariants.md`
...
- Do not start Final until this subbundle's acceptance checklist is complete. Critical gates must include an explicit downstream dependency decision.
## Suggested Agent Prompt

Implement SB36 from `process-dispatch-artifact-validation-residual-boundary-v1`. Follow the exact source references and do not broaden scope. Preserve behavior, keep changes module-local, and record the required proof artifacts before proceeding.
