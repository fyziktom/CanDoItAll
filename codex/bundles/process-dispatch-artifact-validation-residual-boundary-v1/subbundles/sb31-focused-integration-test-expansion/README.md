# SB31 - Focused integration test expansion
...
Focused integration test expansion.
...
6. Record proof under `proof/SB31/` during execution.
...
- `proof/SB31/manifest.md`
- `proof/SB31/semantic-invariants.md`
...
- Do not start SB32 until this subbundle's acceptance checklist is complete. Critical gates must include an explicit downstream dependency decision.
## Suggested Agent Prompt

Implement SB31 from `process-dispatch-artifact-validation-residual-boundary-v1`. Follow the exact source references and do not broaden scope. Preserve behavior, keep changes module-local, and record the required proof artifacts before proceeding.
