...
- Invariant ID: SB32-BUILD-SCAN
- Source raw note: Close with build, focused tests, source scans, and no UI proof.
- Expected behavior: Solution build passes, 22 focused integration tests pass, 9 focused unit boundary assertions pass, and no Core/driver/UI/prohibited viewport proof drift is found.
...
- Changed source files: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactValidation.cs plus helper files listed in bundle://proof/SB32/manifest.md.
