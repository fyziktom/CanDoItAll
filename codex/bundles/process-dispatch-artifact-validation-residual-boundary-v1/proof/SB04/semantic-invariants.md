...
- Invariant ID: SB04-RESIDUAL-GUARDRAILS
- Source raw note: Do not rush Process Core and keep the residual refactor module-local.
- Expected behavior: Residual extraction stays under CanDoItAll.Modules.Processes, does not add Core/driver contracts, and leaves orchestration side effects in the dispatcher partial.
...
- Changed source files: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactValidation.cs plus helper files listed in bundle://proof/SB04/manifest.md.
