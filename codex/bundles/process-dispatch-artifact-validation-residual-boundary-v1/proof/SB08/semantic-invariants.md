...
- Invariant ID: SB08-CLASSIFICATION-PARITY
- Source raw note: Extract residual artifact classification rules without behavior drift.
- Expected behavior: Artifact kind, content-type, and storage-kind classification delegate to internal helper rules while focused parity tests remain green.
...
- Changed source files: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactValidation.cs plus helper files listed in bundle://proof/SB08/manifest.md.
