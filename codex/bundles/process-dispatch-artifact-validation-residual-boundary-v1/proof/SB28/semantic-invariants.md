...
- Invariant ID: SB28-LINECOUNT-PARITY
- Source raw note: Slim ArtifactValidation.cs materially while preserving wrapper consumers.
- Expected behavior: ArtifactValidation.cs line count is 2156, below the 2200 target, with private wrappers retained only as adapters over module-local helpers.
...
- Changed source files: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactValidation.cs plus helper files listed in bundle://proof/SB28/manifest.md.
