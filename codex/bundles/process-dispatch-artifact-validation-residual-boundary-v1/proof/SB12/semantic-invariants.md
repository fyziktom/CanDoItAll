...
- Invariant ID: SB12-BROWSER-PARITY
- Source raw note: Preserve provider-native browser output/path/probe behavior.
- Expected behavior: Provider-native browser output matching, requested managed path resolution, working-directory logic, and file-probe suppression remain behaviorally identical under helper boundaries.
...
- Changed source files: repo://src/CanDoItAll.Modules.Processes/Automation/Dispatch/ProcessRunAutomationDispatchService.ArtifactValidation.cs plus helper files listed in bundle://proof/SB12/manifest.md.
