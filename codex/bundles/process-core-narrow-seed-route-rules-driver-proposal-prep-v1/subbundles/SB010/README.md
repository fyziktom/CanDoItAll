# SB010 — Phase 4 / Module adapter compatibility
...
Update Processes module to consume Core route order/eligibility through module-local adapter/wrapper.
...
- Updated proof transcript under this bundle's `proof/SB010/`.
...
Module compilation and route tests pass.
...
Do not leak dispatcher models into Core.
...
Implement SB010 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
