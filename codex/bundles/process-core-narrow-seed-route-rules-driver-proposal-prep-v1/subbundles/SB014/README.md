# SB014 — Phase 5 / Subprocess denylist and parity tests
...
Add guard tests documenting what must remain module-local.
...
- Updated proof transcript under this bundle's `proof/SB014/`.
...
Tests verify pure vs side-effect split.
...
Do not move projection persistence.
...
Implement SB014 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
