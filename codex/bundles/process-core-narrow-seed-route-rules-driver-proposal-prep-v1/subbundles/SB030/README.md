...
Run completed-stage validator, source scans, final proof index, and produce execution report.
...
- Updated proof transcript under this bundle's `proof/SB030/`.
...
Bundle not complete without proof index.
...
Implement SB030 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
