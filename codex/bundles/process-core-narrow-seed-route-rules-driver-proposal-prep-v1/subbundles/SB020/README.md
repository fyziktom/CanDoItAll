# SB020 — Phase 7 / Project reference graph proof
...
Prove only intended projects reference Core and Core references only allowed projects.
...
- Updated proof transcript under this bundle's `proof/SB020/`.
...
Implement SB020 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
