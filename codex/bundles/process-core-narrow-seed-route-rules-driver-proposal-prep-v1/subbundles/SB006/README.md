# SB006 — Gate B / Core skeleton closure
...
Build solution and prove Core is empty/minimal and dependency-clean.
...
- Updated proof transcript under this bundle's `proof/SB006/`.
...
Do not move second candidate family.
...
Implement SB006 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
