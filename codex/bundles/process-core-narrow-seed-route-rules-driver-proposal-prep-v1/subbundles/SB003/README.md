...
Run build, focused architecture tests, source scans, and no UI/media scans before production moves.
...
- Updated proof transcript under this bundle's `proof/SB003/`.
...
Do not proceed if baseline is unstable.
...
Implement SB003 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
