# SB008 — Phase 3 / Route eligibility pure-rule move
...
Move only source-payload-free run/step eligibility rules to Core.
...
- Updated proof transcript under this bundle's `proof/SB008/`.
...
Do not move route planner if it depends on module-only types.
...
Implement SB008 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
