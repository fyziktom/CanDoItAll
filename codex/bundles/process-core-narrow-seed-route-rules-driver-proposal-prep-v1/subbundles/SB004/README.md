# SB004 — Phase 2 / Create narrow Core project skeleton
...
Create `CanDoItAll.Processes.Core` with allowed dependency only on Contracts unless explicitly justified.
...
- Updated proof transcript under this bundle's `proof/SB004/`.
...
- Core project builds and forbidden-reference test passes.
...
Do not add production logic yet.
...
Implement SB004 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
