# SB013 — Phase 5 / Subprocess lifecycle Core rehearsal
...
Create test-only map of subprocess lifecycle pure rules that could move later.
...
- Updated proof transcript under this bundle's `proof/SB013/`.
...
Docs/tests only; no production move.
...
Do not move subprocess production code in this bundle.
...
Implement SB013 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
