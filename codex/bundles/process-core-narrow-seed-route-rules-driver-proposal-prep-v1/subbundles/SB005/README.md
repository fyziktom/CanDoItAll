# SB005 — Phase 2 / Core dependency and namespace guardrails
...
Add architecture tests scanning Core project refs and source tokens.
...
- Updated proof transcript under this bundle's `proof/SB005/`.
...
Tests reject EF, Infrastructure, AgentFramework, Modules, Storage, Workspace, Driver tokens.
...
Do not rely only on csproj checks; scan source too.
...
Implement SB005 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
