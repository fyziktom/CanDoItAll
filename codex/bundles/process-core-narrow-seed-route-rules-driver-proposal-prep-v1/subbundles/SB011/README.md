# SB011 — Phase 4 / Delete stale route duplicates
...
Remove duplicate route-order/eligibility implementations from module if replaced by Core.
...
- Updated proof transcript under this bundle's `proof/SB011/`.
...
- Source scan proves single source of truth.
...
Keep compatibility wrappers only if needed for callers.
...
Implement SB011 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
