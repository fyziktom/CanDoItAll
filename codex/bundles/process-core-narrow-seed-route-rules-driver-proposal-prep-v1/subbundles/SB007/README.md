# SB007 — Phase 3 / Route stage order Core move
...
Move route stage enum/descriptors and canonical stage order to Core routing namespace.
...
- Updated proof transcript under this bundle's `proof/SB007/`.
...
Do not move route handlers or services.
...
Implement SB007 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
