# SB017 — Phase 6 / Artifact matcher denylist and parity
...
Add tests/source scans rejecting storage/workspace/projection writes in future Core artifact candidates.
...
- Updated proof transcript under this bundle's `proof/SB017/`.
...
Implement SB017 only. Preserve behavior. Do not broaden scope. Record proof before proceeding.
