# SB035 - Reject driver/Core reverse dependency and global using drift

## Status
- Completed
## Objective
Advance core descriptor consumer allow-list hardening by completing: Reject driver/Core reverse dependency and global using drift.
...
## Closure Proof
- Core reverse dependency and global using drift proof: `bundle://proof/SB036/transcripts/p12-source-scans.txt`.
...
Implement SB035 carefully using source-backed proof. Do not trust existing reports without opening current branch code.
