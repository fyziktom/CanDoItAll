# SB044 - Add source-backed sample tests, not prose-only examples

## Status
- Completed
## Objective
Advance documentation and package samples synced to actual code by completing: Add source-backed sample tests, not prose-only examples.
...
## Closure Proof
- Source-backed README tests updated in `repo://tests/CanDoItAll.Tests.Unit/ProcessDriverPackageReadmeSamplesTests.cs`.
- Stale observation aggregation sample corrected to the current instance method call.
...
Implement SB044 carefully using source-backed proof. Do not trust existing reports without opening current branch code.
