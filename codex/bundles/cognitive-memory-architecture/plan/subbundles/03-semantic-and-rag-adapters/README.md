# Subbundle 03-semantic-and-rag-adapters

## Objective

Wrap the existing SemanticCompletion/embedding driver and RAG/Qdrant driver. Add filter/projection metadata support behind new abstractions.
