...
- Unit tests can prove scoring math but miss bad source boundaries; integration tests must include Workbench ingestion, projection, recall, and trace inspection.
