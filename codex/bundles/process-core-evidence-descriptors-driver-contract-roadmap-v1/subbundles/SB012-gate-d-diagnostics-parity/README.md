# SB012 — Gate D: diagnostics parity

## Status
Prepared.

## Objective
Module adapters preserve current retry/provider/no-progress decisions.
...
Implement SB012 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
