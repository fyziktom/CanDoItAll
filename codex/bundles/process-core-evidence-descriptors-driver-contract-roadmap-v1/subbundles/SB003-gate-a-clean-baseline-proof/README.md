# SB003 — Gate A: clean baseline proof

## Status
Prepared.

## Objective
Build, unit architecture, no-Core-creep, no-driver, no-UI, anti-stub scans.
...
Implement SB003 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
