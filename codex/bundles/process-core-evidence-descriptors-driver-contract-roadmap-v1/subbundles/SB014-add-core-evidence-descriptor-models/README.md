# SB014 — Add Core evidence descriptor models

## Status
- Status: Completed

## Objective
Add stable descriptors only; keep file/storage/workspace/validation orchestration local.
...
Implement SB014 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
