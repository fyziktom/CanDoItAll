# SB035 — Focused integration matrix

## Status
Prepared.

## Objective
Run dispatch, subprocess, artifact, finalizer, execution-client, route/core focused tests.
...
Implement SB035 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
