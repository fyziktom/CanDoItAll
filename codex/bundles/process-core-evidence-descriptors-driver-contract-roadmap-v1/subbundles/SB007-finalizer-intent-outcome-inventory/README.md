# SB007 — Finalizer intent/outcome inventory

## Status
- Status: Completed

## Objective
Map workflow/recovery/direct/subprocess finalizer inputs and output/apply conditions.
...
Implement SB007 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
