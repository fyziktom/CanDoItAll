# SB029 — One-driver alpha candidate decision

## Status
- Status: Completed

## Objective
Choose future verification-only alpha candidate or defer.
...
Implement SB029 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
