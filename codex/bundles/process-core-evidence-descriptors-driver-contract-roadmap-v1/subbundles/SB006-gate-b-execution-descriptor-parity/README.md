# SB006 — Gate B: execution descriptor parity

## Status
Prepared.

## Objective
Adapters build descriptors from module snapshots; no execution behavior moves.
...
Implement SB006 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
