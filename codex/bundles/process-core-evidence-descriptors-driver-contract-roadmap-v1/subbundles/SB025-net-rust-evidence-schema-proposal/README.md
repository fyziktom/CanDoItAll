# SB025 — .NET/Rust evidence schema proposal

## Status
- Status: Completed

## Objective
Readonly build/test/proof evidence schema, no command execution.
...
Implement SB025 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
