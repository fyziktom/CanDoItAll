# SB002 — Build warning cleanup/classification

## Status
- Status: Completed

## Objective
Fix or explicitly baseline the 3 current build warnings; no broad suppressions.
...
Implement SB002 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
