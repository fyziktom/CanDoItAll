# SB010 — Retry/provider diagnostics inventory

## Status
Prepared.

## Objective
Classify retry, missing tool, provider fallback, repair and no-progress facts.
...
Implement SB010 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
