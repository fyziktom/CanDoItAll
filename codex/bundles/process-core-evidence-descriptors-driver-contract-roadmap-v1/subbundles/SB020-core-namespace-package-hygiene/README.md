# SB020 — Core namespace/package hygiene

## Status
Prepared.

## Objective
Check namespace stability, no broad helpers, no mutable service APIs.
...
Implement SB020 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
