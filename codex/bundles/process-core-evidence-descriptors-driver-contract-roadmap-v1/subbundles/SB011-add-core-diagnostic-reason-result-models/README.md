# SB011 — Add Core diagnostic reason/result models

## Status
- Status: Completed

## Objective
Only immutable diagnostic descriptors; no provider health calls or repair behavior.
...
Implement SB011 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
