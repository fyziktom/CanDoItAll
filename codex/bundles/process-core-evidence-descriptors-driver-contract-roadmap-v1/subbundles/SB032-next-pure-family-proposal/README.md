# SB032 — Next pure family proposal

## Status
Prepared.

## Objective
Pick next safe Core family or declare Core stable enough for driver-contract work.
...
Implement SB032 from `process-core-evidence-descriptors-driver-contract-roadmap-v1`. Keep Core pure, preserve behavior, and record proof before proceeding.
