...
## Objective
Source scan for no nested model aliases in coordinators.
...
5. Record proof in `proof/SB77/` if implementing this bundle in-repo.
...
Implement SB77 from `process-dispatch-projection-model-rule-decoupling-boundary-v1`. Preserve behavior and projection order. Do not introduce Process Core, production driver APIs, UI changes, or mobile proof artifacts.
