# SB36 - Gate I - core projection rules proof

## Status
- Status: `Completed`

## Objective
Gate I - core projection rules proof.
...
5. Record proof in `proof/SB36/` if implementing this bundle in-repo.
...
Implement SB36 from `process-dispatch-projection-model-rule-decoupling-boundary-v1`. Preserve behavior and projection order. Do not introduce Process Core, production driver APIs, UI changes, or mobile proof artifacts.
