...
## Objective
Source scan for no service static calls in coordinators.
...
5. Record proof in `proof/SB78/` if implementing this bundle in-repo.
...
Implement SB78 from `process-dispatch-projection-model-rule-decoupling-boundary-v1`. Preserve behavior and projection order. Do not introduce Process Core, production driver APIs, UI changes, or mobile proof artifacts.
