# SB28 - Gate G - adapter boundary proof

## Status
Prepared.

## Objective
Gate G - adapter boundary proof.
...
5. Record proof in `proof/SB28/` if implementing this bundle in-repo.
...
Implement SB28 from `process-dispatch-projection-model-rule-decoupling-boundary-v1`. Preserve behavior and projection order. Do not introduce Process Core, production driver APIs, UI changes, or mobile proof artifacts.
