...
## Objective
Extract artifact classification rule calls.
...
5. Record proof in `proof/SB34/` if implementing this bundle in-repo.
...
Implement SB34 from `process-dispatch-projection-model-rule-decoupling-boundary-v1`. Preserve behavior and projection order. Do not introduce Process Core, production driver APIs, UI changes, or mobile proof artifacts.
