# SB44 - Gate K - projection-specific rules proof

## Status
Prepared.

## Objective
Gate K - projection-specific rules proof.
...
5. Record proof in `proof/SB44/` if implementing this bundle in-repo.
...
Implement SB44 from `process-dispatch-projection-model-rule-decoupling-boundary-v1`. Preserve behavior and projection order. Do not introduce Process Core, production driver APIs, UI changes, or mobile proof artifacts.
