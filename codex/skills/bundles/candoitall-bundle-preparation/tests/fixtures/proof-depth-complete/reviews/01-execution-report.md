...
|---|---|---|---|---|---|
| 01 | Passed | Passed | Passed | Passed | Semantic proof included. |
...
- Test proof: `python codex/skills/bundles/candoitall-bundle-preparation/scripts/validate_bundle.py codex/skills/bundles/candoitall-bundle-preparation/tests/fixtures/proof-depth-complete --stage completed`.
...
|---|---|---|
| Require semantic proof | Solved | SB01 semantic proof block and `validate_bundle.py` completed-stage command |
