# AnimationTimeline Specification
...
requestAnimationFrame-based tween helper with easing presets and cancellation.

### Target advanced version

Timeline sequencing, reduced-motion compliance, spring physics, and shared animation budgets.
...
{
    ValueTask AttachAsync(ElementReference host, AnimationTimelineOptions options);
