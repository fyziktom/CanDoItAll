# Implementation Prompt — ConnectorPathPrimitive

Implement `ConnectorPathPrimitive` for the CanDoItAll shared canvas framework.
...
- Do not create a second parallel abstraction next to `ConnectorPathPrimitive` once the dedicated boundary exists.
...
- `ConnectorPathPrimitive` exists as a first-class boundary in the recommended location.
