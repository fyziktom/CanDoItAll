# Implementation Prompt — ImagePrimitive

Implement `ImagePrimitive` for the CanDoItAll shared canvas framework.

## Scope

- Component category: `Image components`
...
- Do not create a second parallel abstraction next to `ImagePrimitive` once the dedicated boundary exists.
...
- `ImagePrimitive` exists as a first-class boundary in the recommended location.
