# ProjectCalendarStateParser Specification
...
Typed parser and defaulting policy used by ProjectCalendarPage during migration.

### Target advanced version

Version-aware parser with migration helpers and strict validation diagnostics.
...
```csharp
public sealed class ProjectCalendarStateParser
{
