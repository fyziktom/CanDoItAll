# CalendarSelectionPanel Specification
...
Document and wrap the current selection-panel data contract in a stable component boundary.

### Target advanced version

Pluggable side-panel tabs, lightweight inspector mode, and shared card primitives.
...
```csharp
public sealed class CalendarSelectionPanelOptions
{
...
public sealed record CalendarSelectionPanelState(string View, DateOnly VisibleDate, string? SelectedId);
```
