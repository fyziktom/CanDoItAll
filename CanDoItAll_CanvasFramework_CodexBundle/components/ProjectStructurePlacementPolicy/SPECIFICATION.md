# ProjectStructurePlacementPolicy Specification
...
Extract ResolveCreatePlacement into a policy service used by create flows.

### Target advanced version

Context-aware placement strategies with collision avoidance and user-configurable preferences.
