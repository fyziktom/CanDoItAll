# PromptSessionAttachmentNode Specification
...
Dedicated attachment node template with thumbnail, name, metadata, and state badges.

### Target advanced version

Preview-on-hover, inline replace/remove actions, and media-type-specific sublayouts.
...
```csharp
public sealed class PromptSessionAttachmentNodeProps
{
