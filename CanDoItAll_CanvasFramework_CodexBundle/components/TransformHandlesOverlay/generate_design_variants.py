"""
Generate design variants for the TransformHandlesOverlay component using the OpenAI Images API.
...
COMPONENT_NAME = "TransformHandlesOverlay"
MODEL = "dall-e-3"
SIZE = "1024x1024"
QUALITY = "hd"
STYLE = "natural"
