...
internal static class GraphCatalog
{
    public static IReadOnlyList<AgentFrameworkIntegrationSimulationSeeder.GraphNodeSpec> BuildGraphSpecs()
    {
        ...
        [
            ...
            new("watch-runtime", ProjectObjectType.Environment, "dotnet-runtime", "Local watch runtime", "Managed app session against the active SQLite profile", "Active", 2040, 900, "repo-landscape", "Runtime currently exposes the seeded project data but the project-structure MCP still points to a stale fixed port."),
