...
**Seniority:** Senior release, operations, or delegated executive authority  
**Minimum years in primary discipline:** 7  
**Minimum years in software delivery:** 10

## Summary
Final go-live decision owner for production promotion and rollback preparedness.

## Purpose
Decide whether the accumulated evidence is sufficient to expose the change to real users, data, and operational load.

## Staffing intent
A senior operational or governance authority who can accept release risk on behalf of the organization.

## Snapshot summary
Final go-live decision owner for production promotion and rollback preparedness.

## Domain tags
release-governance, operational-risk, change-approval
