...
4. Accept only `quality-repair-handoff` or `quality-repair-handoff-after-bughunt` from the repair child.
...
The repair child must diagnose the current defect, make the smallest justified product repair, and independently validate the original criteria before it can return accepted evidence.
