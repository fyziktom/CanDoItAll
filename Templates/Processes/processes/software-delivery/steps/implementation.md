...
Accepted child evidence can come from `slice-handoff`, `slice-handoff-after-repair`, or `slice-handoff-after-manager-repair`. An intermediate `slice-repair-escalation` packet is manager diagnosis input, not accepted implementation proof.
