...
| --- | --- | --- |
| `RQ-01` | `01-mcp-canvas-harness-and-core-node-coverage` | direct MCP navigation, headed snapshot, and route proof |
| `RQ-02` | `01-mcp-canvas-harness-and-core-node-coverage` | screenshots plus explicit node-creation checks |
| `RQ-03` | `02-context-menu-links-and-dependencies` | right-click/menu screenshots and interaction notes |
