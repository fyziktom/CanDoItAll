...
- C:\repositories\CanDoItAll\src\CanDoItAll.Modules.Workspace\ConnectorOutboxService.cs
...
`	ext
Execute only corrective subbundle _corrective-side-effects-reset. Repair the specific blocking defect, rerun the failed proof on fresh artifacts, update the live execution report and gate memo, and do not unblock downstream work until the gate passes.
`
