...
- C:\repositories\CanDoItAll\src\CanDoItAll.Migrations.Sqlite\Migrations
- C:\repositories\CanDoItAll\src\CanDoItAll.Migrations.PostgreSql\Migrations
...
`	ext
Execute only corrective subbundle _corrective-db-integrity-reset. Repair the specific blocking defect, rerun the failed proof on fresh artifacts, update the live execution report and gate memo, and do not unblock downstream work until the gate passes.
`
