...
namespace CanDoItAll.Migrations.Sqlite.Migrations
{
    ...
    public partial class AddProcessRuntimeForeignKeysAndDependencyUniqueness : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Processes_Runs_ProcessDefinitionId_ProcessDefinitionVersionId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_ArtifactExpectations_Processes_StepDefinitions_StepDefinitionId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_ConformanceObservations_Processes_Runs_ProcessRunId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_ConformanceObservations_Processes_StepRuns_StepRunId",
                table: "Processes_ConformanceObservations",
                column: "StepRunId",
                principalTable: "Processes_StepRuns",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_DecisionRecords_Processes_StepBranchOutcomes_BranchOutcomeId",
                table: "Processes_DecisionRecords",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_ImprovementCandidates_Processes_Definitions_ProcessDefinitionId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_RunAssignments_Processes_RoleRequirements_RoleRequirementId",
                table: "Processes_RunAssignments",
                column: "RoleRequirementId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_RunAssignments_Processes_StepDefinitions_StepDefinitionId",
                table: "Processes_RunAssignments",
                column: "StepDefinitionId",
                principalTable: "Processes_StepDefinitions",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_Runs_Processes_DefinitionVersions_ProcessDefinitionId_ProcessDefinitionVersionId",
                table: "Processes_Runs",
                columns: new[] { "ProcessDefinitionId", "ProcessDefinitionVersionId" },
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepArtifactInputs_Processes_ArtifactExpectations_ArtifactExpectationId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepArtifactInputs_Processes_StepDefinitions_StepDefinitionId",
                table: "Processes_StepArtifactInputs",
                column: "StepDefinitionId",
                principalTable: "Processes_StepDefinitions",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepBranchOutcomes_Processes_StepDefinitions_StepDefinitionId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepDependencies_Processes_StepBranchOutcomes_DependsOnBranchOutcomeId",
                table: "Processes_StepDependencies",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepDependencies_Processes_StepDefinitions_DependsOnStepId",
                table: "Processes_StepDependencies",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepDependencies_Processes_StepDefinitions_StepDefinitionId",
                table: "Processes_StepDependencies",
                column: "StepDefinitionId",
                principalTable: "Processes_StepDefinitions",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepRoleRequirements_Processes_RoleRequirements_RoleRequirementId",
                table: "Processes_StepRoleRequirements",
                column: "RoleRequirementId",
                principalTable: "Processes_RoleRequirements",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepRoleRequirements_Processes_StepDefinitions_StepDefinitionId",
                table: "Processes_StepRoleRequirements",
                column: "StepDefinitionId",
                principalTable: "Processes_StepDefinitions",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepRuns_Processes_StepBranchOutcomes_SelectedBranchOutcomeId",
                table: "Processes_StepRuns",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Processes_StepRuns_Processes_StepDefinitions_StepDefinitionId",
                table: "Processes_StepRuns",
                column: "StepDefinitionId",
                principalTable: "Processes_StepDefinitions",
                principalColumn: "Id",
