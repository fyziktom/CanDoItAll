        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workbench_ProjectNodeBindings_Workbench_ProjectObjects_ProjectObjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Workbench_ProjectNodeReferences_Workbench_ProjectObjects_ProjectObjectId",
                        column: x => x.ProjectObjectId,
                        principalTable: "Workbench_ProjectObjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workbench_ProjectNodeReferences_ProjectObjectId_ReferenceKind_OrderIndex",
                table: "Workbench_ProjectNodeReferences",
                columns: new[] { "ProjectObjectId", "ReferenceKind", "OrderIndex" });

            migrationBuilder.CreateIndex(
                name: "IX_Workbench_ProjectNodeReferences_ProjectObjectId_ReferenceKind_ReferenceId",
                table: "Workbench_ProjectNodeReferences",
