    ...
    public partial class AddCognitiveMemoryQualityFollowupHardening : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CognitiveMemory_QualityClusters_ProjectId_AggregateEligible_CompositeScore",
                table: "CognitiveMemory_QualityClusters",
                columns: new[] { "ProjectId", "AggregateEligible", "CompositeScore" });

            migrationBuilder.CreateIndex(
                name: "IX_CognitiveMemory_CuratorCapturedImprovements_AppliedMemoryRecordId",
                table: "CognitiveMemory_CuratorCapturedImprovements",
                column: "AppliedMemoryRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_CognitiveMemory_CuratorCapturedImprovements_AssimilatedMemoryRecordId",
                table: "CognitiveMemory_CuratorCapturedImprovements",
                column: "AssimilatedMemoryRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_CognitiveMemory_CuratorCapturedImprovements_ProjectId_AnchorState_CreatedAtUtc",
                table: "CognitiveMemory_CuratorCapturedImprovements",
                columns: new[] { "ProjectId", "AnchorState", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_CognitiveMemory_CuratorCapturedImprovements_ProjectId_TargetingStatus_CreatedAtUtc",
                table: "CognitiveMemory_CuratorCapturedImprovements",
