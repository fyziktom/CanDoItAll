        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtifactKind = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    Title = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    IsRequired = table.Column<bool>(type: "INTEGER", nullable: false),
                    TrustRequirement = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    SensitivityLevel = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StepRunId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ArtifactKind = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    Title = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    TrustStatus = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    SensitivityLevel = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    ProvenanceSummary = table.Column<string>(type: "TEXT", nullable: false),
                    AllowedFutureUsageSummary = table.Column<string>(type: "TEXT", nullable: false),
                    ReviewSummary = table.Column<string>(type: "TEXT", nullable: false),
                    ManagedStoragePath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ExternalReferenceKey = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessRunId = table.Column<Guid>(type: "TEXT", nullable: false),
                    StepRunId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Severity = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    ...
                    IsSafeNonAction = table.Column<bool>(type: "INTEGER", nullable: false),
                    ContainsSensitiveAssessment = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessRunId = table.Column<Guid>(type: "TEXT", nullable: false),
                    StepRunId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DecisionKind = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    Outcome = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    Title = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Criticality = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    AutonomyLevel = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    ActivePublishedVersionId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImportedFrom = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ...
                    PublishedBy = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresGovernanceReview = table.Column<bool>(type: "INTEGER", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperatingMode = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    PolicyVersion = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    EnvironmentMode = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredProjectAssignmentRole = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    IsRequired = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllowsFallback = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    RoleTemplateSourceKey = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    RoleTemplateSnapshotName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcessRunId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RoleRequirementId = table.Column<Guid>(type: "TEXT", nullable: false),
                    StepDefinitionId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    IsCapabilityGap = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplayPackageKey = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StepKind = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    AllowsManualSkip = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllowsSafeRefusal = table.Column<bool>(type: "INTEGER", nullable: false),
                    RequiresApproval = table.Column<bool>(type: "INTEGER", nullable: false),
                    RequiresDecisionRecord = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    DependsOnStepId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StepDefinitionId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RoleRequirementId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ResponsibilityKind = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false),
                    IsRequired = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentExecutorName = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    CurrentExecutorPartyId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    ReadyAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    StartedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    CompletedAtUtc = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    ...
                    CapabilityGapSeverity = table.Column<string>(type: "TEXT", maxLength: 48, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Processes_DefinitionVersions_ProcessDefinitionId_VersionNumber",
                table: "Processes_DefinitionVersions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Processes_StepDefinitions_ProcessDefinitionVersionId_OrderIndex",
                table: "Processes_StepDefinitions",
                columns: new[] { "ProcessDefinitionVersionId", "OrderIndex" });

            migrationBuilder.CreateIndex(
                name: "IX_Processes_StepRoleRequirements_StepDefinitionId_RoleRequirementId_ResponsibilityKind",
