...
internal static partial class ProjectStructureCanvasCatalog
{
    ...
    [
        ...
        new("add-file-markdown", ProjectObjectType.File, "markdown", "assets", "Markdown", "Create a markdown node for docs, specs, and notes.", "markdown", "sky", "Markdown file", "File title", "README draft", "Folder", "docs", "Content", "Paste markdown content"),
