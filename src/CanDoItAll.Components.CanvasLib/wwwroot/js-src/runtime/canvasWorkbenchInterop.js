(function () {
    ...
    // Legacy DOM/SVG renderer declarations are kept here only until the remaining compatibility lane is retired.
    function legacyRenderLinks(state, visibleNodes) {
    ...
    function legacyRenderNodes(state, visibleNodes) {
        const metrics = state.metrics;
    ...
    function legacyRenderActiveDrag(state) {
    ...
    function legacyRenderMinimap(state, visibleNodes) {
    ...
    function legacyBuildWorkbench(state) {
        clear(state.host);
