...
At least one reviewed screenshot must show a meaningful interaction state, not only an empty landing surface. For a converter app, the reviewed evidence should visibly include entered values and a rendered conversion result.
