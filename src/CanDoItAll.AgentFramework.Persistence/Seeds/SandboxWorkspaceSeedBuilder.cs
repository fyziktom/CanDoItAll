...
internal static class SandboxWorkspaceSeedBuilder
{
    ...
    private const string SeriousDeliveryManagedSeedVersion = "2026-06-agent-template-teams-v20";
    ...
    internal static SandboxWorkspaceDocument Build()
    {
        ...
        var workspaceDotnetStopCapabilityId = CreateStableGuid("capabilities/workspace-dotnet-stop");
        ...
        var capabilities = new List<CapabilityCatalogItem>
        {
            ...
            CreateToolCapability(workspaceDotnetStopCapabilityId, "workspace-dotnet-stop", "Workspace Dotnet Stop", "Stops a kept-alive workspace_dotnet_run process tree from its startup.json receipt and writes cleanup.json proof next to the receipt. Use this instead of workspace_pwsh_run_script for runtime cleanup.", "workspace_dotnet_stop"),
