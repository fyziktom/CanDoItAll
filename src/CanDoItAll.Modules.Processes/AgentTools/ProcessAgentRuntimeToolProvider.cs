...
public sealed class ProcessAgentRuntimeToolProvider(
    ...
    ProcessTemplateMermaidExporter templateMermaidExporter) : IAgentRuntimeToolProvider
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return ValueTask.FromResult(CreateTools(context.Agent));
    }

    private IReadOnlyList<AITool> CreateTools(AgentDefinition agent)
    {
