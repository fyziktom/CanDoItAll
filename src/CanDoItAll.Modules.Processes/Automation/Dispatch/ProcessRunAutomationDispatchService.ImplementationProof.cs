...
internal sealed partial class ProcessRunAutomationDispatchService
{
    ...
    {
        return ProcessSoftwareDeliveryEvidenceAdapter.ResolveMissingConcreteImplementationProofSummary(
            candidate,
            detail);
    }
    ...
    private static string ResolveMissingRunnableApplicationProofSummary(
        ...
        ProcessAutomationExecutionRunDetail detail)
    {
        return ProcessSoftwareDeliveryEvidenceAdapter.ResolveMissingRunnableApplicationProofSummary(
            candidate,
            detail);
    }
