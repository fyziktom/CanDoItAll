...
public static class ProjectAssignmentGanttProjectionAdapter
{
...
public sealed record ProjectAssignmentGanttProjection(
...
public sealed record ProjectAssignmentGanttProjectionIssue(
    ProjectPartyAssignmentDetail Assignment,
    ProjectAssignmentGanttProjectionIssueCode Code,
    string Message);

public enum ProjectAssignmentGanttProjectionIssueCode
{
    InvalidDateRange,
    UnrepresentableDate,
    MissingPartyName
