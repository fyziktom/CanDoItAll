...
namespace CanDoItAll.AgentFramework.UI.Capabilities;
...
public sealed record AgentCapabilityOperationPresentation(Guid AgentId, Guid AttemptId, string Message,
    bool CanVerify, bool CanReconcile, bool CanRetry, bool CanAdopt, bool CanAcknowledgeDiagnostic);

public sealed record AgentCapabilityCuratorPresentation(Guid AttemptId, bool IsBusy, bool RequiresAcknowledgement, bool HasOpenedChat);
...
public sealed record AgentCapabilitiesSnapshot(
    ...
    public AgentCapabilityOperationPresentation? Operation { get; init; }
    public AgentCapabilityPreview? Preview { get; init; }
    public bool IsBusy { get; init; }
    public bool IsAccessPreviewBusy { get; init; }
    public AgentCapabilityCuratorPresentation CuratorLaunch { get; init; } = new(Guid.Empty, false, false, false);
...
public abstract record AgentCapabilitiesIntent {
    ...
    public sealed record AcknowledgeDiagnostic(Guid AgentId, Guid AttemptId) : AgentCapabilitiesIntent;
    public sealed record AcknowledgeCurator(Guid AttemptId) : AgentCapabilitiesIntent;
}
