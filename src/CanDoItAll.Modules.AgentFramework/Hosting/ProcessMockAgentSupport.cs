...
public static class ProcessMockAgentCatalog
{
    ...
    [
        new(
            ...
            "Product Owner",
            "Writes deterministic calculator scope and acceptance criteria.",
            "Write the calculator scope artifact and preserve clear acceptance criteria for downstream agents.",
        ...
        new(
            ...
            "Solution Architect",
            "Writes deterministic calculator architecture guidance.",
            "Write concise architecture notes for a simple calculator app and pass concrete constraints to implementation.",
        ...
        new(
            ...
            "Developer",
            "Writes the first deterministic calculator implementation artifact.",
            "Produce the first calculator implementation artifact. This mock intentionally leaves one QA defect so repair-loop testing is deterministic.",
            AgentWorkloadKind.Programming),
        new(
            ...
            "Process Mock QA",
            "QA Reviewer",
            "Rejects the first calculator implementation and approves the repaired version.",
            "Review calculator artifacts deterministically. Reject the first implementation for repair, then approve the repaired implementation.",
        ...
        new(
            ...
            "Repair Developer",
            "Writes the deterministic calculator repair artifact.",
            "Repair the calculator implementation according to QA findings and preserve a clear repair note.",
            AgentWorkloadKind.Programming),
        new(
