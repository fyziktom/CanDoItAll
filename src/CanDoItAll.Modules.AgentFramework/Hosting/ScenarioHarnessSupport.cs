...
internal static class ScenarioHarnessCatalog
{
    ...
    [
        ...
        new(
            "SC03",
            "Blazor Calculator Generation",
            "Generate a Blazor Web App, replace the home page with a calculator, and build it through the controlled command surface.",
            "SC03 - Generate a .NET 10 Blazor Web App, turn the home page into a simple four-operation calculator, write a README, and build it with the standard dotnet recipe surface.",
        ...
        new(
            "SC10",
            "Calculator Delivery Review",
            "Inspect a generated calculator delivery and produce a review artifact from the integrated runtime.",
            "SC10 - Review the generated ScenarioCalculator project, confirm the calculator assets exist, and save a concise review report.",
            ScenarioAutomationMode.Automated,
            false,
            ["review", "artifacts", "calculator"],
            ["Depends on a generated ScenarioCalculator project."],
            "Automated when a calculator project already exists. In the process proof it should run as the review step after SC03."),
        new(
            "SC11",
            "Multi-Agent Calculator Delivery Process",
            "Run the full process-centric calculator workflow across staffing, approval, agent execution, and messaging.",
            "SC11 - Define and execute the multi-agent calculator delivery process through launch, approval, execution, messaging, and completion.",
            ScenarioAutomationMode.Guided,
            false,
            ["process", "multi-agent", "calculator"],
