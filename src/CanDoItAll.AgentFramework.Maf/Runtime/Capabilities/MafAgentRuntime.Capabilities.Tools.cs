        ...
        IReadOnlyList<FileSkillExecutionPolicy> fileSkillExecutionPolicies)
    {
            ...
            bool suppressApprovalRequirements = false)
        {
            ...
            var tools = toolKey switch
            {
                ...
                "workspace-list-files" or "workspace_list_files" => [AIFunctionFactory.Create(workspacePlugin.ListWorkspaceFiles, "workspace_list_files", "Lists files from the workspace.")],
        ...
        private IReadOnlyList<AITool> CreateWorkspacePluginTools()
        {
            ...
            [
                ...
                AIFunctionFactory.Create(workspacePlugin.ListWorkspaceFiles, "workspace_list_files", "Lists files from the current workspace."),
                AIFunctionFactory.Create(workspacePlugin.SearchWorkspace, "workspace_search", "Searches for text in the current workspace."),
                AIFunctionFactory.Create(workspacePlugin.ReadWorkspaceTextFile, "workspace_read_file", "Reads a text file from the current workspace."),
                AIFunctionFactory.Create(workspacePlugin.StatWorkspacePath, "workspace_stat_path", "Returns file or directory metadata for a workspace path."),
