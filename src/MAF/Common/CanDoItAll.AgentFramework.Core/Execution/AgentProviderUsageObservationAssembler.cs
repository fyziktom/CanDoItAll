...
internal sealed class AgentProviderUsageObservationAssembler
{
    public IReadOnlyList<ProviderUsageObservation> BuildUsageObservations(
    ...
    public IReadOnlyList<ProviderUsageObservation> BuildRuntimeResponseUsageObservations(
        ExecutionRunRecord run,
        AgentDefinition agent,
        ProviderProfile provider,
        AgentRunMetric metric,
    ...
    public IReadOnlyList<ProviderUsageObservation> BuildFailureUsageObservations(
        ExecutionRunRecord run,
        AgentDefinition agent,
        ProviderProfile provider,
    ...
    public IReadOnlyList<ProviderUsageObservation> BuildRepairUsageObservations(
        ExecutionRunRecord run,
        AgentDefinition agent,
        ProviderProfile provider,
    ...
    public static AgentRuntimeResponse AppendRepairUsageObservations(
    ...
    private static ProviderUsageObservation EnrichUsageObservation(
        ExecutionRunRecord run,
        AgentDefinition agent,
        ProviderProfile provider,
        ProviderUsageObservation observation,
