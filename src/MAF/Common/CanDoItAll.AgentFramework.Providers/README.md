...
```powershell
dotnet test tests/Unit/CanDoItAll.Tests.Unit/CanDoItAll.Tests.Unit.csproj --filter "FullyQualifiedName~Provider"
dotnet test tests/Unit/CanDoItAll.Tests.Unit/CanDoItAll.Tests.Unit.csproj --filter "FullyQualifiedName~ProviderRuntime|FullyQualifiedName~ProviderDispatchLaneGate|FullyQualifiedName~ProviderBatchJobBalancer"
```
