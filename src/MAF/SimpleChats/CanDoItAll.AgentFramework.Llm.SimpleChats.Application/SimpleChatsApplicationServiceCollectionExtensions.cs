...
namespace CanDoItAll.AgentFramework.Llm.SimpleChats;

public static class SimpleChatsApplicationServiceCollectionExtensions
{
    public static IServiceCollection AddSimpleChatsApplication(this IServiceCollection services)
    {
