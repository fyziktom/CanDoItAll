...
internal sealed class CognitiveMemoryAutomationSettingsRecordConfiguration : IEntityTypeConfiguration<CognitiveMemoryAutomationSettingsRecord>
{
    public void Configure(EntityTypeBuilder<CognitiveMemoryAutomationSettingsRecord> builder)
    {
        ...
        builder.Property(settings => settings.IsEnabled).HasDefaultValue(false).IsRequired();
        builder.Property(settings => settings.AllowedProviderProfileIds).HasColumnType("TEXT");
        builder.Property(settings => settings.ExecutionProfilesJson).HasColumnName("ModelExecutionProfilesJson").HasColumnType("TEXT");
