...
internal static class MemoryWorkflowExecutorDescriptors
{
    ...
    public static WorkflowExecutorDescriptor MemoryOperation { get; } =
        WorkflowExecutorDescriptorFactory.CreateImplemented(
            ...
            "Memory operation",
            "Executes generic Memory Protocol v1 operations through the shared memory operation handler.",
            ...
            deterministicTestMode: WorkflowExecutorDeterministicTestModeDescriptor.Supported("Routes to the configured generic memory operation handler, which can be substituted in tests."),
