...
Modules own product-facing behavior, navigation, pages, typed UI state, application
services, and module-specific tool providers.
...
| [Test Lab](CanDoItAll.Modules.TestLab/README.md) | Product-facing validation scenarios |
| [Workbench](CanDoItAll.Modules.Workbench/README.md) | Workbench, canvas, and project-structure orchestration |
| [Workspace](CanDoItAll.Modules.Workspace/README.md) | Workspace settings, storage, and data sources |

See the maintained [module map](../../docs/architecture/modules.md) for the module
contract and cross-module rules.
