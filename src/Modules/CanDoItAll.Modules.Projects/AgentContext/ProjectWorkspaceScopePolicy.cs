...
public sealed class ProjectWorkspaceScopePolicy {
    ...
    public ToolInvocationPolicyDecision? EvaluateProjectScope(
        ...
        foreach (var pathArgument in pathArguments) {
            ...
            var normalizedPath = WorkspacePathMatching.NormalizeForMatching(pathArgument.Value);
            ...
            if (WorkspacePathMatching.HasParentTraversalSegment(pathArgument.Value)) {
                return ToolInvocationPolicyDecision.Deny(
                    signature,
            ...
            if (WorkspacePathMatching.IsExternalTargetAliasPath(pathArgument.Value)) {
                continue;
            }
    ...
    public static bool IsManagedProjectMediaPathForCurrentProject(
        string path,
        ToolInvocationPolicyContext context) {
