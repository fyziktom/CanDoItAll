    ...
    public static ProjectStructureNodeCatalogResponse BuildAgentNodeCatalog()
    {
        ...
        return new ProjectStructureNodeCatalogResponse(
            ...
            [
                ...
                "Use Infrastructure with objectSubtype docker-mode for Docker runtime nodes; set metadata.infrastructure.runtimeCommand, runtimeArguments, workingDirectory, and folderPath so the UI can expose only the direct, terminal, and elevation capabilities available on the current host.",
