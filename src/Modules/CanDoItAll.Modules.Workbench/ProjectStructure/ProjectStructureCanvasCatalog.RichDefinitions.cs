...
internal static partial class ProjectStructureCanvasCatalog
{
    ...
    [
        ...
        new("add-file-text", ProjectObjectType.File, "text", "assets", "Text", "Create a plain text node for notes, configs, or snippets.", "text", "neutral", "Text file", "File title", "Runbook", "Folder", "docs/runbooks", "Purpose", "Describe what this file is for", RequiresFile: false, AcceptedFileTypes: ProjectTextAssetFormatCatalog.ResolveBrowserAcceptedFileTypes(ProjectFileSubtype.Text), FilePrompt: "Drop a text file here or choose one.", SubmitLabel: "Add text file", AllowsFileUpload: true),
        new("add-file-json", ProjectObjectType.File, "json", "assets", "JSON", "Create a JSON node with structured file semantics.", "json", "neutral", "JSON file", "File title", "appsettings override", "Folder", "config", "Purpose", "Describe what this JSON file configures", RequiresFile: false, AcceptedFileTypes: ProjectTextAssetFormatCatalog.ResolveBrowserAcceptedFileTypes(ProjectFileSubtype.Json), FilePrompt: "Drop a JSON file here or choose one.", SubmitLabel: "Add JSON file", AllowsFileUpload: true),
        new("add-file-markdown", ProjectObjectType.File, "markdown", "assets", "Markdown", "Create a markdown node for docs, specs, and notes.", "markdown", "sky", "Markdown file", "File title", "README draft", "Folder", "docs", "Purpose", "Describe what this document covers", false, ProjectTextAssetFormatCatalog.ResolveBrowserAcceptedFileTypes(ProjectFileSubtype.Markdown), "Drop a markdown file here or choose one.", true, "Add markdown", AllowsFileUpload: true),
        new("add-file-mermaid", ProjectObjectType.File, "mermaid", "assets", "Mermaid", "Create a Mermaid diagram node with detected diagram type feedback.", "mermaid", "accent", "Mermaid diagram", "Diagram title", "Deployment flow", "Folder", "docs/diagrams", "Purpose", "Describe what this diagram explains", false, ProjectTextAssetFormatCatalog.ResolveBrowserAcceptedFileTypes(ProjectFileSubtype.Mermaid), "Drop a Mermaid file here or choose one.", true, "Add diagram", AllowsFileUpload: true),
        ...
        new("add-file-log", ProjectObjectType.File, "log", "assets", "Log", "Create or attach a typed log file so operational evidence is explicit.", "log", "neutral", "Log file", "File title", "build-output.log", "Usage", "Runtime or job name", "Notes", "What this log shows", RequiresFile: false, AcceptedFileTypes: ProjectTextAssetFormatCatalog.ResolveBrowserAcceptedFileTypes(ProjectFileSubtype.Log), FilePrompt: "Drop a log file here or choose one.", SubmitLabel: "Add log", AllowsFileUpload: true),
        ...
        new("add-repository-folder", ProjectObjectType.Repository, "folder", "runtime", "Folder", "Track a folder inside the configured workspace that can be shown in the system file browser and reused as runtime context.", "folder", "sky", "Local folder", "Folder label", "Shared assets", "Folder path", "C:\\repositories\\shared-assets", "Purpose", "Why this folder matters", false, string.Empty, "Drop a file here or choose one.", true, "Add folder", [Field("repositoryMode", "Mode", "select", "Choose mode", true, [Option("localFolder", "Local folder")]), Field("localPath", "Folder path", "text", "C:\\repositories\\shared-assets", true), Field("relativePath", "Relative path", "text", "docs")], [DefaultValue("repositoryMode", "localFolder")]),
        new("add-script-powershell", ProjectObjectType.Script, "powershell", "runtime", "PowerShell script", "Track an explicit PowerShell script or command with typed arguments and approval policy.", "powershell", "primary", "PowerShell script", "Script title", "Apply migrations", "Context", "Project or owner", "Notes", "What this script does", false, string.Empty, "Drop a file here or choose one.", true, "Add script", ScriptFields(ProjectScriptKind.PowerShell)),
        new("add-script-posix-shell", ProjectObjectType.Script, "posix-shell", "runtime", "POSIX shell script", "Track an explicit POSIX shell script or command with typed arguments and approval policy.", "terminal", "neutral", "POSIX shell script", "Script title", "Run maintenance", "Context", "Project or owner", "Notes", "What this script does", false, string.Empty, "Drop a file here or choose one.", true, "Add script", ScriptFields(ProjectScriptKind.PosixShell)),
        ...
        new("add-environment-python", ProjectObjectType.Environment, "python", "runtime", "Python environment", "Persist a provider, environment, optional entry point, and arguments for direct Python execution.", "python", "mint", "Python environment", "Environment", ".venv", "Context", "Repo or project", "Notes", "How this environment is used", false, string.Empty, "Drop a file here or choose one.", true, "Add environment", [Field("environmentKind", "Kind", "select", "Choose environment", true, [Option("pythonEnvironment", "Python environment")]), Field("pythonProvider", "Provider", "select", "Choose provider", true, PythonProviderOptions), Field("environmentName", "Name", "text", ".venv", true), Field("projectPath", "Project path", "text", "C:\\repositories\\CanDoItAll", true), Field("entryPoint", "Entry point", "text", "app.py"), Field("environmentArguments", "Arguments", "text", "--port 8000")], [DefaultValue("environmentKind", "pythonEnvironment")]),
    ...
    private static IReadOnlyList<CanvasWorkbenchInputField> TaskWorkItemFields()
        =>
        [
    ...
    private static string ResolveScriptKindLabel(ProjectScriptKind kind)
        => kind switch
        {
            ...
            ProjectScriptKind.PosixShell => "POSIX shell",
