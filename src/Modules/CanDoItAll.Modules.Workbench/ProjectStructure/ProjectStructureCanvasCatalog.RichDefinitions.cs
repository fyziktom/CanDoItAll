...
internal static partial class ProjectStructureCanvasCatalog
{
    ...
    [
        ...
        new("add-file-text", ProjectObjectType.File, "text", "assets", "Text", "Create a plain text node for notes, configs, or snippets.", "text", "neutral", "Text file", "File title", "Runbook", "Folder", "docs/runbooks", "Purpose", "Describe what this file is for", RequiresFile: false, AcceptedFileTypes: ".txt,text/plain", FilePrompt: "Drop a text file here or choose one.", SubmitLabel: "Add text file", AllowsFileUpload: true),
        new("add-file-json", ProjectObjectType.File, "json", "assets", "JSON", "Create a JSON node with structured file semantics.", "json", "neutral", "JSON file", "File title", "appsettings override", "Folder", "config", "Purpose", "Describe what this JSON file configures", RequiresFile: false, AcceptedFileTypes: ".json,application/json", FilePrompt: "Drop a JSON file here or choose one.", SubmitLabel: "Add JSON file", AllowsFileUpload: true),
        new("add-file-markdown", ProjectObjectType.File, "markdown", "assets", "Markdown", "Create a markdown node for docs, specs, and notes.", "markdown", "sky", "Markdown file", "File title", "README draft", "Folder", "docs", "Purpose", "Describe what this document covers", false, ".md,.markdown,.txt,text/markdown,text/plain", "Drop a markdown file here or choose one.", true, "Add markdown", AllowsFileUpload: true),
        new("add-file-mermaid", ProjectObjectType.File, "mermaid", "assets", "Mermaid", "Create a Mermaid diagram node with detected diagram type feedback.", "mermaid", "accent", "Mermaid diagram", "Diagram title", "Deployment flow", "Folder", "docs/diagrams", "Purpose", "Describe what this diagram explains", false, ".mmd,.mermaid,text/vnd.mermaid,text/plain", "Drop a Mermaid file here or choose one.", true, "Add diagram", [Field("mermaidText", "Mermaid source", "textarea", "graph TD\nA[Start] --> B[Done]", true)], AllowsFileUpload: true),
