    ...
    private string BuildCanvasOverlayRenderKey()
    {
        ...
        if (processStartDialog is not null)
        {
            builder.Append("|process-start:")
                .Append(processStartDialog.DialogId)
                .Append(':')
                .Append(processStartDialog.LaunchIntentId.Value)
                .Append(':')
                .Append(processStartDialog.LaunchAuthority is not null)
                .Append(':')
                .Append(processStartDialog.IntentStorageKey is not null)
                .Append(':')
                .Append(processStartDialog.PreparedRequest is not null)
                .Append(':')
                .Append(processStartDialog.PreparedRequest?.PreparedAdmissionId?.Value)
                .Append(':')
                .Append(processStartDialog.IsAccepted)
                .Append(':')
