...
internal sealed class BrowserObservedDefectEvidenceContribution : IProcessCompletionDefectEvidenceContribution
{
    ...
    private static readonly Regex VisibleBrowserDefectRegex = new(
        @"(?:\b(?:captured|displayed|expos(?:e(?:d|s)?|ing)|found|not\s+hidden|observed|present|renders?|rendered|reported|showed|shown|visible|visibly)\b.{0,160}(?:#blazor-error-ui|\b(?:blazor|framework)\s+error\s+ui\b|\ban\s+(?:unexpected|unhandled)\s+error\s+(?:has\s+)?occurred\b|\bunhandled\s+(?:application\s+|browser\s+|runtime\s+)?error\b|\b(?:application|browser|page|runtime|ui)\s+(?:crash|error|exception|failure)\b))|(?:(?:#blazor-error-ui|\b(?:blazor|framework)\s+error\s+ui\b|\ban\s+(?:unexpected|unhandled)\s+error\s+(?:has\s+)?occurred\b|\bunhandled\s+(?:application\s+|browser\s+|runtime\s+)?error\b|\b(?:application|browser|page|runtime|ui)\s+(?:crash|error|exception|failure)\b).{0,160}\b(?:captured|displayed|expos(?:e(?:d|s)?|ing)|found|not\s+hidden|observed|present|renders?|rendered|reported|showed|shown|visible|visibly)\b)",
        RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
    private static readonly Regex NegatedBrowserDefectRegex = new(
        @"(?:\b(?:captured|displayed|expos(?:e(?:d|s)?|ing)|found|observed|reported|showed|shown)\b.{0,40}\b(?:no|not|never|without)\b.{0,40}(?:#blazor-error-ui|\b(?:blazor|framework)\s+error\s+ui\b|\ban\s+(?:unexpected|unhandled)\s+error\s+(?:has\s+)?occurred\b|\bunhandled\s+(?:application\s+|browser\s+|runtime\s+)?error\b|\b(?:application|browser|page|runtime|ui)\s+(?:crash|error|exception|failure)\b))|(?:\b(?:no|without)\s+(?:displayed\s+|present\s+|rendered\s+|shown\s+|visible\s+)?(?:#blazor-error-ui|\b(?:blazor|framework)\s+error\s+ui\b|\ban\s+(?:unexpected|unhandled)\s+error\s+(?:has\s+)?occurred\b|\bunhandled\s+(?:application\s+|browser\s+|runtime\s+)?error\b|\b(?:application|browser|page|runtime|ui)\s+(?:crash|error|exception|failure)\b))|(?:\b(?:not|never)\s+(?:captured|displayed|expos(?:e(?:d|s)?|ing)|found|observed|present|rendered|reported|showed|shown|visible)\b.{0,40}(?:#blazor-error-ui|\b(?:blazor|framework)\s+error\s+ui\b|\ban\s+(?:unexpected|unhandled)\s+error\s+(?:has\s+)?occurred\b|\bunhandled\s+(?:application\s+|browser\s+|runtime\s+)?error\b|\b(?:application|browser|page|runtime|ui)\s+(?:crash|error|exception|failure)\b))|(?:(?:#blazor-error-ui|\b(?:blazor|framework)\s+error\s+ui\b|\ban\s+(?:unexpected|unhandled)\s+error\s+(?:has\s+)?occurred\b|\bunhandled\s+(?:application\s+|browser\s+|runtime\s+)?error\b|\b(?:application|browser|page|runtime|ui)\s+(?:crash|error|exception|failure)\b).{0,40}\b(?:absent|(?:is|was|remains?|became)\s+hidden|no\s+longer\s+(?:displayed|present|rendered|shown|visible)|not\s+(?:displayed|present|rendered|shown|visible)|display\s*(?:is|was|=|:)\s*none)\b)",
        RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
