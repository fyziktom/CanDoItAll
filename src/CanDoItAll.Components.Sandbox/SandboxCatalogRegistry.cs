...
public static class SandboxCatalogRegistry
{
    ...
    [
        ...
        new(
            ...
            "Navigation",
            "/groups/navigation",
            "Shared navigation primitives for workspace tabs, steps, and list-detail movement.",
            ["tabs", "secondary tabs", "steps", "list detail shells"],
            ["Keyboard navigation should remain coherent.", "The active state must be obvious at a glance.", "Dense content should not break the affordance model."]),
        new(
    ...
    [
        ...
        CreateExample("actions-happy", SandboxGroupKey.Actions, "Primary action hierarchy", SandboxScenarioKey.HappyPath, "Primary, secondary, and ghost action contrast.", ["buttons"], "Button"),
        CreateExample("actions-dense", SandboxGroupKey.Actions, "Dense inline actions", SandboxScenarioKey.DenseContent, "Action rows inside a compact review surface.", ["dense", "inline"], "Button", "StatusBadge"),
        ...
        CreateExample("navigation-happy", SandboxGroupKey.Navigation, "Workspace navigation", SandboxScenarioKey.HappyPath, "Tabs, steps, and list-detail shell in a standard workflow.", ["keyboard", "tabs"], "Tabs", "Steps", "ListDetailShell"),
        ...
        CreateCustomExample("navigation-tabs-lab", SandboxGroupKey.Navigation, "Tabs lab", "/groups/navigation/tabs", SandboxScenarioKey.HappyPath, "Dedicated tabs page for border modes, overflow strategies, consumer classes, and failure-path coverage.", ["tabs", "responsive", "edge-cases"], "Tabs"),
        CreateExample("feedback-happy", SandboxGroupKey.Feedback, "Status surfaces", SandboxScenarioKey.HappyPath, "Alerts, badges, notifications, and load states.", ["status"], "Alert", "Notification", "StatusBadge"),
        ...
        CreateExample("overlays-happy", SandboxGroupKey.Overlays, "Contextual help", SandboxScenarioKey.HappyPath, "Help popovers and sticky actions around a review surface.", ["overlay"], "HelpPopover", "StickyActionFooter"),
        CreateExample("overlays-dense", SandboxGroupKey.Overlays, "Dense approval flow", SandboxScenarioKey.DenseContent, "Inline approval surface with secondary actions and modal affordance.", ["dense", "approval"], "StickyActionFooter", "Alert"),
        CreateExample("overlays-empty", SandboxGroupKey.Overlays, "No modal context", SandboxScenarioKey.EmptyState, "Overlay surface before the user selects a record.", ["empty"], "EmptyState", "HelpPopover"),
