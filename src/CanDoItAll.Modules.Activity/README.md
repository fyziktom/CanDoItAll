# CanDoItAll.Modules.Activity

## Purpose

Product module for activity feeds, audit-style events, and runtime activity surfaces.
...
```powershell
dotnet build src/CanDoItAll.Modules.Activity/CanDoItAll.Modules.Activity.csproj
```
