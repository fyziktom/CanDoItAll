...
internal sealed class EfMemoryRetentionApplier(
    IDbContextFactory<AppDbContext> dbContextFactory)
{
        ...
        string reason)
    {
        ...
        if (decision == MemoryLedgerRetentionDecision.Forget &&
            record.IpfsSnapshot is { PinState: MemoryIpfsPinState.Pinned } ipfs)
        {
            record = record with
            {
