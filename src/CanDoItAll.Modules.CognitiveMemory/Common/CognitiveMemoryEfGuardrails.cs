...
public static class CognitiveMemoryEfGuardrails
{
    ...
    [
        ...
        new(typeof(CognitiveMemoryCuratorSessionRecord), [nameof(CognitiveMemoryCuratorSessionRecord.ProjectId), nameof(CognitiveMemoryCuratorSessionRecord.Status), nameof(CognitiveMemoryCuratorSessionRecord.UpdatedAtUtc)], false),
        new(typeof(CognitiveMemoryCuratorSessionRecord), [nameof(CognitiveMemoryCuratorSessionRecord.ProjectId), nameof(CognitiveMemoryCuratorSessionRecord.RuntimeMode), nameof(CognitiveMemoryCuratorSessionRecord.ConversationDepth), nameof(CognitiveMemoryCuratorSessionRecord.Status)], false),
        new(typeof(CognitiveMemoryCuratorTurnRecord), [nameof(CognitiveMemoryCuratorTurnRecord.CuratorSessionId), nameof(CognitiveMemoryCuratorTurnRecord.Sequence)], true),
        new(typeof(CognitiveMemoryCuratorCapturedImprovementRecord), [nameof(CognitiveMemoryCuratorCapturedImprovementRecord.ProjectId), nameof(CognitiveMemoryCuratorCapturedImprovementRecord.CaptureKind), nameof(CognitiveMemoryCuratorCapturedImprovementRecord.Status), nameof(CognitiveMemoryCuratorCapturedImprovementRecord.CreatedAtUtc)], false),
