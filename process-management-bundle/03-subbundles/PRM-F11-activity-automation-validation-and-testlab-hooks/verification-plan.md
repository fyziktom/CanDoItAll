# Verification plan — PRM-F11

## Expected verification outcomes

- Activity entries and automation signals appear for the expected process events.
- Validation/TestLab attachments round-trip across process run queries.

## Automated tests

- Unit tests for core rules and invariants relevant to `PRM-F11`
