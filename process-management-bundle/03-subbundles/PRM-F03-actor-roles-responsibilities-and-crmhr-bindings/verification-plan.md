# Verification plan — PRM-F03

## Expected verification outcomes

- Bindings resolve CRM-HR parties and AI-agent profiles.
- Rebinding changes only future or explicitly reassigned work, not historical facts.
- Actor UIs show durable identity plus display snapshot.

## Automated tests

- Unit tests for core rules and invariants relevant to `PRM-F03`
