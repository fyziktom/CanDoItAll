# Verification plan — PRM-F15

## Expected verification outcomes

- Both migration projects compile and apply cleanly.
- Core process queries stay performant in integration smoke tests.

## Automated tests

- Unit tests for core rules and invariants relevant to `PRM-F15`
