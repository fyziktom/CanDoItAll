# Verification plan — PRM-F01

## Expected verification outcomes

- App boots with the new module enabled.
- Shell navigation highlights Processes correctly.
- Project UX links reach the process surfaces.
- No existing route or module registration regresses.

## Automated tests

- Unit tests for core rules and invariants relevant to `PRM-F01`
