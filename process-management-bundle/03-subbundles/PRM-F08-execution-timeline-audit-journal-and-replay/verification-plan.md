# Verification plan — PRM-F08

## Expected verification outcomes

- Journal coverage exists for start, claim, handoff, approval, branch selection, completion, and failure.
- Replay output matches the observed run path.

## Automated tests

- Unit tests for core rules and invariants relevant to `PRM-F08`
