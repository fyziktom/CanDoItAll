# Verification plan — PRM-F12

## Expected verification outcomes

- Import warnings are explicit and test-covered.
- JSON packages preserve full semantics even when Mermaid does not.

## Automated tests

- Unit tests for core rules and invariants relevant to `PRM-F12`
