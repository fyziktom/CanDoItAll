# Verification plan — PRM-F02

## Expected verification outcomes

- Publishing freezes a version snapshot.
- Cloning a template creates a draft in the target scope.
- Invalid graphs are rejected before publication.

## Automated tests

- Unit tests for core rules and invariants relevant to `PRM-F02`
