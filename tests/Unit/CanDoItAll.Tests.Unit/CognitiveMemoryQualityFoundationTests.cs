...
public sealed class CognitiveMemoryQualityFoundationTests
{
    ...
    {
        var qualitySource = ReadRepositoryFiles("src", "Modules", "CanDoItAll.Modules.CognitiveMemory", "Quality");
    ...
    {
        var advancedSource = ReadRepositoryFiles("src", "Modules", "CanDoItAll.Modules.CognitiveMemory", "Advanced");
        var qualitySource = ReadRepositoryFiles("src", "Modules", "CanDoItAll.Modules.CognitiveMemory", "Quality");
