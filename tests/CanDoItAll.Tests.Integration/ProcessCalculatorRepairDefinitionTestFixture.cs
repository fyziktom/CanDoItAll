...
internal static class ProcessCalculatorRepairDefinitionTestFixture
{
    public static class StepKeys
    {
        public const string Scope = "calculator-scope";
        public const string Architecture = "calculator-architecture";
        public const string FirstImplementation = "calculator-first-implementation";
        public const string QaFirstReview = "calculator-qa-first-review";
        public const string DirectReleaseNotes = "calculator-direct-release-notes";
        public const string RepairImplementation = "calculator-repair-implementation";
        public const string QaRecheck = "calculator-qa-recheck";
        public const string ReleaseNotes = "calculator-release-notes";
    }
    ...
    public static class ArtifactTitles
    {
        ...
        public const string Architecture = "Calculator architecture artifact";
        public const string FirstImplementation = "Calculator first implementation artifact";
        public const string QaFirstReview = "Calculator QA rejection artifact";
        public const string DirectReleaseNotes = "Calculator direct release notes artifact";
        public const string RepairImplementation = "Calculator repair artifact";
        public const string QaRecheck = "Calculator QA approval artifact";
        public const string ReleaseNotes = "Calculator release notes artifact";
    }

    public static CalculatorRepairProcessDefinitionFixture Create(Guid projectId)
    {
        ...
        {
            ProjectId = projectId,
            Name = "Deterministic calculator QA repair process",
            Summary = "Exercises calculator scope, implementation, QA rejection, repair, QA approval, and release notes.",
            ...
            ChangeSummary = "Initial deterministic calculator repair-loop definition.",
            ...
            [
                ...
                CreateRole(
                    ...
                    "Repair Developer",
                    "Own calculator defect repair.",
                    "Process mock repair developer for deterministic divide-by-zero fix."),
                CreateRole(
            ...
            [
                ...
                new ProcessStepEditorModel
                {
                    ...
                    Title = "Write calculator architecture",
                    StepKind = ProcessStepKind.Work,
                    Dependencies = CreateDependencies((scopeStepId, null)),
                    InputContractSummary = "Accepted calculator scope.",
                    ...
                    [
                        CreateArtifactExpectation(
                            ...
                            "Architecture artifact must define the calculator boundary and QA expectations.")
                    ]
                },
                new ProcessStepEditorModel
                {
                    ...
                    Title = "Write first calculator implementation",
                    StepKind = ProcessStepKind.Work,
                    ...
                    [
                        CreateArtifactExpectation(
                            ...
                            "First implementation artifact must identify the deterministic divide-by-zero defect.")
                    ]
                },
                new ProcessStepEditorModel
                {
                    ...
                    Title = "Review first calculator implementation",
                    ...
                    ExceptionPolicySummary = "Block when QA cannot identify the required disposition.",
                    TargetLeadHours = 1,
                    CanvasX = 980,
                    CanvasY = 160,
                    BranchOutcomes =
                    [
                        new ProcessStepBranchOutcomeEditorModel
                        {
                            ...
                            Description = "Route the calculator implementation through defect repair."
                        },
                        new ProcessStepBranchOutcomeEditorModel
                        {
                ...
                new ProcessStepEditorModel
                {
                    ...
                    Title = "Write direct calculator release notes",
                ...
                new ProcessStepEditorModel
                {
                    ...
                    Title = "Repair calculator implementation",
                    StepKind = ProcessStepKind.Work,
                    ...
                    OutputContractSummary = "Repaired calculator implementation.",
                    ...
                    [
                        CreateArtifactExpectation(
                            ...
                            "Repair artifact must document the divide-by-zero fix.")
                    ]
                },
                new ProcessStepEditorModel
                {
                    ...
                    Title = "Recheck repaired calculator implementation",
                    StepKind = ProcessStepKind.Review,
                    ...
                    ExceptionPolicySummary = "Block when repair verification is incomplete.",
                    TargetLeadHours = 1,
                    CanvasX = 1540,
                    CanvasY = 240,
                    BranchOutcomes =
                    [
                        new ProcessStepBranchOutcomeEditorModel
                        {
                            ...
                            Key = BranchOutcomeKeys.Approved,
                            Title = "Approved",
                            Description = "Route repaired calculator implementation to release notes."
                        }
                    ],
                    RoleAssignments =
                    [
                ...
                new ProcessStepEditorModel
                {
                    ...
                    Title = "Write calculator release notes",
                    StepKind = ProcessStepKind.Delivery,
        ...
        return new CalculatorRepairProcessDefinitionFixture(
            editor,
            stepIdsByKey,
...
internal sealed record CalculatorRepairProcessDefinitionFixture(
