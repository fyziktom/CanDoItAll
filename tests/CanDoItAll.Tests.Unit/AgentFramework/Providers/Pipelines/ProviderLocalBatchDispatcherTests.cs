...
public sealed class ProviderLocalBatchDispatcherTests
{
    ...
    public void ProviderPipelineProject_HasCleanDependencyDirection()
    {
        ...
        var projectFile = File.ReadAllText(Path.Combine(root, "src/CanDoItAll.AgentFramework.ProviderPipelines/CanDoItAll.AgentFramework.ProviderPipelines.csproj"));
        ...
        var source = string.Join(
            Environment.NewLine,
            Directory
                .EnumerateFiles(Path.Combine(root, "src", "CanDoItAll.AgentFramework.ProviderPipelines"), "*.cs")
    ...
    public void ProviderPipelinePhase_DoesNotAdoptExistingConsumers()
    {
        ...
        var filesThatMustNotAdoptProviderPipelines = new[]
        {
            ...
            "src/CanDoItAll.AgentFramework.Voice/CanDoItAll.AgentFramework.Voice.csproj",
