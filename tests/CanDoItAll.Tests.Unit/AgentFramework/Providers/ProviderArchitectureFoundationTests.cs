...
public sealed class ProviderArchitectureFoundationTests
{
    ...
    public void GenericProviderContracts_DoNotExposeProviderSpecificOperationNames()
    {
        ...
        var providerProjectRoot = Path.Combine(root, "src/CanDoItAll.AgentFramework.Providers");
    ...
    public void FoundationPhase_DoesNotReplaceExistingRuntimeConsumers()
    {
        ...
        Assert.Contains(
            ...
            File.ReadAllText(Path.Combine(root, "src/CanDoItAll.AgentFramework.Core/Contracts/Contracts.cs")),
            StringComparison.Ordinal);
        Assert.Contains(
            "ApplyProviderModelMaintenanceResult",
            File.ReadAllText(Path.Combine(root, "src/CanDoItAll.AgentFramework.Core/Providers/ProviderServices.cs")),
            StringComparison.Ordinal);
        Assert.Contains(
            "providerRuntimeGateway",
            File.ReadAllText(Path.Combine(root, "src/CanDoItAll.AgentFramework.Maf/Runtime/Providers/MafAgentRuntime.ProviderHealth.cs")),
            StringComparison.Ordinal);
        Assert.Contains(
            "ProviderRuntimeVoiceDriver",
            File.ReadAllText(Path.Combine(root, "src/CanDoItAll.AgentFramework.Voice/AgentVoiceDriverFactory.cs")),
            StringComparison.Ordinal);
        var imageToolProviderSource = File.ReadAllText(Path.Combine(root, "src/CanDoItAll.Modules.AgentFramework/AgentTools/ImageGenerationAgentRuntimeToolProvider.cs"));
        Assert.Contains(
