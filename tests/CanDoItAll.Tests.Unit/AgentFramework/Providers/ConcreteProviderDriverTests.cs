...
public sealed class ConcreteProviderDriverTests
{
    ...
    public void ConcreteDrivers_ConsumersUseProviderRuntimeAdoptionBoundaries()
    {
        ...
        Assert.Contains(
            ...
            File.ReadAllText(Path.Combine(root, "src/CanDoItAll.AgentFramework.Maf/Runtime/Providers/MafProviderRuntimeGateway.cs")),
            StringComparison.Ordinal);
        Assert.Contains(
            "IAgentImageGenerationService",
            File.ReadAllText(Path.Combine(root, "src/CanDoItAll.Modules.AgentFramework/AgentTools/ImageGenerationAgentRuntimeToolProvider.cs")),
            StringComparison.Ordinal);
