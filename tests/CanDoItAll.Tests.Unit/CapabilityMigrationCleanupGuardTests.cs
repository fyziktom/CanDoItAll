...
public sealed class CapabilityMigrationCleanupGuardTests
{
    ...
    {
        var source = ReadRepositoryFile("src/CanDoItAll.AgentFramework.Persistence/Seeds/SandboxWorkspaceSeedBuilder.cs");
    ...
    {
        var source = ReadRepositoryFiles("src/CanDoItAll.AgentFramework.Maf/Runtime/Capabilities");
    ...
    {
        var accessSource = ReadRepositoryFiles("src/CanDoItAll.AgentFramework.Maf/Runtime/Capabilities");
        var policySource = ReadRepositoryFile("src/CanDoItAll.AgentFramework.Maf/Runtime/Capabilities/MafAgentRuntime.Capabilities.Access.Policies.cs");
    ...
    {
        var mafSource = ReadRepositoryFiles("src/CanDoItAll.AgentFramework.Maf/Runtime/Capabilities");
        var evaluatorSource = ReadRepositoryFile("src/CanDoItAll.AgentFramework.Capabilities.Access/CapabilityAccessPolicyEvaluator.cs");
    ...
    public void SB12_INV_CLEANUP_005_external_tool_and_mcp_setup_failures_remain_structured()
    {
        var source = string.Join(
            Environment.NewLine,
            ReadRepositoryFile("src/CanDoItAll.AgentFramework.Tools/External/ExternalProcessToolInvoker.cs"),
            ReadRepositoryFile("src/CanDoItAll.AgentFramework.Tools/External/ExternalHttpToolInvoker.cs"),
            ReadRepositoryFile("src/CanDoItAll.AgentFramework.Tools/External/ToolDiagnostics.cs"),
            ReadRepositoryFile("src/CanDoItAll.AgentFramework.Mcp/Runtime/McpSetupTestService.cs"),
            ReadRepositoryFile("src/CanDoItAll.AgentFramework.Mcp/Diagnostics/McpDiagnostics.cs"));
        ...
        Assert.Contains("MaskedDetail", ReadRepositoryFile("src/CanDoItAll.AgentFramework.Capabilities.Abstractions/CapabilityModels.cs"), StringComparison.Ordinal);
