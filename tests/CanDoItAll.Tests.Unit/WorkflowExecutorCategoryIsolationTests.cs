...
public sealed class WorkflowExecutorCategoryIsolationTests
{
    ...
    public void DefaultExecutorImplementationsMovedOutOfMafWorkflowFolder()
    {
        ...
        var mafWorkflowFolder = Path.Combine(root, "src", "CanDoItAll.AgentFramework.Maf", "Runtime", "Workflows");
        ...
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Control", "ControlWorkflowExecutors.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Transforms", "JsonTransformWorkflowExecutor.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Workspace", "WorkspaceFileWorkflowExecutor.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Network", "HttpFetchWorkflowExecutor.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Documents", "SpreadsheetWorkflowExecutor.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Media", "ImageGenerationWorkflowExecutor.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.ProjectStructure", "ProjectStructureWorkflowExecutor.cs")));
    }
    ...
    {
        var root = FindRepositoryRoot();
        var mafRegistration = File.ReadAllText(Path.Combine(root, "src", "CanDoItAll.AgentFramework.Workflows.MafAdapter", "MafWorkflowAdapterServiceCollectionExtensions.cs"));
        var moduleRegistration = File.ReadAllText(Path.Combine(root, "src", "CanDoItAll.Modules.AgentFramework", "Services", "AgentFrameworkModuleServiceCollectionExtensions.cs"));
    ...
    public void StandardCategoryProjectsUseExpectedDependencyBoundaries()
    {
        AssertProjectReferences(
            "src/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Control/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Control.csproj",
        ...
        AssertProjectReferences(
            "src/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Transforms/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Transforms.csproj",
            ...
            ["Microsoft.Extensions.DependencyInjection.Abstractions"]);
        AssertProjectReferences(
            "src/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Workspace/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Workspace.csproj",
        ...
        AssertProjectReferences(
            "src/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Network/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Network.csproj",
            ...
            ["Microsoft.Extensions.DependencyInjection.Abstractions"]);
        AssertProjectReferences(
            "src/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Documents/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Documents.csproj",
            ...
            ["Microsoft.Extensions.DependencyInjection.Abstractions"]);
        AssertProjectReferences(
            "src/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Media/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Media.csproj",
            ["CanDoItAll.AgentFramework.Core", "CanDoItAll.AgentFramework.Models", "CanDoItAll.AgentFramework.WorkflowExecutors.Core"],
            ["Microsoft.Extensions.DependencyInjection.Abstractions"]);
        AssertProjectReferences(
            "src/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.ProjectStructure/CanDoItAll.AgentFramework.WorkflowExecutors.Standard.ProjectStructure.csproj",
    ...
    public void LargeExecutorCategoriesAreSplitByResponsibility()
    {
        var root = FindRepositoryRoot();
        AssertSplit(
            Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.Workspace"),
            "SourceIngestionWorkflowExecutor.cs",
            [
        ...
        AssertSplit(
            Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Standard.ProjectStructure"),
            "ProjectStructureWorkflowExecutor.cs",
            [
