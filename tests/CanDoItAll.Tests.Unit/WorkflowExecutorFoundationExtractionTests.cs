...
public sealed class WorkflowExecutorFoundationExtractionTests
{
    ...
    {
        var abstractionReferences = ReadProjectReferences("src/CanDoItAll.AgentFramework.WorkflowExecutors.Abstractions/CanDoItAll.AgentFramework.WorkflowExecutors.Abstractions.csproj");
        Assert.Equal(
        ...
        var coreReferences = ReadProjectReferences("src/CanDoItAll.AgentFramework.WorkflowExecutors.Core/CanDoItAll.AgentFramework.WorkflowExecutors.Core.csproj");
        Assert.Equal(
            [
                "CanDoItAll.AgentFramework.Models",
    ...
    public void ExecutorContractsAndSharedHelpersMovedOutOfOldOwners()
    {
        ...
        {
            Path.Combine(root, "src", "CanDoItAll.AgentFramework.Core", "Workflows", "WorkflowExecutorContracts.cs"),
            Path.Combine(root, "src", "CanDoItAll.AgentFramework.Core", "Workflows", "WorkflowExecutorObservability.cs")
        };
        ...
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Abstractions", "WorkflowExecutorContracts.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Core", "WorkflowExecutorInvoker.cs")));
        Assert.True(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.WorkflowExecutors.Core", "WorkflowExecutorJson.cs")));
        Assert.False(File.Exists(Path.Combine(root, "src", "CanDoItAll.AgentFramework.Maf", "Runtime", "Workflows", "WorkflowExecutorJson.cs")));
    ...
    public void HostAndModuleRegistrationUseExecutorCoreExtension()
    {
        ...
        {
            Path.Combine(root, "src", "CanDoItAll.AgentFramework.Hosting", "AgentFrameworkServiceCollectionExtensions.cs"),
            Path.Combine(root, "src", "CanDoItAll.Modules.AgentFramework", "Services", "AgentFrameworkModuleServiceCollectionExtensions.cs")
        };
    ...
    public void FeatureModulesAndPluginsReferenceExecutorFoundationProjects()
    {
        AssertProjectReferences(
            "src/CanDoItAll.Modules.CognitiveMemory/CanDoItAll.Modules.CognitiveMemory.csproj",
            "CanDoItAll.AgentFramework.WorkflowExecutors.Core");
        AssertProjectReferences(
        ...
        AssertProjectReferences(
            ...
            "CanDoItAll.AgentFramework.WorkflowExecutors.Abstractions");
        AssertProjectReferences(
            "src/plugins/CanDoItAll.Plugin.Docker/CanDoItAll.Plugin.Docker.csproj",
            "CanDoItAll.AgentFramework.WorkflowExecutors.Abstractions");
    }
