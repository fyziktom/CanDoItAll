...
public sealed class WorkflowAbstractionsBuilderTests
{
    ...
    public void WorkflowAbstractionAndBuilderProjectsDoNotReferenceForbiddenImplementationProjects()
    {
        ...
        {
            Path.Combine(root, "src", "CanDoItAll.AgentFramework.Workflows.Abstractions", "CanDoItAll.AgentFramework.Workflows.Abstractions.csproj"),
            Path.Combine(root, "src", "CanDoItAll.AgentFramework.Workflows.Builder", "CanDoItAll.AgentFramework.Workflows.Builder.csproj")
        };
