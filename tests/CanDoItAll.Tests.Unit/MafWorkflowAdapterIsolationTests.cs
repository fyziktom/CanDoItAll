...
public sealed class MafWorkflowAdapterIsolationTests
{
    ...
    {
        var root = FindRepoRoot();
        var adapterRoot = Path.Combine(root, "src", "CanDoItAll.AgentFramework.Workflows.MafAdapter");
        ...
        var mafWorkflowDirectory = Path.Combine(root, "src", "CanDoItAll.AgentFramework.Maf", "Runtime", "Workflows");
