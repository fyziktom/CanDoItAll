...
Keep node identity stable, preserve brainstorming history, and model typed evolution through facet activation/invalidation or node-kind transition history rather than destructive in-place mutation.
